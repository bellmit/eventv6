 ...
 * 
 */
@Service(value = "zhouBianStatOfPetitionRecordService")
public class ZhouBianStatOfPetitionRecordServiceImpl implements IZhouBianStatService {
	@Autowired
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("peopleTypeTableName", "T_ZZ_PETITION_RECORD");
