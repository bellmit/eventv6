package cn.ffcs.zhsq.drawGrid.controller;
...
import cn.ffcs.shequ.zzgl.service.grid.IGisGridInfoService;
 ...
 */
@Controller
@RequestMapping(value = "/zhsq/drowGridController")
public class DrowGridController  extends ZZBaseController{
	@Autowired
	private IGisGridInfoService gisGridInfoService;
	@Autowired
	...
	public String index(HttpSession session,
		...
		return "/zzgl/drowGrid/list_drowGrid.ftl";
	}
	...
	public cn.ffcs.common.EUDGPagination listData(
		...
		eudPagination = gisGridInfoService.findGisGridInfoPagination(page, rows, paramsMap);
