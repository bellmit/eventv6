 ...
 *
 */
@Service(value="zhouBianStatOfVolunteerFireTeamService")
public class ZhouBianStatOfVolunteerFireTeamServiceImpl implements IZhouBianStatService {
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("markType", ConstantValue.MARKER_TYPE_FIRE_XF_ZY);
	...
	public String getZhouBianPagePath(String zhoubianType) {
		return "/map/arcgis/standardmappage/zhoubian/zhoubian_volunteerfireteam.ftl";
	}
