...
@Service(value = "kuangXuanStatOfStreetlight")
public class KuangXuanStatOfStreetlightImpl implements IKuangXuanStatService {

	@Autowired
	protected IGisInfoService gisInfoService;

	/**
	 * 根据params的参数获取路灯的统计信息
	 * 
	 * @param params
	 * @return
	 */
	...
	public int statOfKuangXuan(Map<String, Object> params) {
		params.put("resTypeId", 24L);
		params.put("markerType", "02010501");
