 ...
 * 框选志愿消防队服务
 */
@Service(value = "kuangXuanStatOfVolunteerFireTeamService")
public class KuangXuanStatOfVolunteerFireTeamServiceImpl implements IKuangXuanStatService {
	...
	public int statOfKuangXuan(Map<String, Object> params) {
		params.put("markerType", ConstantValue.MARKER_TYPE_FIRE_XF_ZY);
	...
	public String getKuangXuanPagePath(String kuangXuanType) {
		return "/map/arcgis/standardmappage/kuangxuan/kuangxuan_volunteerFireTeam.ftl";
	}
}
