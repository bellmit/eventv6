 ...
 *
 */
@Service(value="zhouBianStatOfNaturalWaterSourceService")
public class ZhouBianStatOfNaturalWaterSourceServiceImpl implements IZhouBianStatService {
	@Autowired 
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		...
		int resultCount = this.zhouBianStatMapper.statOfWaterSourceZhouBianCount(params);
		return resultCount;
	}
	...
	public EUDGPagination statOfZhouBianList(int pageNo, int pageSize,
		...
		if (pageNo == 1) {
			pagination.setTotal(this.zhouBianStatMapper.statOfWaterSourceZhouBianCount(params));
		}
		RowBounds rowBounds = new RowBounds((pageNo - 1) * pageSize, pageSize);
		List<Map<String, Object>> list = this.zhouBianStatMapper.statOfWaterSourceZhouBianListPage(params, rowBounds);
