 ...
 *
 */
@Service(value="zhouBianSyrysService")
public class ZhouBianStatOfSyrysServiceImpl implements IZhouBianStatService {
	@Autowired 
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("peopleTypeTableName", "T_DC_CI_RS_UNEMPLOYED");
		params.put("empWay", "shiye");
		int resultCount = this.zhouBianStatMapper.getZKSListboxChoseByOrgCode(params);
		return resultCount;
	}
	...
	public EUDGPagination statOfZhouBianList(int pageNo, int pageSize,
		...
		params.put("empWay", "shiye");
		if (pageNo == 1) {
			pagination.setTotal(this.zhouBianStatMapper.getZKSListboxChoseByOrgCode(params));
		}
		RowBounds rowBounds = new RowBounds((pageNo - 1) * pageSize, pageSize);
		List<Map<String, Object>> list = this.zhouBianStatMapper.getZKSListboxChoseByOrgCodePageList(params, rowBounds);
