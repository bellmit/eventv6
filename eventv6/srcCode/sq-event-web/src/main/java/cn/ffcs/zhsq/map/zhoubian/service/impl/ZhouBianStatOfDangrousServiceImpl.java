 ...
 * 
 */
@Service(value = "zhouBianStatOfDangrousService")
public class ZhouBianStatOfDangrousServiceImpl implements IZhouBianStatService {
	@Autowired
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("peopleTypeTableName", "T_ZZ_DANGEROUS_GOODS_RECORD");
