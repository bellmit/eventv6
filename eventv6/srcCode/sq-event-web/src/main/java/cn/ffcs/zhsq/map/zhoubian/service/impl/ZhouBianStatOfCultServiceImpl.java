 ...
 * 
 */
@Service(value = "zhouBianStatOfCultService")
public class ZhouBianStatOfCultServiceImpl implements IZhouBianStatService {
	@Autowired
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("peopleTypeTableName", "T_ZZ_CULT_RECORD");
