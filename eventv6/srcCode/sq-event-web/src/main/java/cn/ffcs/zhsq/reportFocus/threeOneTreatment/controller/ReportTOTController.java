package cn.ffcs.zhsq.reportFocus.threeOneTreatment.controller;

import cn.ffcs.zhsq.reportFocus.reportFeedback.IReportFeedbackService;
import cn.ffcs.zhsq.reportFocus.threeOneTreatment.service.impl.FocusReportNode364Enum;
import cn.ffcs.zhsq.reportFocus.threeOneTreatment.service.impl.TOTDataSourceEnum;
 ...
 */
@Controller
@RequestMapping("/zhsq/reportTOT")
public class ReportTOTController extends ReportTwoVioPreController {
    ...
    public String toList(HttpSession session,
                         ...
                         @RequestParam(value = "reportType", required=false, defaultValue="15") String reportType,
                         @RequestParam Map<String, Object> params,
                         ModelMap map) {
        super.toList(session, listType, reportType, params, map);

        return "/zzgl/reportFocus/threeOneTreatment/list_tot.ftl";
    }
    ...
    public String toMsgReadingList(HttpSession session,
        ...
        return "/zzgl/reportFocus/threeOneTreatment/list_tot_msgReading.ftl";
    }
    ...
    public String toAdd(HttpSession session,
        ...
        return "/zzgl/reportFocus/threeOneTreatment/add_tot.ftl";
    }
    ...
    public String toDetail(HttpSession session,
        ...
        map.addAttribute("formType", FocusReportNode364Enum.FORM_TYPE.toString());

        if(CommonFunctions.isNotBlank(map,"isEditable") && Boolean.valueOf(String.valueOf(map.get("isEditable")))) {

            return "/zzgl/reportFocus/threeOneTreatment/detail_tot_editable.ftl";
        }

        return "/zzgl/reportFocus/threeOneTreatment/detail_tot.ftl";
    }

    @Override
    protected boolean isFrom12345(Object dataSource) {
        return TOTDataSourceEnum.PLATFORM_12345.getDataSource().equals(dataSource);
    }

    @Override
    protected String getBizType() {
        return IReportFeedbackService.BizType.THREE_ONE_TREATMENT.getCode();
    }
}
