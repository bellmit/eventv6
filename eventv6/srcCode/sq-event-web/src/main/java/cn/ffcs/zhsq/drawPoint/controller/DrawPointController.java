package cn.ffcs.zhsq.drawPoint.controller;
 ...
 */
@Controller
@RequestMapping(value = "/zhsq/drawPointController")
public class DrawPointController  extends ZZBaseController{
	@Autowired
...
//		map.addAttribute("USE_DRAW_BUILDING_OUTLINE", USE_DRAW_BUILDING_OUTLINE);
		...
		return "/zzgl/drawPoint/list_drawPoint.ftl";
	}
	@ResponseBody
	...
	public EUDGPagination listData(
		...
		paramsMap.put("pointName", pointName);
		...
		EUDGPagination eudPagination = pointInfoService.searchMapList(page, rows, paramsMap);
