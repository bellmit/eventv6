...
/**
 * @Description: 南安房屋安全隐患信息流程_常规_重大(3530102)流程节点名称
 * @ClassName:   FocusReportNode3530102Enum   
 * @author:      张联松(zhangls)
 * @date:        2020年11月25日 下午3:02:12
 */
public enum FocusReportNode3530102Enum {
	WORKFLOW_TYPE_ID("focus_report", "流程类型"),
	FORM_TYPE_ID("3530102", "流程表单ID"),
	...
	private FocusReportNode3530102Enum(String taskNodeName, String taskNodeNameZH) {
