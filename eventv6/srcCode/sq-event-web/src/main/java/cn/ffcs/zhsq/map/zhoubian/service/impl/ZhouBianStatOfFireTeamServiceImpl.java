 ...
 *
 */
@Service(value="zhouBianStatOfFireTeamService")
public class ZhouBianStatOfFireTeamServiceImpl implements IZhouBianStatService {
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		...
		int resultCount = this.zhouBianStatMapper.statOfFireTeamZhouBianCount(params);
		return resultCount;
	}
	...
	public EUDGPagination statOfZhouBianList(int pageNo, int pageSize, Map<String, Object> params) {
		...
		if (pageNo == 1) {
			pagination.setTotal(this.zhouBianStatMapper.statOfFireTeamZhouBianCount(params));
		}
		RowBounds rowBounds = new RowBounds((pageNo - 1) * pageSize, pageSize);
		List<Map<String, Object>> list = this.zhouBianStatMapper.statOfFireTeamZhouBianListPage(params, rowBounds);
	...
	public String getZhouBianPagePath(String zhoubianType) {
		return "/map/arcgis/standardmappage/zhoubian/zhoubian_fireteam.ftl";
	}
