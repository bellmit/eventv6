 ...
 * 框选义务消防队服务
 */
@Service(value = "kuangXuanStatOfObligationFireTeamService")
public class KuangXuanStatOfObligationFireTeamServiceImpl implements IKuangXuanStatService {
	...
	public int statOfKuangXuan(Map<String, Object> params) {
		params.put("markerType", ConstantValue.MARKER_TYPE_FIRE_XF_YW);
	...
	public String getKuangXuanPagePath(String kuangXuanType) {
		return "/map/arcgis/standardmappage/kuangxuan/kuangxuan_obligationFireTeam.ftl";
	}
}
