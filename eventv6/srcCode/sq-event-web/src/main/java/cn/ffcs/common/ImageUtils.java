...
public class ImageUtils {
	...
	public static void main(String[] args) {
		// 1-缩放图像：
		// 方法一：按比例缩放
//        ImageUtils.scale("e:/1.jpg", "e:/2.jpg", 2, true);//测试OK
//        // 方法二：按高度和宽度缩放
//        ImageUtils.scale2("e:/1.jpg", "e:/2.jpg", 300, 300, true);//测试OK
//
//        // 2-切割图像：
//        // 方法一：按指定起点坐标和宽高切割
...
//        // 方法三：指定切片的宽度和高度
//		  ImageUtils.cut3("e:/1.jpg", "e:/2.jpg", 300, 300 );//测试OK
//
//        // 3-图像类型转换：
...
//        ImageUtils.pressImage("e:/abc2.jpg", "e:/abc.jpg","e:/abc_pressImage.jpg", 0, 0, 0.5f);//测试OK
		ImageUtils.rsscale("e:/1.jpg","e:/1.jpg",280);
	}
	 ...
	 * @param flag 缩放选择:true 放大; false 缩小;
	 */
	public final static void rsscale(String srcImageFile, String result,
									 int size) {
		double scale = 1;
		try {
			BufferedImage src = ImageIO.read(new File(srcImageFile)); // 读入文件
			...
			if(width > size || height > size){
				if(width > height){
					scale = mutiple(width,size);
				}else{
					scale = mutiple(height,size);
				}
			}
	...
	public static double mutiple(int a, int b){
		String aStr = String.valueOf(a);
		String bStr = String.valueOf(b);
		double c = Double.parseDouble(aStr)/Double.parseDouble(bStr);
		return c;
	}
