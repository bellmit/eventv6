                                ...
                                <div class="RightShadow">
                                    <div class="list NorForm" style="position:relative;">
                                        ...
                                        <@block name="collectWaysCondition">
                                            ...
                                            <tr>
                                                <td>
                                                    <label class="LabName width65px"><span>快捷标签：</span></label>
...
<script type="text/javascript">
    ...
    function add() {
        var url = '${rc.getContextPath()}/zhsq/event/problemReportController/toAddEventByType.jhtml?typesForList=${typesForList!}&trigger=${trigger!}';
	<#if isRemoveTypes??>
    ...
    function edit() {
        ...
        var url = '${rc.getContextPath()}/zhsq/event/problemReportController/toAddEventByType.jhtml?eventId='+idStr+'&typesForList=${typesForList!}&trigger=${trigger!}';
        <#if isRemoveTypes??>
        	url += '&isRemoveTypes=${isRemoveTypes?c}';
        </#if>
    ...
    function print() {
        ...
        if(_bizPlatform == "001"){
            ...
            var url = '${rc.getContextPath()}/zhsq/event/problemReportController/print.jhtml?eventId='+idStr;
    ...
    function del() {
        ...
        $.messager.confirm('提示', '您确定删除选中的事件吗？', function(r){
            if(_bizPlatform == "001"){
                $.ajax({
                    type: "POST",
                    url: '${rc.getContextPath()}/zhsq/event/problemReportController/delOldEvent.jhtml',
                    data: 'oldidStr='+idStr,
                    dataType:"json",
                ...
                if (r){
                    ...
                    $.ajax({
                        type: "POST",
                        url: '${rc.getContextPath()}/zhsq/event/problemReportController/delEvent.jhtml',
                        data: 'idStr='+idStr,
                        dataType:"json",
                        success: function(data){
                            modleclose();
    ...
    function invalid(operateName, invalidType) {
		...
		$.messager.confirm('提示', '您确定' + operateName + '选中的事件吗？', function(r){
			if(r) {
				...
				var url = '${rc.getContextPath()}/zhsq/event/problemReportController/toInvalidEvent.jhtml',
    ...
    function restart() {
        if(idStr) {
            ...
            if(status && status != '04') {
                ...
                var url = '${rc.getContextPath()}/zhsq/event/problemReportController/toRestartEvent.jhtml?eventId='+idStr+'&typesForList=${typesForList!}&trigger=${trigger!}';
			<#if isRemoveTypes??>
                url += '&isRemoveTypes=${isRemoveTypes?c}';
			</#if>
    ...
    function changeEventList() {
        ...
        var url = '${rc.getContextPath()}/zhsq/event/problemReportController/listEvent.jhtml?t=${eventType}&model=${model}&trigger=${trigger!}&eventAttrTrigger=${eventAttrTrigger!}';
