...
<script type="text/javascript">
	$(function() {
		...
		AnoleApi.initListComboBox("stateStr", "state", null, null, [""], {
        	...
        	DataSrc: [{"name":"受理中", "value":"1"},{"name":"单位处理", "value":"2"},{"name":"退回发起人", "value":"3"},{"name":"归档待评", "value":"4"},{"name":"已评价", "value":"5"}]
        });
	...
	function loadList() {
		$('#list').datagrid({
			...
			singleSelect: true,
			fit: true,
			url: '${rc.getContextPath()}/zhsq/requestion/listDataAll_Main.jhtml',
