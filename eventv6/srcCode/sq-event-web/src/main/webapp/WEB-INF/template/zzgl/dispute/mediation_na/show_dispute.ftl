                                                ...
                                                <div class="pb15 deviceSumbox">
                                                    ...
                                                    <div class="tab_docking_type" style="display: block">
                                                        <table class="table table-bordered table-hover">
                                                            ...
                                                            <tr>
                                                                <td >当事人信息：</td>
                                                                <td title="${partydate.party_name}"><input name="party_name" id="party_name"
                                                                           type="text"
                                                                           value="${partydate.party_name}"
                                                                           class="m-wrap media required"
                                                                           readonly></td>
                                                                <td title="${partydate.party_sex}" style="width:50px"><input name="party_sex" id="party_sex"
                                                                           type="text"
                                                                           value="${partydate.party_sex}"
                                                                           class="m-wrap media required"
                                                                           readonly>
                                                                </td>
                                                                <td title="${partydate.party_idCard}"><input name="party_idCard" id="party_idCard"
                                                                           type="text"
                                                                           value="${partydate.party_idCard}"
                                                                           class="m-wrap media required"
                                                                           readonly></td>
                                                                <td title="${partydate.party_phone}"><input name="party_phone" id="party_phone"
                                                                           type="text"
                                                                           value="${partydate.party_phone}"
                                                                           class="m-wrap media required"
                                                                           readonly></td>
                                                                <td title="${partydate.party_address}" style="width:430px"><input name="party_address"
                                                                           id="party_address"
                                                                           type="text"
                                ...
                                <div class="span10" style="padding-left:130px;">
                                    <div class="bootstrap-table"><div class="fixed-table-toolbar">
                                            ...
                                            <div class="fixed-table-body">
                                                <table    data-page-list="[5, 10, 20, 50, 100, 200]" data-search="false" data-height="460"  class="table table-hover" style="/* margin-top: -40px; */">
                                                    <thead style="">
                                                    <tr style="">
                                                        <th style="">
...
<script type="text/javascript">
    <#if attachment?? && attachment?size ==0>$("#photo").hide() </#if>
</script>
<script type="text/javascript">
...
<script type="text/javascript">
    ...
    $(".img_item").click(function () {
        var divindex = $(this).attr("data");
        mySwiper.slideTo(divindex, 0, false);
        var enwidth = $(window).width();
        var enheight = window.innerHeight;
        $(".enlarge").width(enwidth);
        $(".enlarge").height(enheight);
