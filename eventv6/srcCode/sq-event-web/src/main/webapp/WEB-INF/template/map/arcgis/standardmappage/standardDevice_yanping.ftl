...
function CloseSearchBtn(){
	...
	function gisPosition(res){
		if (typeof parent.MMApi != "undefined") {	// 判断是否是高德地图
			...
			opt.ecs = $('#elementsCollectionStr').val();
			opt.gridId = $('#gridId').val();
			opt.url = "${rc.getContextPath()}/zhsq/map/arcgis/arcgisDataOfYanpingStDeviceController/getArcgisLocateDataListOfDeviceInfos.jhtml?ids="+res+"&markerType=${deviceType!}";
		...
		if($('#elementsCollectionStr').val() != "") {
			var url = "${rc.getContextPath()}/zhsq/map/arcgis/arcgisDataOfYanpingStDeviceController/getArcgisLocateDataListOfDeviceInfos.jhtml?ids="+res+"&markerType=${deviceType!}";
