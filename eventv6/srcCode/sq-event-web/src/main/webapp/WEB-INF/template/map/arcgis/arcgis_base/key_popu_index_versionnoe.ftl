...
<head>
	...
	#2、
	 -->
	 <script > 
	 var sysUrl = '${ANOLE_COMPONENT_URL}';
	 var fileUrl = "${SQ_FILE_URL!''}";
	 </script>
	...
	<style>
		...
		.mapchart{display:none;background:url(${uiDomain}/images/chart_bg1.png) no-repeat; width:266px; height:266px;position:absolute;z-index:4;top:40px;}
...
<div class="MapTools">
	...
	<div id="mapStyleDiv" class="MapStyle" style="display:none;bottom:58px;">
