	                                    ...
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                                    	...
	                                    	<tr>
	                                    		<td>
	                                    			...
	                                    			<input type="text" id="eventStatus" name="eventStatus" class="queryParam hide" />
	                                    			<input class="inp1" type="text" id="eventStatusName" style="width:135px;"></input>
	                                    		</td>
	                                    	</tr>
	                                    	<tr>
	                                    		<td>
	                                    	...
	                                    	<tr>
	                                    		<td>
	                                    			...
	                                    			<input type="text" id="source" name="source" class="queryParam hide" />
	                                    			<input class="inp1" type="text" id="sourceName" style="width:135px;"></input>
	                                    		</td>
	                                    	</tr>
	                                    	<tr>
	                                    		<td>
	                                    			<label class="LabName width65px"><span>紧急程度：</span></label>
	                                    			<input type="text" id="urgencyDegree" name="urgencyDegree" class="queryParam hide" />
	                                    			<input class="inp1" type="text" id="urgencyDegreeName" style="width:135px;"></input>
	                                    		</td>
	                                    	</tr>
	                                    </table>
	                                </div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		var eventStatusDictCodes4Remove = "${eventStatusDictCodes4Remove!}";
		
		AnoleApi.initListComboBox("eventStatusName", "eventStatus", {"A001093095":eventStatusDictCodes4Remove.split(",")}, null, null, { 
			RenderType: '01',
			ChooseType : "1",
			FilterType : "1",
			ShowOptions:{
		...
		AnoleApi.initListComboBox("sourceName", "source", "A001093222", null, null, { 
			RenderType: '01',
			ChooseType : "1",
			ShowOptions:{
        		EnableToolbar : true
		...
		AnoleApi.initListComboBox("urgencyDegreeName", "urgencyDegree", "A001093271", null, null, {
			RenderType: '01',
			ChooseType : "1",
			ShowOptions:{
        		EnableToolbar : true
