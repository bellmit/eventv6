...
<div class="MapBar">
    <div class="con AlphaBack">
    	...
    	<div class="zhuanti fr"><a href="javascript:void(0);">全球眼</a></div>
    </div>
    ...
    <div class="ztIcon AlphaBack titlefirstall" style="display:block;">
		<div class="title">
			...
			<span class="fr" onclick="showObjectList2();"><img src="${uiDomain!''}/images/map/gisv0/special_config/images/refresh.png" /></span>
...
function showObjectList2(){
	showObjectList('全球眼GIS');
	$("#titlePath").html("全球眼");
}
