...
<body style="border:none">
	...
	<input type="hidden" id="useNature" value="<#if useNature??>${useNature}</#if>" />
    ...
    <div class="" style="display:block;">
        ...
        <div class="ListSearch">
        	<div class="condition">
            	<ul>
                	<li class="LC1">地址：</li>
                	<li class="LC2"><input id="addressKey" name="addressKey" type="text" class="inp1" /></li>
                </ul>
				<ul>
                	<li class="LC1">名称：</li>
			...
			success: function(data){
				...
				if(list && list.length>0) {
					for(var i=0;i<list.length;i++){
					  ...
					  if(buildingAddress!=null && buildingAddress!="" && buildingAddress.length>12){
						buildingAddress = buildingAddress.substring(0,15)+"...";
					  }else{
						buildingAddress = buildingAddress;
					  }
					  var standardAddress = val.standardAddress;
					  if(standardAddress!=null && standardAddress!="" && standardAddress.length>12){
						standardAddress = standardAddress.substring(0,11)+"...";
					  }else{
