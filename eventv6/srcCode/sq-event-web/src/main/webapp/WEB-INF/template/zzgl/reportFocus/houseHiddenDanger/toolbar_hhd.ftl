...
<div id="jqueryToolbar">
	<form id="hhdQueryForm">
		<input type="hidden" id="listType" name="listType" class="queryParam" value="${listType!'1'}" />
		<input type="hidden" id="reportType" name="reportType" value="${reportType!'2'}" class="queryParam iconParam" />
		<input type="hidden" name="routineInterval3530101" class="queryParam" value="${routineInterval3530101!}" />
		<input type="hidden" name="routineInterval3530102" class="queryParam" value="${routineInterval3530102!}" />
		<input type="hidden" name="routineInterval3530201" class="queryParam" value="${routineInterval3530201!}" />
		...
		<div class="ConSearch">
	        <div class="fl">
	        	<ul>
	            	...
	            	<li>关键字：</li>
	                <li><input name="keyWord" type="text" class="inp1 keyBlank w150 queryParam" id="keyWord" value="报告人姓名/楼栋地址" defaultValue="报告人姓名/楼栋地址" onfocus="_onfocus(this);" onblur="_onblur(this);" onkeydown="_onkeydown();" /></li>
	                            ...
	                            <div class="RightShadow">
	                                <div class="list NorForm" style="position:relative;">
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                                    	...
	                                    	<tr>
	                                    		<td><label class="LabName width65px"><span>楼栋名称：</span></label><input class="inp1 queryParam" type="text" name="buildingName" style="width:248px;"></input></td>
	                                    	</tr>
	                                    	<tr>
	                                    		<td>
	                                    			<label class="LabName width65px"><span>隐患类别：</span></label>
	                                    			<input type="text" class="hide queryParam" id="hhdType" name="hhdType" />
	                                    			<input class="inp1" type="text" id="hhdTypeName" style="width:248px;"></input>
	                                    		</td>
	                                    	</tr>
	                                    	<#if !(listType??) || (listType?? && listType != '1')>
	                                    	<tr>
	                                    		<td>
	                                    			<label class="LabName width65px"><span>隐患类型：</span></label>
	                                    			<input type="text" class="hide queryParam" id="riskType" name="riskType" />
	                                    			<input class="inp1" type="text" id="riskTypeName" style="width:248px;"></input>
	                                    		</td>
	                                    	</tr>
	                                    	</#if>
	                                    	<tr>
	        ...
	        <div class="btns">
	        	<ul>            	
	            	...
	            	<li><a href="#" class="chongzhi" title="重置查询条件" onclick="resetCondition('hhdQueryForm')">重置</a></li>
	            </ul>
	        </div>
	        <div class="clear"></div>‍
...
<script type="text/javascript">
	$(function() {
		...
		if($('#reportStatus').length > 0) {
			AnoleApi.initTreeComboBox("reportStatusName", "reportStatus", "B210004001", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		if($('#riskType').length > 0) {
			AnoleApi.initTreeComboBox("riskTypeName", "riskType", "B210004002", null, null, {
				ShowOptions: {
					EnableToolbar : true
				}
			});
		...
		AnoleApi.initTreeComboBox("hhdTypeName", "hhdType", "B210004003", null, null, {
			ShowOptions: {
				EnableToolbar : true
			}
		});
		...
		if($('#dataSourceArrayName').length > 0) {
			AnoleApi.initTreeComboBox("dataSourceArrayName", "dataSourceArray", "B210004009", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		init4DateRender('hhdQueryForm');
	});
    
    function queryData() {
    	var searchArray = new Array();
    	
		$("#hhdQueryForm .queryParam").each(function() {
...
<@block name="operateFunction">
	<#include "/zzgl/reportFocus/houseHiddenDanger/operate_hhd.ftl" />
</@block>
