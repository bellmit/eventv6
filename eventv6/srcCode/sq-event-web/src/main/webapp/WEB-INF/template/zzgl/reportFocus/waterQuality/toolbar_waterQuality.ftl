		...
		<div class="ConSearch">
	                            ...
	                            <div class="RightShadow">
	                                <div class="list NorForm" style="position:relative;">
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                                    	...
	                                    	<tr>
	                                    		<td>
	                                    			<label class="LabName width65px"><span>问题类型：</span></label>
	                                    			<input id="matterType" name="matterType" type="text" value="" class="queryParam hide"/>
	                                    			<input id="matterTypeName" type="text" class="inp1 InpDisable" style="width:248px;" />
	                                    		</td>
	                                    	</tr>
	                                    	<#if listType?? && (listType == '3' || listType == '4' || listType == '5' || listType == '6')>
	                                    		<tr>
	                                    			<td>
	                                    				<label class="LabName width65px"><span>行政处罚：</span></label>
	                                    				<input id="administrativeSactionType" name="administrativeSactionType" type="text" value="" class="queryParam hide"/>
	                                    				<input id="administrativeSactionTypeName" type="text" class="inp1 InpDisable" style="width:248px;" />
	                                    			</td>
	                                    		</tr>
	                                    	</#if>
	                                    	<tr>
	        ...
	        <div class="btns">
	        	<ul>            	
	            	...
	            	<li><a href="#" class="chongzhi" title="重置查询条件" onclick="resetCondition('waterQualityForm')">重置</a></li>
	            </ul>
	        </div>
	        <div class="clear"></div>‍
...
<script type="text/javascript">
	$(function() {
		...
		if($('#reportStatus').length > 0) {
			AnoleApi.initTreeComboBox("reportStatusName", "reportStatus", "B210005001", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		if($('#administrativeSactionType').length > 0) {
			AnoleApi.initTreeComboBox("administrativeSactionTypeName", "administrativeSactionType", "B210005003", null, null, {
				ShowOptions: {
					EnableToolbar : true
				}
			});
		...
		AnoleApi.initTreeComboBox("matterTypeName", "matterType", "B210005002", null, null, {
			ShowOptions: {
				EnableToolbar : true
			}
		});
		...
		if($('#dataSourceArrayName').length > 0) {
			AnoleApi.initTreeComboBox("dataSourceArrayName", "dataSourceArray", "B210005004", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		init4DateRender('waterQualityForm');
	});
	
	function queryData() {
		var searchArray = new Array();
    	
		$("#waterQualityForm .queryParam").each(function() {
...
<@block name="operateFunction">
	<#include "/zzgl/reportFocus/waterQuality/operate_waterQuality.ftl" />
</@block>
