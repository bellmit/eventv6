...
<div class="MapBar">
	...
	<div class="ztIcon AlphaBack world">
    	...
    	<div class="h_20"></div>
		<ul>
			<li class="YellowBg" onclick="showObjectList('护路护线')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon32.png" /></p>
				<p class="word AlphaBack">护路护线</p>
			</li>
			...
			<li class="YellowBg" onclick="showObjectList('网格')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon17.png" /></p>
				<p class="word AlphaBack">网格</p>
			</li>
			 <!-----------------------------------房------------------------------------->
	...
	<div class="ztIcon AlphaBack metter">
		...
		<ul>
			...
			<li class="CyanBg" onclick="showObjectList('归档事件')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/attention.png" /></p>
				<p class="word AlphaBack">归档事件</p>
			</li>
    ...
    <div class="ztIcon AlphaBack situation">
    	...
    	<div class="h_20"></div>
		<ul>
			<li class="PurpleBg" onclick="showObjectList('护路护线队员')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon31.png" /></p>
				<p class="word AlphaBack">护路护线队员</p>
			</li>
