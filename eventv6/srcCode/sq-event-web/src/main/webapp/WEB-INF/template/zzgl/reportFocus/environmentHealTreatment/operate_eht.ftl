<script type="text/javascript">
    function add(opt) {
        ...
        var url = "${rc.getContextPath()}/zhsq/reportEHT/toAdd.jhtml?listType=" + $('#listType').val();
    ...
    function edit() {
        ...
        if(reportUUID == "") {
            ...
            var url = "${rc.getContextPath()}/zhsq/reportEHT/toAdd.jhtml?listType=" + $('#listType').val() + "&reportUUID=" + reportUUID;
        ...
        if(reportUUID == "") {
            ...
            $.messager.confirm('提示', '您确定删除选中的整治信息吗？', function(r) {
                if(r){
                    ...
                    $.ajax({
                        type: "POST",
                        url: '${rc.getContextPath()}/zhsq/reportEHT/delReportFocus.jhtml',
