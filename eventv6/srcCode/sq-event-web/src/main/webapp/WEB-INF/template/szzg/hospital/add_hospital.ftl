...
<div>
    <div id="content-d" class="MC_con content light" style="overflow-x:hidden">
        <div class="NorForm NorForm2">
            <form id="tableForm" name="tableForm" action="${rc.getContextPath()}/zhsq/szzg/hospital/saveOrUpdate.jhtml"
                  method="post">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td><label class="LabName"><span>医院类型：</span></label>
                            ...
                            <input id="typeName" name="typeName" data-options="required:true" type="text"
                                   class="inp1 InpDisable easyui-validatebox" style="width:160px;"
                        </td>
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>医院名称：</span></label>
                            <input name="hospitalName" id="hospitalName" maxLength="100" type="text"
                                   class="inp1 easyui-validatebox" style="width: 500px;"
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>医院地址：</span></label>
                            <input name="address" id="address" maxLength="100" type="text"
                                   class="inp1 easyui-validatebox" style="width: 500px;"
                                   data-options="tipPosition:'bottom',required:true,validType:['maxLength[100]','characterCheck']"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="LeftTd"><label class="LabName"><span>法定代表人：</span></label>
                            <input name="legalRepresentative" id="legalRepresentative" type="text"
                                   style="height: 30px;width: 160px;" class="inp1 inp2 easyui-validatebox"
                                   maxlength="51"
                                   data-options="tipPosition:'bottom',validType:['maxLength[50]','characterCheck']"/>
                        </td>
                        <td><label class="LabName"><span>联系电话：</span></label>
                            <input name="tel" id="tel" style="height: 30px;width: 160px;" type="text"
                                   validType='mobileorphone' class="inp1 inp2 easyui-validatebox" maxlength="51"
                                   data-options="tipPosition:'bottom',validType:['maxLength[50]','characterCheck']"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="LeftTd"><label class="LabName"><span>邮政编码：</span></label>
                            <input name="postcode" id="postcode" type="text" style="height: 30px;width: 160px;"
                                   class="inp1 inp2 easyui-validatebox" validType='zipCode'
                                   data-options="tipPosition:'bottom',max:999999,min:0"/>
                        </td>
                        <td><label class="LabName"><span>官方网址：</span></label>
                            <input name="url" id="url" style="height: 30px;width: 160px;" type="text"
                                   class="inp1 inp2 easyui-validatebox" maxlength="51"
                                   data-options="tipPosition:'bottom',validType:['maxLength[50]','characterCheck']"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="LeftTd"><label class="LabName"><span>是否城镇职工医保定点单位：</span></label>
                            <div class="Check_Radio"><input type="checkBox" name="isUebmiFixedUnit"
                                                            id="isUebmiFixedUnit" value="0"
                                                            onclick="changeUebValue();"/><label for="isUebmiFixedUnit"
                                                                                                style="cursor:pointer;">是</label>
                            </div>
                        </td>
                        <td class="LeftTd"><label class="LabName"><span>是否新农合定点单位：</span></label>
                            <div class="Check_Radio"><input type="checkBox" name="isNcmsFixedUnit" id="isNcmsFixedUnit"
                                                            value="0" onclick="changeNcmValue();"/><label
                                    for="isNcmsFixedUnit" style="cursor:pointer;">是</label></div>
                        </td>
                    </tr>

                    <tr>
                        <td class="LeftTd"><label class="LabName"><span>占地面积：</span></label>
                            <input name="area" id="area" type="text" style="height: 30px;width: 160px;"
                                   class="inp1 inp2 easyui-numberbox"
                                   data-options="tipPosition:'bottom',precision:2,max:99999999,min:0"/>&nbsp;(公顷)
                        </td>
                        <td><label class="LabName"><span>建筑面积：</span></label>
                            <input name="constructionArea" id="constructionArea" style="height: 30px;width: 140px;"
                                   type="text" class="inp1 inp2 easyui-numberbox"
                                   data-options="tipPosition:'bottom',precision:2,max:99999999,min:0"/>&nbsp;(平方米)
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="LeftTd"><label class="LabName"><span>住院床位数：</span></label>
                            <input name="hospitalBeds" id="hospitalBeds" type="text" style="height: 30px;width: 160px;"
                                   class="inp1 inp2 easyui-numberbox"
                                   data-options="tipPosition:'bottom',max:99999999,min:0"/>&nbsp;(床)
                        </td>
                        <td><label class="LabName"><span>员工总数：</span></label>
                            <input name="employeeNum" id="employeeNum" style="height: 30px;width: 160px;" type="text"
                                   class="inp1 inp2 easyui-numberbox"
                                   data-options="tipPosition:'bottom',max:99999999,min:0"/>&nbsp;(人)
                        </td>
                    </tr>
                    <tr>
                        <td class="LeftTd"><label class="LabName"><span>专业技术人员数量：</span></label>
                            <input name="specialistNum" id="specialistNum" type="text"
                                   style="height: 30px;width: 160px;" class="inp1 inp2 easyui-numberbox"
                                   data-options="tipPosition:'bottom',max:99999999,min:0"/>&nbsp;(人)
                        </td>
                        <td><label class="LabName"><span>血库库存量：</span></label>
                            <input name="bloodBankStock" id="bloodBankStock" style="height: 30px;width: 160px;"
                                   type="text" class="inp1 inp2 easyui-numberbox"
                                   data-options="tipPosition:'bottom',max:99999999,min:0"/>&nbsp;(单位)
                        </td>
                    </tr>

                    <tr>
                        <td colspan="2" class="LeftTd RightTd"><label class="LabName"><span>医院简介：</span></label>
                            <textarea name="hospitalSummary" id="hospitalSummary" cols="45" rows="30"
                                      style="width: 500px;height: 80px;" class="area1 easyui-validatebox"
                                      maxLength="201"
                                      data-options="tipPosition:'bottom',validType:['maxLength[200]','characterCheck']"></textarea>
                        </td>
                    </tr>
