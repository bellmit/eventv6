...
<div id="jqueryToolbar">
	<form id="psvForm">
		...
		<input type="hidden" id="reportType" name="reportType" value="${reportType!'7'}" class="queryParam iconParam" />
		...
		<div class="ConSearch">
	                            ...
	                            <div class="RightShadow">
	                                <div class="list NorForm" style="position:relative;">
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                                    	...
	                                    	<tr>
	                                    		<td><label class="LabName width65px"><span>贫困户姓名：</span></label><input class="inp1 queryParam" type="text" name="poorVillagerName" style="width:248px;"></input></td>
	                                    	</tr>
	                                    	<tr>
	                                    		<td>
	                                    			<label class="LabName width65px"><span>发现来源：</span></label>
	                                    			<input type="text" class="hide queryParam" id="collectSource" name="collectSource" />
	                                    			<input class="inp1" type="text" id="collectSourceName" style="width:248px;"></input>
	                                    		</td>
	                                    	</tr>
	                                    	<tr>
	                                    		<td>
	        ...
	        <div class="btns">
	        	<ul>            	
	            	...
	            	<li><a href="#" class="chongzhi" title="重置查询条件" onclick="resetCondition('psvForm')">重置</a></li>
	            </ul>
	        </div>
	        <div class="clear"></div>‍
...
<script type="text/javascript">
	$(function() {
		...
		if($('#reportStatus').length > 0) {
			AnoleApi.initTreeComboBox("reportStatusName", "reportStatus", "B210007001", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		AnoleApi.initTreeComboBox("collectSourceName", "collectSource", "B210007002", null, null, {
			RenderType : "01",
			ShowOptions: {
				EnableToolbar : true
			}
		...
		init4DateRender('psvForm');
	});
	
	function queryData() {
		var searchArray = new Array();
		
		$("#psvForm .queryParam").each(function() {
...
<@block name="operateFunction">
	<#include "/zzgl/reportFocus/poorSupportVisit/operate_psv.ftl" />
</@block>
