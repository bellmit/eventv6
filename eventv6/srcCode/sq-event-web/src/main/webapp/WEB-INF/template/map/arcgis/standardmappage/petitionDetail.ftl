    ...
    <div class="con ManagerWatch">
        <div class="ManagerInfo">
            <ul>
                ...
                <li style="width:245px;">
                    ...
                    <p><code>所属区域：</code>${teamMember.orgName!''}</p>
        ...
        <div class="ManagerContact">
            <ul id="operationBtn">
                ...
                <li id="callPhone" class="YellowBg" onclick="showCall('${teamMember.tel!''}','${teamMember.name!''}','<#if teamMember.photoPath??>${RESOURSE_SERVER_PATH}${teamMember.photoPath}</#if>');"><img  src="${uiDomain!''}/images/map/gisv0/special_config/images/mc_2.png" />语音盒呼叫</li>
