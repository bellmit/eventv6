...
<div class="MainContent">
    <#include "/zzgl/reportFocus/povertyPreMonitor/toolbar_ppm.ftl" />
</div>
...
<script type="text/javascript">
    ...
    function loadDataList(){
        ...
        $('#list').datagrid({
            ...
            singleSelect: true,
            idField:'reportId',
            url:'${rc.getContextPath()}/zhsq/reportPPM/listReportFocusData.json',
            columns:[[
                ...
                {field:'personName', title:'姓名', align:'center', width:fixWidth(0.13), formatter: titleFormatter},
