...
function CloseSearchBtn(){
	...
	function loadMessage(pageNo,pageSize){
		...
		var postData = 'page='+pageNo+'&rows='+pageSize+'&gridId='+gridId+'&gridName='+gridName+'&corName='+corName+'&corCode='+corCode+'&corType='+corType;
		//alert(postData);
		$.ajax({
			type: "POST",
			url: '${rc.getContextPath()}/zhsq/map/arcgis/arcgisdataofnewgroup/nonPublicOrgListData.json?t='+Math.random(),
			data: postData,
			dataType:"json",
