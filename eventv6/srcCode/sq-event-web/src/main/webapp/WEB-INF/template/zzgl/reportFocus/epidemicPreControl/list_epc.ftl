...
<div class="MainContent">
	<#include "/zzgl/reportFocus/epidemicPreControl/toolbar_epc.ftl" />
</div>
...
<script type="text/javascript">
    ...
    function loadDataList(){
    	...
    	$('#list').datagrid({
			...
			singleSelect: true,
			idField:'reportId',
			url:'${rc.getContextPath()}/zhsq/reportEPC/listReportFocusData.json',
			columns:[[
				{field:'reportId', checkbox:true, width:40, hidden:'true'},
				{field:'reportCode', title:'报告编号', align:'left', width:fixWidth(0.18), formatter: clickFormatter4EPC},
				{field:'reporterName', title:'报告人姓名', align:'center', width:fixWidth(0.14), formatter: titleFormatter},
				{field:'kpcName', title:'人员姓名', align:'center', width:fixWidth(0.13), formatter: titleFormatter},
    ...
    function clickFormatter4EPC(value, rec, rowIndex) {
		var title = "";
