...
//加载列表历史告警信息列表
	function loadAlarmInfo() {
		$('#alarmInfo').datagrid({
			...
			width:500,
			height:250,
			url: '${rc.getContextPath()}/zhsq/map/arcgis/arcgisDataOfYanpingStDeviceController/findAirHistoryList.jhtml',
			queryParams: $('#searchForm').serializeJson(), 
			columns: [[
					{field:'PM_TWO', title:'PM2.5', align:'center',width:100},
					{field:'PM_TEN', title:'PM10', align:'center',width:100},
					{field:'AQI', title:'空气质量值AQI', align:'center',width:100},
					{field:'AQI_STATUS', title:'空气质量状况', align:'center',width:100},
					{field:'PRIM_POLL', title:'首要污染物', align:'center',width:100},
