		...
		<input type="hidden" id="module" name="module" value="<#if module??>${module}</#if>" />
            <div class="NorForm">
            	<table id="formInfo" width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                  	<td class="LeftTd"><label class="LabName"><span>发生日期：</span></label><div class="Check_Radio FontDarkBlue"><#if relatedEvents.occuDateStr??>${relatedEvents.occuDateStr}</#if></div></td>
                    ...
                    <td><label class="LabName"><span><font color="red">*</font>所在学校：</span></label><div class="Check_Radio FontDarkBlue" style="width:150px;"><#if relatedEvents.bizName??>${relatedEvents.bizName}</#if></div></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="LeftTd"><label class="LabName"><span><font color="red">*</font>主犯(嫌疑犯)证件姓名：</span></label><div class="Check_Radio FontDarkBlue" style="width:121px;"><#if relatedEvents.prisonersName??>${relatedEvents.prisonersName}</#if></div></td>
                    <td><label class="LabName"><span>主犯(嫌疑犯)证件类型：</span></label><div class="Check_Radio FontDarkBlue"><#if relatedEvents.prisonersDocTypeName??>${relatedEvents.prisonersDocTypeName}</#if></div></td>
                    <td><label class="LabName"><span><font color="red">*</font>主犯(嫌疑犯)证件号码：</span></label><div class="Check_Radio FontDarkBlue" style="width:150px;"><#if relatedEvents.prisonersDocNo??>${relatedEvents.prisonersDocNoHS}</#if></div></td>
                  </tr>
                  <tr>
                    <td class="LeftTd"><label class="LabName"><span>作案人数：</span></label><div class="Check_Radio FontDarkBlue"><#if relatedEvents.crimeNum??>${relatedEvents.crimeNum}人</#if></div></td>
                    <td><label class="LabName"><span>在逃人数：</span></label><div class="Check_Radio FontDarkBlue"><#if relatedEvents.ecapeNum??>${relatedEvents.ecapeNum}人</#if></div></td>
                    <td><label class="LabName"><span>抓捕人数：</span></label><div class="Check_Radio FontDarkBlue"><#if relatedEvents.arrestedNum??>${relatedEvents.arrestedNum}人</#if></div></td>
                  </tr>
                  <tr>
