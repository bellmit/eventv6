        ...
        <div class="ListSearch">
        	<div class="MetterCondition">
            	<ul class="content" style="height:26px;">
                	<li class="LC1" style="float:left; line-height:26px; width:59px;">姓名：</li>
            	...
            	<#if infoOrgCode?index_of("320903") == 0>
            		<li onclick="selectOnly(this)" value="">网格及以上</li>
        			<li onclick="selectOnly(this)" class="current" value="6">网格级</li>
            	<#else>
            		<li onclick="selectOnly(this)" class="current" value="">网格及以上</li>
        			<li onclick="selectOnly(this)" value="6">网格级</li>
            	</#if>
                    <div class="clear"></div>
                </ul>
                <ul id="content-md1" class="type content light">
            		...
            		<li onclick="selectOnly(this)" style="width:60px;" value="1">在线</li>
            		<li onclick="selectOnly(this)" style="width:60px;" value="2">离线</li>
                    <div class="clear"></div>
                </ul>
	...
	function loadMessage(pageNo,pageSize,searchType){
    	...
    	$('#content-md0').find('li').each(function() {
			if ($(this).attr('class') == 'current') {
				gridLevel = $(this).attr('value');
			}
		});
    	$('#content-md1').find('li').each(function() {
			if ($(this).attr('class') == 'current') {
				onlineStatus = $(this).attr('value');
			}
		});
