...
<div class="MainContent">
	<#include "/zzgl/reportFocus/threeOneTreatment/toolbar_tot.ftl" />
</div>
...
<script type="text/javascript">
    ...
    function loadDataList(){
    	...
    	$('#list').datagrid({
			...
			singleSelect: true,
			idField:'reportId',
			url:'${rc.getContextPath()}/zhsq/reportTOT/listReportFocusData.json',
			columns:[[
				{field:'reportId', checkbox:true, width:40, hidden:'true'},
				{field:'reportCode', title:'报告编号', align:'left', width:fixWidth(0.18), formatter: clickFormatter4TOT},
				{field:'reporterName', title:'报告人姓名', align:'center', width:fixWidth(0.14), formatter: titleFormatter},
				{field:'personInvolved', title:'业主姓名', align:'center', width:fixWidth(0.13), formatter: titleFormatter},
    ...
    function clickFormatter4TOT(value, rec, rowIndex) {
		var title = "";
