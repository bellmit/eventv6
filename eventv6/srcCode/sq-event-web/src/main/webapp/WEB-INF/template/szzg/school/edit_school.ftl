        ...
        <div class="NorForm NorForm2">
            <form id="tableForm" name="tableForm" action="${rc.getContextPath()}/zhsq/szzg/school/saveOrUpdate.jhtml"  method="post">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <input type="hidden" id="seqid" name="seqid" value="<#if SchoolBo.seqid??>${SchoolBo.seqid}</#if>"/>
                    <tr>
                        <td><label class="LabName"><span><font style="color:red">*</font>学校类型：</span></label>
                            <input id="type" name="type" type="hidden" value="<#if SchoolBo.type??>${SchoolBo.type}</#if>"/>
                            <input id="typeName" name="typeName"  data-options="required:true"  value="<#if SchoolBo.typeName??>${SchoolBo.typeName}</#if>" type="text" class="inp1 InpDisable easyui-validatebox" style="width:160px;"
                        </td>

                        <td colspan="2" class="LeftTd"><label class="LabName"><span><font style="color:red">*</font>所属区域：</span></label>
                            <input type="hidden" id="orgCode" name="orgCode" value="<#if SchoolBo.orgCode??>${SchoolBo.orgCode}</#if>" >
                            <input class="inp1 inp2 InpDisable easyui-validatebox" type="text" id="orgName" value="<#if SchoolBo.orgName??>${SchoolBo.orgName}</#if>"
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span><font style="color:red">*</font>学校名称：</span></label>
                            <input name="schoolName" id="schoolName" maxLength="100" type="text" value="<#if SchoolBo.schoolName??>${SchoolBo.schoolName}</#if>" class="inp1 easyui-validatebox" style="width: 510px;" data-options="tipPosition:'bottom',required:true,validType:['maxLength[100]','characterCheck']"/></td>
                    </tr>

                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span><font style="color:red">*</font>学校地址：</span></label>
                            <input name="address" id="address" maxLength="100" value="<#if SchoolBo.address??>${SchoolBo.address}</#if>" type="text" class="inp1 easyui-validatebox" style="width: 510px;" data-options="tipPosition:'bottom',required:true,validType:['maxLength[100]','characterCheck']"/></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2"  class="LeftTd "><label class="LabName"><span>网址：</span></label>
                            <input name="url" id="url" type="text" style="height: 30px;width: 500px;" class="inp1 inp2 easyui-validatebox" value="<#if SchoolBo.url??>${SchoolBo.url}</#if>" data-options="tipPosition:'bottom',validType:['maxLength[100]','characterCheck']"/>
                        </td>
                    </tr>
                </table>
            </form>
