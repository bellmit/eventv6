		...
		<div class="con LyWatch" style="height:173px;overflow:auto;">
		      <ul>
		          <li>
		               ...
		               <p>案件类型：
		               	<#if eventInfo.eventTypeCN??>
			               	<span class="FontDarkBlue" title="${eventInfo.eventTypeCN}">
			               		${eventInfo.eventTypeCN}
			               	</span>
		               	<#else>
		               		<span class="FontDarkBlue">
			               		未知
		               ...
		               <p>案件分级：
		               	<#if eventInfo.eventLevelCN??>
			               	<span class="FontDarkBlue" title="${eventInfo.eventLevelCN}">
			               		${eventInfo.eventLevelCN}
			               	</span>
		               	<#else>
		               		<span class="FontDarkBlue">
			               		未知
