...
<div class="container">
    <div class="con-warp">
        ...
        <div class="mainbox-d" style="height: 500px">
            <div class="mon-list">
                <iframe id="curList" src="${rc.getContextPath()}/zhsq/szzg/eventController/toEventList.jhtml?eventType=my&model=l&initiatorId=${gridAdminUserId}&initiatorOrgId=-1"
...
<script>
    $(function () {
        ...
        $("#eventL").click(function () {
            $("#curList").attr("src", "${rc.getContextPath()}/zhsq/szzg/eventController/toEventList.jhtml?eventType=my&model=l&initiatorId=${gridAdminUserId}&initiatorOrgId=-1");
        });
