		...
		<div class="con AlphaBack1" style="height:32px">
	    	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	          <tr style="float:left;">
	    		...
	    		<td>
	          	 	<a href="#" onclick="choose('drawPoint')" id="drawPoint" class="NorToolBtn SetCenterBtn">标注</a>
	          	</td>
	          	<td>
	          		<a href="#" onclick="choose('cancleDrawPoint')" id="cancleDrawPoint" class="NorToolBtn BackBtn" style="display:none;">取消标注</a>
	    		</td>
	          	<#--<td>-->
	          		<#--<a href="#" onclick="choose('drawBuilding')" id="drawBuilding" class="NorToolBtn DrawBorderBtn">轮廓编辑</a>-->
	    		<#--</td>-->
	          	<#--<td>-->
	          		<#--<a href="#" onclick="choose('cancleDrawOrEditBuilding')" id="cancleDrawOrEditBuilding" class="NorToolBtn BackBtn" style="display:none;">取消轮廓绘制</a>-->
	    		<#--</td>-->
	          	<#--<td>-->
	          		<#--<a href="#" onclick="choose('delDrawData')" id="delDrawData" class="NorToolBtn DrawBorderBtn">删除轮廓</a>-->
	    		<#--</td>-->
	    		<#if BUILDING_BIND_AID_DISPLAY?? && BUILDING_BIND_AID_DISPLAY == '1'>
		          	<td>
		    	 		<div id = "MapLevel" class="MapLevel fl" style="width:122px">
			    	 		<ul>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		...
		document.getElementById("wid").value = '<#if wid??>${wid}</#if>';
		document.getElementById("showGridId").value = '<#if showGridId??>${showGridId}</#if>';
...
<script type="text/javascript">
		...
		$.ajax({   
			 ...
			 success: function(data){
			 	...
			 	if(obj != null) {
			 		$("#x").val(obj.x);
					$("#y").val(obj.y);
					var mapCenterLevel = map.getView().getZoom();
	...
	function drawBuildingHS(){
		...
		if(buildingId != null && buildingId != ''){
			...
			$.messager.alert('提示','请选择要绘制轮廓的楼宇!','info');
		}
	}
