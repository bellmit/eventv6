...
<div class="MainContent">
	<@block name="eventToolbar">
		<#include "/zzgl/event/problemReport/nanChangForLargeData/eventDataGridToolbar.ftl" />
	</@block>
</div>
...
<script type="text/javascript">
	...
	<#if extraParams??>
        ...
        $('#list').datagrid({
            ...
            idField:'eventId',
            url:'${rc.getContextPath()}/zhsq/event/problemReportController/listData.json',
    ...
    function attentionEvent(obj,isAttention,eventId){
        ...
        if(attention=='添加关注'){
            $.ajax({
                type: "POST",
                url:'${rc.getContextPath()}/zhsq/event/problemReportController/addAttention.json?t='+Math.random(),
                data: postData,
                dataType:"json",
            ...
            $.ajax({
                type: "POST",
                url:'${rc.getContextPath()}/zhsq/event/problemReportController/canclAttention.json?t='+Math.random(),
                data: postData,
                dataType:"json",
                success: function(data){
                    //alert(data);
    ...
    function remindEvent1(obj,eventId,instanceId){
        var url = "${rc.getContextPath()}/zhsq/event/problemReportController/toAddRemind.jhtml?eventId=" + eventId + "&instanceId=" +instanceId;
        showMaxJqueryWindow("督办信息", url, 480, 280);
    }

    function urgeEvent(obj,eventId,instanceId){
        var url = "${rc.getContextPath()}/zhsq/event/problemReportController/toAddUrge.jhtml?eventId=" + eventId + "&instanceId=" +instanceId;
