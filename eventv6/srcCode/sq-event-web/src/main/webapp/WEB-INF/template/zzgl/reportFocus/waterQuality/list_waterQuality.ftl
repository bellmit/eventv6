...
<div class="MainContent">
	<#include "/zzgl/reportFocus/waterQuality/toolbar_waterQuality.ftl" />
</div>
...
<script type="text/javascript">
    ...
    function loadDataList(){
    	...
    	$('#list').datagrid({
			...
			singleSelect: true,
			idField:'reportId',
			url:'${rc.getContextPath()}/zhsq/reportWQ/listReportFocusData.json',
			columns:[[
				{field:'reportId', checkbox:true, width:40, hidden:'true'},
				{field:'reportCode', title:'报告编号', align:'left', width:fixWidth(0.17), formatter: clickFormatter},
				{field:'reporterName', title:'报告人姓名', align:'center', width:fixWidth(0.13), formatter: titleFormatter},
				{field:'matterTypeName', title:'问题类型', align:'center', width:fixWidth(0.12)},
				{field:'reportTimeStr', title:'报告时间', align:'center', width:fixWidth(0.13)},
				{field:'occurred', title:'发生地址', align:'center', width:fixWidth(0.25), formatter: titleFormatter},
				<#if listType??>
				...
				{field:'reportStatusName', title:'报告状态', align:'center', width:fixWidth(0.1)}
			]],
