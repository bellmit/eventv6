...
<@override name="patrolTypeInput">
	<label class="LabName"><span>巡访类型：</span></label>
	<input type="hidden" id="patrolType" name="patrolType" <#if patrolType??>value="${patrolType}"</#if> />
	<input type="text" class="inp1 easyui-validatebox" style="margin-left:-30px;width:236px" data-options="required:true,tipPosition:'bottom'" id="patrolTypeName" value="" />
</@override>
...
<@override name="geographicalLabelingInput">
    <tr>
	  ...
	  <input type="text" class="easyui-validatebox" style="height:30px;width:127px;cursor: pointer;font-size:12px" id="pointSelectionName" data-options="required:true,tipPosition:'bottom',prompt:'请选择'" editable="false"  value="<#if pointSelectionName??>${pointSelectionName}</#if>" />
	  </td>
    </tr>
    <style>
	.textbox .textbox-prompt{color:rgb(128, 128, 128)}
	</style>
</@override>
...
<tr>
	...
	<input type="hidden" id="patrolType" name="patrolType" <#if patrolType??>value="${patrolType}"</#if> />
	<input type="text" class="inp1 easyui-validatebox" style="width:175px" data-options="required:true,tipPosition:'bottom'" id="patrolTypeName" value="" />
	</td>
	<#else>
...
<@override name="contactUserTr">
	<tr>
		<td style="border-bottom:none;">
			<label class="LabName"><span id="contactUserLabelSpan"><label class="Asterik">*</label>联系人员：</span></label><input  id="contactUser" name="contactUser" type="text" class="inp1 easyui-validatebox" data-options="required:true,tipPosition:'bottom',validType:['maxLength[30]','characterCheck']" value="${event.contactUser!}" />
		</td>
	</tr>
</@override>
<@override name="contactTelTr">
	<tr>
		<td style="border-bottom:none;">
			<label class="LabName"><span id="contactTelLabelSpan"><label class="Asterik">*</label>联系电话：</span></label><input name="tel" id="tel" type="text" class="inp1 easyui-validatebox" data-options="required:true,tipPosition:'bottom',validType:'mobileorphone'" value="${event.tel!}" />
		</td>
	</tr>
</@override>
...
<@override name="initExpandScript">
       ...
       $("#patrolTypeName").css({"width":$("#influenceDegreeName").width()+24,"margin-left":"0px"});
