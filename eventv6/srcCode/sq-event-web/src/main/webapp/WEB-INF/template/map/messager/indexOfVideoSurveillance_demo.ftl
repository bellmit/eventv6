...
<div class="facemainer">
    <div class="facecon-left">
        ...
        <div class="faceinfo">
            <h3>报警信息</h3>
            <ul>
                <#--<li><lable class="nawid">设备编号：</lable><span class="blue" data="deviceNum">111</span></li>-->
                <li><lable class="nawid">设备地址：</lable><span style="display:inline-block;width:160px;" class="blue" data="remark">111</span></li>
                <li><lable class="nawid">进入视野时间：</lable><span class="blue" data="timestampStartStr">${startTimeInp!''}</span></li>
                <li><lable class="nawid">离开视野时间：</lable><span class="blue" data="timestampEndStr">${endTimeInp!''}</span></li>
                <!--<li><lable class="nawid">历史出现次数：</lable><span class="blue" data="historyAppearTimes">1</span></li> -->
            </ul>
        </div>
    </div><!--end .facecon-left-->
    <div class="xsdbox">相似度<p class="xsno" data="similarity">88%</p></div>
    <div class="facecon-rigt">
        ...
        <div class="faceinfo">
            <h3>人员基本信息</h3>
            <ul>
                <li><lable class="nawid">姓名：</lable><span class="blue" data="name"></span></li>
                <li><lable class="nawid">证件号：</lable><span class="blue" data="person_id">350422197801235678</span></li>
			<#--<li>-->
