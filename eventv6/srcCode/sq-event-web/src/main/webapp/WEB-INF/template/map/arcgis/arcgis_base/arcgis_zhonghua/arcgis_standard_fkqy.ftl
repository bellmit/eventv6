...
<div class="MapBar">
    <div class="con AlphaBack">
        ...
        <div class="zhuanti fr">
        	<a href="javascript:void(0);"><span onclick="showObjectListFkqy()" >防控区域</span></a>
        </div>
      <!--   <div class="PartyMember fl">
        	<ul>
            	<li><span  onclick="showObjectListFkpqAndQqy()" >防控片区</span></li>
            </ul>
        </div> -->
    ...
    <div class="ztIcon AlphaBack titlefirstall" style="display:none;">
		<div class="title" style="display:none;">
			...
			<span id="searchBtnId" class="fr" onclick="ShowSearchBtn()"><img src="${uiDomain!''}/images/map/gisv0/special_config/images/search.png" /></span>
...
//显示防控区域
function showObjectListFkqy(){
	var level = (parseInt($("#gridLevel").val()) < 6) ? parseInt($("#gridLevel").val())+1 : parseInt($("#gridLevel").val());
 	getArcgisDataOfFkqySegmentGrids($("#gridId").val(),$("#gridCode").val(),currentArcgisConfigInfo.mapType ,level);
}
