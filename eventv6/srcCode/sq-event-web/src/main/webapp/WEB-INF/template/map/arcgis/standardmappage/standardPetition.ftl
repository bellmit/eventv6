...
//var temp1= $(".ListSearch").is(":visible");//是否可见
    ...
    function loadMessage(pageNo, pageSize, searchType) {
        ...
        postData = 'page=' + pageNo + '&rows=' + pageSize + '&gridId=' + gridId + '&name=' + name + '&bizType=' + bizType;
        if ($('#elementsCollectionStr').val() != "") {
            postData += '&elementsCollectionStr=' + $('#elementsCollectionStr').val();
        }
        $.ajax({
            type: "POST",
            url: '${rc.getContextPath()}/zhsq/map/arcgis/arcgisdataofpoplocal/petitionListData.json',
            data: postData,
            dataType: "json",
            success: function (data) {
                ...
                if (list && list.length > 0) {
                    for (var i = 0; i < list.length; i++) {
                        ...
                        tableBody += '<dt>';
                        tableBody += '<span class="fr">' + (val.tel == null ? '' : '<img src="${uiDomain!''}/images/map/gisv0/special_config/images/people_06.png">' + (val.tel)) + '</span>';
    ...
    function selected(id) {
        ...
        var url = '${rc.getContextPath()}/zhsq/map/arcgis/arcgisdataofpoplocal/petitionDetail.jhtml?memberId=' + id;
    ...
    function gisPosition(res) {
        if (typeof parent.MMApi != "undefined") {	// 判断是否是高德地图
            ...
            opt.ecs = $('#elementsCollectionStr').val();
            opt.gridId = $('#gridId').val();
            opt.url = "${rc.getContextPath()}/zhsq/map/arcgis/arcgisdataofpoplocal/getLocateDataListOfPetition.jhtml?ids=" + res;
        ...
        if ($('#elementsCollectionStr').val() != "") {
            var url = "${rc.getContextPath()}/zhsq/map/arcgis/arcgisdataofpoplocal/getLocateDataListOfPetition.jhtml?ids=" + res;
            ...
            var gridAdminurl = "${rc.getContextPath()}/zhsq/map/arcgis/arcgisdataofpoplocal/getLocateDataListOfPetition.jhtml?ids=" + res + "&showType=2";
