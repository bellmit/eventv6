...
function getArcgisDataByCurrentSet(){
	...
	fea.render(queryCondition,'gridLayer'+gridLyerNum,ykFeatureUrl,1,true,null,null,null,null,false,getInfoDetailOnMap);
	...
	$("#map"+currentN).ffcsMap.centerAt({
			x : 118.5675876,          //中心点X坐标
			y : 24.809199243,           //中心点y坐标
