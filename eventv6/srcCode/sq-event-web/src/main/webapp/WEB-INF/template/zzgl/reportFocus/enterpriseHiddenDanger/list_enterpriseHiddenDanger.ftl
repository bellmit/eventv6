...
<div class="MainContent">
	<#include "/zzgl/reportFocus/enterpriseHiddenDanger/toolbar_enterpriseHiddenDanger.ftl" />
</div>
...
<script type="text/javascript">
    ...
    function loadDataList(){
    	...
    	$('#list').datagrid({
			...
			singleSelect: true,
			idField:'reportId',
			url:'${rc.getContextPath()}/zhsq/reportEHD/listReportFocusData.json',
			columns:[[
				...
				{field:'enterpriseName', title:'企业名称', align:'center', width:fixWidth(0.13), formatter: titleFormatter},
