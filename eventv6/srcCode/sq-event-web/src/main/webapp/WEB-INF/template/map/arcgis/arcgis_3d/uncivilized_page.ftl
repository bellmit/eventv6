    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <!-- 底部链接 -->
                <a style="margin-top:.1rem;width:7rem;margin-left:6rem;font-size:.2rem" href="javascript:void(0)" class="nct-btn">请拨打12345热线</a>
            </div>
        </div>
        <script src="${uiDomain!''}/web-assets/plugins/jquery-nicescroll/jquery.nicescroll-1.js"></script>
        <script>
        
        	var picGalleryPath = "${rc.getContextPath()}/zhsq/nanChang3D/toImgGalleryPage.jhtml";
