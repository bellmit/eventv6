...
<html style="overflow:hidden">
	<head>
		...
		.mf-item>input {background-color: rgba(1, 6, 46, 0.3) ! important;color: white ! important}
		.ztree {background-color: rgba(1, 6, 46, 0.3) !important;}
		.ztree *{color:white!important;background-color: rgba(1, 6, 46, 0.3) ! important;}
		.TimeControl .current,.TimeControl .TimeSearchBtn{margin-left:0;background-color:#00d8ff !important;}
		.TimeControl *{color:white!important;background-color: rgba(1, 6, 46, 0.3) !important;}
		...
		.backpic {
			background: url(${uiDomain!''}/web-assets/themes/transparent/images/fpdx-container.jpg) no-repeat center;
    		background-size: 100% 100%;
		}
		.i-img{
		width:0.16rem;height:0.18rem;display:block;margin-left:-0.07rem; margin-top:-0.05rem;
		}
		.i-img>img{
			width:100%;
			height:100%;
	    ...
	    .serch-main>div.mask-serch{
	        position: absolute;
	        top:0.5rem;
	        left: -50%;
	        width: 5rem;
	        height: 2rem;
	        box-shadow: inset 0 0 0.08rem rgba(0, 176, 255, .4);
	        border: solid .01rem rgba(0, 176, 255, 0.5);
	        background-color: rgba(1, 6, 46, 0.7) ;
	        color: #fff;
	        font-size: 0.14rem;
	    ...
	    .mask-serch table .td1{
	        text-align: right;
	        width:25%
	    }
	    .mask-serch table .td2{
	 		width:75%
	    }
	    .mask-serch table .input01{
	        color: #fff!important;
	        width: 100%;
	        height: 0.3rem;
	        padding: 0 0.1rem;
	    ...
	    .input01{
	    	background: rgba(1, 6, 46, 0.7)!important ;
	    }
	...
	<body class="backpic">
		...
		<div class="container-fluid">
			<div class="wrap_container">
				...
				<div class="mask-content mask-content1" style="display: block;margin-top:.3rem">
					<div class="mc1-content" style="display: block;">
						...
						<div class="mask-filter clearfix">
							...
							<div class="mf-item mf-item3 clearfix fl">
								<p>上报时间：</p>
								<input type="text" id="_createTimeDateRender" class="inp1 InpDisable maet-ti-select" style="color:white;width:3.5rem;font-size:.14rem" value="${createTimeStart!}<#if createTimeStart?? && createTimeEnd??> ~ </#if>${createTimeEnd!}"/></p>
							</div>
							<div class="mf-item mf-item3 clearfix fl">
								<p>平台来源：</p>
								<input type="text" id="bizPlatform"  class="bs hide" style="width: 2.0rem"/>
								<input type="text" id="bizPlatformName" class="bs" style="width: 6.0rem"/>
							</div>
							<div class="mf-item clearfix fl">
								<p>关键字：</p>
								<input type="text" id="keyRemarkWord" class="bs" style="width: 1.5rem">
							</div>
							<div class="serch-main mf-item mf-item2 clearfix fl" style="cursor: pointer;">
							    <p>高级搜索</p>
							    <div class="mask-serch h-x">
							        <table>
							            <colgroup>
							            ...
							            <tbody>
							                <tr style="margin-bottom: 20px;">
							                    <td class="td1"><p>事件分类：</p></td>
							                    <td class="td2"><p><input type="text" id="typeName" style="width:8rem" class="input01 bs" /><input type="text" id="type" class="input01 bs hide" value="${type!''}"/></p></td>
							                </tr>
							                <tr  style="margin-bottom: 20px;">
							                    <td class="td1"><p>事件编号：</p></td>
							                    <td class="td2"><p><input type="text" id="code" class="input01 bs" placeholder="" /></p></td>
							                </tr>
							                <tr  style="margin-bottom: 20px;">
							                    <td class="td1"><p>事件状态：</p></td>
							                    <td class="td2"><p><input type="text" id="eventStatusName" style="width:8rem" class="input01 bs" /><input type="text" id="eventStatus" class="input01 bs hide" value="${eventStatus!''}"/></p></td>
							                </tr>
							            </tbody>
							        </table>
							    </div>
				...
				<div class="mask-content mask-content2">
					...
					<div class="mc-box flex" style="margin-top:.8rem">
							...
							<div class="mdt-box mtr20">
								<div class="md-text mcbl-bg bs">
									...
									<div class="mdt-item flex">
										<div>
											<p class="mdt-icon">巡访类型:</p>
										</div>
										<p class="white flex1 variable" id="patrolTypeName"></p>
									</div>
									<div class="mdt-item flex">
										<div>
											<p class="mdt-icon">责任点位:</p>
										</div>
										<p class="white flex1 variable" id="pointSelectionName"></p>
									</div>
									<div class="mdt-item flex">
										<div>
						...
						<div class="mcb-right flex1 mlr10">
							...
							<div class="mcb-r-bottom mcb-r-bottom1 bs" style="height:5.2rem">
								...
								<div class="mcb-rb-content mcb-rb-content1" style="height:4.7rem">
									...
									<div class="layer_aj_bt_s">
										<div class="layer_aj_bt_line"><i class="i-img"><img src="${uiDomain!''}/web-assets/_big-screen/nanchang-cc/images/icon-cont-arrow-down.png"/></i></div>
										<ul class="layer_aj_bt_items variable" id="flowDetail" style="margin-top:.3rem">
											
										</ul>
									</div>
								</div>	
							</div>
							<div class="mcb-r-bottom mcb-r-bottom2 bs" style="display: block;height:5.2rem">
								<div class="mc-title bs flex flex-ac flex-jb">
									<p>办理</p>
								</div>
								<!-- 待办事件办理 -->
    <div class="mae-container mae-event-handle" id="mae-event-handle" style="display:block;margin-left:-4.5rem;height:48%;width:12rem">
       ...
       <#include "/zzgl/event/workflow/select_user.ftl" />
		...
		var isAndroid = u.indexOf('Android') > -1 || u.indexOf('Linux') > -1; //android终端或者uc浏览器
			...
			var eventTypeApi=null;
			var bizPlatformApi=null;
			var eventStatusApi=null;
			...
			$(function(){
				...
				eventTypeApi=AnoleApi.initTreeComboBox("typeName", "type", "A001093199", null, null, {
	                ChooseType : "1" ,
	                EnabledSearch : true,
	                ShowOptions: {
	                    EnableToolbar : true
	            ...
	            bizPlatformApi=AnoleApi.initListComboBox("bizPlatformName", "bizPlatform", "B6027", null, null, {
		            ChooseType : "1" ,
		            ShowOptions: {
		                EnableToolbar : true
		            }
		        ...
		        eventStatusApi = AnoleApi.initListComboBox("eventStatusName", "eventStatus", null, null, null, {
		            RenderType:'01',
		            DataSrc: [
		            	{"name":"受理", "value":"00"},
		            	{"name":"已上报", "value":"01"},
		        ...
		        $('#code').css('width',$('#typeName').width()+27);
			});
			
			$('.serch-main>p').on('click',function(e){
                e.stopPropagation();
                $('.mask-serch').slideToggle(200);
                $('.h-x').getNiceScroll().resize();
            });
            
            $('.mask-serch').on('click',function(e){
                e.stopPropagation();
            })
			...
			// 滚动条优化
			$('.mt-tbody,.mdt-box,.mcb-rb-content1,#eventContentStr,.h-x').niceScroll({
				cursorcolor: '#00a0e9',
				cursoropacitymax: '.4',
				cursorwidth: ".05rem",
			...
			$('.mc2-back').click(function(){
				$('#mae-event-handle').getNiceScroll().remove();
				...
				$('#submitSupervise').click(function(){
			 	...
			 	$.ajax({
					...
					success: function(data){
						...
						$('#urgenceDegreeStr').html(formatStr(event.urgencyDegreeName));
						$('#patrolTypeName').html(formatStr(data.patrolTypeName));
						$('#pointSelectionName').html(formatStr(data.pointSelectionName));
						$('#influenceStr').html(formatStr(event.influenceDegreeName));
						$('#involvePeopleStr').html(formatStr(event.involvedNumName));
						$('#contactor').html(formatStr(event.contactUser)+'('+formatStr(event.tel)+')');
						$('#sourceStr').html(formatStr(event.sourceName));
						$('#collectStr').html(formatStr(event.collectWayName));
						$('#gridPathStr').html(formatStr(event.gridPath));
						$('#eventNumStr').html(formatStr(event.code));
						$('#cerateTimeStr').html(formatStr(event.happenTimeStr));
						$('#eventContentStr').html(formatStr(event.content));
						$('#occurdStr').html(formatStr(event.occurred));
						$('#curStatus').html(formatStr(event.statusName));
						$('#eventNameStr').html('['+formatStr(event.eventClass)+']'+event.eventName);
						...
						for(var i=0,j=flow.length;i<j;i++){
							...
							if(d.IS_CURRENT_TASK){
						        ...
						        '<p class="aj_items_t aj_items_t_yellow" style="color:'+handleColorArr[d.ORG_LEVEL]+'">'+d.HANDLE_PERSON+'</p>'+
						        '</div>';
								...
								'<p class="aj_items_t aj_items_t_green bs"><span style="color:'+handleColorArr[d.ORG_LEVEL]+';">'+formatStr(d.TRANSACTOR_NAME)+'('+d.ORG_NAME+')'+'</span><span> 耗时 '+d.INTER_TIME+'</span><br><span>办理时间</span>:'+d.START_TIME+'</p>'+
								'</div>';
								if(d.REMARKS){
						...
						$('#mae-event-handle').getNiceScroll().remove();//隐藏办理环节的线
			...
			function initEventList(urgencyDegreeStr,infoOrgCodeStr){
				...
				queryParams.isCapCurHandlerName=true;
				//获取事件列表页信息
				$.ajax({
					type: "POST",
					...
					success: function(data){
						...
						for(var i=0,j=list.length;i<j;i++){
							...
							'<td title="'+d.happenTimeStr+'">'+d.happenTimeStr+'</td>'+
							'<td title="'+d.handleDateStr+'">'+d.handleDateStr+'</td>'+
							'<td title="'+formatStr(d.eventClass)+'">'+formatStr(d.eventClass)+'</td>'+
							'<td title="'+d.gridPath+'">'+d.gridPath+'</td>'+
							'<td title="'+d.statusName+'">'+d.statusName+'</td>'+
							'<td title="'+checkStr(d.curHandlerName)+'">'+checkStr(d.curHandlerName)+'</td>'+
							'</tr>';
						...
						//设置分页
						if(data.eventList.total==0||data.eventList.total<pageSize){
			    			$("#pageDiv").hide();
						}else{
			   				$("#pageDiv").show();
			...
			function resetEventList(){
				...
				$('.variableTable').html('');
				$('#code').val('');
				eventTypeApi.doClearing();
				bizPlatformApi.doClearing();
				eventStatusApi.doClearing();
				initEventList();
			}
			...
			function getQueryParams(){
				...
				queryParams.eventStatus = $('#eventStatus').val();
