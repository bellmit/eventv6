        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <span class="Check_Radio FontDarkBlue">${(bo.appealTitle)!}</span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
...
<div class="BigTool">
    <div class="BtnList">
        <a href="###" onclick="startWorkflow('<#if bo.appealId??>${bo.appealId?c}</#if>');" class="BigNorToolBtn BigShangBaoBtn">提交</a>
