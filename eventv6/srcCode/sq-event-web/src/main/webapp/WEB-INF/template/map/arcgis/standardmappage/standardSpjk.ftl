...
<body style="border:none;">
	...
	<input type="hidden" id="eyesType" value="${eyesType}" />
	<input type="hidden" id="pageSize" value="20" />
    <div id="list" class="" style="display:block;">
...
function CloseSearchBtn(){
	...
	function loadMessage(pageNo,pageSize,searchType){
		...
		$.ajax({
			type: "POST",
			url: '${rc.getContextPath()}/zhsq/map/arcgis/arcgisDataOfSituationController/spjkListData.json?t='+Math.random(), 
			data: postData,
			dataType:"json",
