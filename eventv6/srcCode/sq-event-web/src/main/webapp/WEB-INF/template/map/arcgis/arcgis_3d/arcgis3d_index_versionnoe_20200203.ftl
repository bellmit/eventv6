...
<head>	
	...
	<link rel="stylesheet" type="text/css" href="${uiDomain!''}/web-assets/_big-screen/nanchang-cc/css/tongxunlu.css" />
...
<style>
		...
		.tonxunlu-main{z-index:100;}
		.tonxunlu-main .tonxunlu-content{padding:0.1rem 0.15rem;margin:0;}
		.miaobaoxie{margin-top:0;}
        ...
        .to-manage2{
            ...
            margin:0.2rem 0.25rem 0px 0px;
            line-height: 0.4rem;
            padding: 0 0.1rem;
            background-color: rgba(48,104,239,0.3);
            box-shadow: inset 0px 0px 14px 0px rgba(48, 176, 240, 0.8);
            border-radius: 0.2rem;
            border: solid 1px rgba(0, 210, 255, 0.8);
	...
	<script type="text/javascript">
		...
		var isAndroid = u.indexOf('ua_ffcs') > -1 ; //公司APP特有添加属性
		function logout(){
		...
		function noticeList(){
			if(isAndroid){ 
				window.location.href="protocol://android?notice_list:";
			}
		}
		...
		function AIfxShow(){
			...
			// $('#AIfxIframe').attr('src',"http://10.20.111.27:17043/ctm01civilized-web/#/alarmList?username="+partyName);
			$('#AIfxIframe').attr('src',"http://10.20.111.27/civilized-web/#/alarmList?username="+partyName);
		}
		function AIfxHide(){
		...
		function szfxShow(){
			...
			$('#szfxIframe').attr('src',"http://10.20.114.102:10003/pc/index.html#/");
		}
		function szfxHide(){
...
<body>
	...
	<div class="container-fluid">
		<div class="wrap-container">
			...
			<!-- 弹窗层 start -->
			<div id="popupWindowDiv" class="mask-container" style="display: none;z-index: 110;">
				<div class="mc-item mci-big mci-big2" id="mc-item" style="display:block; top:2.29rem; margin-top:0">
                    <!-- 小号弹窗用mci-small -->
                    <div class="xqm-im-top" id="moveDiv">
						<i></i>
						<!-- <p>待办事件</p> -->
						<p id="title_p">待办事件</p>
						...
						<div class="mae-container mae-container-on dianwei-center1" id="dianwei-center1">
					        <div class="dianwei-shipin xqi-bs clearfix"  style="background:none; border:none;">
					            <div class="dianwei-shipin-title clearfix" id="dianwei-shipin-title">
					                ...
					                <p id="quickSupervision" class="quickSupervision" style="float:right;cursor: pointer;<#if showQuickSupervision?? && showQuickSupervision=='true'><#else>display:none</#if>">一键督察</p>
					            </div>
			...
			<div class="header clearfix" style="z-index:100;">
				<div class="nav clearfix">
						...
						<div class="struc-cont " >
	                        <div class="swiper-container swiper1">
	                            <div class="swiper-wrapper">
	                            	<div id="szfx" class="swiper-slide struc-item" style="font-size:0.22rem;display:none">
										<a href="javascript:;"  >
											<p style="color: white;">文明指数</p>
										</a>
	                                </div>
	                                <div id="zhdd" class="swiper-slide struc-item nav-item-on" style="font-size:0.22rem">
										<a href="javascript:;" >
											<p style="color: white;">指挥调度</p>
										</a>
									</div>
									<div id="sdcp" class="swiper-slide struc-item" style="font-size:0.22rem">
										<a href="javascript:;"  >
											<p style="color: white;">实地测评</p>
										</a>
	                                </div>
					...
					<a href="javascript:;" title="南昌城市大脑 | 文明创建不下线" class="logo">
						<img src="${uiDomain!''}/web-assets/_big-screen/nanchang-cc/images/logo3.png">
					</a>
				<div style="float:right;">
                    <a href="javascript:;" id="city" class="fr to-manage2" style="float:left" ><i></i>搜索</span></a>
					...
					<ul class="person-list" id="person-list">
							...
							<li id="noticeList">
								<a href="javascript:void(0);" class="" onclick="noticeList()">
									<i class="icon-envelope"></i>
									<b >通知公告</b>
								</a>
							</li>
							<li id="isPhone">
								<a href="javascript:void(0);" class="" onclick="showComm()">
									<i class="icon-envelope"></i>
									<b >通讯录</b>
								</a>
							</li>
			...
			<!-- 左侧 start -->
			<!-- 市级tabs -->
			<div class="event-wrap event-left1 event-sw event-sw-on evt-pos1" id="event-left1"  style="z-index:11;">
				<div class="tabs">
				...
				<div class="tabs">
					...
					<#if (videoPosition??)>
						...
						<div class="tabs-item tabs-item2">
			                <div id="deviceId" class="tabs-cont tabs-cont2" data-type="evt-device">
					...
					<#if (pointPosition??)>
						...
						<div class="event-point-select clearfix">
			...
			<!-- 点位负责人 start -->
			<div class="event-wrap evt-pos2" id="civ_div">
				<div class="cont-panel cont-panel-deep">
			...
			<!-- 区域、时间选择 strat -->
			<div class="event-wrap evt-pos3 clearfix">
				<div class="left-nav">
			...
			<!-- 右侧 end -->
			 ...
			 <!-- 通讯录 -->
            <div class="tonxunlu-main" style="display: none;">
                <div class="tonxunlu-main-top">
                    <p>通讯录<i></i></p>
                </div>
                <div class="tonxunlu-content">
                    <div class="tonxunlu-content-l">
                        <div class="miaobaoxie">
                            <p class="menuList" id="menu"></p>
                        </div>
                        <div class="zuzhi">
                            <div class="zuzhi-01" id="orgSub">
                                <p>下属组织</p>
                            </div>
                        </div>
                    </div>
                    <div class="tonxunlu-content-r">
                        <div class="tonxunlu-content-r01 tonxunlu-show">
                        <div class="tonxunlu-zz-top" style="display:flex">
                                <p>组织成员</p>
                                <div class="input-server" style="align-self: center;width: 200px;position: absolute;right: 20px;">
		                            <ul>
		                                <li class="li1">
		                                    <div class="div1"><input autocomplete="off" type="text" id="keyWords" name="keyWords" placeholder="请输入关键词" class="input-server1"></div>
		                                </li>
		                                <li class="li2" onclick="search()" style="cursor: pointer;">
		                                    <span>搜索</span>
		                                </li>
		                                <li class="li3 mlr10" onclick="clearKey()" style="cursor: pointer;">
		                                    <span>重置</span>
		                                </li>
		                            </ul>
		                        </div>
                            </div>
                            <div class="tonxunlu-zz-btn">
                                <ul class="zuzhisanji" id="presonList">
                                </ul>
                            </div>
                        </div>
                        <div class="tonxunlu-content-r02">
                            <div class="content-r-01">
                                <p><img src="${uiDomain!''}/web-assets/_big-screen/nanchang-cc/images/tongxunlu/icon-toux01.png"></p>
                                <p id="personName">-</p>
                            </div>
                            <div class="content-r-02">
                                <div class="content-r-02-l">
                                    <p>职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务</p>
                                    <p>联系电话</p>
                                    <p>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</p>
                                    <p>公司电话</p>
                                </div>
                                <div class="content-r-02-r">
                                    <p id="postition">-</p>
                                    <p id="phone" >-</p>
                                    <p id="email">暂无</p>
                                    <p id="comPhone">暂无</p>
	   ...
	   //热力图对象
		...
		function drawPolygon(){
			...
			if(gridLevel==4){
				...
				url='${rc.getContextPath()}/zhsq/nanChang3D/getArcgisDrawDataOfPointsByCode.json?infoOrgCode=${gridCode}'+"&pointLevels="+pointLevels+"&pointTypes="+pointTypes+"&pointName="+spointName+'&mapt=5';
		...
		function showPointMark(bizData){
            if (bizData.infoOrgCode&&bizData.infoOrgCode.length >= 6) {
...
//			$.fn.ffcsMap.removeLayer("pointLayer", {}, function() {});   //清点位图层
			...
			for(var i=0;i<hightLightLayer.graphics.length;i++){
                    ...
                    if (bizDataId[j] == hightLightLayer.graphics.items[i].attributes.data._oldData.id) {
		...
		function showListPointDetail(bizDataId){
			...
			if(pointPosition){
				if(gridLevel==4){//网格级别是街道
					var spointName= $("#myiframe1").contents().find("#spointName").val();
					url='${rc.getContextPath()}/zhsq/nanChang3D/getArcgisDrawDataOfPointsByCode.json?infoOrgCode=${orgCode}'+"&pointLevels="+pointLevels+"&pointTypes="+pointTypes+"&pointName="+spointName+'&mapt=5';
					var extent = $.fn.ffcsMap.getViewExtent();
					var xmax=extent.xmax,xmin=extent.xmin,ymax=extent.ymax,ymin=extent.ymin;
					url+='&xmax='+xmax+'&xmin='+xmin+'&ymax='+ymax+'&ymin='+ymin;
    ...
    function showPointData(data){
		...
		function initFn2 () {
			...
			$('.swiper1 .swiper-slide').on('click', function () {
				if($(this).attr('id')=="sdcp"){
					window.open('http://10.20.114.102:10008');
					return;
				}
                ...
                //if(navigator.userAgent.match("ua_ffcs_nc")){
				if(isAndroid){ 
                	if($("#aifxDiv").hasClass('nav-item-on')||$("#xffx").hasClass('nav-item-on')||$("#clsb").hasClass('nav-item-on')||$("#szfx").hasClass('nav-item-on')){
                    	$("#gridNameClick").hide();
                    	$("#todoTotalClick").hide();
                        $("#city").hide();
                    }else{
...
function dateChange(){
   ...
   function isopen(boo){  
	   ...
	   if(heatSwitch==1){
			...
			$.ajax({
					...
					success: function(data) {
						...
						if(data && data.length>0) {
							...
							for(var i=0;i<data.length;i++){
								var cam ={code:data[i].APPSECRET,name:data[i].NAME,useType:data[i].USE_TYPE};
								camLayerObj[data[i].ID]=cam;
								var obj ={useType:data[i].USE_TYPE,text:data[i].NAME,monitorId:data[i].ID,indexCode:data[i].APPSECRET,x:parseFloat(data[i].X),y:parseFloat(data[i].Y),iconUrl:'${uiDomain!''}/web-assets/_big-screen/nanchang-cc/images/',iconWidth:28,iconHeight:36 }
		...
		function openAndroidVideo(json){
			window.location.href="getPlayerUrl:" + JSON.stringify(json);
		}
		var lastGraphic = null;
		var lastpic = null;
		//视频详情页面
		function showCamPoint(data,graphic,userType){
			if(lastGraphic != null){
			...
			isCamListDetail=false;
				var useType= camLayerObj[data.monitorId].useType;
			if(isAndroid){ 
				$.ajax({
					url: '${GBP_DOMAIN!''}/gbp/globalEyes/api/findGlabalEyeInfoJsonp.jhtml?callback=?',
					dataType:"jsonp",
					async: false,
					data:{
						"monitorId":data.monitorId,"isVideoUrl":"1"
					},
					success: function(d){
						openAndroidVideo({"monitor_code":data.indexCode,"monitor_name":data.text,"url":d.rtspUrl,"x":data.x,"y":data.y,"grid_name":gridName,"grid_id":gridId} );
					}
				});
				//alert("getPlayerUrl:" + JSON.stringify(json));
			}else{
				$('#title_p').html("视频详情");
				isPointDetail=true;
				//$('.mask-container').css('display', 'block');
				...
				getVideoDetail(data.indexCode,data.monitorId,data.useType);
				...
				$('.mask-container-on').removeClass('mask-container-on');
				$('#mask-vedio').addClass('mask-container-on');
				$("#video_name").html(data.text?data.text:'');
				$("#video_code").html(data.indexCode?data.indexCode:'');
			}
		...
		function mapZoomChange(view){
			...
			$.ajax({
					...
					success: function(data) {
						if(data.list!=null && data.list.length>0 && data.list[0].infoOrgCode.indexOf('${gridCode}')==0){
							var g = data.list[0];
							if(gridId==g.gridId){
								return;
							}
    ...
    function initFn3 () {
        ...
        $('#shangbao').click(function () {
        	eventReportFlag="event";
        	messageVideo();
        });
        
        // 督察上报
        $('#quickSupervision').click(function () {
        	eventReportFlag="supervision";
        	messageVideo();
        });
 
    };
	
	function messageVideo(){//往视频播放页面传消息执行截图
		var videoObj = document.getElementById("videoUrl"+currentIndex);
		videoObj.contentWindow.postMessage({'event':'monitorSnapshotByBtu'}, '${GBP_DOMAIN!''}/gbp/globalEyes/play/index.jhtml?snapshotType=messageSub&isAutoplay=1&monitorId='+$(videoObj).attr('dataId'));
	}
       var param = {
           centerX : '',
           centerY : '',
       ...
       $("#city").click(function(){
           ...
           $.fn.ffcsMap.Geometry.RemoveText("textLayer");
           //隐藏复选框
           $('.tabs-check').removeClass('tabs-check-on');
           //事件热力高亮
           $('.tabs-cont').removeClass('pc-icon-tabs-0deg');
           $("#myiframe1").attr("src","${rc.getContextPath()}/zhsq/map/DDEarthController/camList.jhtml?seachList=1&line=&infoOrgCode=3601");

           //默认层级为9
           $.fn.ffcsMap.setZoom(9)
		   //去除热力图
           heatMap.removeLayer();

       });
       //搜索时撒点
       function cityPoint(struc3DAry) {
           $.fn.ffcsMap.renderPoint("pointLayer", struc3DAry);
       }
       //点击列表时如果是乡镇就缩放
       function countrysideZoom() {
		   $.fn.ffcsMap.setZoom(15);
       }
		//视频详情
		...
		window.addEventListener("message",function(e){  
				if(e.data.event == 'monitorSnapshot'){
					eventReport(e.data);
				}
			},false);
		function getVideoDetail(indexCode,monitorId,useType){ 
			...
			if(videoSelectByHand!=''){//手动选中
				if(videoSelectByHand.attr("play")==="0"){
					var html='<iframe src="" width="100%" height="100%" dataId="'+monitorId+'" id=videoUrl'+(selectByHand)+' webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" frameborder="0" allowtransparency="true" allowfullscreen=""  allow="autoplay"></iframe>';
				...
				if(videoSelect!=''){//如果有选中某个框
					if(videoSelect.attr("play")==="0"){
						var html='<iframe src="" width="100%" height="100%" dataId="'+monitorId+'"  id=videoUrl'+(selected)+' webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" frameborder="0" allowtransparency="true" allowfullscreen=""  allow="autoplay"></iframe>';
					...
					for(var i=0;i<playArr.length;i++){//查找下一个视频播放框下标
						if(playArr[i] == 0){
							nextLi = i;
							var html='<iframe src="" width="100%" height="100%" dataId="'+monitorId+'"  id=videoUrl'+i+' webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" frameborder="0" allowtransparency="true" allowfullscreen=""  allow="autoplay"></iframe>';
			...
			currentIndex=nextLi;
			videoIframe.attr("src","${GBP_DOMAIN!''}/gbp/globalEyes/play/index.jhtml?snapshotType=messageSub&isAutoplay=1&monitorId="+monitorId);;//;
			selectByHand='';
			videoSelectByHand='';
			selectNext();
		}
		...
		function eventReport(monitorData){
			$.ajax({
				type : 'POST',
				dataType : "json",
				url: '${rc.getContextPath()}/zhsq/map/DDEarthController/saveImg.json',
				data:{'base64':monitorData.pictureData},
				success: function(data){
					if(data){
						//var monitorById =$("#monitorId").val();
						var event = JSON.stringify({"isReport":false} );  
						if(eventReportFlag=='supervision'){
							$("#event_frame").attr("src","${rc.getContextPath()}/zhsq/event/eventDisposalController/toAddEventByVideo.jhtml?from=_ncSupervision&picName=&monitorById="+monitorData.id+"&attrId="+data+"&eventJson="+encodeURIComponent(event));
						}else{
							$("#event_frame").attr("src","${rc.getContextPath()}/zhsq/event/eventDisposalController/toAddEventByVideo.jhtml?from=_nc3d&picName=&monitorById="+monitorData.id+"&attrId="+data+"&eventJson="+encodeURIComponent(event));
						}
	...
	<script>
            var box = document.getElementById("moveDiv"); //获取元素
            var box2 = document.getElementById("mc-item"); //获取元素
            var box1 = document.getElementById("dianwei-center1"); //获取元素
            ...
            document.onmousemove = function(e) {
                ...
                if(isDrop) {　　　　
    				...
    				var rem = winW * whdef;             
                    　　
                    box1.style.left = (moveX+winW2+0.2*rem) + "px";　　
                    box1.style.top = (moveY+0.2*rem) + "px";　　　　　　　　　　
                } else {
                    return;　　　　　　　　　　
                }
     ...
     <script>
		...
		function getOrgSub(){
			...
			$.ajax({
				type: "POST",
				url: '${rc.getContextPath()}/zhsq/map/arcgis/arcgis/loadOaCommunicatGroupList.jhtml',
				data:{
					createGroupParentId : commucatGroupId
				},
				success: function(data){
					if(data){
						var list =data.data
						...
						if(list.length){
							for(var i=0;i<list.length;i++){
								var bo = list[i];
								if(init_value>0){
									if(bo.id !=commucatGroupId){
										html +='<div class="zuzhi-item" style="cursor:pointer;" onclick = "getClick('+bo.id+')"  ondblclick="getDbClick('+bo.id+","+'\''+bo.groupName+'\''+')">';
			                            html+='<p><i><img src="${uiDomain!''}/web-assets/_big-screen/nanchang-cc/images/tongxunlu/icon-touxzz.png"></i>';
			                            html+='<psan>'+bo.groupName+'</psan></p>';
			                        	html +='</div>';
			                        	commucatGroupId = list[1].id;
			                        	getCommPerson();
									}
								}else{
									var htmlMenu = '<a class="active" data-orgid="'+bo.id+'">'+bo.groupName+'></a>';
									$("#menu").append(htmlMenu);
									commucatGroupId = bo.id;
									init_value++;
						            getOrgSub();
								}
							}
		...
		//双击事件
		function getDbClick(id,name){
			$('.menuList>a').removeClass('active');
			$('.zuzhi .zuzhi-item').removeClass('active');
			var htmlMenu = '<a class="active" data-orgid="'+id+'">'+name+'></a>';
			$("#menu").append(htmlMenu);
			$('.tonxunlu-content-r01').addClass('tonxunlu-show');
            $('.tonxunlu-content-r02').removeClass('tonxunlu-show');
            commucatGroupId = id;
            getOrgSub();
		}
		//单击事件
		...
		function getCommPerson(){
			...
			$.ajax({
				type: "POST",
				url: '${rc.getContextPath()}/zhsq/map/arcgis/arcgis/loadOaCommunicatPersonList.jhtml',
				data:{
					commucatGroupId :commucatGroupId,
					keyWords :keyWords
				},
				success: function(data){
					$("#presonList").html('');
					if(data){
						...
						if(rows){
							for(var i=0;i<rows.length;i++){
								html += '<li style="cursor:pointer;" onclick = "getDetail('+rows[i].id+","+'\''+rows[i].orgCode+'\''+')">';
								html += '<p><img src="${uiDomain!''}/web-assets/_big-screen/nanchang-cc/images/tongxunlu/icon-touxgr02.png"></p>';
								html += '<p title="'+rows[i].name+'">'+rows[i].name.substring(0,5)+'</p>';
								html += '</li>';
							}
							$("#presonList").html(html);
						}
						layer.closeAll();
					}
				}
		...
		//人员详情
		function getDetail(id,orgCode){
			var layerMsg = layer.load(1,{ // 此处1没有意义，随便写个东西
			    icon: 0, // 0~2 ,0比较好看
			    shade: [0.5,'black'] // 黑色透明度0.5背景
			});
			$('.tonxunlu-content-r01').removeClass('tonxunlu-show');
            $('.tonxunlu-content-r02').addClass('tonxunlu-show');
			$.ajax({
				type: "POST",
				url: '${rc.getContextPath()}/zhsq/map/arcgis/arcgis/detailPerson.jhtml',
				data:{
					orgCode : orgCode,
					detailPersonId : id
				},
				success: function(data){
					var bo = data.oaCommunicatPerson;
					if(bo){
						$("#personName").html(bo.name)
						$("#postition").html(bo.position)
						var html='<a href="javascript:void(0)" onclick="getPhone('+bo.phone+')" style="color: yellow">'+bo.phone+'</a>'
						$("#phone").html(html)
						if(bo.email){
							$("#email").html(bo.email)
						}else{
		...
		function getPhone(phone){
			if(isAndroid){ 
				window.location.href="protocol://android?phone_number:"+phone;
			}
		}
        $(function () {
            //通讯录
            $('.zuzhi-01 .zuzhi-item').on('click',function(){
                $('.zuzhi .zuzhi-item').removeClass('active');
                $(this).addClass('active');
                $('.tonxunlu-content-r01').addClass('tonxunlu-show');
                $('.tonxunlu-content-r02').removeClass('tonxunlu-show');
            });
            $('.tonxunlu-main-top>p>i').on('click',function(){
                $('.tonxunlu-main').fadeOut(200);
            });
            ...
            //美化滚动条
	        $(window).on('load resize', function () {
	            $('.dianwei-xianze-title, .dianwei-xianze-content,.zuzhi').niceScroll({
        ...
        function showComm(){
        	 $('.tonxunlu-main').css('display','block');
 			var layerMsg = layer.load(1,{ // 此处1没有意义，随便写个东西
			    icon: 0, // 0~2 ,0比较好看
			    shade: [0.5,'black'] // 黑色透明度0.5背景
			});
