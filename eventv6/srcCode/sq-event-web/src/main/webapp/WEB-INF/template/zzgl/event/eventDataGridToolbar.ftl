		...
		<@block name="generalParam">
            ...
            <div class="fl" id="topSearchUl">
                <ul>
                    ...
                    <li id="advanceSearchLi" style="position:relative;">
                            ...
                            <div class="LeftShadow">
                                <div class="RightShadow">
                                    <div class="list NorForm" style="position:relative;">
                                        <table id="advanceSearchTable" width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr class="queryConfig" configName="排序字段">
                                                <td>
                                            ...
                                            <tr id="orderByFieldRadioTr" class="queryConfigSub hide">
                                                <td>
                                            ...
                                            <tr class="queryConfig query4todo" configName="是否接收">
	                                    		<td>
                                            ...
                                            <tr id="eventTypeTr" class="queryConfig" configName="事件分类">
	                                    		<td>
                                            ...
                                            <tr class="queryConfig" configName="事件编号">
                                                <td><label class="LabName width65px"><span>事件编号：</span></label><input class="inp1 selectWidth queryParam" type="text" id="code" name="code"></input></td>
                                            </tr>
                                            <@block name="eventStatusTrBlock">
										<#if eventType=="all" || eventType=="attention">
                                            <tr class="queryConfig" configName="事件状态">
                                            ...
                                            <tr class="queryConfig" configName="事发时间">
                                                <td>
                                            ...
                                            <#if eventType??>
                                            	<#if eventType != 'draft'>
                                            		<tr class="queryConfig" configName="办结期限">
                                            			<td>
                                            	...
                                            	<#if eventType == "all">
                                            		<tr class="queryConfig" configName="结案时间">
                                            			<td>
                                            	...
                                            	<#elseif eventType == 'history'>
                                            		<tr class="queryConfig" configName="归档时间">
                                            			<td>
                                            ...
                                            <tr class="queryConfig" configName="采集人">
                                                <td><label class="LabName width65px"><span>采集人：</span></label><input class="inp1 selectWidth queryParam" type="text" id="contactUser" name="contactUser"></input></td>
                                            </tr>
                                            
                                        <#if eventType??&&(eventType=='all' || eventType=='history')>
                                        	<tr class="queryConfig" configName="采集人所属组织">
                                                <td>
                                        ...
                                        <@block name="collectWaysCondition">
                                            <tr class="queryConfig" configName="采集渠道">
                                                <td>
                                            ...
                                            <tr class="queryConfig" configName="信息来源">
                                                <td>
                                        ...
                                        <@block name="influenceDegreesCondition">
                                            <tr class="queryConfig" configName="影响范围">
                                                <td>
                                        ...
                                        <@block name="urgencyDegreesCondition">
                                            <tr class="queryConfig" configName="紧急程度">
                                                <td>
                                            ...
                                            <tr class="<#if eventType=="history">queryConfig<#else>hide</#if>" configName="评价等级">
                                                <td>
                                            ...
                                            <tr id="attrFlagTr" class="<#if eventType=="all" || eventType=="history">queryConfig<#else>hide</#if>" configName="附件类型">
                                                <td>
										...
										<#if isShowPlatformSelect?? &&(isShowPlatformSelect=="true")>
                                            <tr class="queryConfig" configName="对接平台">
                                                <td>
										...
										<#if isShowOrgSelect?? &&(isShowOrgSelect=="true")>
                                            <tr class="queryConfig" configName="办理环节">
                                                <td>
										...
										<#if eventType=="all">
											<tr id="handlerTr" class="queryConfig" configName="办理单位">
												<td>
													<label class="LabName width65px"><span>办理单位：</span></label>
													<input id="eventOrgOrgId" name="eventOrgOrgId" value="" class="queryParam hide"/>
													<input type="text" class="inp1 selectWidth InpDisable" id="eventOrgOrgName" value=""/>
												</td>
											</tr>
										</#if>
                                        </table>
...
<script type="text/javascript">
	...
	<#if eventType??>
		...
		<#if eventType == 'all'>
			AnoleApi.initFuncOrgZtreeComboBox("eventOrgOrgName", "eventOrgOrgId", null, {
				OnCleared : function() {
					$("#eventOrgOrgId").val("");
				},
				EnabledSearch : false,
		...
		<#if eventType=='all' || eventType=='history'>
        ...
        <@block name="createTimeDateRenderInit">
        ...
        var collectWayDictCode = "${collectWayDictCode!}";
        if(isNotBlankStringTrim(collectWayDictCode)) {
            AnoleApi.initTreeComboBox("collectWaysName", "collectWays", {
                "A001093096" : [${collectWayDictCode!}]
            }, null, null, {//0 展示指定的字典；1 去除指定的字典；
                RenderType : "01",
                ShowOptions: {
                    EnableToolbar : true
        ...
        if(isNotBlankStringTrim(sourceDictCode)) {
            AnoleApi.initTreeComboBox("sourcesName", "sources", {
        ...
        var influenceDegreeDictCode = "${influenceDegreeDictCode!}";
        if(isNotBlankStringTrim(influenceDegreeDictCode)) {
            AnoleApi.initTreeComboBox("influenceDegreesName", "influenceDegrees", {
                "A001093094" : [${influenceDegreeDictCode!}]
            }, null, null, {//0 展示指定的字典；1 去除指定的字典；
                RenderType : "01",
                ShowOptions: {
                    EnableToolbar : true
        ...
        var urgencyDegreeDictCode = "${urgencyDegreeDictCode!}";
        if(isNotBlankStringTrim(urgencyDegreeDictCode)) {
            AnoleApi.initTreeComboBox("urgencyDegreesName", "urgencyDegrees", {
                "A001093271" : [${urgencyDegreeDictCode!}]
            }, null, null, {//0 展示指定的字典；1 去除指定的字典；
                RenderType : "01",
                ShowOptions: {
                    EnableToolbar : true
        ...
        var attrFlagDictCode = "${attrFlagDictCode!}";
        if(isNotBlankStringTrim(attrFlagDictCode)) {
            AnoleApi.initTreeComboBox("attrFlagsName", "attrFlags", {
                "B063" : [${attrFlagDictCode!}]
            }, null, null, {//0 展示指定的字典；1 去除指定的字典；
                RenderType : "01",
                ShowOptions: {
                    EnableToolbar : true
    ...
    function invalid(operateName, invalidType) {
		...
		$.messager.confirm('提示', '您确定' + operateName + '选中的事件吗？', function(r){
			if(r) {
				...
				var url = '${rc.getContextPath()}/zhsq/event/eventDisposalController/toInvalidEvent.jhtml',
	...
	<@block name="resetConditionFunction">
        ...
        <@block name="statussResetCondition">
            <#if eventType=="all" || eventType=="attention">
    ...
    function queryData(searchArray){
		...
		<@block name="queryParamFormatBlock">
        ...
        //高级查询
        <@block name="advancedStatussSearch">
            <#if eventType=="all" || eventType=="attention">
                var eventStatus = "";
  ...
  //导出
   ...
   //导出所有
    function doExportByBdio(){
    	$.messager.confirm('提示', '是否导出查询数据？', function(r){
    		if (r) {  
    			  conditionSearch();
    			  showExportWindows("导出基础信息统计","${BDIO_URL!''}/export/form/ex_cg_event.jhtml",$("#list").datagrid('options').queryParams,$(window).width(),$(window).height());
    		}
    	});
    }
    ...
    function addAttention() {
		if(idStr==null || idStr=="") {
			...
			$.messager.confirm('提示', '确定添加关注信息吗？', function(r) {
				if(r) {
					modleopen();
	...
	function delAttention() {
		if(idStr==null || idStr=="") {
			...
			$.messager.confirm('提示', '确定取消关注信息吗？', function(r) {
				if(r) {
					modleopen();
    ...
    function init4DateRender(renderId, startTimeId, endTimeId) {
        <@block name="anoleDateRenderFormat">
            var dateRender = null;
