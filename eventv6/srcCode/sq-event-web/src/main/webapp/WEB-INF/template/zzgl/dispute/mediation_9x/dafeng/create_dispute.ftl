						...
						<div class="fw-main">
								...
								<div class="fw-det-toggle">
									<ul class="fw-xw-from clearfix">
										...
										<li class="xw-com1">
											...
											<input name="disputeCondition" id="disputeCondition" class="inp1 easyui-validatebox from flex1 bg-btm-arrow1" type="text" value="<#if disputeMediation.disputeCondition??>${disputeMediation.disputeCondition}</#if>" data-options="tipPosition:'bottom',required:true, validType:['minLength[20]','maxLength[1000]','characterCheck']" placeholder="请输入事件描述"/>
										</li>
										<li class="xw-com3">
										...
										<li class="xw-com3">
											...
											<input name="eventNatureName" id="eventNatureName" class="inp1 inp2 InpDisable easyui-validatebox validatebox-text validatebox-invalid from flex1 bg-btm-arrow1" type="text" data-options="tipPosition:'bottom',required:true,validType:['maxLength[1000]','characterCheck']" placeholder="请选择事件性质">
										</li>
										<li class="xw-com3">
										...
										<li class="xw-com3">
											...
											<input name="riskCodeName" id="riskCodeName" class="from flex1 bg-btm-arrow1" type="text" data-options="tipPosition:'bottom',required:true,validType:['maxLength[1000]','characterCheck']" placeholder="请选择风险类型">
									 	...
									 	<li class="xw-com3">
											...
											<input name="riskGradeName" id="riskGradeName" class="from flex1 bg-btm-arrow1" type="text" data-options="tipPosition:'bottom',required:true,validType:['maxLength[1000]','characterCheck']" placeholder="请选择风险等级">
										</li>
										<li class="xw-com3">
										...
										<li class="xw-com3">
											<span class="fw-from1"><i class="spot-xh">*</i>矛盾纠纷类型：</span>
											...
											<input name="disputeType3Name" id="disputeType3Name" class="inp1 inp2 InpDisable easyui-validatebox validatebox-text validatebox-invalid from flex1 bg-btm-arrow1" type="text" data-options="tipPosition:'bottom',required:true,validType:['maxLength[1000]','characterCheck']" placeholder="请输入矛盾纠纷类型">
										</li> 
										<li class="xw-com3">
											<span class="fw-from1"><i class="spot-xh">*</i>涉及单位：</span>
											<input name="involvedOrgName" id="involvedOrgName" class="inp1 easyui-validatebox from flex1 bg-btm-arrow1" type="text" value="<#if disputeMediation.involvedOrgName??>${disputeMediation.involvedOrgName}</#if>" data-options="tipPosition:'bottom',required:true,validType:['maxLength[100]','characterCheck']" placeholder="请输入涉及单位"/>
										</li>
										<li class="xw-com1">
										...
										<li class="xw-com1">
											<span class="fw-from1" style="margin-top:3%;"><i class="spot-xh">*</i>附件上传：</span>
							...
							<div class="fw-det-tog mt10" id="3">
								...
								<div class="fw-det-toggle">
									<ul class="fw-xw-from clearfix">
										<li class="xw-com3">
											<span class="fw-from1"><i class="spot-xh">*</i>化解方式：</span>
											<input type="hidden" id="mediationType" name="mediationType" value="<#if disputeMediation.mediationType??>${disputeMediation.mediationType}</#if>" data-options="tipPosition:'bottom'">
											<input name="mediationTypeStr" id="mediationTypeStr" class="inp1 inp2 InpDisable easyui-validatebox validatebox-text validatebox-invalid from flex1 bg-btm-arrow1" type="text" placeholder="请选择" data-options="tipPosition:'bottom',required:true,validType:['maxLength[1000]','characterCheck']">
										</li>
										<li class="xw-com3">
											<span class="fw-from1"><i class="spot-xh">*</i>最后调解日期：</span>
											<input id="mediationDateStr" name="mediationDateStr" type="text" class="Wdate inp1 inp2 easyui-validatebox from flex1 bg-btm-arrow2 pr30" readonly="readonly" data-options="required:true" onclick="WdatePicker({el:'mediationDateStr',dateFmt:'yyyy-MM-dd'})" data-options="required:true,tipPosition:'bottom'"  value="<#if disputeMediation.mediationDateStr??>${disputeMediation.mediationDateStr}</#if>"/>
										...
										<li class="xw-com3">
											<span class="fw-from1"><i class="spot-xh">*</i>化解责任人姓名：</span>
											<input name="mediator" id="mediator" class="inp1 easyui-validatebox from flex1 bg-btm-arrow1" type="text" value="<#if disputeMediation.mediator??>${disputeMediation.mediator}</#if>"  data-options="required:true,validType:['maxLength[15]','characterCheck']">
										</li>
										<li class="xw-com3">
											<span class="fw-from1"><i class="spot-xh">*</i>化解责任人身份证：</span>
											<input name="hjCertNumber" id="hjCertNumber" class="inp1 from flex1 bg-btm-arrow1 easyui-validatebox" type="text" value="<#if disputeMediation.hjCertNumber??>${disputeMediation.hjCertNumber}</#if>"  data-options="required:true,validType:['idcard']">
										</li>
										<li class="xw-com3">
											<span class="fw-from1"><i class="spot-xh">*</i>化解组织：</span>
											<input name="mediationOrgName" id="mediationOrgName" class="from flex1 bg-btm-arrow1 easyui-validatebox" type="text" value="<#if disputeMediation.mediationOrgName??>${disputeMediation.mediationOrgName}</#if>"  data-options="required:true,validType:['maxLength[50]','characterCheck']"/>
										</li> 
										<li class="xw-com3">
											<span class="fw-from1"><i class="spot-xh">*</i>化解是否成功：</span>
											 <input type="hidden" id="isSuccess" name="isSuccess"  value="<#if disputeMediation.isSuccess??>${disputeMediation.isSuccess}</#if>" data-options="tipPosition:'bottom'">
											 <input name="isSuccessStr" id="isSuccessStr" class="inp1 inp2 InpDisable easyui-validatebox validatebox-text validatebox-invalid from flex1 bg-btm-arrow1" type="text" placeholder="请选择" data-options="tipPosition:'bottom',required:true,validType:['maxLength[1000]','characterCheck']">
										</li>
										<li class="xw-com3">
											<span class="fw-from1"><i class="spot-xh">*</i>化解责任人联系方式：</span>
											<input name="mediationTel" id="mediationTel" class="inp1 from flex1 bg-btm-arrow1 easyui-numberbox" type="text" value="<#if disputeMediation.mediationTel??>${disputeMediation.mediationTel}</#if>" maxlength="11" data-options="required:true,validType:['maxLength[11]','characterCheck','telNum']"/>
										</li>
										<li class="xw-com1">
											<span class="fw-from1"><i class="spot-xh">*</i>化解情况：</span>
...
//         	addMainPeople();
            ...
            function addMainPeople(){
 		        var main_people_html = '<div id="sel_'+index+'" style="border:1px #e5e5e5 solid;margin-top:5px">'+
										...
										'</li>'+
										'<li class="xw-com3">'+
											'<span class="fw-from1"><i class="spot-xh">*</i>联系电话：</span>'+
											'<input name="involvedPeople['+index+'].tel" id="tel'+index+'" data-options="required:true,prompt:\'请输入正确的手机号码\' , validType:\'telNum\'"  class="inp1 inp2 InpDisable easyui-validatebox validatebox-text  from flex1 bg-btm-arrow1" type="text" value="${involvedPeople.tel!''}" placeholder="请输入联系电话">'+
										'</li>'+
										'<li class="xw-com1">'+
		    ...
		    function tableSubmit(type){
				...
				let attachmentNum = bigupload.getAttachmentNum();
				if(attachmentNum == 0){
		    ...
		    function main_people_html (index,data){
		    		var main_people_html = '<div id="sel_'+index+'" style="border:1px #e5e5e5 solid;margin-top:5px">'+
						'<ul class="fw-xw-from clearfix" style="margin-top:15px">'+
							...
							'<li class="xw-com3">'+
								'<span class="fw-from1"><i class="spot-xh">*</i>联系电话：</span>'+
								'<input name="involvedPeople['+index+'].tel" id="tel'+index+'"  class="from flex1 bg-btm-arrow1 easyui-numberbox" oninput="value=value.replace(\/[^\\d]\/g,\'\')" maxlength="11" data-options="required:true,prompt:\'请输入正确的手机号码\' , validType:\'telNum\'" type="text" value="${involvedPeople.tel!''}" placeholder="请输入联系电话">'+
							'</li>'+
