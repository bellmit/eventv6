<script type="text/javascript">
    function add(opt) {
        ...
        var url = "${rc.getContextPath()}/zhsq/reportPPM/toAdd.jhtml?listType=" + $('#listType').val();
    ...
    function edit() {
        ...
        if(reportUUID == "") {
            ...
            var url = "${rc.getContextPath()}/zhsq/reportPPM/toAdd.jhtml?listType=" + $('#listType').val() + "&reportUUID=" + reportUUID;
    ...
    function del() {
        ...
        if(reportUUID == "") {
            ...
            $.messager.confirm('提示', '您确定删除选中的监测信息吗？', function(r) {
                if(r){
                    modleopen();

                    $.ajax({
                        type: "POST",
                        url: '${rc.getContextPath()}/zhsq/reportPPM/delReportFocus.jhtml',
                        ...
                        error:function(data){
                            $.messager.alert('错误','删除监测信息失败！','error');
                        }
                    });
                }
            });
    ...
    function detail(reportUUID, instanceId, listType) {
        if(reportUUID) {
            ...
            var url = "${rc.getContextPath()}/zhsq/reportPPM/toDetail.jhtml?reportUUID=" + reportUUID + "&listType=" + listType + "&reportType=" + $('#reportType').val();
