...
/**
 * 扫黑除恶(Sweep Black Remove Evil) 线索管理(Clue) 工作流接口
 * @author zhangls
 *
 */
public interface IEventSBREClueWorkflowService {
	/**
	 * 启动流程
	 * @param clueId		线索id
	 * @param userInfo		用户信息
	 ...
	 * @throws Exception
	 */
	public boolean startWorkflow4Clue(Long clueId, UserInfo userInfo, Map<String, Object> extraParam) throws Exception;
	 ...
	 * @throws Exception
	 */
	public boolean subWorkflow4Clue(Long clueId, String nextNodeName, List<UserInfo> nextUserInfoList, UserInfo userInfo, Map<String, Object> extraParam) throws Exception;
	 ...
	 * @throws Exception
	 */
	public boolean rejectWorkflow4Clue(Long clueId, String rejectToNodeName, UserInfo userInfo, Map<String, Object> extraParam) throws Exception;
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> findCurTaskData(Long clueId, UserInfo userInfo) throws Exception;
	 ...
	 * @throws Exception
	 */
	public boolean isCurTaskPaticipant(Long clueId, UserInfo userInfo, Map<String, Object> extraParam) throws Exception;
	/**
	 * 判断用户是否为当前任务的办理人员
