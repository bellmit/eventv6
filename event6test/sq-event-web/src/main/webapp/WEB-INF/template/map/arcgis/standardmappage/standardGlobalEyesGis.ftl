...
<body style="border:none;">
    ...
    <div class="" style="display:block;">
        ...
        <div class="NorPage" style="display:none;">
...
function CloseSearchBtn(){
	...
	function loadMessage(pageNo,pageSize,searchType){
		...
		var postData = 'page='+pageNo+'&rows='+10000+'&orgCode='+orgCode+'&platformName='+platformName;
		$.ajax({
			type: "POST",
	...
	if("1" != window.parent.IS_ACCUMULATION_LAYER) {
			...
			if(window.parent.currentListNumStr.indexOf(currentPageNum+"")>=0) {
				...
				window.parent.currentListNumStr = currentListNumStr+","+currentPageNum;
			}
		}
		if (res==""){
			return ;
