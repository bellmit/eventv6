...
function treeNodeClick(event, treeId, treeNode, clickFlag) {
	...
	parent.gridTreeClickCallback(treeNode.id, treeNode.name, treeNode.orgId, treeNode.orgCode, treeNode.gridPhoto, parseInt(treeNode.gridLevel),treeNode.gridCode);
}
