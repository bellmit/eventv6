...
<div class="MapBar">
	...
	<div class="ztIcon AlphaBack people">
		...
		<ul>
			...
			<li class="PrinkBg" onclick="showObjectList('上访人员')">
			...
			<li class="PurpleBg" onclick="showObjectList('矫正人员')">
	...
	<div class="ztIcon AlphaBack world">
		...
		<ul>
			...
			<li class="YellowBg" onclick="showObjectList('企业')">
			 ...
			 <!-----------------------------------房------------------------------------->
			<li class="YellowBg" onclick="showObjectList('物业管理住宅')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon17.png" /></p>
			...
			<li class="PrinkBg" onclick="showObjectList('城市综合体')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon17.png" /></p>
			...
			<li class="PrinkBg" onclick="showObjectList('公园广场')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon17.png" /></p>
	...
	<div class="ztIcon AlphaBack metter">
		...
		<ul>
			...
			<li class="CyanBg" onclick="showEventCollectEntryPanel()">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/collect.png" /></p>
				<p class="word AlphaBack">采集录入_旧</p>
			</li>
			<li class="CyanBg" onclick="showObjectList('待办上报_旧')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon20.png" /></p>
				<p class="word AlphaBack">待办上报_旧</p>
			</li>
			<li class="CyanBg" onclick="showObjectList('待办分流_旧')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon20.png" /></p>
				<p class="word AlphaBack">待办分流_旧</p>
			</li>
			<li class="CyanBg" onclick="showObjectList('将到期_旧')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon22.png" /></p>
				<p class="word AlphaBack">将到期_旧</p>
			</li>
			<li class="CyanBg" onclick="showObjectList('已过期_旧')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon22.png" /></p>
				<p class="word AlphaBack">已过期_旧</p>
			</li>
		</ul>
        <div class="clear"></div>
        <!-- <div class="zonglan">
	...
	<div class="ztIcon AlphaBack thing">
		...
		<ul>
			...
			<li class="PrinkBg" onclick="showObjectList('公交站')">
			...
			<li class="PrinkBg" onclick="showObjectList('路灯')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon25.png" /></p>
				<p class="word AlphaBack">路灯</p>
			</li>
			<li class="PrinkBg" onclick="showObjectList('井盖')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon25.png" /></p>
				<p class="word AlphaBack">井盖</p>
			</li>
			<li class="PrinkBg" onclick="showObjectList('供水')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon25.png" /></p>
				<p class="word AlphaBack">供水</p>
			</li>
			<li class="PrinkBg" onclick="showObjectList('供热')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon25.png" /></p>
				<p class="word AlphaBack">供热</p>
			</li>
			<li class="PrinkBg" onclick="showObjectList('燃气')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon25.png" /></p>
				<p class="word AlphaBack">燃气</p>
			</li>
		</ul>
        <div class="clear"></div>
	</div>
    ...
    <div class="ztIcon AlphaBack situation">
		...
		<ul>
			...
			<li class="PurpleBg" onclick="showObjectList('志愿者')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon27.png" /></p>
				<p class="word AlphaBack">志愿者</p>
			</li>
			<li class="PurpleBg" onclick="showObjectList('巡逻段警')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon27.png" /></p>
				<p class="word AlphaBack">巡逻段警</p>
			</li>
			<li class="PurpleBg" onclick="showObjectList('巡逻队')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon27.png" /></p>
				<p class="word AlphaBack">巡逻队</p>
			</li>
			<li class="PurpleBg" onclick="showObjectList('治保会')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon27.png" /></p>
				<p class="word AlphaBack">治保会</p>
			</li>
			<li class="PurpleBg" onclick="showObjectList('警务室')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon27.png" /></p>
				<p class="word AlphaBack">警务室</p>
			</li>
			<li class="PurpleBg" onclick="showObjectList('案件警情')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon27.png" /></p>
				<p class="word AlphaBack">案件警情</p>
			</li>
			<li class="PurpleBg" onclick="showObjectList('隐患')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon27.png" /></p>
				<p class="word AlphaBack">隐患</p>
			</li>
			<li class="PurpleBg" onclick="showObjectList('派出所')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon27.png" /></p>
				<p class="word AlphaBack">派出所</p>
			</li>
		</ul>
        <div class="clear"></div>
	</div>
  ...
  <!--  <div class="ztIcon AlphaBack organization">
    ...
    <div class="ztIcon AlphaBack organization">
		...
		<ul>
			...
			<!-----------------------------------支部建设-组织机构------------------------------------->
			<li class="BlueBg" onclick="showObjectList('机关支部')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">机关支部</p>
			</li>
			<li class="BlueBg" onclick="showObjectList('村（居）党组织')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">村党组织</p>
			</li>
			<li class="BlueBg" onclick="showObjectList('网格党支部')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">网格党支部</p>
			</li>
			<li class="BlueBg" onclick="showObjectList('其他类型非公党支部')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">其他类型</p>
			</li>
			<!-----------------------------------支部建设-特殊党员情况------------------------------------->
    		<li class="BlueBg" onclick="showObjectList('高年龄、高党龄')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">高年龄、高党龄</p>
			</li>
			<li class="BlueBg" onclick="showObjectList('农村70周岁以上')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">农村70周岁以上生活困难老党员</p>
			</li>
			<li class="BlueBg" onclick="showObjectList('普通生活困难党员')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">普通生活困难党员</p>
			</li>
			<!-----------------------------------党风廉政-组织架构------------------------------------->
    		<li class="BlueBg" onclick="showOrgIndependentPanel('jgw')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">纪工委</p>
			</li>
			<li class="BlueBg" onclick="showOrgIndependentPanel('cj')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">村居</p>
			</li>
			<!-----------------------------------党风廉政-效能监督------------------------------------->
    		<li class="BlueBg" onclick="showOrgIndependentPanel('sjll')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">事件录入</p>
			</li>
			<li class="BlueBg" onclick="showObjectList('党廉-在办事件')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">在办事件</p>
			</li>
			<li class="BlueBg" onclick="showObjectList('党廉-历史事件')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">历史事件</p>
			</li>
			<!-----------------------------------党风廉政-活动开展情况------------------------------------->
    		<!--<li class="BlueBg" onclick="showOrgIndependentPanel('hdkz_jd')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">活动-街道</p>
			</li>
			<li class="BlueBg" onclick="showOrgIndependentPanel('hdkz_cj')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">活动-村居</p>
			</li>
			<!-----------------------------------人民防空-人防组织------------------------------------->
     		<li class="BlueBg" onclick="showOrgIndependentPanel('jcrfzz')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">基层人防职责</p>
			</li>
			<li class="BlueBg" onclick="showOrgIndependentPanel('jcrfxz')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">基层人防小组</p>
			</li> 
			<!-----------------------------------人民防空-指挥通信------------------------------------->
    		<li class="BlueBg" onclick="showOrgIndependentPanel('fkjbfb')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">防空警报分布</p>
			</li>
			<li class="BlueBg" onclick="showObjectList('人防管理员分布')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">人防管理员分布</p>
			</li>
			<li class="BlueBg" onclick="showOrgIndependentPanel('fkfajyl')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">防空方案及演练</p>
			</li>
			<li class="BlueBg" onclick="showOrgIndependentPanel('zhtxsd')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">指挥通信手段</p>
			</li> 
			<!-----------------------------------人民防空-人防工程------------------------------------->
    		<li class="BlueBg" onclick="showOrgIndependentPanel('zcfg')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">政策法规</p>
			</li>
			<li class="BlueBg" onclick="showOrgIndependentPanel('rfjjsqcl')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">人防结建申请材料</p>
			</li>
			<li class="BlueBg" onclick="showOrgIndependentPanel('rfgcfb')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/dangzuzhi.png" /></p>
				<p class="word AlphaBack">人防工程分布</p>
			</li>
		</ul>
        <div class="clear"></div>
	</div>
