...
<!-- baseDataTabs end -->
 ...
 <!-----------------------------------设置------------------------------------->
    <div class="NorMapOpenDiv2 zhoubianWindow hide dest" style="bottom:30px; left:60px;">
		<div class="box" style="width:375px;height:404px;">
...
<div class="MapBar">
	...
	<div class="ztIcon AlphaBack people">
		...
		<ul>
			...
			<li class="GreenBg" onclick="showObjectList('消防安全管理员')" title="消防安全管理员">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon33.png" /></p>
				<p class="word AlphaBack">消防安全管理员</p>
			</li>
		</ul>
        <div class="clear"></div>
	</div>
	...
	<div class="ztIcon AlphaBack world">
		...
		<ul>
			 <!-----------------------------------房------------------------------------->
			<li class="YellowBg" onclick="showObjectList('物业管理住宅')" title="物业管理住宅">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon17.png" /></p>
				<p class="word AlphaBack">物业管理住宅</p>
			</li>
			<li class="CyanBg" onclick="showObjectList('社区托管住宅')" title="社区托管住宅">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon17.png" /></p>
				<p class="word AlphaBack">社区托管住宅</p>
			</li>
			<li class="CyanBg" onclick="showObjectList('单位自管住宅')" title="单位自管住宅">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon17.png" /></p>
			...
			<li class="CyanBg" onclick="showObjectList(写字楼')">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon17.png" /></p>
				<p class="word AlphaBack">写字楼</p>
			</li>
			<li class="PrinkBg" onclick="showObjectList('城市综合体')" title="城市综合体">
				<p class="pic"><img src="${rc.getContextPath()}/theme/arcgis/standardmappage/images/icon17.png" /></p>
