...
<div class="MapBar">
    ...
    <div class="ztIcon AlphaBack titlefirstall" style="display:block;">
		<div class="title">
			...
			<span class="fr" onclick="showObjectListDy()"><img src="${uiDomain!''}/images/map/gisv0/special_config/images/refresh.png" /></span>
...
function showObjectListDy(){
	showObjectList('党员');
	$("#titlePath").html("专题图层 > 党员");
}
