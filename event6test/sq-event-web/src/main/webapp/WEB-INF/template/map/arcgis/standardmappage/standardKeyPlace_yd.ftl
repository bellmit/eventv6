    ...
    <div class="" style="display:block;">
        ...
        <div class="ListSearch">
        	<div class="condition">
                ...
                <ul>
                    <li class="LC1" style="width:100px;">是否九小场所：</li>
                    <li class="LC2" style="width:130px;">
                        <input type="hidden" id="nineSmallType" name="nineSmallType"/>
                        <input type="text" id="nineSmallTypeStr" class="sel1" style="width: 105px"/>
                    </li>
                </ul>
            	<ul>
                	<li class="LC1">&nbsp;</li>
...
var inputNum;
$(function () {
	AnoleApi.initTreeComboBox("nineSmallTypeStr", "nineSmallType", "D006014", null, null, {
        RenderType : "01",
		ShowOptions:{
			EnableToolbar : true
		}
...
function CloseSearchBtn(){
	...
	function loadMessage(pageNo,pageSize,searchType){
		...
		var nineSmallType = $("#nineSmallType").val();
		$.blockUI({message: "加载中..." , css: {width: '150px',height:'50px',lineHeight:'50px',top:'40%',left:'20%',
    	background:'url(${rc.getContextPath()}/css/loading.gif) no-repeat',textIndent:'20px'},overlayCSS:{backgroundColor:'#fff'}});
		var postData = 'page='+pageNo+'&rows='+pageSize+'&gridId='+gridId+'&plaName='+plaName+'&plaType='+plaType+'&isFocus='+isFocus+'&nineSmallType='+nineSmallType;
		$.ajax({
			type: "POST",
			...
			success: function(data){
				...
				if(list && list.length>0) {
					for(var i=0;i<list.length;i++){
					  ...
					  var roomAddress = val.baseAddr;
					  if(roomAddress==null || roomAddress==""){
                          roomAddress = val.roomAddress;
					  }
					  
					  tableBody+='<dl onclick="selected(\''+val.plaId+'\',\''+(val.plaName==null?'':val.plaName)+'\')">';
					  tableBody+='<dt>';
                        if (val.isNineSmall == '1' && val.nineSmallType != null && val.nineSmallType == '001') {
                            tableBody+='<span style="padding-right: 5px;"><img src="${uiDomain!''}/web-assets/common/images/iconclass/iconbox/special/icon-s-school.png" width="18px" height="18px"></span>';
                        } else if(val.isNineSmall == '1' && val.nineSmallType != null && val.nineSmallType == '002'){
                            tableBody+='<span style="padding-right: 5px;"><img src="${uiDomain!''}/web-assets/common/images/iconclass/iconbox/special/icon-s-clinic.png" width="18px" height="18px"></span>';
						} else if(val.isNineSmall == '1' && val.nineSmallType != null && val.nineSmallType == '003'){
                            tableBody+='<span style="padding-right: 5px;"><img src="${uiDomain!''}/web-assets/common/images/iconclass/iconbox/special/icon-s-shop.png" width="18px" height="18px"></span>';
                        } else if(val.isNineSmall == '1' && val.nineSmallType != null && val.nineSmallType == '004'){
                            tableBody+='<span style="padding-right: 5px;"><img src="${uiDomain!''}/web-assets/common/images/iconclass/iconbox/special/icon-s-sestaurant.png" width="18px" height="18px"></span>';
                        } else if(val.isNineSmall == '1' && val.nineSmallType != null && val.nineSmallType == '005'){
                            tableBody+='<span style="padding-right: 5px;"><img src="${uiDomain!''}/web-assets/common/images/iconclass/iconbox/special/icon-s-hotel.png" width="18px" height="18px"></span>';
                        } else if(val.isNineSmall == '1' && val.nineSmallType != null && val.nineSmallType == '006'){
                            tableBody+='<span style="padding-right: 5px;"><img src="${uiDomain!''}/web-assets/common/images/iconclass/iconbox/special/icon-s-amusement.png" width="18px" height="18px"></span>';
                        } else if(val.isNineSmall == '1' && val.nineSmallType != null && val.nineSmallType == '007'){
                            tableBody+='<span style="padding-right: 5px;"><img src="${uiDomain!''}/web-assets/common/images/iconclass/iconbox/special/icon-s-Internet cafe.png" width="18px" height="18px"></span>';
                        } else if(val.isNineSmall == '1' && val.nineSmallType != null && val.nineSmallType == '008'){
                            tableBody+='<span style="padding-right: 5px;"><img src="${uiDomain!''}/web-assets/common/images/iconclass/iconbox/special/icon-s-shower.png" width="18px" height="18px"></span>';
                        } else if(val.isNineSmall == '1' && val.nineSmallType != null && val.nineSmallType == '009'){
                            tableBody+='<span style="padding-right: 5px;"><img src="${uiDomain!''}/web-assets/common/images/iconclass/iconbox/special/icon-s-workshop.png" width="18px" height="18px"></span>';
                        }
