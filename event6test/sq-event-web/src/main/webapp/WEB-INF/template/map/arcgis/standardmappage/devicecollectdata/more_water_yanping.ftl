...
//加载列表历史告警信息列表
	function loadAlarmInfo() {
		$('#alarmInfo').datagrid({
			...
			width:500,
			height:250,
			url: '${rc.getContextPath()}/zhsq/map/arcgis/arcgisDataOfYanpingStDeviceController/findWaterHistoryList.jhtml',
			queryParams: $('#searchForm').serializeJson(), 
			columns: [[
					{field:'PH', title:'PH', align:'center'},
					{field:'TEMP', title:'水温(℃)', align:'center',width:100},
					{field:'DORATE', title:'溶解氧(mg/L)', align:'center',width:100},
					{field:'ELEC', title:'电导率(μs/cm)', align:'center',width:100},
					{field:'TURB', title:'浊度(NTU)', align:'center',width:100},
