...
<div id="mapBodyLeft" class="MapBar">
    <iframe id="biReport" name="biReport" style="border:0; width: 100%; height: 100%;" src="${BI_REPORT}/report/specialCrowd/echarts" scrolling="no"></iframe>
</div>
<div id="mapBodyRight" class="MapBar" style="right:0px;left:auto;">
    <div class="con AlphaBack" style="position: absolute; z-index: 3;">
	...
	<div class="page-container" id="map0" style="position: absolute; width:100%; height:100%; z-index: -1;"></div>
    <!-----------------------------------人地事物情------------------------------------->
...
function _init() {
	...
	$("#map0").height(_height);
	$("#mapBodyLeft").width(_width / 3).height(_height);
	$("#mapBodyRight").width(_width / 3 * 2).height(_height);
