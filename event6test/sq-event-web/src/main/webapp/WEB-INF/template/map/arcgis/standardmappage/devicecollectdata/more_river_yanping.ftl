...
//加载列表历史告警信息列表
	function loadAlarmInfo() {
		$('#alarmInfo').datagrid({
			...
			width:500,
			height:250,
			url: '${rc.getContextPath()}/zhsq/map/arcgis/arcgisDataOfYanpingStDeviceController/findRiverHistoryList.jhtml',
			queryParams: $('#searchForm').serializeJson(), 
			columns: [[
					{field:'PH', title:'PH', align:'center',width:100},
					{field:'RDO', title:'溶解氧(mg/L)', align:'center',width:100},
					{field:'CODMN', title:'高锰酸盐指数(mg/L)', align:'center',width:100},
					{field:'CODCR', title:'化学需氧量(mg/L)', align:'center',width:100},
					{field:'BOD5', title:'五日生化需氧量(mg/L)', align:'center',width:100},
					{field:'NHN', title:'氨氮(mg/L)', align:'center',width:100},
					{field:'TP', title:'总磷(mg/L)', align:'center',width:100},
