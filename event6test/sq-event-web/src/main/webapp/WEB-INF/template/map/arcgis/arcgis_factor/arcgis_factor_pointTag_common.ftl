...
<#include "/component/maxJqueryEasyUIWin.ftl" />
	<div class="MapBar">
		<div class="con AlphaBack1" style="height:32px">
			...
			<input type="hidden" id="FACTOR_URL" value="${FACTOR_URL}" disabled="true" />
			<input type="hidden" id="FACTOR_SERVICE" value="${FACTOR_SERVICE}" disabled="true" />
...
function getArcgisDataByCurrentSet(){
	...
	ykFeatureUrl = document.getElementById("FACTOR_SERVICE").value;
...
function saveFeatureToServer(layerName,attributeCfg,oldData) {
	$.fn.ffcsMap.setProxy("${rc.getContextPath()}"+document.getElementById("FACTOR_URL").value);
