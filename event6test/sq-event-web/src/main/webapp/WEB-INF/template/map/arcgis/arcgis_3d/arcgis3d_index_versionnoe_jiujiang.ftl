...
<style>
	...
	<script type="text/javascript">
		...
		function clsbShow(){
			...
			$('#clsbIframe').attr('src',"http://10.20.142.3:10021/sq-oa-web/web/boardController/index.mhtml");
		}
		function clsbHide(){
		...
		function zhxxShow(){
			...
			$('#zhxxIframe').attr('src',"http://10.100.10.37:10001/zzgrid/zzgl/grid/zhxx/zhxx_jiujiang.jhtml");
		}
		function zhxxHide(){
		...
		function lcryShow(){
			...
			$('#lcryIframe').attr('src',"${SQ_BI_URL}/report/jiuJiangYiQing/index.jhtml");
		}
		function lcryHide(){
		...
		//企业复工	qyfg
		function qyfgShow(){
			$('#qyfgDiv').css({"display":"block","height":"100%"});
			$('#qyfgDiv').addClass('event-sw-on');
			$('#qyfgIframe').attr('src',"http://10.100.10.37:10008/report/yq/bigScreen/index.jhtml ");
		}
		function qyfgHide(){
			$('#qyfgDiv').css({"display":"none","height":"0%"});
			$('#qyfgDiv').removeClass('event-sw-on');
			$('#qyfgIframe').attr('src',"");
		}
		//社区工作  sqgz
		function sqgzShow(){
			...
			$('#sqgzIframe').attr('src',"${SQ_BI_URL}/report/nanChangBigScreen/index.jhtml?type=jiuJiang");
		}
		function sqgzHide(){
		...
		function wzbzShow(){
			...
			$('#wzbzIframe').attr('src',"${SQ_BI_URL}/report/suppliesGap/index.jhtml");
		}
		function wzbzHide(){
...
<body>
	...
	<div class="container-fluid">
		<div class="wrap-container">
			...
			<!-- 企业复工start -->
			<div  id='qyfgDiv'   style="z-index:50;position: absolute;width:100%; height: 0%;" >
				<iframe id='qyfgIframe' src="" frameborder="0" width="100%" height="100%"></iframe>
			</div>
			<!-- 企业复工end -->
			...
			<div class="header clearfix" style="z-index:100;">
				<div class="nav clearfix">
	                        ...
	                        <div class="swiper-container swiper1">
								...
								<#if (fcz??)>
									<div id="lcry" class="swiper-slide struc-item" style="font-size:0.22rem">
										<a href="javascript:;"  >
											<p style="color: white;">返城人员</p>
										</a>
	                                </div>
								</#if>
								<#if (qyfg??)>
									<div id="qyfg" class="swiper-slide struc-item" style="font-size:0.22rem">
										<a href="javascript:;"  >
											<p style="color: white;">企业复工</p>
										</a>
	                                </div>
								</#if>	
								<#if (sqz??)>
					...
					<a href="javascript:;" title="南昌市创建全国文明城市指挥调度平台" class="logo">
						<img src="${uiDomain!''}/web-assets/_big-screen/nanchang-cc/images/shouye/top-title2.png">
					</a>
				<div style="float:right;">
					...
					<div class="support-title">
						<p style="font-size:18px;color:#CADCF8;">中国电信提供技术支持
						</p>
					</div>
				</div>
			<!-- 头部、导航end -->
    ...
    function showPointData(data){
		...
		function initFn2 () {
			...
			$('.swiper1 .swiper-slide').on('click', function () {
                ...
                //if(navigator.userAgent.match("ua_ffcs_nc")){
				if(isAndroid){ 
                	if($("#aifxDiv").hasClass('nav-item-on')||$("#xffx").hasClass('nav-item-on')||$("#clsb").hasClass('nav-item-on')||$("#szfx").hasClass('nav-item-on')||$("#qsfx").hasClass('nav-item-on')||$("#zhxx").hasClass('nav-item-on')||$("#lcry").hasClass('nav-item-on')||$("#qyfg").hasClass('nav-item-on')||$("#sqgz").hasClass('nav-item-on')||$("#wzbz").hasClass('nav-item-on')){
                    	$("#gridNameClick").hide();
                    	$("#todoTotalClick").hide();
                    }else{
                    	$("#gridNameClick").show();
