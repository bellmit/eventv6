...
<script type="text/javascript">
    ...
    function loadDataList() {
        $('#list').datagrid({
            ...
            singleSelect: true,
            idField: 'seqid',
            url: '${rc.getContextPath()}/zhsq/szzg/education/listDataPriEdu.json',
            columns: [[
    ...
    function add() {
        var url = '${rc.getContextPath()}/zhsq/szzg/education/addPriEdu.jhtml';
        showMaxJqueryWindow("新增人文素质信息", url,800, fixHeight(0.72));
    }
    ...
    function edit() {
        ...
        if (rows.length != 1) {
            ...
            var url = '${rc.getContextPath()}/zhsq/szzg/education/editPriEdu.jhtml?seqid=' + rows[0].SEQID;
            showMaxJqueryWindow("编辑小学就读情况信息", url, 300, fixHeight(0.72));
        }
    }
        ...
        if (rows.length != 1) {
            ...
            $.messager.confirm('提示', '您确定删除选中的信息吗?', function(r) {
                if (r) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '${rc.getContextPath()}/zhsq/szzg/education/deletePriEdu.json',
