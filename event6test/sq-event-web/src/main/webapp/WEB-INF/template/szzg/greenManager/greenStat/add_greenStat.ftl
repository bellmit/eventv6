...
<div>
    <div id="content-d" class="MC_con content light" style="overflow-x:hidden">
        <div class="NorForm NorForm2">
            <form id="tableForm" name="tableForm" action="${rc.getContextPath()}/zhsq/szzg/greenindicators/saveOrUpdate.jhtml"
                  method="post">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>所属年份：</span></label>
                            <input class="inp1 inp2 InpDisable  Wdate timeClass easyui-validatebox" type="text" id="syear"
                        ...
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>所属区域：</span></label>
                            ...
                            <input class="inp1 inp2 InpDisable easyui-validatebox" type="text" id="orgName"
                                   data-options="required:true"  style="width:140px;" name="orgName"/>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>绿化覆盖面积：</span></label>
                            <input name="gCoverarea" id="gCoverarea" maxLength="30" type="text" class="inp1 easyui-numberbox"
                        ...
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>绿化覆盖率：</span></label>
                            <input name="gCoverrate" id="gCoverrate" maxLength="30" type="text" class="inp1 easyui-numberbox"
                                   style="width: 140px;height:30px"
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>建成区面积：</span></label>
                            <input name="builtupArea" id="builtupArea" maxLength="30" type="text" class="inp1 easyui-numberbox"
                                   style="width: 140px;height:30px"
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>公园绿地面积：</span></label>
                            <input name="gParkarea" id="gParkarea" maxLength="30" type="text" class="inp1 easyui-numberbox"
                                   style="width: 140px;height:30px"
                                   data-options="tipPosition:'bottom',precision:2,required:true,max:99999999,min:0"/>&nbsp;(公顷)
                        </td>

                        <td colspan="2" class="LeftTd"><label class="LabName"><span>人均公园绿地面积：</span></label>
                            <input name="gPerparkarea" id="gPerparkarea" maxLength="30" type="text" class="inp1 easyui-numberbox"
                                   style="width: 140px;height:30px"
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>森林面积：</span></label>
                            <input name="forestArea" id="forestArea" maxLength="30" type="text" class="inp1 easyui-numberbox"
                                   style="width: 140px;height:30px"
                                   data-options="tipPosition:'bottom',precision:2,required:true,max:99999999,min:0"/>&nbsp;(公顷)
                        </td>

                        <td colspan="2" class="LeftTd"><label class="LabName"><span>森林覆盖率：</span></label>
                            <input name="forestCoverarea" id="forestCoverarea" maxLength="30" type="text" class="inp1 easyui-numberbox"
                                   style="width: 140px;height:30px"
                                   data-options="tipPosition:'bottom',precision:2,required:true,max:100,min:0"/>&nbsp;(%)
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>区域面积：</span></label>
                            <input name="regionalArea" id="regionalArea" maxLength="30" type="text" class="inp1 easyui-numberbox"
                                   style="width: 140px;height:30px"
                                   data-options="tipPosition:'bottom',precision:2,required:true,max:99999999,min:0"/>&nbsp;(平方公里)
                        </td>
