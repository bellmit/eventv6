                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>所属年份：</span></label>
                            <input class="inp1 inp2 InpDisable  Wdate timeClass easyui-validatebox" type="text" id="yearStr" value="${yearStr}"
                                   data-options="required:true" name="yearStr"   onClick="WdatePicker({isShowClear:false,maxDate:'%y',dateFmt:'yyyy'})" readonly="true"/>

                        </td>
                    </tr>
                    <tr>

                        <td colspan="2" class="RightTd"><label class="LabName"><span>所属网格：</span></label>
                    ...
                    <tr>
                        ...
                        <td><label class="LabName"><span>文化程度：</span></label>
                            ...
                            <input class="inp1 inp2 InpDisable easyui-validatebox" type="text" id="typeName"
                                   data-options="required:true" name="typeName"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>男性人数：</span></label>
                            <input name="males" id="males" maxLength="30" type="text" class="inp1 inp2 InpDisable easyui-numberbox"
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>女性人数：</span></label>
                            <input name="females" id="females" maxLength="30" type="text"  class="inp1 inp2 InpDisable easyui-numberbox"
                                   style="width: 100px; height:30px;"
                                   data-options="tipPosition:'bottom',required:true,max:99999999,min:0"/>&nbsp;(人)
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" class="LeftTd"><label class="LabName"><span>总人数：</span></label>
                            <input name="totalPeople" id="totalPeople" maxLength="30" type="text"  class="inp1 easyui-numberbox"
                                   style="width: 100px;height:30px;"
                                   data-options="tipPosition:'bottom',required:true,max:99999999,min:0" onblur="add()"/>&nbsp;(人)
                        </td>
                    </tr>
...
<script type="text/javascript">
  ...
  $(function(){
        ...
        //加载数据字典：文化程度
        AnoleApi.initTreeComboBox("typeName", null,'A001051004',function(gridId, items){
