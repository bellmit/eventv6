...
<div class="MainContent">
	<#include "/zzgl/reportFocus/poorSupportVisit/toolbar_psv_msgReading.ftl" />
</div>
    ...
    function loadDataList(){
    	...
    	$('#list').datagrid({
			...
			columns:[[
				...
				{field:'reportUUID', title:'报告编号', align:'left', width:fixWidth(0.2), formatter: clickFormatter},
