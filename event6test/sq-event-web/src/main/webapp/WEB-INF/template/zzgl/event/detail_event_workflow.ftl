...
<body>
	<div id="ts" class="easyui-tabs" fit="true" border="false" style="margin: 0; height:450px;">
		<div title="事件信息详情">
			<iframe id="eventDetail" scrolling='no' frameborder='0' src='${rc.getContextPath()}/zhsq/event/eventDisposalController/detailEvent.jhtml?eventId=${eventId?c}' style='width:99.9%;height:100%;'></iframe>
		</div>
		<!--<div title="事件照片及视频" >
			<iframe id="eventImg" scrolling='no' frameborder='0' src='${rc.getContextPath()}/zzgl/event/requiredEvent/eventImg.jhtml?eventId=${eventId?c}' style='width:99.9%;height:100%;'></iframe>
		</div>-->
    </div>
