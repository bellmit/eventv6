...
<html>
	<head>
		...
		<title><@block name="delEventApplicationPageTitle">事件删除列表</@block></title>
	...
	<body class="easyui-layout">
		<div class="MainContent">
			<#include "/zzgl/timeApplication/delEventApplication/toolbar_app_delEvent.ftl" />
		</div>
		    ...
		    function loadDataList(){
		    	...
		    	$('#list').datagrid({
					...
					columns:[[
						...
						{field:'createTimeStr',title:'<@block name="createTimeStrFieldTitle">删除时间</@block>', align:'center',width:fixWidth(0.1),sortable:true, formatter: dateFormatter},
						{field:'reason',title:'<@block name="reasonFieldTitle">删除原因</@block>', align:'center',width:fixWidth(0.2),sortable:true, formatter: titleFormatter},
