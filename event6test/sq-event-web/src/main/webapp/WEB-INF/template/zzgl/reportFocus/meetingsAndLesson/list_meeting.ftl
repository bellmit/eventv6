...
<div class="MainContent">
    <#include "/zzgl/reportFocus/meetingsAndLesson/toolbar_meeting.ftl" />
</div>
...
<script type="text/javascript">
    ...
    function loadDataList(){
        ...
        $('#list').datagrid({
            ...
            singleSelect: true,
            idField:'reportId',
            url:'${rc.getContextPath()}/zhsq/reportMeeting/listReportFocusData.json',
            columns:[[
                ...
                {field:'partyGroupName', title:'党组织名称', align:'center', width:fixWidth(0.2), formatter: titleFormatter},
                {field:'reportTimeStr', title:'报告时间', align:'center', width:fixWidth(0.14)},
                {field:'occurred', title:'发生地址', align:'center', width:fixWidth(0.2), formatter: titleFormatter},
                {field:'meetingTypeName', title:'会议类型', align:'center', width:fixWidth(0.1), formatter: titleFormatter},
