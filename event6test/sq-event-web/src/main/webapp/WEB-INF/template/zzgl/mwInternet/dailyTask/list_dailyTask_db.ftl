...
<script type="text/javascript">
	...
	function loadList() {
		$('#list').datagrid({
			...
			singleSelect: true,
			fit: true,
			url: '${rc.getContextPath()}/zhsq/dailyTask/listData.jhtml?indexType=db',
	...
	function edit() {
		...
		if (rows.length != 1) {
			...
			var url = '${rc.getContextPath()}/zhsq/dailyTask/todo.jhtml?id=' + rows[0].ddtId+'&taskId='+rows[0].wfDbid_+'&instanceId='+rows[0].wfInstanceId;
