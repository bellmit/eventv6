...
<div class="MainContent">
	<#include "/zzgl/eventCase/toolbar_eventCase.ftl" />
</div>
    ...
    function loadDataList(){
    	...
    	$('#list').datagrid({
			...
			columns:[[
				...
				{field:'caseName',title:'案件标题', align:'left',width:fixWidth(0.2),sortable:true, formatter: clickFormatter},
				{field:'happenTimeStr',title:'案发时间', align:'center',width:fixWidth(0.1),sortable:true, formatter: dateFormatter},
                {field:'eventClass',title:'案件分类', align:'center',width:fixWidth(0.2),sortable:true},
