	                            ...
	                            <div class="RightShadow">
	                                <div class="list NorForm" style="position:relative;">
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                                    	...
	                                    	<tr>
	                                    		<td><label class="LabName width65px"><span>图斑编号：</span></label><input class="inp1 queryParam" type="text" id="mapNum" name="mapNum" style="width:248px;"></input></td>
	                                    	</tr>
	                                    	<tr>
...
<script type="text/javascript">
	$(function() {
		...
		if($('#reportStatus').length > 0) {
			AnoleApi.initTreeComboBox("reportStatusName", "reportStatus", "B210001003", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		if($('#dataSourceArrayName').length > 0) {
			AnoleApi.initTreeComboBox("dataSourceArrayName", "dataSourceArray", "B210001008", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		init4DateRender('twoVioPreQueryForm');
	});
	...
	function exportData(){
		var modelName = "两违防治";
		var url = 'http://bdio.v6.aishequ.org/export/form/T_EVENT_TWO_VIOLATION_PRE_EXPORT.jhtml?';
...
<@block name="operateFunction">
	<#include "/zzgl/reportFocus/twoVioPre/operate_twoVioPre.ftl" />
</@block>
