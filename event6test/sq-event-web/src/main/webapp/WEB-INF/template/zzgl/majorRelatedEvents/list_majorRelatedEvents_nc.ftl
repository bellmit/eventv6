...
<div class="MainContent">
	<#include "/zzgl/majorRelatedEvents/relatedEventsDataGridToolbar_nc.ftl" />
</div>
...
<div region="center" title="<span class='easui-layout-title'>涉及案件列表(南昌)</span>" border="false" style="overflow:hidden;">
	<table id="list"></table>
</div>
...
<script type="text/javascript">
 var startGridId = "${startGridId?c}";
	...
	if(eventLevel) {
    	...
    	$('#list').datagrid({
			...
			columns:[[
				...
				{field:'reName',title:'案(事)件名称', align:'left',width:'20%',sortable:true,
				...
				{field:'occuDateStr',title:'发生日期', align:'center',width:'1%',sortable:true,
				...
				{field:'eventLevelCN',title:'案件分级', align:'center',width:'8%',sortable:true},
				{field:'gridPath',title:'所属网格', align:'center',width:'10%',sortable:true,
    ...
    function gridTreeClickCallback(gridId,gridName,orgCode) {
    $("#gridId").val(gridId);
    searchData();
