...
<body>
	<div class="MC_con content light">
		...
		<form id="tableForm" name="tableForm" action="${rc.getContextPath()}/zhsq/dailyTask/submit.jhtml"  method="post">
			...
			<input type="hidden" name="ddtId" value="${bo.ddtId}"/>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
	           <tr>
	           		...
	           		<tr>
		                <td colspan="5">
							...
							<div class="Check_Radio">
						    	<a href="#" class="NorToolBtn EditBtn fl" id="userSelectBtn" onclick="selectUser('userIds', 'userNames', 'curOrgIds', 'curOrgNames', 'task');">选择办理人</a>
							</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		var swfOpt = {
			...
			ajaxData: {'bizId':${bo.ddtId?c},'attachmentType':'${REQ_ATTACHMENT_TYPE!}','eventSeq':'1'}
	    };
		fileUpload(swfOpt);
