...
<div id="content-d" class="MC_con content light">
    <div name="tab" id="div0" class="NorForm">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <@block name="isOpenSelectInput">
            <tr>
                 <td colspan="2"><label class="LabName"><span>事件类型：</span></label>
                     <input class="inp1" type="hidden" id="eventType" name="eventType" style="width:135px;" />
                     <input class="inp1" type="text" id="eventTypeStr" name="eventTypeStr" style="width:145px;" />
                 </td>
            </tr>
            </@block>
            <tr>
...
<div class="BigTool">
    <div class="BtnList">
        <a href="javascript:;" class="BigNorToolBtn SaveBtn" onClick="report();">受理</a>
        <a href="javascript:;" class="BigNorToolBtn RejectBtn" onClick="reject();">退回</a>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        fileUpload(swfOpt);
        AnoleApi.initTreeComboBox("eventTypeStr", "eventType", "A001093199", null, ["${appealCatalogMappingType!'0702'}"]);
    });
    ...
    function startWorkflow(appealId) {
        if (appealId && appealId > 0) {
            ...
            $.ajax({
                ...
                data: {'publicAppealId': appealId,'eventType':$('#eventType').val()},
                dataType: "json",
