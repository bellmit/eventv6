...
<div class="MainContent">
	<#include "/zzgl/reportFocus/ruralHousing/toolbar_ruralHousing.ftl" />
</div>
...
<script type="text/javascript">
    ...
    function loadDataList(){
    	...
    	$('#list').datagrid({
			...
			singleSelect: true,
			idField:'reportId',
			url:'${rc.getContextPath()}/zhsq/reportRuralHousing/listReportFocusData.json',
			columns:[[
				{field:'reportId', checkbox:true, width:40, hidden:'true'},
				{field:'reportCode', title:'报告编号', align:'left', width:fixWidth(0.18), formatter: clickFormatter4RH},
				{field:'reporterName', title:'报告人姓名', align:'center', width:fixWidth(0.14), formatter: titleFormatter},
				{field:'householder', title:'建房户姓名', align:'center', width:fixWidth(0.13), formatter: titleFormatter},
    ...
    function clickFormatter4RH(value, rec, rowIndex) {
		var title = "";
