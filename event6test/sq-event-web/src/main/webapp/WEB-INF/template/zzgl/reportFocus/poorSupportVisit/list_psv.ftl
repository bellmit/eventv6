...
<div class="MainContent">
	<#include "/zzgl/reportFocus/poorSupportVisit/toolbar_psv.ftl" />
</div>
...
<script type="text/javascript">
    ...
    function loadDataList(){
    	...
    	$('#list').datagrid({
			...
			singleSelect: true,
			idField:'reportId',
			url:'${rc.getContextPath()}/zhsq/reportPSV/listReportFocusData.json',
			columns:[[
				...
				{field:'reporterName', title:'报告人姓名', align:'center', width:fixWidth(0.12), formatter: titleFormatter},
				{field:'poorVillagerName', title:'贫困户名称', align:'center', width:fixWidth(0.12), formatter: titleFormatter},
				{field:'occurred', title:'发生地址', align:'center', width:fixWidth(0.2), formatter: titleFormatter},
				{field:'collectSourceName', title:'报告来源', align:'center', width:fixWidth(0.18), formatter: titleFormatter},
				<#if listType??>
				...
				{field:'reportStatusName', title:'报告状态', align:'center', width:fixWidth(0.07)}
			]],
