...
<div class="MainContent">
    <#include "/zzgl/reportFocus/environmentHealTreatment/toolbar_eht.ftl" />
</div>
...
<script type="text/javascript">
    ...
    function loadDataList(){
        ...
        $('#list').datagrid({
            ...
            singleSelect: true,
            idField:'reportId',
            url:'${rc.getContextPath()}/zhsq/reportEHT/listReportFocusData.json',
            columns:[[
                {field:'reportId', checkbox:true, width:40, hidden:'true'},
                {field:'reportCode', title:'报告编号', align:'left', width:fixWidth(0.18), formatter: clickFormatter4PPM},
                {field:'reporterName', title:'报告人姓名', align:'center', width:fixWidth(0.14), formatter: titleFormatter},
                {field:'problemTypeName', title:'问题类型', align:'center', width:fixWidth(0.13), formatter: titleFormatter},
    ...
    function clickFormatter4PPM(value, rec, rowIndex) {
        var title = "";
