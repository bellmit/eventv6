    ...
    <form id="ppmQueryForm">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="text" class="hide queryParam" id="problemType" name="problemType" />
                                                    <input class="inp1" type="text" id="problemTypeName" style="width:248px;"></input>
                                                </td>
                                            </tr>
        ...
        <div class="ToolBar" id="toolbarDiv">
            <div id="actionDiv" class="tool fr hide">
                ...
                <a id="add" href="javascript:void(0)" onclick="add({dataSource:'03,04'})" class="NorToolBtn AddBtn">新增(非网格员)</a>
                <a id="add" href="javascript:void(0)" onclick="add({dataSource:'02'})" class="NorToolBtn AddBtn">新增(12345)</a>
...
<script type="text/javascript">
    $(function() {
        ...
        if($('#reportStatus').length > 0) {
            AnoleApi.initTreeComboBox("reportStatusName", "reportStatus", "B210014001", null, null, {
                RenderType : "01",
                ShowOptions: {
                    EnableToolbar : true
                }
        ...
        if($('#dataSourceArrayName').length > 0) {
            AnoleApi.initTreeComboBox("dataSourceArrayName", "dataSourceArray", "B210014002", null, null, {
                RenderType : "01",
                ShowOptions: {
                    EnableToolbar : true
                }
        ...
        if($('#problemType').length > 0){
            AnoleApi.initTreeComboBox("problemTypeName", "problemType", "B210014003", null, null, {
                //RenderType : "01",
                ShowOptions: {
                    EnableToolbar : true
                }
...
<@block name="operateFunction">
    <#include "/zzgl/reportFocus/environmentHealTreatment/operate_eht.ftl" />
</@block>
