...
<div id="jqueryToolbar">
	<form id="msgReadingForm">
		...
		<input type="hidden" id="reportType" name="reportType" value="${reportType!'8'}" class="queryParam" />
	                                    ...
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                                    	...
	                                    	<tr>
	                                    		<td>
	                                    			...
	                                    			<input class="inp1 hide queryParam" type="text" id="msgSendDayStart" name="msgSendDayStart"></input>
	                                    			<input class="inp1 hide queryParam" type="text" id="msgSendDayEnd" name="msgSendDayEnd"></input>
	                                    			<input type="text" id="_msgSendDayRender" class="inp1 InpDisable dateRenderWidth" />
	                                    		</td>
	                                    	</tr>
	                                    </table>
	                                </div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		init4DateRender('_msgSendDayRender', 'msgSendDayStart', 'msgSendDayEnd');
	...
	function detail(reportUUID, instanceId, msgId, msgReceiveStatus) {
		if(msgId && msgReceiveStatus && msgReceiveStatus == '0') {
			$.ajax({
				type: "POST",
				url: '${rc.getContextPath()}/zhsq/reportRuralHousing/readMsg.jhtml',
				data: {'msgId' : msgId},
				dataType:"json",
		...
		if(reportUUID) {
			...
			var url = "${rc.getContextPath()}/zhsq/reportRuralHousing/toDetail.jhtml?reportUUID=" + reportUUID + "&listType=" + listType + "&reportType=" + $('#reportType').val();
