	 	...
	 	<div name="tab" id="content0" class="NorForm">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<#if childList ?? && (childList?size > 0)>
					<tr>
	                    <td class="LeftTd" colspan="2"><div class="title FontDarkBlue">受理信息<#if isBack ?? && isBack=='1'><a class="NorToolBtn" style="margin-left:10px;font-size:14px;float:right;padding:4px 7px 7px 7px;color:rgb(255, 255, 255);" href="###" onclick="showBackList('${bo.reqId}');">查看驳回信息</a></#if></div></td>
	                </tr>
                </#if>
			</table>
                ...
                <#if childList ?? && (childList?size > 0)>
	                <#list childList as line>
		                <tr style="background: center bottom #f4f4f4;">
		                   <th style="border:1px solid #bed3df ;width: 180px;" >联动单位</th>
		                   <th style="border:1px solid #bed3df ;width: 180px;" >联络员</th>
		                   <th style="border:1px solid #bed3df ;width: 180px;" >分管领导</th>
		                   <th style="border:1px solid #bed3df ;width: 120px;" >截止日期</th>
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                        	<span class=" FontDarkBlue" >${(line.overTime)!}</span>
	                        </td>
	                        <td>
			            ...
			            <tr style="background: center bottom #f4f4f4;">
		                   <th colspan="4" style="border:1px solid #bed3df ;width: 160px;" >回访信息</th>
		                   <th colspan="1" style="border:1px solid #bed3df ;width: 160px;" >满意度</th>
		                </tr>
	                    <tr>
			                <td colspan="4" title="${(line.visit)!}">
