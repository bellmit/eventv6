					...
					<div class="fl" >
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
								...
								<td>
									<label class="LabName"><span>所属网格：</span></label><input type="text" class="inp1 InpDisable easyui-validatebox inpt1_bg" style="width:222px;" data-options="required:true" id="gridName" name="gridName" value="<#if event.gridName??>${event.gridName}</#if>" />
								</td>
							</tr>
							<tr>
					    		<td colspan="2" class="LeftTd">
				    			<label class="LabName"><span><label class="Asterik">*</label>事件标题：</span></label><input type="text" class="inp1 easyui-validatebox inpt1_bg" style="width:550px;" data-options="required:true,tipPosition:'bottom',validType:['maxLength[100]','characterCheck']" name="eventName" id="eventName" value="<#if event.eventName??>${event.eventName}</#if>" />
				    			</td>
					    	</tr>
							<tr>
					    		<td colspan="2" class="LeftTd">
				    			<label class="LabName"><span><label class="Asterik">*</label>详细地址：</span></label><input type="text" class="inp1 easyui-validatebox inpt1_bg" style="width:550px;" data-options="required:true,tipPosition:'bottom',validType:['maxLength[255]','characterCheck']" name="occurred" id="occurred" value="<#if event.occurred??>${event.occurred}</#if>" />
				    		</td>
					    	</tr>
							<tr>
								<td   class="LeftTd"  >
					    		...
					    		<td><label class="LabName"><span>责任点位：</span></label>
						 	    	<input type="hidden" id="pointSelection" name="pointSelection" value="${pointSelection!'0'}" />
									<input type="text" class="inp1 easyui-validatebox inpt1_bg" style="width:227px;height: 30px" data-options="tipPosition:'bottom',prompt:'请选择'" id="pointSelectionName" placeholder="请选择" value="" />
						  		</td>
					      ...
					      <td>
							...
							<input type="text" class="inp1 easyui-validatebox inpt1_bg" style="width:222px;" data-options="required:true,tipPosition:'bottom'" id="patrolTypeName" value="" />
						  </td>
				    		...
				    		<td>
								...
								<input type="text" class="inp1 easyui-validatebox inpt1_bg"  style="width: 222px" data-options="required:true,tipPosition:'bottom'" id="influenceDegreeName" value="<#if event.influenceDegreeName??>${event.influenceDegreeName}</#if>" />
							</td>
					        ...
					        <td>
								...
								<input type="text" class="inp1 easyui-validatebox inpt1_bg"  style="width: 222px" data-options="required:true,tipPosition:'bottom'" id="sourceName" value="<#if event.sourceName??>${event.sourceName}</#if>" />
				    		</td>
				        </tr>
				    	<tr>
				    		<td>
								...
								<input type="text" class="inp1 easyui-validatebox inpt1_bg"  style="width: 222px" data-options="required:true,tipPosition:'bottom'" id="urgencyDegreeName" value="<#if event.urgencyDegreeName??>${event.urgencyDegreeName}</#if>" />
				    		</td>
				    		...
				    		<td>
								...
								<input type="text" class="inp1 easyui-validatebox inpt1_bg"  style="width: 222px" data-options="required:true,tipPosition:'bottom'" id="involvedNumName" value="<#if event.involvedNumName??>${event.involvedNumName}</#if>" />
							</td>
				    	</tr>
					    <tr>
				    		<td class="LeftTd" style="border-bottom:none;">
				    			<label class="LabName"><span><label class="Asterik">*</label>联系人员：</span></label>
				    			<input  id="contactUser" name="contactUser" type="text" style="width:222px" class="inp1 easyui-validatebox inpt1_bg" data-options="required:true,tipPosition:'bottom',validType:['maxLength[30]','characterCheck']" value="<#if event.contactUser??>${event.contactUser}</#if>" />
				    		</td>
				    		<td class="LeftTd" style="border-bottom:none;">
				    			<label class="LabName"><span><label class="Asterik">*</label>联系电话：</span></label>
				    			<input name="tel" id="tel" type="text" style="width:222px" class="inp1 easyui-validatebox inpt1_bg" data-options="required:true,tipPosition:'bottom',validType:'mobileorphone'" value="<#if event.tel??>${event.tel}</#if>" />
				    		</td>
				    	</tr>
				    	<#if eventLabelDict??>
					    <tr>
				    		<td class="LeftTd" style="border-bottom:none;">
				    			...
				    			<input type="hidden" id="eventLabelIds" name="eventLabelIds" value="<#if eventLabelIds??>${eventLabelIds}</#if>" />
								<input type="text" class="inp1 easyui-validatebox inpt1_bg"  style="width: 222px" data-options="required:true,tipPosition:'bottom'" id="eventLabelName" value="<#if eventLabelName??>${eventLabelName}</#if>" />
				    		</td>
				    	</tr>
					    </#if>	
				    	<tr>
...
<script type="text/javascript">
	...
	$(function() {
	   ...
	   <#if eventLabelDict??>	
	        AnoleApi.initListComboBox("eventLabelName", "eventLabelIds", null, null, null, {
	            DataSrc: [
                   ...
                   $.ajax({
					   ...
					   success: function(data){
						   if(data.length>0){
						       ...
						       //searchParams.x=118.589316153391;
						       //searchParams.y=24.94493421656269;
						   }
					   }
		    	   });
               }else{
			...
			success: function(data) {
			    ...
			    if(data.result){
			    	...
			    	if(isNotBlankString(instanceId)) {
			    		//请求后台进行自动流转到12345
			    		$.ajax({
							url : '${rc.getContextPath()}/zhsq/nanChang3D/autoFlow.jhtml',
