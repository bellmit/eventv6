        ...
        <div class="fl">
        	<ul>
                ...
                <li>
                	...
                	<input id="gridName" type="hidden" class="inp1 InpDisable" style="width:150px;"/>
                </li>
            	<li>关键字：</li>
                ...
                <li style="position:relative;">
            		...
            		<div class="AdvanceSearch DropDownList hide" style="width:300px; top: 42px; left: -130px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                      	<td>
                                      		...
                                      		<input id="occuDateStr" type="text" class="inp1" style="width:180px;" value="<#if isOuterrelatedEventsForSearch??>${isOuterrelatedEventsForSearch.occuDateStartStr!''} ~ </#if><#if isOuterrelatedEventsForSearch??>${isOuterrelatedEventsForSearch.occuDateEndStr!''}</#if>"/>
