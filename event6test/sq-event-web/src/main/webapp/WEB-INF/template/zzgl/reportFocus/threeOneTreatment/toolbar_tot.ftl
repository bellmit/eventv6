	...
	<form id="totQueryForm">
		...
		<div class="ConSearch">
	                            ...
	                            <div class="RightShadow">
	                                <div class="list NorForm" style="position:relative;">
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                                    	...
	                                    	<tr>
	                                    		<td><label class="LabName width65px"><span>业主姓名：</span></label><input class="inp1 queryParam" type="text" id="personInvolved" name="personInvolved" style="width:248px;"></input></td>
	                                    	</tr>
	                                    	<tr>
	                                    		<td>
	        ...
	        <div class="btns">
	        	<ul>            	
	            	...
	            	<li><a href="#" class="chongzhi" title="重置查询条件" onclick="resetCondition('totQueryForm')">重置</a></li>
	            </ul>
	        </div>
	        <div class="clear"></div>‍
	    ...
	    <div class="ToolBar" id="toolbarDiv">
	    	<div id="actionDiv" class="tool fr hide">
				...
				<a id="add" href="javascript:void(0)" onclick="add({dataSource:'03,04,05'})" class="NorToolBtn AddBtn">新增(非网格员)</a>
				...
				<a id="recallWorkflow" href="javascript:void(0)" onclick="recallWorkflow()" class="NorToolBtn RecallBtn">撤回</a>
				<a id="remind" href="javascript:void(0)" onclick="remind(1)" class="NorToolBtn EditBtn">督办</a>-->
			</div>
	    </div>
	</form>
</div>
...
<script type="text/javascript">
	$(function() {
		...
		if($('#reportStatus').length > 0) {
			AnoleApi.initTreeComboBox("reportStatusName", "reportStatus", "B210015002", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		if($('#hiddenDangerTypeName').length > 0) {
			AnoleApi.initTreeComboBox("hiddenDangerTypeName", "hiddenDangerType", "B210015003", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		if($('#dataSourceArrayName').length > 0) {
			AnoleApi.initTreeComboBox("dataSourceArrayName", "dataSourceArray", "B210015001", null, null, {
				RenderType : "01",
				ShowOptions: {
					EnableToolbar : true
				}
		...
		init4DateRender('totQueryForm');
	});
	
    function queryData() {
    	var searchArray = new Array();
    	
		$("#totQueryForm .queryParam").each(function() {
...
<@block name="operateFunction">
	<#include "/zzgl/reportFocus/threeOneTreatment/operate_tot.ftl" />
</@block>
