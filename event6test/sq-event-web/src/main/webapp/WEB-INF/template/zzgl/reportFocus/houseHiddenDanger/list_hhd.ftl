...
<div class="MainContent">
	<#include "/zzgl/reportFocus/houseHiddenDanger/toolbar_hhd.ftl" />
</div>
    ...
    function loadDataList(){
    	...
    	$('#list').datagrid({
			...
			columns:[[
				...
				{field:'reporterName', title:'报告人姓名', align:'center', width:fixWidth(0.11), formatter: titleFormatter},
				/*{field:'buildingName', title:'楼栋名称', align:'center', width:fixWidth(0.15), formatter: titleFormatter},*/
				{field:'reportTimeStr', title:'报告时间', align:'center', width:fixWidth(0.13)},
				{field:'occurred', title:'楼栋地址', align:'center', width:fixWidth(0.17), formatter: titleFormatter},
				{field:'riskTypeName', title:'隐患类型', align:'center', width:fixWidth(0.1)},
				<#if listType??>
