...
function ShowSearchBtn(){
	var iframeId = $("#idssControlApplyDiv iframe:visible").attr("id");
	
	window.frames[iframeId].ShowOrCloseSearchBtn();
}
function CloseSearchBtn(){
	var iframeId = $("#idssControlApplyDiv iframe:visible").attr("id");
	
	window.frames[iframeId].CloseSearchBtn();
}
