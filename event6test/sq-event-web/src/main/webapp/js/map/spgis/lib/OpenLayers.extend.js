...
OpenLayers.Util.modifyAlphaImageDiv = function(div, id, px, sz, imgURL, 
	...
	if (typeof isInnerImg == "undefined" || isInnerImg == null || isInnerImg == true) {
...
OpenLayers.Util.createAlphaImageDiv = function(id, px, sz, imgURL, 
                                               position, border, sizing, 
                                               opacity, delayDisplay, isInnerImg) {
	...
	if (typeof isInnerImg == "undefined" || isInnerImg == null || isInnerImg == true) {
		...
		div.appendChild($(imgURL)[0]);
	}

    OpenLayers.Util.modifyAlphaImageDiv(div, id, px, sz, imgURL, position, 
                                        border, sizing, opacity, isInnerImg);
...
OpenLayers.Icon = OpenLayers.Class({
     ...
     */
    initialize: function(url, size, offset, calculateOffset, html) {
		this.url = url;
        this.size = size;// || {w: 20, h: 20}; modify by YangCQ 20160421
		...
		this.imageDiv = OpenLayers.Util.createAlphaImageDiv(id, null,
			null, this.isShowImg ? this.url : this.html, null, null, null, null, null, this.isShowImg);
    },
     ...
     */
    draw: function(px) {
		// YangCQ add html 20160420
        OpenLayers.Util.modifyAlphaImageDiv(this.imageDiv, 
                                            null, 
                                            null, 
                                            this.size, 
                                            this.isShowImg ? this.url : this.html, 
                                            "absolute", null, null, null, this.isShowImg);
        this.moveTo(px);
    ...
    setOpacity: function(opacity) {
        OpenLayers.Util.modifyAlphaImageDiv(this.imageDiv, null, null, null, 
                                            null, null, null, null, opacity, this.isShowImg);
    ...
    moveTo: function (px) {
        ...
        if (this.imageDiv != null) {
            if (this.px == null) {
                ...
                }, null, null, null, null, null, null, this.isShowImg);
            }
        }
    },
...
OpenLayers._getScriptLocation = function() {
	return MMGlobal.ContextPath + "/js/map/spgis/lib/";
};
