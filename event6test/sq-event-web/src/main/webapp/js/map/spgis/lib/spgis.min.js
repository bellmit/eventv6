var Lemon=Lemon||{REVISION:"0.1",Register:function(a){for(var a=a.split("."),b="",c="",d=0;d<a.length;d++)0!=d&&(c+="."),c+=a[d],b+="if (typeof("+c+") == 'undefined') "+c+" = new Object();";""!=b&&eval(b)}};Lemon.Register("Lemon");Lemon.Inherit=function(a,b){function c(){}if(a instanceof Array)for(var d=0;d<a.length;d++)for(var e in a[d].prototype)c.prototype[e]=a[d].prototype[e];else c.prototype=a.prototype;d=new c;d.constructor=b;b.prototype=d};
Lemon.Class=function(a,b,c){function d(){}d.prototype=b;if(null==d.prototype.autoclassname){for(var b=d.prototype,e="",f=0;10>f;f++)e+="123456789poiuytrewqasdfghjklmnbvcxzQWERTYUIPLKJHGFDSAZXCVBNM".charAt(Math.ceil(1E8*Math.random())%60);b.autoclassname=e}if(a instanceof Array)for(b=0;b<a.length;b++){if(null!=a[b])for(var g in a[b].prototype)void 0==d.prototype[g]&&(d.prototype[g]=a[b].prototype[g])}else for(g in a.prototype)void 0==d.prototype[g]&&(d.prototype[g]=a.prototype[g]);null!=c&&(d.constructor=
c);return d};Lemon.DoType={};Lemon.DoType.Get=0;Lemon.DoType.Post=1;Lemon.DebugPanel=function(){this.PanelObj=null;this.isadd=!1;this.CreatePanel=function(){this.PanelObj=$("<div></div>");this.PanelObj.attr("id","lemon_ui_debugpanel");this.PanelObj.addClass("lemon_ui_debugpanel");this.PanelObj.css("display","none")};this.CreatePanel()};
Lemon.DebugPanel.prototype={constructor:Lemon.DebugPanel,AppendChar:function(a){var b=new Date,b=b.getHours()+":"+b.getMinutes()+":"+b.getSeconds()+":"+b.getMilliseconds();this.PanelObj.prepend(b+"-> "+a+"\n\r<br>")},Show:function(){this.PanelObj.css("display","block");this.PanelObj.css("width","1000");this.PanelObj.css("height","100");this.PanelObj.css("font-size","12px");this.PanelObj.css("background-color","black");this.PanelObj.css("color","Yellow");this.PanelObj.css("overflow","scroll");this.PanelObj.css({border:"1px solid #03476F",
position:"absolute",left:"0px",bottom:"0px"})},Hide:function(){this.PanelObj.css("display","none")},GetDisplay:function(){return"none"==this.PanelObj.css("display")?!1:!0},OpenDebugPanel:function(){this.GetDisplay()?this.Hide():this.Show()},ByTheEnd:function(){},adddom:function(){this.PanelObj.appendTo("body");this.isadd=!0}};Lemon.SE=Lemon.SE||function(){};Lemon.SE.S2001="\u6ca1\u6709\u5b9e\u73b0";Lemon.SE.S2002="\u672a\u5b9a\u4e49\u6d88\u606f";Lemon.SE.S2003="\u6dfb\u52a0\u4e86\u975e\u6cd5\u7684\u53c2\u6570";
Lemon.SE.S2004="\u8fd4\u56de\u503c\u4e3anull";Lemon.SE.S1001="\u8fd0\u884c\u57df\u4e0d\u53ef\u4fe1\u670d\u52a1\u6ca1\u6709\u8fd0\u884c\u6743\u9650 \u670d\u52a1\u8bf7\u6c42\u57df\u9519\u8bef";Lemon.SE.S1002="\u672a\u5b9a\u4e49\u6d88\u606f";Lemon.SE.P001="ldomnlkweioi32kioli3";Lemon.SE.P002="ldomncaidset98l32";Lemon.Disposable=function(){};Lemon.Disposable.prototype={constructor:Lemon.Disposable,Desturct:function(){for(var a in this)this[a]=null}};Lemon.EventTarget=function(){this.handlers={}};
Lemon.EventTarget.prototype={constructor:Lemon.EventTarget,addHandler:function(a,b){if("undefined"!=typeof b&&(b instanceof Lemon.OnEventTargetCallBack||void 0!=b.execute))"undefined"==typeof this.handlers[a]&&(this.handlers[a]=[]),this.handlers[a].push(b)},fire:function(a){a.target||(a.target=this);if(this.handlers[a.type]instanceof Array)for(var b=this.handlers[a.type],c=0,d=b.length;c<d;c++)b[c].execute(a)},removeHandler:function(a,b){if(this.handlers[a]instanceof Array){for(var c=this.handlers[a],
d=0,e=c.length;d<e&&c[d]!==b;d++);c.splice(d,1)}}};
Lemon.Hashtable=function(){this._hash={};this._count=0;this.add=function(a,b){if(this._hash.hasOwnProperty(a))return!1;this._hash[a]=b;this._count++;return!0};this.remove=function(a){delete this._hash[a];this._count--};this.count=function(){return this._count};this.items=function(a){if(this.contains(a))return this._hash[a]};this.contains=function(a){return this._hash.hasOwnProperty(a)};this.clear=function(){this._hash={};this._count=0};this.keys=function(){var a={};for(i in this._hash)a[i]="";return a};
this.values=function(){var a={};for(i in this._hash)a[this._hash[i]]="";return a};this.keyArry=function(){var a=[];for(i in this._hash)a.push(i);return a};this.valueArry=function(){var a=[];for(i in this._hash)a.push(this._hash[i]);return a}};Lemon.MSG=self.console||{info:function(){},log:function(){},warn:function(){},error:function(){},debug:function(){}};
Lemon.MSG.InitPanel=function(){Lemon.MSG.MsgPanel=Lemon.MSG.MsgPanel||new Lemon.DebugPanel;Lemon.MSG.MsgPanel.isDebug=Lemon.MSG.MsgPanel.isDebug||!0;Lemon.MSG.MsgPanel.Debug=Lemon.MSG.MsgPanel.Debug||function(a){Lemon.MSG.MsgPanel.isDebug&&("object"==typeof a?Lemon.MSG.MsgPanel.printObject(a):Lemon.MSG.MsgPanel.AppendChar(a),Lemon.MSG.debug(a))};Lemon.MSG.MsgPanel.printObject=function(a){var b=[];for(i in a)"object"==typeof a[i]?b.push(i+"={"+Lemon.MSG.MsgPanel.printObject(a[i])+"}"):b.push(i+"="+
a[i]+"\n");Lemon.MSG.MsgPanel.AppendChar(b.join(""))};Lemon.Debug=Lemon.MSG.MsgPanel.Debug};Lemon.MSG.openPanel=function(){Lemon.MSG.MsgPanel.isadd||Lemon.MSG.MsgPanel.adddom();Lemon.MSG.MsgPanel.OpenDebugPanel()};Lemon.MSG.InitPanel();Lemon.OnEventTargetCallBack=function(){};Lemon.OnEventTargetCallBack.prototype={constructor:Lemon.OnEventTargetCallBack,execute:function(){throw Lemon.SE.S2001;}};Lemon.CBR=function(){this.ResultObj=null};
Lemon.CBR.prototype={constructor:Lemon.CBR,SetResult:function(a){this.ResultObj=a},CallBack:function(){throw msg0001;}};Lemon.RemoteProgrameCallbrack=function(){this.sicurl="";this.normalCB=null;this.ErrorCB=new Lemon.CBRError;this.parameters=new Lemon.Hashtable;this.GetParaString=function(){var a={},b;for(b in this.parameters.keys())a[b]=this.parameters.items(b);return a}};
Lemon.RemoteProgrameCallbrack.prototype={constructor:Lemon.RemoteProgrameCallbrack,addParameter:function(a,b){this.parameters.add(a,b)},setErrorCBR:function(a){this.ErrorCB=a},setNormalCBR:function(a){this.normalCB=a},setServiceAddress:function(a){this.sicurl=a},run:function(){throw msg0001;}};Lemon.CBR=function(){this.ResultObj=null};Lemon.CBR.prototype={constructor:Lemon.CBR,SetResult:function(a){this.ResultObj=a},CallBack:function(){throw msg0001;}};
Lemon.RemoteProgrameCallbrack=function(){this.sicurl="";this.normalCB=null;this.ErrorCB=new Lemon.CBRError;this.parameters=new Lemon.Hashtable;this.GetParaString=function(){var a={},b;for(b in this.parameters.keys())a[b]=this.parameters.items(b);return a}};
Lemon.RemoteProgrameCallbrack.prototype={constructor:Lemon.RemoteProgrameCallbrack,addParameter:function(a,b){this.parameters.add(a,b)},setErrorCBR:function(a){this.ErrorCB=a},setNormalCBR:function(a){this.normalCB=a},setServiceAddress:function(a){this.sicurl=a},run:function(){throw msg0001;}};Lemon.CBRError=function(a){Lemon.CBR.call(this);this.MessageTitle=a||Lemon.SE.S2002};Lemon.Inherit(Lemon.CBR,Lemon.CBRError);
Lemon.CBRError.prototype.CallBack=function(){var a=this.MessageTitle+" [statusText]:"+this.ResultObj.statusText+" [status]:"+this.ResultObj.status;Lemon.MSG.debug(a);Lemon.MSG.MsgPanel.Debug(a)};Lemon.CBRBts=function(a){Lemon.CBR.call(this);this.ResultObj=null;this.cb=a};Lemon.Inherit([Lemon.CBR,Lemon.Disposable],Lemon.CBRBts);Lemon.CBRBts.prototype.CallBack=function(){null!=this.cb&&this.cb(this.ResultObj)};Lemon.RPCFormFileup=function(a){Lemon.RemoteProgrameCallbrack.call(this);this.formctl=a};
Lemon.Inherit([Lemon.RemoteProgrameCallbrack,Lemon.Disposable],Lemon.RPCFormFileup);Lemon.RPCFormFileup.prototype.run=function(){var a="",b=this.parameters.keys();for(k in b)a+=k+"="+this.parameters.items(k)+"&";this.formctl.action=this.sicurl+"?"+a};Lemon.RPCGet=function(){Lemon.RemoteProgrameCallbrack.call(this)};Lemon.Inherit([Lemon.RemoteProgrameCallbrack,Lemon.Disposable],Lemon.RPCGet);
Lemon.RPCGet.prototype.run=function(){jQuery.support.cors=!0;var a=this.ErrorCB,b=this.normalCB;$.ajax({async:!0,type:"GET",url:this.sicurl,data:this.GetParaString(),dataType:"json",contentType:"application/x-www-form-urlencoded;charset=utf-8",timeout:15E3,xhrFields:{withCredentials:!0},crossDomain:!0,success:function(a){null==a&&Lemon.MSG.MsgPanel.Debug(Lemon.SE.S2004);b.SetResult(a);b.CallBack()},complete:function(){},error:function(b){a.SetResult(b);a.CallBack()}})};Lemon.RPCPost=function(){Lemon.RemoteProgrameCallbrack.call(this)};
Lemon.Inherit([Lemon.RemoteProgrameCallbrack,Lemon.Disposable],Lemon.RPCPost);
Lemon.RPCPost.prototype.run=function(){jQuery.support.cors=!0;var a=this.ErrorCB,b=this.normalCB;$.ajax({async:!0,type:"POST",url:this.sicurl,data:this.GetParaString(),dataType:"json",contentType:"application/x-www-form-urlencoded;charset=utf-8",timeout:15E3,xhrFields:{withCredentials:!0},crossDomain:!0,success:function(a){null==a&&Lemon.MSG.MsgPanel.Debug(Lemon.SE.S2004);b.SetResult(a);b.CallBack()},complete:function(){},error:function(b){a.SetResult(b);a.CallBack()}})};
Lemon.LemonModule=function(a){this.name=a;this.params=new Lemon.Hashtable};Lemon.LemonModule.prototype={constructor:Lemon.LemonServer,addPar:function(a,b){var c=null;"string"==typeof b||"number"==typeof b||"boolean"==typeof b?c=b:"object"==typeof b?c=JSON.stringify(b):(c=Lemon.SE.S2003,Lemon.MSG.MsgPanel.Debug(Lemon.SE.S2003));this.params.add(a,c)}};Lemon.LemonServer=function(a,b,c){this.host=a;this.port=b;this.serverStatus="";this.domain=c;this.initcb=null};
Lemon.LemonServer.prototype={constructor:Lemon.LemonServer,connect:function(){},getHost:function(){return this.host},getDomain:function(){return this.domain},getAddress:function(){return"http://"+this.host+":"+this.port},setConnectCallBack:function(a){this.initcb=a}};Lemon.ClientAccessInterface=function(){this.cainame=""};Lemon.ClientAccessInterface.prototype={constructor:Lemon.ClientAccessInterface,getCRB:function(){throw Lemon.SE.S2001;},getErrorCRB:function(){throw Lemon.SE.S2001;}};
Lemon.CaiJSON=function(a,b){Lemon.ClientAccessInterface.call(this);this.cainame="jcpb";this.crb=new Lemon.CBRBts(a);this.ecrb=new Lemon.CBRBts(b)};Lemon.Inherit([Lemon.ClientAccessInterface,Lemon.Disposable],Lemon.CaiJSON);Lemon.CaiJSON.prototype.getCRB=function(){return this.crb};Lemon.CaiJSON.prototype.getErrorCRB=function(){return this.ecrb};
Lemon.ServiceAccessInterface=function(){this.sicobj=null;this.sainame="";this.module=this.cai=null;this.setpars=function(a,b){var c=b.params.keys();for(k in c)a.parameters.remove(k),a.addParameter(k,b.params.items(k));return a}};Lemon.ServiceAccessInterface.prototype={constructor:Lemon.ServiceAccessInterface,launch:function(){throw msg0001;},setModule:function(a){this.module=a},setClientAccessInterface:function(a){this.cai=a},setLemonServer:function(a){this.sicobj=a}};
Lemon.SaiFileUpForm=function(a,b,c){Lemon.ServiceAccessInterface.call(this);this.sainame="fileup";this.sicobj=a;this.module=b;this.formctl=c;this.setpars=function(a,b){var c=b.params.keys();for(k in c)a.parameters.remove(k),a.addParameter(k,b.params.items(k));return a}};Lemon.Inherit(Lemon.ServiceAccessInterface,Lemon.SaiFileUpForm);
Lemon.SaiFileUpForm.prototype.launch=function(){this.cai=new Lemon.CaiJSON(null);var a=new Lemon.RPCFormFileup(this.formctl);a.setNormalCBR(null);a.setServiceAddress(this.sicobj.getAddress()+"/"+this.sainame+"/"+this.cai.cainame+"/"+this.module.name);a.addParameter(Lemon.SE.P001,this.sicobj.getDomain());a=this.setpars(a,this.module);a.run()};Lemon.SaiTier=function(a,b,c){Lemon.ServiceAccessInterface.call(this);this.sainame="lemon";this.sicobj=a;this.cai=b;this.module=c};
Lemon.Inherit(Lemon.ServiceAccessInterface,Lemon.SaiTier);
Lemon.SaiTier.prototype.launch=function(a){a==Lemon.DoType.Get?(a=new Lemon.RPCGet,a.setNormalCBR(this.cai.getCRB()),a.setErrorCBR(this.cai.getErrorCRB()),a.setServiceAddress(this.sicobj.getAddress()+"/"+this.sainame+"/"+this.cai.cainame+"/"+this.module.name),a.addParameter(Lemon.SE.P001,this.sicobj.getDomain()),a=this.setpars(a,this.module),a.run()):a==Lemon.DoType.Post&&(a=new Lemon.RPCPost,a.setNormalCBR(this.cai.getCRB()),a.setErrorCBR(this.cai.getErrorCRB()),a.setServiceAddress(this.sicobj.getAddress()+
"/"+this.sainame+"/"+this.cai.cainame+"/"+this.module.name),a.addParameter(Lemon.SE.P001,this.sicobj.getDomain()),a=this.setpars(a,this.module),a.run())};/*
 Apache 2 
...
OpenLayers.Util.distVincenty=function(a,b){for(var c=OpenLayers.Util.VincentyConstants,d=c.a,e=c.b,c=c.f,f=OpenLayers.Util.rad(b.lon-a.lon),g=Math.atan((1-c)*Math.tan(OpenLayers.Util.rad(a.lat))),h=Math.atan((1-c)*Math.tan(OpenLayers.Util.rad(b.lat))),j=Math.sin(g),g=Math.cos(g),l=Math.sin(h),h=Math.cos(h),m=f,n=2*Math.PI,o=20;1E-12<Math.abs(m-n)&&0<--o;){var p=Math.sin(m),q=Math.cos(m),r=Math.sqrt(h*p*h*p+(g*l-j*h*q)*(g*l-j*h*q));if(0==r)return 0;var q=j*l+g*h*q,s=Math.atan2(r,q),t=Math.asin(g*h*
p/r),u=Math.cos(t)*Math.cos(t),p=q-2*j*l/u,v=c/16*u*(4+c*(4-3*u)),n=m,m=f+(1-v)*c*Math.sin(t)*(s+v*r*(p+v*q*(-1+2*p*p)))}if(0==o)return NaN;d=u*(d*d-e*e)/(e*e);c=d/1024*(256+d*(-128+d*(74-47*d)));return(e*(1+d/16384*(4096+d*(-768+d*(320-175*d))))*(s-c*r*(p+c/4*(q*(-1+2*p*p)-c/6*p*(-3+4*r*r)*(-3+4*p*p))))).toFixed(3)/1E3};
OpenLayers.Util.destinationVincenty=function(a,b,c){for(var d=OpenLayers.Util,e=d.VincentyConstants,f=e.a,g=e.b,h=e.f,e=a.lon,a=a.lat,j=d.rad(b),b=Math.sin(j),j=Math.cos(j),a=(1-h)*Math.tan(d.rad(a)),l=1/Math.sqrt(1+a*a),m=a*l,n=Math.atan2(a,j),a=l*b,o=1-a*a,f=o*(f*f-g*g)/(g*g),p=1+f/16384*(4096+f*(-768+f*(320-175*f))),q=f/1024*(256+f*(-128+f*(74-47*f))),f=c/(g*p),r=2*Math.PI;1E-12<Math.abs(f-r);)var s=Math.cos(2*n+f),t=Math.sin(f),u=Math.cos(f),v=q*t*(s+q/4*(u*(-1+2*s*s)-q/6*s*(-3+4*t*t)*(-3+4*s*
s))),r=f,f=c/(g*p)+v;c=m*t-l*u*j;g=Math.atan2(m*u+l*t*j,(1-h)*Math.sqrt(a*a+c*c));b=Math.atan2(t*b,l*u-m*t*j);j=h/16*o*(4+h*(4-3*o));s=b-(1-j)*h*a*(f+j*t*(s+j*u*(-1+2*s*s)));Math.atan2(a,-c);return new OpenLayers.LonLat(e+d.deg(s),d.deg(g))};
OpenLayers.Util.getParameters=function(a,b){var b=b||{},a=null===a||void 0===a?window.location.href:a,c="";if(OpenLayers.String.contains(a,"?"))var d=a.indexOf("?")+1,c=OpenLayers.String.contains(a,"#")?a.indexOf("#"):a.length,c=a.substring(d,c);for(var d={},c=c.split(/[&;]/),e=0,f=c.length;e<f;++e){var g=c[e].split("=");if(g[0]){var h=g[0];try{h=decodeURIComponent(h)}catch(j){h=unescape(h)}g=(g[1]||"").replace(/\+/g," ");try{g=decodeURIComponent(g)}catch(l){g=unescape(g)}!1!==b.splitArgs&&(g=g.split(","));
...
OpenLayers.Util.getRenderedDimensions=function(a,b,c){var d,e,f=document.createElement("div");f.style.visibility="hidden";for(var g=c&&c.containerElement?c.containerElement:document.body,h=!1,j=null,l=g;l&&"body"!=l.tagName.toLowerCase();){var m=OpenLayers.Element.getStyle(l,"position");if("absolute"==m){h=!0;break}else if(m&&"static"!=m)break;l=l.parentNode}if(h&&(0===g.clientHeight||0===g.clientWidth))j=document.createElement("div"),j.style.visibility="hidden",j.style.position="absolute",j.style.overflow=
...
OpenLayers.Util.vendorPrefix=function(){function a(a,b){if(void 0===f[b]){var d,e=0,m=c.length,n="undefined"!==typeof a.cssText;for(f[b]=null;e<m;e++)if((d=c[e])?(n||(d=d.toLowerCase()),d=d+b.charAt(0).toUpperCase()+b.slice(1)):d=b,void 0!==a[d]){f[b]=d;break}}return f[b]}function b(b){return a(d,b)}var c=["","O","ms","Moz","Webkit"],d=document.createElement("div").style,e={},f={};return{css:function(a){if(void 0===e[a]){var c=a.replace(/(-[\s\S])/g,function(a){return a.charAt(1).toUpperCase()}),
c=b(c);c=c?c.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}).replace(/^ms-/,"-ms-"):null;e[a]=c}return e[a]},js:a,style:b,cssCache:e,jsCache:f}}();
OpenLayers.Animation=function(a){var b=OpenLayers.Util.vendorPrefix.js(a,"requestAnimationFrame"),c,d=a[b]||function(b){a.setTimeout(b,16)};c=function(b,c){d.apply(a,[b,c])};var e=0,f={};return{isNative:!!b,requestFrame:c,start:function(a,b,d){var b=0<b?b:Number.POSITIVE_INFINITY,l=++e,m=+new Date;f[l]=function(){f[l]&&+new Date-m<=b?(a(),f[l]&&c(f[l],d)):delete f[l]};c(f[l],d);return l},stop:function(a){delete f[a]}}}(window);
...
(function(){function a(a){a.x=180*a.x/d;a.y=180/Math.PI*(2*Math.atan(Math.exp(a.y/d*Math.PI))-Math.PI/2);return a}function b(a){a.x=a.x*d/180;var b=Math.log(Math.tan((90+a.y)*Math.PI/360))/Math.PI*d;a.y=Math.max(-2.003750834E7,Math.min(b,2.003750834E7));return a}function c(c,d){var e=OpenLayers.Projection.addTransform,f=OpenLayers.Projection.nullTransform,g,o,p,q,r;g=0;for(o=d.length;g<o;++g){p=d[g];e(c,p,b);e(p,c,a);for(r=g+1;r<o;++r)q=d[r],e(p,q,f),e(q,p,f)}}var d=2.003750834E7,e=["EPSG:900913",
...
((a-1)*(d.x-b.x)|0),d.y+((a-1)*(d.y-b.y)|0),a)},done:function(a){c.applyTransform();var a=c.getResolution()/a.scale,d=c.getZoomForResolution(a,true);c.moveTo(c.getZoomTargetCenter(b,a),d,true)}}}))}else f=b?c.getZoomTargetCenter(b,c.getResolutionForZoom(a)):null,c.setCenter(f,a)},zoomIn:function(){this.zoomTo(this.getZoom()+1)},zoomOut:function(){this.zoomTo(this.getZoom()-1)},zoomToExtent:function(a,b){a instanceof OpenLayers.Bounds||(a=new OpenLayers.Bounds(a));var c=a.getCenterLonLat();if(this.baseLayer.wrapDateLine){c=
...
OpenLayers.Geometry.segmentsIntersect=function(a,b,c){var d=c&&c.point,c=c&&c.tolerance,e=!1,f=a.x1-b.x1,g=a.y1-b.y1,h=a.x2-a.x1,j=a.y2-a.y1,l=b.y2-b.y1,m=b.x2-b.x1,n=l*h-m*j,l=m*g-l*f,g=h*g-j*f;0==n?0==l&&0==g&&(e=!0):(f=l/n,n=g/n,0<=f&&(1>=f&&0<=n&&1>=n)&&(d?(h=a.x1+f*h,n=a.y1+f*j,e=new OpenLayers.Geometry.Point(h,n)):e=!0));if(c)if(e){if(d){a=[a,b];b=0;a:for(;2>b;++b){f=a[b];for(j=1;3>j;++j)if(h=f["x"+j],n=f["y"+j],d=Math.sqrt(Math.pow(h-e.x,2)+Math.pow(n-e.y,2)),d<c){e.x=h;e.y=n;break a}}}}else{a=
...
OpenLayers.Geometry.distanceSquaredToSegment=function(a,b){var c=a.x,d=a.y,e=b.x1,f=b.y1,g=b.x2,h=b.y2,j=g-e,l=h-f,m=(j*(c-e)+l*(d-f))/(Math.pow(j,2)+Math.pow(l,2));0>=m||(1<=m?(e=g,f=h):(e+=m*j,f+=m*l));return{distance:Math.pow(e-c,2)+Math.pow(f-d,2),x:e,y:f,along:m}};
...
OpenLayers.Geometry.Curve=OpenLayers.Class(OpenLayers.Geometry.MultiPoint,{componentTypes:["OpenLayers.Geometry.Point"],getLength:function(){var a=0;if(this.components&&1<this.components.length)for(var b=1,c=this.components.length;b<c;b++)a+=this.components[b-1].distanceTo(this.components[b]);return a},getApproachCompoent:function(a){var b=null,b=-1,c=0,d=this.getLength();if(this.components&&1<this.components.length)for(var e=1,f=this.components.length;e<f;e++){var c=c+this.components[e-1].distanceTo(this.components[e]),
g=Math.abs(a-c);if(g==a){if(1==e){b=1;break}return this.components[e-1]}if(g<d)d=g;else{b=e;break}}-1==b&&(b=1);a=this.components[b];b=this.components[b-1];d=c=0;c=a.x>b.x?(a.x-b.x)/2+b.x:(b.x-a.x)/2+a.x;d=a.y>b.y?(a.y-b.y)/2+b.y:(b.y-a.y)/2+a.y;return b=new OpenLayers.Geometry.Point(c,d)},getGeodesicLength:function(a){var b=this;if(a){var c=new OpenLayers.Projection("EPSG:4326");c.equals(a)||(b=this.clone().transform(a,c))}a=0;if(b.components&&1<b.components.length)for(var d,e=1,f=b.components.length;e<
...
e,f,g,h,j,l,m,n=0,o=d.length;a:for(;n<o;++n){c=d[n];e=c.x1;f=c.x2;g=c.y1;h=c.y2;var p=0,q=a.length;for(;p<q;++p){j=a[p];if(j.x1>f)break;if(!(j.x2<e)&&(l=j.y1,m=j.y2,!(Math.min(l,m)>Math.max(g,h))&&!(Math.max(l,m)<Math.min(g,h))&&OpenLayers.Geometry.segmentsIntersect(c,j))){b=!0;break a}}}}else b=a.intersects(this);return b},getSortedSegments:function(){for(var a=this.components.length-1,b=Array(a),c,d,e=0;e<a;++e)c=this.components[e],d=this.components[e+1],b[e]=c.x<d.x?{x1:c.x,y1:c.y,x2:d.x,y2:d.y}:
{x1:d.x,y1:d.y,x2:c.x,y2:c.y};return b.sort(function(a,b){return a.x1-b.x1})},splitWithSegment:function(a,b){for(var c=!(b&&!1===b.edge),d=b&&b.tolerance,e=[],f=this.getVertices(),g=[],h=[],j=!1,l,m,n,o={point:!0,tolerance:d},p=null,q=0,r=f.length-2;q<=r;++q)if(d=f[q],g.push(d.clone()),l=f[q+1],m={x1:d.x,y1:d.y,x2:l.x,y2:l.y},m=OpenLayers.Geometry.segmentsIntersect(a,m,o),m instanceof OpenLayers.Geometry.Point&&((n=m.x===a.x1&&m.y===a.y1||m.x===a.x2&&m.y===a.y2||m.equals(d)||m.equals(l)?!0:!1)||c))m.equals(h[h.length-
1])||h.push(m.clone()),!(0===q&&m.equals(d))&&!m.equals(l)&&(j=!0,m.equals(d)||g.push(m),e.push(new OpenLayers.Geometry.LineString(g)),g=[m.clone()]);j&&(g.push(l.clone()),e.push(new OpenLayers.Geometry.LineString(g)));if(0<h.length)var s=a.x1<a.x2?1:-1,t=a.y1<a.y2?1:-1,p={lines:e,points:h.sort(function(a,b){return s*a.x-s*b.x||t*a.y-t*b.y})};return p},split:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h;if(a instanceof OpenLayers.Geometry.LineString){var j=this.getVertices(),l,m,n,o,p,q=[];g=[];
for(var r=0,s=j.length-2;r<=s;++r){l=j[r];m=j[r+1];n={x1:l.x,y1:l.y,x2:m.x,y2:m.y};h=h||[a];d&&q.push(l.clone());for(var t=0;t<h.length;++t)if(o=h[t].splitWithSegment(n,b))if(p=o.lines,0<p.length&&(p.unshift(t,1),Array.prototype.splice.apply(h,p),t+=p.length-2),d)for(var u=0,v=o.points.length;u<v;++u)p=o.points[u],p.equals(l)||(q.push(p),g.push(new OpenLayers.Geometry.LineString(q)),q=p.equals(m)?[]:[p.clone()])}d&&(0<g.length&&0<q.length)&&(q.push(m.clone()),g.push(new OpenLayers.Geometry.LineString(q)))}else c=
a.splitWith(this,b);h&&1<h.length?f=!0:h=[];g&&1<g.length?e=!0:g=[];if(f||e)c=d?[g,h]:h;return c},splitWith:function(a,b){return a.split(this,b)},getVertices:function(a){return!0===a?[this.components[0],this.components[this.components.length-1]]:!1===a?this.components.slice(1,this.components.length-1):this.components.slice()},distanceTo:function(a,b){var c=!(b&&!1===b.edge)&&b&&b.details,d,e={},f=Number.POSITIVE_INFINITY;if(a instanceof OpenLayers.Geometry.Point){for(var g=this.getSortedSegments(),
h=a.x,j=a.y,l,m=0,n=g.length;m<n;++m)if(l=g[m],d=OpenLayers.Geometry.distanceToSegment(a,l),d.distance<f){if(f=d.distance,e=d,0===f)break}else if(l.x2>h&&(j>l.y1&&j<l.y2||j<l.y1&&j>l.y2))break;e=c?{distance:e.distance,x0:e.x,y0:e.y,x1:h,y1:j}:e.distance}else if(a instanceof OpenLayers.Geometry.LineString){var g=this.getSortedSegments(),h=a.getSortedSegments(),o,p,q=h.length,r={point:!0},m=0,n=g.length;a:for(;m<n;++m){j=g[m];l=j.x1;p=j.y1;for(var s=0;s<q;++s)if(d=h[s],o=OpenLayers.Geometry.segmentsIntersect(j,
d,r)){f=0;e={distance:0,x0:o.x,y0:o.y,x1:o.x,y1:o.y};break a}else d=OpenLayers.Geometry.distanceToSegment({x:l,y:p},d),d.distance<f&&(f=d.distance,e={distance:f,x0:l,y0:p,x1:d.x,y1:d.y})}c||(e=e.distance);0!==f&&j&&(d=a.distanceTo(new OpenLayers.Geometry.Point(j.x2,j.y2),b),m=c?d.distance:d,m<f&&(e=c?{distance:f,x0:d.x1,y0:d.y1,x1:d.x0,y1:d.y0}:m))}else e=a.distanceTo(this,b),c&&(e={distance:e.distance,x0:e.x1,y0:e.y1,x1:e.x0,y1:e.y0});return e},simplify:function(a){if(this&&null!==this){var b=this.getVertices();
if(3>b.length)return this;var c=function(a,b,d,j){for(var l=0,m=0,n=b,o;n<d;n++){o=a[b];var p=a[d],q=a[n],q=Math.abs(0.5*(o.x*p.y+p.x*q.y+q.x*o.y-p.x*o.y-q.x*p.y-o.x*q.y));o=Math.sqrt(Math.pow(o.x-p.x,2)+Math.pow(o.y-p.y,2));o=2*(q/o);o>l&&(l=o,m=n)}l>j&&m!=b&&(e.push(m),c(a,b,m,j),c(a,m,d,j))},d=b.length-1,e=[];e.push(0);for(e.push(d);b[0].equals(b[d]);)d--,e.push(d);c(b,0,d,a);a=[];e.sort(function(a,b){return a-b});for(d=0;d<e.length;d++)a.push(b[e[d]]);return new OpenLayers.Geometry.LineString(a)}return this},
CLASS_NAME:"OpenLayers.Geometry.LineString"});
OpenLayers.Geometry.MultiLineString=OpenLayers.Class(OpenLayers.Geometry.Collection,{componentTypes:["OpenLayers.Geometry.LineString"],split:function(a,b){for(var c=null,d=b&&b.mutual,e,f,g,h,j=[],l=[a],m=0,n=this.components.length;m<n;++m){f=this.components[m];g=!1;for(var o=0;o<l.length;++o)if(e=f.split(l[o],b)){if(d){g=e[0];for(var p=0,q=g.length;p<q;++p)0===p&&j.length?j[j.length-1].addComponent(g[p]):j.push(new OpenLayers.Geometry.MultiLineString([g[p]]));g=!0;e=e[1]}if(e.length){e.unshift(o,
1);Array.prototype.splice.apply(l,e);break}}g||(j.length?j[j.length-1].addComponent(f.clone()):j=[new OpenLayers.Geometry.MultiLineString(f.clone())])}j&&1<j.length?g=!0:j=[];l&&1<l.length?h=!0:l=[];if(g||h)c=d?[j,l]:l;return c},splitWith:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h,j,l;if(a instanceof OpenLayers.Geometry.LineString){l=[];j=[a];for(var m=0,n=this.components.length;m<n;++m){g=!1;f=this.components[m];for(var o=0;o<j.length;++o)if(e=j[o].split(f,b)){d&&(g=e[0],g.length&&(g.unshift(o,
1),Array.prototype.splice.apply(j,g),o+=g.length-2),e=e[1],0===e.length&&(e=[f.clone()]));g=0;for(var p=e.length;g<p;++g)0===g&&l.length?l[l.length-1].addComponent(e[g]):l.push(new OpenLayers.Geometry.MultiLineString([e[g]]));g=!0}g||(l.length?l[l.length-1].addComponent(f.clone()):l=[new OpenLayers.Geometry.MultiLineString([f.clone()])])}}else c=a.split(this);j&&1<j.length?h=!0:j=[];l&&1<l.length?g=!0:l=[];if(h||g)c=d?[j,l]:l;return c},CLASS_NAME:"OpenLayers.Geometry.MultiLineString"});
...
e=b.components[f+1],a+=OpenLayers.Util.rad(e.x-d.x)*(2+Math.sin(OpenLayers.Util.rad(d.y))+Math.sin(OpenLayers.Util.rad(e.y)));a=40680631590769*a/2}return a},containsPoint:function(a){for(var b=OpenLayers.Number.limitSigDigs,c=b(a.x,14),a=b(a.y,14),d=this.components.length-1,e,f,g,h,j,l=0,m=0;m<d;++m)if(e=this.components[m],g=b(e.x,14),e=b(e.y,14),f=this.components[m+1],h=b(f.x,14),f=b(f.y,14),e==f){if(a==e&&(g<=h&&c>=g&&c<=h||g>=h&&c<=g&&c>=h)){l=-1;break}}else{j=b((a-f)*((h-g)/(f-e))+h,14);if(j==
c&&(e<f&&a>=e&&a<=f||e>f&&a<=e&&a>=f)){l=-1;break}j<=c||g!=h&&(j<Math.min(g,h)||j>Math.max(g,h))||(e<f&&a>=e&&a<f||e>f&&a<e&&a>=f)&&++l}return-1==l?1:!!(l&1)},intersects:function(a){var b=!1;if("OpenLayers.Geometry.Point"==a.CLASS_NAME)b=this.containsPoint(a);else if("OpenLayers.Geometry.LineString"==a.CLASS_NAME)b=a.intersects(this);else if("OpenLayers.Geometry.LinearRing"==a.CLASS_NAME)b=OpenLayers.Geometry.LineString.prototype.intersects.apply(this,[a]);else for(var c=0,d=a.components.length;c<
...
OpenLayers.Geometry.Polygon.createRegularPolygonCurve=function(a,b,c,d){var e=d/180*Math.PI*(1/c-d/360);d&&(e+=d/180*Math.PI);for(var f,g,h=[],j=0;j<c;++j)f=e+2*(j*(d/360))*Math.PI/c,g=a.x+b*Math.cos(f),f=a.y+b*Math.sin(f),h.push(new OpenLayers.Geometry.Point(g,f));return new OpenLayers.Geometry.LineString(h)};OpenLayers.Geometry.MultiPolygon=OpenLayers.Class(OpenLayers.Geometry.Collection,{componentTypes:["OpenLayers.Geometry.Polygon"],CLASS_NAME:"OpenLayers.Geometry.MultiPolygon"});
...
"featureMembers":"featureMember";a=this.writeNode("gml:"+b,a);this.setAttributeNS(a,this.namespaces.xsi,"xsi:schemaLocation",this.schemaLocation);return OpenLayers.Format.XML.prototype.write.apply(this,[a])},writers:{gml:{featureMember:function(a){var b=this.createElementNSPlus("gml:featureMember");this.writeNode("feature:_typeName",a,b);return b},MultiPoint:function(a){for(var b=this.createElementNSPlus("gml:MultiPoint"),a=a.components||[a],c=0,d=a.length;c<d;++c)this.writeNode("pointMember",a[c],
...
c=this.xy?new OpenLayers.Geometry.Point(c[0],c[1],c[2]):new OpenLayers.Geometry.Point(c[1],c[0],c[2]);b.points=[c]},posList:function(a,b){for(var c=this.getChildValue(a).replace(this.regExes.trimSpace,"").split(this.regExes.splitSpace),d=b.srsDimension||parseInt(a.getAttribute("srsDimension")||a.getAttribute("dimension"),10)||2,e,f,g,h=Array(c.length/d),j=0,l=c.length;j<l;j=j+d){e=c[j];f=c[j+1];g=d==2?void 0:c[j+2];h[j/d]=this.xy?new OpenLayers.Geometry.Point(e,f,g):new OpenLayers.Geometry.Point(f,
...
featurePrefix:this.featurePrefix,featureType:this.featureType,srsName:this.srsName},a),b=a.featurePrefix,c=this.createElementNSPlus("wfs:Query",{attributes:{typeName:(b?b+":":"")+a.featureType,srsName:a.srsName}});a.featureNS&&c.setAttribute("xmlns:"+b,a.featureNS);if(a.propertyNames)for(var b=0,d=a.propertyNames.length;b<d;b++)this.writeNode("wfs:PropertyName",{property:a.propertyNames[b]},c);if(a.filter){OpenLayers.Format.WFST.v1_1_0.prototype.setFilterProperty.call(this,a.filter);this.writeNode("ogc:Filter",
...
case "FeatureCollection":d=[];switch(e.type){case "Feature":try{d.push(this.parseFeature(e))}catch(h){d=null;OpenLayers.Console.error(h)}break;case "FeatureCollection":a=0;for(b=e.features.length;a<b;++a)try{d.push(this.parseFeature(e.features[a]))}catch(j){d=null;OpenLayers.Console.error(j)}break;default:try{var l=this.parseGeometry(e);d.push(new OpenLayers.Feature.Vector(l))}catch(m){d=null;OpenLayers.Console.error(m)}}}}else OpenLayers.Console.error("Bad JSON: "+a);return d},isValidType:function(a,
...
new OpenLayers.Format.QueryStringFilter({srsInBBOX:this.srsInBBOX});this.filterToParams=function(a,d){return b.write(a,d)}}},read:function(a){OpenLayers.Protocol.prototype.read.apply(this,arguments);a=OpenLayers.Util.applyDefaults(a,this.options);a.params=OpenLayers.Util.applyDefaults(a.params,this.options.params);if(a.filter&&this.filterToParams)a.params=this.filterToParams(a.filter,a.params);var b=new OpenLayers.Protocol.Response({requestType:"read"}),c=this.createRequest(a.url,a.params,OpenLayers.Function.bind(function(c){b.data=
...
OpenLayers.Format.EncodedPolyline=OpenLayers.Class(OpenLayers.Format,{geometryType:"linestring",initialize:function(a){OpenLayers.Format.prototype.initialize.apply(this,[a])},read:function(a){var b;if(this.geometryType=="linestring")b=OpenLayers.Geometry.LineString;else if(this.geometryType=="linearring")b=OpenLayers.Geometry.LinearRing;else if(this.geometryType=="multipoint")b=OpenLayers.Geometry.MultiPoint;else if(this.geometryType!="point"&&this.geometryType!="polygon")return null;for(var a=this.decodeDeltas(a,
2),c=a.length,d=[],e=0;e+1<c;){var f=a[e++],g=a[e++];d.push(new OpenLayers.Geometry.Point(g,f))}return this.geometryType=="point"?new OpenLayers.Feature.Vector(d[0]):this.geometryType=="polygon"?new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Polygon([new OpenLayers.Geometry.LinearRing(d)])):new OpenLayers.Feature.Vector(new b(d))},decode:function(a,b,c){for(var a=this.decodeDeltas(a,b,c||1E5),c=a.length,d=[],e=0;e+(b-1)<c;){for(var f=[],g=0;g<b;++g)f.push(a[e++]);d.push(f)}return d},write:function(a){var a=
(a.constructor==Array?a[0]:a).geometry,b=a.CLASS_NAME.split(".")[2].toLowerCase();if(b=="point")a=Array(a);else if(b=="linestring"||b=="linearring"||b=="multipoint")a=a.components;else if(b=="polygon")a=a.components[0].components;else return null;for(var b=[],c=a.length,d=0;d<c;++d){var e=a[d];b.push(e.y);b.push(e.x)}return this.encodeDeltas(b,2)},encode:function(a,b,c){for(var c=c||1E5,d=[],e=a.length,f=0;f<e;++f)for(var g=a[f],h=0;h<b;++h)d.push(g[h]);return this.encodeDeltas(d,b,c)},encodeDeltas:function(a,
b,c){var d,e=Array(b);for(d=0;d<b;++d)e[d]=0;for(var f=a.length,g=0;g<f;)for(d=0;d<b;++d,++g){var h=a[g],j=h-e[d];e[d]=h;a[g]=j}return this.encodeFloats(a,c||1E5)},decodeDeltas:function(a,b,c){var d,e=Array(b);for(d=0;d<b;++d)e[d]=0;for(var a=this.decodeFloats(a,c||1E5),c=a.length,f=0;f<c;)for(d=0;d<b;++d,++f){e[d]=e[d]+a[f];a[f]=e[d]}return a},encodeFloats:function(a,b){for(var c=b||1E5,d=a.length,e=0;e<d;++e)a[e]=Math.round(a[e]*c);return this.encodeSignedIntegers(a)},decodeFloats:function(a,b){for(var c=
b||1E5,d=this.decodeSignedIntegers(a),e=d.length,f=0;f<e;++f)d[f]=d[f]/c;return d},encodeSignedIntegers:function(a){for(var b=a.length,c=0;c<b;++c){var d=a[c],e=d<<1;d<0&&(e=~e);a[c]=e}return this.encodeUnsignedIntegers(a)},decodeSignedIntegers:function(a){for(var a=this.decodeUnsignedIntegers(a),b=a.length,c=0;c<b;++c){var d=a[c];a[c]=d&1?~(d>>1):d>>1}return a},encodeUnsignedIntegers:function(a){for(var b="",c=a.length,d=0;d<c;++d)b=b+this.encodeUnsignedInteger(a[d]);return b},decodeUnsignedIntegers:function(a){for(var b=
[],c=0,d=0,e=a.length,f=0;f<e;++f){var g=a.charCodeAt(f)-63,c=c|(g&31)<<d;if(g<32){b.push(c);d=c=0}else d=d+5}return b},encodeFloat:function(a,b){a=Math.round(a*(b||1E5));return this.encodeSignedInteger(a)},decodeFloat:function(a,b){return this.decodeSignedInteger(a)/(b||1E5)},encodeSignedInteger:function(a){var b=a<<1;a<0&&(b=~b);return this.encodeUnsignedInteger(b)},decodeSignedInteger:function(a){a=this.decodeUnsignedInteger(a);return a&1?~(a>>1):a>>1},encodeUnsignedInteger:function(a){for(var b,
c="";a>=32;){b=(32|a&31)+63;c=c+String.fromCharCode(b);a=a>>5}return c=c+String.fromCharCode(a+63)},decodeUnsignedInteger:function(a){for(var b=0,c=0,d=a.length,e=0;e<d;++e){var f=a.charCodeAt(e)-63,b=b|(f&31)<<c;if(f<32)break;c=c+5}return b},CLASS_NAME:"OpenLayers.Format.EncodedPolyline"});
...
OpenLayers.Tile.Image=OpenLayers.Class(OpenLayers.Tile,{url:null,imgDiv:null,frame:null,imageReloadAttempts:null,layerAlphaHack:null,asyncRequestId:null,maxGetUrlLength:null,canvasContext:null,crossOriginKeyword:null,initialize:function(a,b,c,d,e,f){OpenLayers.Tile.prototype.initialize.apply(this,arguments);this.url=d;this.layerAlphaHack=this.layer.alpha&&OpenLayers.Util.alphaHack();if(this.maxGetUrlLength!=null||this.layer.gutter||this.layerAlphaHack){this.frame=document.createElement("div");this.frame.style.position=
"absolute";this.frame.style.overflow="hidden"}this.maxGetUrlLength!=null&&OpenLayers.Util.extend(this,OpenLayers.Tile.Image.IFrame)},destroy:function(){if(this.imgDiv){this.clear();this.frame=this.imgDiv=null}this.asyncRequestId=null;OpenLayers.Tile.prototype.destroy.apply(this,arguments)},draw:function(){var a=OpenLayers.Tile.prototype.draw.apply(this,arguments);if(a){if(this.layer!=this.layer.map.baseLayer&&this.layer.reproject)this.bounds=this.getBoundsFromBaseLayer(this.position);if(this.isLoading)this._loadEvent=
"reload";else{this.isLoading=true;this._loadEvent="loadstart"}this.renderTile();this.positionTile()}else a===false&&this.unload();return a},renderTile:function(){if(this.layer.async){var a=this.asyncRequestId=(this.asyncRequestId||0)+1;this.layer.getURLasync(this.bounds,function(b){if(a==this.asyncRequestId){this.url=b;this.initImage()}},this)}else{this.url=this.layer.getURL(this.bounds);this.initImage()}},positionTile:function(){var a=this.getTile().style,b=this.frame?this.size:this.layer.getImageSize(this.bounds),
c=1;this.layer instanceof OpenLayers.Layer.Grid&&(c=this.layer.getServerResolution()/this.layer.map.getResolution());a.left=this.position.x+"px";a.top=this.position.y+"px";a.width=Math.round(c*b.w)+"px";a.height=Math.round(c*b.h)+"px"},clear:function(){OpenLayers.Tile.prototype.clear.apply(this,arguments);var a=this.imgDiv;if(a){var b=this.getTile();b.parentNode===this.layer.div&&this.layer.div.removeChild(b);this.setImgSrc();if(this.layerAlphaHack===true)a.style.filter="";OpenLayers.Element.removeClass(a,
"olImageLoadError")}this.canvasContext=null},getImage:function(){if(!this.imgDiv){this.imgDiv=OpenLayers.Tile.Image.IMAGE.cloneNode(false);var a=this.imgDiv.style;if(this.frame){var b=0,c=0;if(this.layer.gutter){b=this.layer.gutter/this.layer.tileSize.w*100;c=this.layer.gutter/this.layer.tileSize.h*100}a.left=-b+"%";a.top=-c+"%";a.width=2*b+100+"%";a.height=2*c+100+"%"}a.visibility="hidden";a.opacity=0;if(this.layer.opacity<1)a.filter="alpha(opacity="+this.layer.opacity*100+")";a.position="absolute";
if(this.layerAlphaHack){a.paddingTop=a.height;a.height="0";a.width="100%"}this.frame&&this.frame.appendChild(this.imgDiv)}return this.imgDiv},setImage:function(a){this.imgDiv=a},initImage:function(){this.events.triggerEvent("beforeload");this.layer.div.appendChild(this.getTile());this.events.triggerEvent(this._loadEvent);var a=this.getImage();if(this.url&&OpenLayers.Util.isEquivalentUrl(a.src,this.url))this._loadTimeout=window.setTimeout(OpenLayers.Function.bind(this.onImageLoad,this),0);else{this.stopLoading();
this.crossOriginKeyword&&a.removeAttribute("crossorigin");OpenLayers.Event.observe(a,"load",OpenLayers.Function.bind(this.onImageLoad,this));OpenLayers.Event.observe(a,"error",OpenLayers.Function.bind(this.onImageError,this));this.imageReloadAttempts=0;this.setImgSrc(this.url)}},setImgSrc:function(a){var b=this.imgDiv;if(a){b.style.visibility="hidden";b.style.opacity=0;this.crossOriginKeyword&&(a.substr(0,5)!=="data:"?b.setAttribute("crossorigin",this.crossOriginKeyword):b.removeAttribute("crossorigin"));
b.src=a}else{this.stopLoading();this.imgDiv=null;b.parentNode&&b.parentNode.removeChild(b)}},getTile:function(){return this.frame?this.frame:this.getImage()},createBackBuffer:function(){if(this.imgDiv&&!this.isLoading){var a;if(this.frame){a=this.frame.cloneNode(false);a.appendChild(this.imgDiv)}else a=this.imgDiv;this.imgDiv=null;return a}},onImageLoad:function(){var a=this.imgDiv;this.stopLoading();a.style.visibility="inherit";a.style.opacity=this.layer.opacity;this.isLoading=false;this.canvasContext=
null;this.events.triggerEvent("loadend");if(this.layerAlphaHack===true)a.style.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+a.src+"', sizingMethod='scale')"},onImageError:function(){var a=this.imgDiv;if(a.src!=null){this.imageReloadAttempts++;if(this.imageReloadAttempts<=OpenLayers.IMAGE_RELOAD_ATTEMPTS)this.setImgSrc(this.layer.getURL(this.bounds));else{OpenLayers.Element.addClass(a,"olImageLoadError");this.events.triggerEvent("loaderror")}}},stopLoading:function(){OpenLayers.Event.stopObservingElement(this.imgDiv);
...
"webkitTransitionEnd","otransitionend","oTransitionEnd"],initialize:function(a,b,c,d){OpenLayers.Layer.HTTPRequest.prototype.initialize.apply(this,arguments);this.grid=[];this._removeBackBuffer=OpenLayers.Function.bind(this.removeBackBuffer,this);this.initProperties();this.rowSign=this.tileOriginCorner.substr(0,1)==="t"?1:-1},initProperties:function(){if(this.options.removeBackBufferDelay===void 0)this.removeBackBufferDelay=this.singleTile?0:2500;if(this.options.className===void 0)this.className=
...
e;d++)this.destroyTile(c[d]);this.grid=[];this.gridLayout=this.gridResolution=null}},addOptions:function(a,b){var c=a.singleTile!==void 0&&a.singleTile!==this.singleTile;OpenLayers.Layer.HTTPRequest.prototype.addOptions.apply(this,arguments);if(this.map&&c){this.initProperties();this.clearGrid();this.tileSize=this.options.tileSize;this.setTileSize();this.moveTo(null,true)}},clone:function(a){a==null&&(a=new OpenLayers.Layer.Grid(this.name,this.url,this.params,this.getOptions()));a=OpenLayers.Layer.HTTPRequest.prototype.clone.apply(this,
[a]);if(this.tileSize!=null)a.tileSize=this.tileSize.clone();a.grid=[];a.gridResolution=null;a.backBuffer=null;a.backBufferTimerId=null;a.loading=false;a.numLoadingTiles=0;return a},moveTo:function(a,b,c){OpenLayers.Layer.HTTPRequest.prototype.moveTo.apply(this,arguments);a=a||this.map.getExtent();if(a!=null){var d=!this.grid.length||b,e=this.getTilesBounds(),f=this.map.getResolution();this.getServerResolution(f);if(this.singleTile){if(d||!c&&!e.containsBounds(a)){b&&this.transitionEffect!=="resize"&&
this.removeBackBuffer();(!b||this.transitionEffect==="resize")&&this.applyBackBuffer(f);this.initSingleTile(a)}}else if(d=d||!e.intersectsBounds(a,{worldBounds:this.map.baseLayer.wrapDateLine&&this.map.getMaxExtent()})){b&&(this.transitionEffect==="resize"||this.gridResolution===f)&&this.applyBackBuffer(f);this.initGriddedTiles(a)}else this.moveGriddedTiles()}},getTileData:function(a){var b=null,c=a.lon,d=a.lat,e=this.grid.length;if(this.map&&e){var f=this.map.getResolution(),a=this.tileSize.w,g=
this.tileSize.h,h=this.grid[0][0].bounds,j=h.left,h=h.top;if(c<j&&this.map.baseLayer.wrapDateLine)var l=this.map.getMaxExtent().getWidth(),m=Math.ceil((j-c)/l),c=c+l*m;c=(c-j)/(f*a);d=(h-d)/(f*g);f=Math.floor(c);j=Math.floor(d);if(j>=0&&j<e)(e=this.grid[j][f])&&(b={tile:e,i:Math.floor((c-f)*a),j:Math.floor((d-j)*g)})}return b},destroyTile:function(a){this.removeTileMonitoringHooks(a);a.destroy()},getServerResolution:function(a){var b=Number.POSITIVE_INFINITY,a=a||this.map.getResolution();if(this.serverResolutions&&
OpenLayers.Util.indexOf(this.serverResolutions,a)===-1){var c,d,e,f;for(c=this.serverResolutions.length-1;c>=0;c--){e=this.serverResolutions[c];d=Math.abs(e-a);if(d>b)break;b=d;f=e}a=f}return a},getServerZoom:function(){var a=this.getServerResolution();return this.serverResolutions?OpenLayers.Util.indexOf(this.serverResolutions,a):this.map.getZoomForResolution(a)+(this.zoomOffset||0)},applyBackBuffer:function(a){this.backBufferTimerId!==null&&this.removeBackBuffer();var b=this.backBuffer;if(!b){b=
this.createBackBuffer();if(!b)return;a===this.gridResolution?this.div.insertBefore(b,this.div.firstChild):this.map.baseLayer.div.parentNode.insertBefore(b,this.map.baseLayer.div);this.backBuffer=b;var c=this.grid[0][0].bounds;this.backBufferLonLat={lon:c.left,lat:c.top};this.backBufferResolution=this.gridResolution}for(var c=this.backBufferResolution/a,d=b.childNodes,e,f=d.length-1;f>=0;--f){e=d[f];e.style.top=(c*e._i*e._h|0)+"px";e.style.left=(c*e._j*e._w|0)+"px";e.style.width=Math.round(c*e._w)+
"px";e.style.height=Math.round(c*e._h)+"px"}a=this.getViewPortPxFromLonLat(this.backBufferLonLat,a);c=this.map.layerContainerOriginPx.y;b.style.left=Math.round(a.x-this.map.layerContainerOriginPx.x)+"px";b.style.top=Math.round(a.y-c)+"px"},createBackBuffer:function(){var a;if(this.grid.length>0){a=document.createElement("div");a.id=this.div.id+"_bb";a.className="olBackBuffer";a.style.position="absolute";var b=this.map;a.style.zIndex=this.transitionEffect==="resize"?this.getZIndex()-1:b.Z_INDEX_BASE.BaseLayer-
(b.getNumLayers()-b.getLayerIndex(this));for(var b=0,c=this.grid.length;b<c;b++)for(var d=0,e=this.grid[b].length;d<e;d++){var f=this.grid[b][d],g=this.grid[b][d].createBackBuffer();if(g){g._i=b;g._j=d;g._w=f.size.w;g._h=f.size.h;g.id=f.id+"_bb";a.appendChild(g)}}}return a},removeBackBuffer:function(){if(this._transitionElement){for(var a=this.transitionendEvents.length-1;a>=0;--a)OpenLayers.Event.stopObserving(this._transitionElement,this.transitionendEvents[a],this._removeBackBuffer);delete this._transitionElement}if(this.backBuffer){this.backBuffer.parentNode&&
this.backBuffer.parentNode.removeChild(this.backBuffer);this.backBufferResolution=this.backBuffer=null;if(this.backBufferTimerId!==null){window.clearTimeout(this.backBufferTimerId);this.backBufferTimerId=null}}},moveByPx:function(){this.singleTile||this.moveGriddedTiles()},setTileSize:function(a){if(this.singleTile){a=this.map.getSize();a.h=parseInt(a.h*this.ratio,10);a.w=parseInt(a.w*this.ratio,10)}OpenLayers.Layer.HTTPRequest.prototype.setTileSize.apply(this,[a])},getTilesBounds:function(){var a=
null,b=this.grid.length;if(b)var a=this.grid[b-1][0].bounds,b=this.grid[0].length*a.getWidth(),c=this.grid.length*a.getHeight(),a=new OpenLayers.Bounds(a.left,a.bottom,a.left+b,a.bottom+c);return a},initSingleTile:function(a){this.events.triggerEvent("retile");var b=a.getCenterLonLat(),c=a.getWidth()*this.ratio,a=a.getHeight()*this.ratio,b=new OpenLayers.Bounds(b.lon-c/2,b.lat-a/2,b.lon+c/2,b.lat+a/2),c=this.map.getLayerPxFromLonLat({lon:b.left,lat:b.top});this.grid.length||(this.grid[0]=[]);if(a=
this.grid[0][0])a.moveTo(b,c);else{a=this.addTile(b,c);this.addTileMonitoringHooks(a);a.draw();this.grid[0][0]=a}this.removeExcessTiles(1,1);this.gridResolution=this.getServerResolution()},calculateGridLayout:function(a,b,c){var d=c*this.tileSize.w,c=c*this.tileSize.h,e=Math.floor((a.left-b.lon)/d)-this.buffer,f=this.rowSign,a=Math[~f?"floor":"ceil"](f*(b.lat-a.top+c)/c)-this.buffer*f;return{tilelon:d,tilelat:c,startcol:e,startrow:a}},getTileOrigin:function(){var a=this.tileOrigin;if(!a)var a=this.getMaxExtent(),
b={tl:["left","top"],tr:["right","top"],bl:["left","bottom"],br:["right","bottom"]}[this.tileOriginCorner],a=new OpenLayers.LonLat(a[b[0]],a[b[1]]);return a},getTileBoundsForGridIndex:function(a,b){var c=this.getTileOrigin(),d=this.gridLayout,e=d.tilelon,f=d.tilelat,g=d.startcol,d=d.startrow,h=this.rowSign;return new OpenLayers.Bounds(c.lon+(g+b)*e,c.lat-(d+a*h)*f*h,c.lon+(g+b+1)*e,c.lat-(d+(a-1)*h)*f*h)},initGriddedTiles:function(a){this.events.triggerEvent("retile");var b=this.map.getSize(),c=this.getTileOrigin(),
d=this.map.getResolution(),e=this.getServerResolution(),f=d/e,d=this.tileSize.w/f,f=this.tileSize.h/f,g=Math.ceil(b.h/f)+2*this.buffer+1,b=Math.ceil(b.w/d)+2*this.buffer+1;this.gridLayout=e=this.calculateGridLayout(a,c,e);var c=e.tilelon,h=e.tilelat,e=this.map.layerContainerOriginPx.x,j=this.map.layerContainerOriginPx.y,l=this.getTileBoundsForGridIndex(0,0),m=this.map.getViewPortPxFromLonLat(new OpenLayers.LonLat(l.left,l.top));m.x=Math.round(m.x)-e;m.y=Math.round(m.y)-j;var e=[],j=this.map.getCenter(),
n=0;do{var o=this.grid[n];if(!o){o=[];this.grid.push(o)}var p=0;do{var l=this.getTileBoundsForGridIndex(n,p),q=m.clone();q.x=q.x+p*Math.round(d);q.y=q.y+n*Math.round(f);var r=o[p];if(r)r.moveTo(l,q,false);else{r=this.addTile(l,q);this.addTileMonitoringHooks(r);o.push(r)}q=l.getCenterLonLat();e.push({tile:r,distance:Math.pow(q.lon-j.lon,2)+Math.pow(q.lat-j.lat,2)});p=p+1}while(l.right<=a.right+c*this.buffer||p<b);n=n+1}while(l.bottom>=a.bottom-h*this.buffer||n<g);this.removeExcessTiles(n,p);this.gridResolution=
d=this.getServerResolution();e.sort(function(a,b){return a.distance-b.distance});a=0;for(d=e.length;a<d;++a)e[a].tile.draw()},getMaxExtent:function(){return this.maxExtent},addTile:function(a,b){var c=new this.tileClass(this,b,a,null,this.tileSize,this.tileOptions);this.events.triggerEvent("addtile",{tile:c});return c},addTileMonitoringHooks:function(a){a.onLoadStart=function(){if(this.loading===false){this.loading=true;this.events.triggerEvent("loadstart")}this.events.triggerEvent("tileloadstart",
{tile:a});this.numLoadingTiles++;!this.singleTile&&(this.backBuffer&&this.gridResolution===this.backBufferResolution)&&OpenLayers.Element.addClass(a.getTile(),"olTileReplacing")};a.onLoadEnd=function(b){this.numLoadingTiles--;b=b.type==="unload";this.events.triggerEvent("tileloaded",{tile:a,aborted:b});if(!this.singleTile&&!b&&this.backBuffer&&this.gridResolution===this.backBufferResolution){var c=a.getTile();if(OpenLayers.Element.getStyle(c,"display")==="none"){var d=document.getElementById(a.id+
"_bb");d&&d.parentNode.removeChild(d)}OpenLayers.Element.removeClass(c,"olTileReplacing")}if(this.numLoadingTiles===0){if(this.backBuffer)if(this.backBuffer.childNodes.length===0)this.removeBackBuffer();else{this._transitionElement=b?this.div.lastChild:a.imgDiv;b=this.transitionendEvents;for(c=b.length-1;c>=0;--c)OpenLayers.Event.observe(this._transitionElement,b[c],this._removeBackBuffer);this.backBufferTimerId=window.setTimeout(this._removeBackBuffer,this.removeBackBufferDelay)}this.loading=false;
this.events.triggerEvent("loadend")}};a.onLoadError=function(){this.events.triggerEvent("tileerror",{tile:a})};a.events.on({loadstart:a.onLoadStart,loadend:a.onLoadEnd,unload:a.onLoadEnd,loaderror:a.onLoadError,scope:this})},removeTileMonitoringHooks:function(a){a.unload();a.events.un({loadstart:a.onLoadStart,loadend:a.onLoadEnd,unload:a.onLoadEnd,loaderror:a.onLoadError,scope:this})},moveGriddedTiles:function(){for(var a=this.buffer+1;;){var b=this.grid[0][0],c=b.position.x+this.map.layerContainerOriginPx.x,
b=b.position.y+this.map.layerContainerOriginPx.y,d=this.getServerResolution()/this.map.getResolution(),d={w:Math.round(this.tileSize.w*d),h:Math.round(this.tileSize.h*d)};if(c>-d.w*(a-1))this.shiftColumn(true,d);else if(c<-d.w*a)this.shiftColumn(false,d);else if(b>-d.h*(a-1))this.shiftRow(true,d);else if(b<-d.h*a)this.shiftRow(false,d);else break}},shiftRow:function(a,b){var c=this.grid,d=a?0:c.length-1,e=a?-1:1;this.gridLayout.startrow=this.gridLayout.startrow+e*this.rowSign;for(var f=c[d],g=c[a?
"pop":"shift"](),h=0,j=g.length;h<j;h++){var l=g[h],m=f[h].position.clone();m.y=m.y+b.h*e;l.moveTo(this.getTileBoundsForGridIndex(d,h),m)}c[a?"unshift":"push"](g)},shiftColumn:function(a,b){var c=this.grid,d=a?0:c[0].length-1,e=a?-1:1;this.gridLayout.startcol=this.gridLayout.startcol+e;for(var f=0,g=c.length;f<g;f++){var h=c[f],j=h[d].position.clone(),l=h[a?"pop":"shift"]();j.x=j.x+b.w*e;l.moveTo(this.getTileBoundsForGridIndex(f,d),j);h[a?"unshift":"push"](l)}},removeExcessTiles:function(a,b){for(var c,
d;this.grid.length>a;){var e=this.grid.pop();c=0;for(d=e.length;c<d;c++){var f=e[c];this.destroyTile(f)}}c=0;for(d=this.grid.length;c<d;c++)for(;this.grid[c].length>b;){e=this.grid[c];f=e.pop();this.destroyTile(f)}},onMapResize:function(){if(this.singleTile){this.clearGrid();this.setTileSize()}},getTileBounds:function(a){var b=this.maxExtent,c=this.getResolution(),d=c*this.tileSize.w,c=c*this.tileSize.h,e=this.getLonLatFromViewPortPx(a),a=b.left+d*Math.floor((e.lon-b.left)/d),b=b.bottom+c*Math.floor((e.lat-
...
"PROPERTIES");d.appendChild(e);a=a.get_image.properties;if(a.featurecoordsys!=null){d=this.createElementNS("","FEATURECOORDSYS");e.appendChild(d);a.featurecoordsys.id===0?d.setAttribute("string",a.featurecoordsys.string):d.setAttribute("id",a.featurecoordsys.id)}if(a.filtercoordsys!=null){d=this.createElementNS("","FILTERCOORDSYS");e.appendChild(d);a.filtercoordsys.id===0?d.setAttribute("string",a.filtercoordsys.string):d.setAttribute("id",a.filtercoordsys.id)}if(a.envelope!=null){d=this.createElementNS("",
"ENVELOPE");e.appendChild(d);d.setAttribute("minx",a.envelope.minx);d.setAttribute("miny",a.envelope.miny);d.setAttribute("maxx",a.envelope.maxx);d.setAttribute("maxy",a.envelope.maxy)}d=this.createElementNS("","IMAGESIZE");e.appendChild(d);d.setAttribute("height",a.imagesize.height);d.setAttribute("width",a.imagesize.width);if(a.imagesize.height!=a.imagesize.printheight||a.imagesize.width!=a.imagesize.printwidth){d.setAttribute("printheight",a.imagesize.printheight);d.setArrtibute("printwidth",a.imagesize.printwidth)}if(a.background!=
null){d=this.createElementNS("","BACKGROUND");e.appendChild(d);d.setAttribute("color",a.background.color.r+","+a.background.color.g+","+a.background.color.b);a.background.transcolor!==null&&d.setAttribute("transcolor",a.background.transcolor.r+","+a.background.transcolor.g+","+a.background.transcolor.b)}if(a.layerlist!=null&&a.layerlist.length>0){d=this.createElementNS("","LAYERLIST");e.appendChild(d);for(e=0;e<a.layerlist.length;e++){var f=this.createElementNS("","LAYERDEF");d.appendChild(f);f.setAttribute("id",
a.layerlist[e].id);f.setAttribute("visible",a.layerlist[e].visible);if(typeof a.layerlist[e].query=="object"){var g=a.layerlist[e].query;if(g.where.length<0)continue;var h=null,h=typeof g.spatialfilter=="boolean"&&g.spatialfilter?this.createElementNS("","SPATIALQUERY"):this.createElementNS("","QUERY");h.setAttribute("where",g.where);typeof g.accuracy=="number"&&g.accuracy>0&&h.setAttribute("accuracy",g.accuracy);typeof g.featurelimit=="number"&&g.featurelimit<2E3&&h.setAttribute("featurelimit",g.featurelimit);
typeof g.subfields=="string"&&g.subfields!="#ALL#"&&h.setAttribute("subfields",g.subfields);typeof g.joinexpression=="string"&&g.joinexpression.length>0&&h.setAttribute("joinexpression",g.joinexpression);typeof g.jointables=="string"&&g.jointables.length>0&&h.setAttribute("jointables",g.jointables);f.appendChild(h)}typeof a.layerlist[e].renderer=="object"&&this.addRenderer(f,a.layerlist[e].renderer)}}}else if(a.get_feature!=null){d=this.createElementNS("","GET_FEATURES");d.setAttribute("outputmode",
"newxml");d.setAttribute("checkesc","true");a.get_feature.geometry?d.setAttribute("geometry",a.get_feature.geometry):d.setAttribute("geometry","false");a.get_feature.compact&&d.setAttribute("compact",a.get_feature.compact);a.get_feature.featurelimit=="number"&&d.setAttribute("featurelimit",a.get_feature.featurelimit);d.setAttribute("globalenvelope","true");c.appendChild(d);if(a.get_feature.layer!=null&&a.get_feature.layer.length>0){e=this.createElementNS("","LAYER");e.setAttribute("id",a.get_feature.layer);
d.appendChild(e)}a=a.get_feature.query;if(a!=null){e=null;e=a.isspatial?this.createElementNS("","SPATIALQUERY"):this.createElementNS("","QUERY");d.appendChild(e);typeof a.accuracy=="number"&&e.setAttribute("accuracy",a.accuracy);if(a.featurecoordsys!=null){d=this.createElementNS("","FEATURECOORDSYS");a.featurecoordsys.id==0?d.setAttribute("string",a.featurecoordsys.string):d.setAttribute("id",a.featurecoordsys.id);e.appendChild(d)}if(a.filtercoordsys!=null){d=this.createElementNS("","FILTERCOORDSYS");
a.filtercoordsys.id===0?d.setAttribute("string",a.filtercoordsys.string):d.setAttribute("id",a.filtercoordsys.id);e.appendChild(d)}if(a.buffer>0){d=this.createElementNS("","BUFFER");d.setAttribute("distance",a.buffer);e.appendChild(d)}if(a.isspatial){d=this.createElementNS("","SPATIALFILTER");d.setAttribute("relation",a.spatialfilter.relation);e.appendChild(d);if(a.spatialfilter.envelope){f=this.createElementNS("","ENVELOPE");f.setAttribute("minx",a.spatialfilter.envelope.minx);f.setAttribute("miny",
a.spatialfilter.envelope.miny);f.setAttribute("maxx",a.spatialfilter.envelope.maxx);f.setAttribute("maxy",a.spatialfilter.envelope.maxy);d.appendChild(f)}else typeof a.spatialfilter.polygon=="object"&&d.appendChild(this.writePolygonGeometry(a.spatialfilter.polygon))}a.where!=null&&a.where.length>0&&e.setAttribute("where",a.where)}}b.appendChild(c);return OpenLayers.Format.XML.prototype.write.apply(this,[b])},addGroupRenderer:function(a,b){var c=this.createElementNS("","GROUPRENDERER");a.appendChild(c);
for(var d=0;d<b.length;d++)this.addRenderer(c,b[d])},addRenderer:function(a,b){if(OpenLayers.Util.isArray(b))this.addGroupRenderer(a,b);else{var c=this.createElementNS("",b.type.toUpperCase()+"RENDERER");a.appendChild(c);c.tagName=="VALUEMAPRENDERER"?this.addValueMapRenderer(c,b):c.tagName=="VALUEMAPLABELRENDERER"?this.addValueMapLabelRenderer(c,b):c.tagName=="SIMPLELABELRENDERER"?this.addSimpleLabelRenderer(c,b):c.tagName=="SCALEDEPENDENTRENDERER"&&this.addScaleDependentRenderer(c,b)}},addScaleDependentRenderer:function(a,
b){(typeof b.lower=="string"||typeof b.lower=="number")&&a.setAttribute("lower",b.lower);(typeof b.upper=="string"||typeof b.upper=="number")&&a.setAttribute("upper",b.upper);this.addRenderer(a,b.renderer)},addValueMapLabelRenderer:function(a,b){a.setAttribute("lookupfield",b.lookupfield);a.setAttribute("labelfield",b.labelfield);if(typeof b.exacts=="object")for(var c=0,d=b.exacts.length;c<d;c++){var e=b.exacts[c],f=this.createElementNS("","EXACT");typeof e.value=="string"&&f.setAttribute("value",
e.value);typeof e.label=="string"&&f.setAttribute("label",e.label);typeof e.method=="string"&&f.setAttribute("method",e.method);a.appendChild(f);if(typeof e.symbol=="object"){var g=null;e.symbol.type=="text"&&(g=this.createElementNS("","TEXTSYMBOL"));if(g!=null){for(var h=this.fontStyleKeys,j=0,l=h.length;j<l;j++){var m=h[j];e.symbol[m]&&g.setAttribute(m,e.symbol[m])}f.appendChild(g)}}}},addValueMapRenderer:function(a,b){a.setAttribute("lookupfield",b.lookupfield);if(typeof b.ranges=="object")for(var c=
0,d=b.ranges.length;c<d;c++){var e=b.ranges[c],f=this.createElementNS("","RANGE");f.setAttribute("lower",e.lower);f.setAttribute("upper",e.upper);a.appendChild(f);if(typeof e.symbol=="object"){var g=null;e.symbol.type=="simplepolygon"&&(g=this.createElementNS("","SIMPLEPOLYGONSYMBOL"));if(g!=null){typeof e.symbol.boundarycolor=="string"&&g.setAttribute("boundarycolor",e.symbol.boundarycolor);typeof e.symbol.fillcolor=="string"&&g.setAttribute("fillcolor",e.symbol.fillcolor);typeof e.symbol.filltransparency==
"number"&&g.setAttribute("filltransparency",e.symbol.filltransparency);f.appendChild(g)}}}else if(typeof b.exacts=="object"){c=0;for(d=b.exacts.length;c<d;c++){e=b.exacts[c];f=this.createElementNS("","EXACT");typeof e.value=="string"&&f.setAttribute("value",e.value);typeof e.label=="string"&&f.setAttribute("label",e.label);typeof e.method=="string"&&f.setAttribute("method",e.method);a.appendChild(f);if(typeof e.symbol=="object"){g=null;e.symbol.type=="simplemarker"&&(g=this.createElementNS("","SIMPLEMARKERSYMBOL"));
if(g!=null){typeof e.symbol.antialiasing=="string"&&g.setAttribute("antialiasing",e.symbol.antialiasing);typeof e.symbol.color=="string"&&g.setAttribute("color",e.symbol.color);typeof e.symbol.outline=="string"&&g.setAttribute("outline",e.symbol.outline);typeof e.symbol.overlap=="string"&&g.setAttribute("overlap",e.symbol.overlap);typeof e.symbol.shadow=="string"&&g.setAttribute("shadow",e.symbol.shadow);typeof e.symbol.transparency=="number"&&g.setAttribute("transparency",e.symbol.transparency);
typeof e.symbol.usecentroid=="string"&&g.setAttribute("usecentroid",e.symbol.usecentroid);typeof e.symbol.width=="number"&&g.setAttribute("width",e.symbol.width);f.appendChild(g)}}}}},addSimpleLabelRenderer:function(a,b){a.setAttribute("field",b.field);for(var c=["featureweight","howmanylabels","labelbufferratio","labelpriorities","labelweight","linelabelposition","rotationalangles"],d=0,e=c.length;d<e;d++){var f=c[d];b[f]&&a.setAttribute(f,b[f])}if(b.symbol.type=="text"){var g=b.symbol,h=this.createElementNS("",
"TEXTSYMBOL");a.appendChild(h);c=this.fontStyleKeys;d=0;for(e=c.length;d<e;d++){f=c[d];g[f]&&h.setAttribute(f,b[f])}}},writePolygonGeometry:function(a){if(!(a instanceof OpenLayers.Geometry.Polygon))throw{message:"Cannot write polygon geometry to ArcXML with an "+a.CLASS_NAME+" object.",geometry:a};for(var b=this.createElementNS("","POLYGON"),c=0,d=a.components.length;c<d;c++){for(var e=a.components[c],f=this.createElementNS("","RING"),g=0,h=e.components.length;g<h;g++){var j=e.components[g],l=this.createElementNS("",
"POINT");l.setAttribute("x",j.x);l.setAttribute("y",j.y);f.appendChild(l)}b.appendChild(f)}return b},parseResponse:function(a){typeof a=="string"&&(a=(new OpenLayers.Format.XML).read(a));var b=new OpenLayers.Format.ArcXML.Response,c=a.getElementsByTagName("ERROR");if(c!=null&&c.length>0)b.error=this.getChildValue(c,"Unknown error.");else{c=a.getElementsByTagName("RESPONSE");if(c==null||c.length==0){b.error="No RESPONSE tag found in ArcXML response.";return b}var d=c[0].firstChild.nodeName;if(d=="#text")d=
c[0].firstChild.nextSibling.nodeName;if(d=="IMAGE"){c=a.getElementsByTagName("ENVELOPE");a=a.getElementsByTagName("OUTPUT");if(c==null||c.length==0)b.error="No ENVELOPE tag found in ArcXML response.";else if(a==null||a.length==0)b.error="No OUTPUT tag found in ArcXML response.";else{c=this.parseAttributes(c[0]);d=this.parseAttributes(a[0]);b.image=typeof d.type=="string"?{envelope:c,output:{type:d.type,data:this.getChildValue(a[0])}}:{envelope:c,output:d}}}else if(d=="FEATURES"){a=c[0].getElementsByTagName("FEATURES");
c=a[0].getElementsByTagName("FEATURECOUNT");b.features.featurecount=c[0].getAttribute("count");if(b.features.featurecount>0){c=a[0].getElementsByTagName("ENVELOPE");b.features.envelope=this.parseAttributes(c[0],"number");a=a[0].getElementsByTagName("FEATURE");for(c=0;c<a.length;c++){for(var d=new OpenLayers.Feature.Vector,e=a[c].getElementsByTagName("FIELD"),f=0;f<e.length;f++){var g=e[f].getAttribute("name"),h=e[f].getAttribute("value");d.attributes[g]=h}e=a[c].getElementsByTagName("POLYGON");if(e.length>
0){e=e[0].getElementsByTagName("RING");f=[];for(g=0;g<e.length;g++){h=[];h.push(this.parsePointGeometry(e[g]));for(var j=e[g].getElementsByTagName("HOLE"),l=0;l<j.length;l++)h.push(this.parsePointGeometry(j[l]));f.push(new OpenLayers.Geometry.Polygon(h))}d.geometry=f.length==1?f[0]:new OpenLayers.Geometry.MultiPolygon(f)}b.features.feature.push(d)}}}else b.error="Unidentified response type."}return b},parseAttributes:function(a,b){for(var c={},d=0;d<a.attributes.length;d++)c[a.attributes[d].nodeName]=
b=="number"?parseFloat(a.attributes[d].nodeValue):a.attributes[d].nodeValue;return c},parsePointGeometry:function(a){var b=[],c=a.getElementsByTagName("COORDS");if(c.length>0){a=this.getChildValue(c[0]);a=a.split(/;/);for(c=0;c<a.length;c++){var d=a[c].split(/ /);b.push(new OpenLayers.Geometry.Point(d[0],d[1]))}}else{a=a.getElementsByTagName("POINT");if(a.length>0)for(c=0;c<a.length;c++)b.push(new OpenLayers.Geometry.Point(parseFloat(a[c].getAttribute("x")),parseFloat(a[c].getAttribute("y"))))}return new OpenLayers.Geometry.LinearRing(b)},
...
(function(){function a(){this._object=f&&!j?new f:new window.ActiveXObject("Microsoft.XMLHTTP");this._listeners=[]}function b(){return new a}function c(a){b.onreadystatechange&&b.onreadystatechange.apply(a);a.dispatchEvent({type:"readystatechange",bubbles:false,cancelable:false,timeStamp:new Date+0})}function d(a){try{a.responseText=a._object.responseText}catch(b){}try{var c;var d=a._object,e=d.responseXML,f=d.responseText;if(h&&f&&e&&!e.documentElement&&d.getResponseHeader("Content-Type").match(/[^\/]+\/[^\+]+\+xml/)){e=
...
b.prototype=a.prototype;if(g&&f.wrapped)b.wrapped=f.wrapped;b.UNSENT=0;b.OPENED=1;b.HEADERS_RECEIVED=2;b.LOADING=3;b.DONE=4;b.prototype.readyState=b.UNSENT;b.prototype.responseText="";b.prototype.responseXML=null;b.prototype.status=0;b.prototype.statusText="";b.prototype.priority="NORMAL";b.prototype.onreadystatechange=null;b.onreadystatechange=null;b.onopen=null;b.onsend=null;b.onabort=null;b.prototype.open=function(a,f,j,o,p){delete this._headers;arguments.length<3&&(j=true);this._async=j;var q=
this,r=this.readyState,s;if(h&&j){s=function(){if(r!=b.DONE){e(q);q.abort()}};window.attachEvent("onunload",s)}b.onopen&&b.onopen.apply(this,arguments);arguments.length>4?this._object.open(a,f,j,o,p):arguments.length>3?this._object.open(a,f,j,o):this._object.open(a,f,j);this.readyState=b.OPENED;c(this);this._object.onreadystatechange=function(){if(!g||j){q.readyState=q._object.readyState;d(q);if(q._aborted)q.readyState=b.UNSENT;else{if(q.readyState==b.DONE){delete q._data;e(q);h&&j&&window.detachEvent("onunload",
...
b[3],b[4]);delete a.__func};if(!OpenLayers.Request)OpenLayers.Request={};OpenLayers.Request.XMLHttpRequest=b})();OpenLayers.ProxyHost="";OpenLayers.Request||(OpenLayers.Request={});
...
async:true,data:a.write(),callback:function(a){var e=a.responseXML;if(!e||!e.documentElement)e=a.responseText;a=(new OpenLayers.Format.ArcXML).read(e);b.call(c,this.getUrlOrImage(a.image.output))},scope:this})},getUrlOrImage:function(a){var b="";a.url?b=a.url:a.data&&(b="data:image/"+a.type+";base64,"+a.data);return b},setLayerQuery:function(a,b){for(var c=0;c<this.options.layers.length;c++)if(a==this.options.layers[c].id){this.options.layers[c].query=b;return}this.options.layers.push({id:a,visible:true,
...
b.query.accuracy;else{a=this.map.getCenter();c=this.map.getViewPortPxFromLonLat(a);c.x++;c=this.map.getLonLatFromPixel(c);h.request.get_feature.query.accuracy=c.lon-a.lon}h.request.get_feature.query.where=b.query.where;h.request.get_feature.query.spatialfilter.relation="area_intersection";OpenLayers.Request.POST({url:this.getFullRequestString({CustomService:"Query"}),data:h.write(),callback:function(a){a=h.parseResponse(a.responseText);h.iserror()?e.call(f,null):e.call(f,a.features)}})},clone:function(a){a==
null&&(a=new OpenLayers.Layer.ArcIMS(this.name,this.url,this.getOptions()));return a=OpenLayers.Layer.Grid.prototype.clone.apply(this,[a])},CLASS_NAME:"OpenLayers.Layer.ArcIMS"});
...
setMap:function(a){OpenLayers.Control.prototype.setMap.apply(this,arguments);this.map.events.register("buttonclick",this,this.onButtonClick)},draw:function(a){OpenLayers.Control.prototype.draw.apply(this,arguments);a=this.position;this.buttons=[];var b={w:20,h:14},c={w:40,h:14},d=new OpenLayers.Pixel(a.x+b.w/2,a.y),e=new OpenLayers.Pixel(a.x,a.y);this._addButton("panup","north-mini.png",e,c);a.y=d.y+b.h;this._addButton("panleft","west-mini.png",a,b);this._addButton("panright","east-mini.png",a.add(b.w,
0),b);this._addButton("pandown","south-mini.png",e.add(0,b.h*2),c);this._addButton("zoomin","zoom-plus-mini.png",d.add(0,b.h*3+5),b);this._addButton("zoomout","zoom-minus-mini.png",d.add(0,b.h*4+5),b);return this.div},_addButton:function(a,b,c,d){b=OpenLayers.Util.getImageLocation(b);c=OpenLayers.Util.createAlphaImageDiv(this.id+"_"+a,c,d,b,"absolute");c.style.cursor="pointer";this.div.appendChild(c);c.action=a;c.className="olButton";this.buttons.push(c);return c},_removeButton:function(a){this.div.removeChild(a);
...
OpenLayers.Control.PanZoomBar=OpenLayers.Class(OpenLayers.Control.PanZoom,{zoomStopWidth:10,zoomStopHeight:11,slider:null,sliderEvents:null,zoombarDiv:null,zoomWorldIcon:!1,panIcons:!0,forceFixedZoomLevel:!1,mouseDragStart:null,deltaY:null,zoomStart:null,destroy:function(){this._removeZoomBar();this.map.events.un({changebaselayer:this.redraw,updatesize:this.redraw,scope:this});OpenLayers.Control.PanZoom.prototype.destroy.apply(this,arguments);delete this.mouseDragStart;delete this.zoomStart},setMap:function(a){OpenLayers.Control.PanZoom.prototype.setMap.apply(this,
arguments);this.map.events.on({changebaselayer:this.redraw,updatesize:this.redraw,scope:this})},redraw:function(){if(this.div!=null){this.removeButtons();this._removeZoomBar()}this.draw()},draw:function(a){OpenLayers.Control.prototype.draw.apply(this,arguments);a=this.position.clone();this.buttons=[];var b={w:20,h:14},c={w:40,h:14};if(this.panIcons){var d=new OpenLayers.Pixel(a.x+b.w/2,a.y),e=new OpenLayers.Pixel(a.x,a.y),f=b.w;this.zoomWorldIcon&&(d=new OpenLayers.Pixel(a.x+b.w,a.y));this._addButton("panup",
"../../lib/img/north-mini.png",e,c);a.y=d.y+b.h;this._addButton("panleft","../../lib/img/west-mini.png",a,b);if(this.zoomWorldIcon){this._addButton("zoomworld","../../lib/img/zoom-world-mini.png",a.add(b.w,0),b);f=f*2}this._addButton("panright","../../lib/img/east-mini.png",a.add(f,0),b);this._addButton("pandown","../../lib/img/south-mini.png",e.add(0,b.h*2),c);this._addButton("zoomin","../../lib/img/zoom-plus-mini.png",d.add(0,b.h*3+5),b);d=this._addZoomBar(d.add(0,b.h*4+5));this._addButton("zoomout",
"../../lib/img/zoom-minus-mini.png",d,b)}else{this._addButton("zoomin","../../lib/img/zoom-plus-mini.png",a,b);d=this._addZoomBar(a.add(0,b.h));this._addButton("zoomout","../../lib/img/zoom-minus-mini.png",d,b);if(this.zoomWorldIcon){d=d.add(0,b.h+3);this._addButton("zoomworld","../../lib/img/zoom-world-mini.png",d,b)}}return this.div},_addZoomBar:function(a){var b=OpenLayers.Util.getImageLocation("../../lib/img/slider.png"),c=this.id+"_"+this.map.id,d=this.map.getMinZoom(),e=this.map.getNumZoomLevels()-
1-this.map.getZoom(),e=OpenLayers.Util.createAlphaImageDiv(c,a.add(0,e*this.zoomStopHeight),{w:20,h:9},b,"absolute");e.style.cursor="move";this.slider=e;this.sliderEvents=new OpenLayers.Events(this,e,null,true,{includeXY:true});this.sliderEvents.on({touchstart:this.zoomBarDown,touchmove:this.zoomBarDrag,touchend:this.zoomBarUp,mousedown:this.zoomBarDown,mousemove:this.zoomBarDrag,mouseup:this.zoomBarUp});var f={w:this.zoomStopWidth,h:this.zoomStopHeight*(this.map.getNumZoomLevels()-d)},b=OpenLayers.Util.getImageLocation("../../lib/img/zoombar.png"),
c=null;if(OpenLayers.Util.alphaHack()){c=this.id+"_"+this.map.id;c=OpenLayers.Util.createAlphaImageDiv(c,a.add(5,0),{w:f.w,h:this.zoomStopHeight},b,"absolute",null,"crop");c.style.height=f.h+"px"}else c=OpenLayers.Util.createDiv("OpenLayers_Control_PanZoomBar_Zoombar"+this.map.id,a.add(5,0),f,b);c.style.cursor="pointer";c.className="olButton";this.zoombarDiv=c;this.div.appendChild(c);this.startTop=parseInt(c.style.top);this.div.appendChild(e);this.map.events.register("zoomend",this,this.moveZoomBar);
return a=a.add(0,this.zoomStopHeight*(this.map.getNumZoomLevels()-d))},_removeZoomBar:function(){this.sliderEvents.un({touchstart:this.zoomBarDown,touchmove:this.zoomBarDrag,touchend:this.zoomBarUp,mousedown:this.zoomBarDown,mousemove:this.zoomBarDrag,mouseup:this.zoomBarUp});this.sliderEvents.destroy();this.div.removeChild(this.zoombarDiv);this.zoombarDiv=null;this.div.removeChild(this.slider);this.slider=null;this.map.events.unregister("zoomend",this,this.moveZoomBar)},onButtonClick:function(a){OpenLayers.Control.PanZoom.prototype.onButtonClick.apply(this,
...
mouseup:this.passEventToSlider,scope:this});this.mouseDragStart=a.xy.clone();this.zoomStart=a.xy.clone();this.div.style.cursor="move";this.zoombarDiv.offsets=null;OpenLayers.Event.stop(a)}},zoomBarDrag:function(a){if(this.mouseDragStart!=null){var b=this.mouseDragStart.y-a.xy.y,c=OpenLayers.Util.pagePosition(this.zoombarDiv);if(a.clientY-c[1]>0&&a.clientY-c[1]<parseInt(this.zoombarDiv.style.height)-2){b=parseInt(this.slider.style.top)-b;this.slider.style.top=b+"px";this.mouseDragStart=a.xy.clone()}this.deltaY=
this.zoomStart.y-a.xy.y;OpenLayers.Event.stop(a)}},zoomBarUp:function(a){if((OpenLayers.Event.isLeftClick(a)||a.type==="touchend")&&this.mouseDragStart){this.div.style.cursor="";this.map.events.un({touchmove:this.passEventToSlider,mouseup:this.passEventToSlider,mousemove:this.passEventToSlider,scope:this});var b=this.map.zoom;if(!this.forceFixedZoomLevel&&this.map.fractionalZoom){b=b+this.deltaY/this.zoomStopHeight;b=Math.min(Math.max(b,0),this.map.getNumZoomLevels()-1)}else{b=b+this.deltaY/this.zoomStopHeight;
b=Math.max(Math.round(b),0)}this.map.zoomTo(b);this.zoomStart=this.mouseDragStart=null;this.deltaY=0;OpenLayers.Event.stop(a)}},moveZoomBar:function(){var a=(this.map.getNumZoomLevels()-1-this.map.getZoom())*this.zoomStopHeight+this.startTop+1;this.slider.style.top=a+"px"},CLASS_NAME:"OpenLayers.Control.PanZoomBar"});OpenLayers.Format.WFSCapabilities=OpenLayers.Class(OpenLayers.Format.XML.VersionedOGC,{defaultVersion:"1.1.0",CLASS_NAME:"OpenLayers.Format.WFSCapabilities"});
OpenLayers.Format.WFSCapabilities.v1=OpenLayers.Class(OpenLayers.Format.XML,{namespaces:{wfs:"http://www.opengis.net/wfs",xlink:"http://www.w3.org/1999/xlink",xsi:"http://www.w3.org/2001/XMLSchema-instance",ows:"http://www.opengis.net/ows"},errorProperty:"featureTypeList",defaultPrefix:"wfs",read:function(a){typeof a=="string"&&(a=OpenLayers.Format.XML.prototype.read.apply(this,[a]));if(a&&a.nodeType==9)a=a.documentElement;var b={};this.readNode(a,b);return b},readers:{wfs:{WFS_Capabilities:function(a,
b){this.readChildNodes(a,b)},FeatureTypeList:function(a,b){b.featureTypeList={featureTypes:[]};this.readChildNodes(a,b.featureTypeList)},FeatureType:function(a,b){var c={};this.readChildNodes(a,c);b.featureTypes.push(c)},Name:function(a,b){var c=this.getChildValue(a);if(c){c=c.split(":");b.name=c.pop();if(c.length>0)b.featureNS=this.lookupNamespaceURI(a,c[0])}},Title:function(a,b){var c=this.getChildValue(a);if(c)b.title=c},Abstract:function(a,b){var c=this.getChildValue(a);c&&(b["abstract"]=c)}}},
CLASS_NAME:"OpenLayers.Format.WFSCapabilities.v1"});OpenLayers.Format.WFSCapabilities.v1_1_0=OpenLayers.Class(OpenLayers.Format.WFSCapabilities.v1,{regExes:{trimSpace:/^\s*|\s*$/g,removeSpace:/\s*/g,splitSpace:/\s+/,trimComma:/\s*,\s*/g},readers:{wfs:OpenLayers.Util.applyDefaults({DefaultSRS:function(a,b){var c=this.getChildValue(a);if(c)b.srs=c}},OpenLayers.Format.WFSCapabilities.v1.prototype.readers.wfs),ows:OpenLayers.Format.OWSCommon.v1.prototype.readers.ows},CLASS_NAME:"OpenLayers.Format.WFSCapabilities.v1_1_0"});
...
var e=this.map.getLayerPxFromLonLat({lon:this.extent.left,lat:this.extent.top});if(d){this.tile=new OpenLayers.Tile.Image(this,e,this.extent,null,this.tileSize);this.addTileMonitoringHooks(this.tile)}else{this.tile.size=this.tileSize.clone();this.tile.position=e.clone()}this.tile.draw()}},setTileSize:function(){var a=this.extent.getWidth()/this.map.getResolution(),b=this.extent.getHeight()/this.map.getResolution();this.tileSize=new OpenLayers.Size(a,b)},addTileMonitoringHooks:function(a){a.onLoadStart=
...
this.events.triggerEvent("start",{features:a});var b=this.layer.projection,c=this.layer.map.getProjectionObject();if(!c.equals(b)){for(var d=a.length,e=Array(d),f,g,h=0;h<d;++h){f=a[h];g=f.clone();g.fid=f.fid;g.state=f.state;if(f.url)g.url=f.url;g._original=f;g.geometry.transform(c,b);e[h]=g}a=e}this.layer.protocol.commit(a,{callback:this.onCommit,scope:this})},onCommit:function(a){var b={response:a};if(a.success()){for(var c=a.reqFeatures,d,e=[],f=a.insertIds||[],g=0,h=0,j=c.length;h<j;++h){d=c[h];
d=d._original||d;if(a=d.state){if(a==OpenLayers.State.DELETE)e.push(d);else if(a==OpenLayers.State.INSERT){d.fid=f[g];++g}d.state=null}}e.length>0&&this.layer.destroyFeatures(e);this.events.triggerEvent("success",b)}else this.events.triggerEvent("fail",b)},CLASS_NAME:"OpenLayers.Strategy.Save"});
OpenLayers.Events.featureclick=OpenLayers.Class({cache:null,map:null,provides:["featureclick","nofeatureclick","featureover","featureout"],initialize:function(a){this.target=a;if(a.object instanceof OpenLayers.Map)this.setMap(a.object);else if(a.object instanceof OpenLayers.Layer.Vector)a.object.map?this.setMap(a.object.map):a.object.events.register("added",this,function(){this.setMap(a.object.map)});else throw"Listeners for '"+this.provides.join("', '")+"' events can only be registered for OpenLayers.Layer.Vector or OpenLayers.Map instances";
for(var b=this.provides.length-1;b>=0;--b)a.extensions[this.provides[b]]=true},setMap:function(a){this.map=a;this.cache={};a.events.register("mousedown",this,this.start,{extension:true});a.events.register("mouseup",this,this.onClick,{extension:true});a.events.register("touchstart",this,this.start,{extension:true});a.events.register("touchmove",this,this.cancel,{extension:true});a.events.register("touchend",this,this.onClick,{extension:true});a.events.register("mousemove",this,this.onMousemove,{extension:true})},
start:function(a){this.startEvt=a},cancel:function(){delete this.startEvt},onClick:function(a){if(this.startEvt&&(a.type==="touchend"||OpenLayers.Event.isLeftClick(a))){a=this.getFeatures(this.startEvt);delete this.startEvt;for(var b,c,d={},e=0,f=a.length;e<f;++e){b=a[e];c=b.layer;d[c.id]=true;b=this.triggerEvent("featureclick",{feature:b});if(b===false)break}e=0;for(f=this.map.layers.length;e<f;++e){c=this.map.layers[e];c instanceof OpenLayers.Layer.Vector&&!d[c.id]&&this.triggerEvent("nofeatureclick",
{layer:c})}}},onMousemove:function(a){delete this.startEvt;for(var b=this.getFeatures(a),c={},a=[],d,e=0,f=b.length;e<f;++e){d=b[e];c[d.id]=d;this.cache[d.id]||a.push(d)}var b=[],g;for(g in this.cache){d=this.cache[g];d.layer&&d.layer.map?c[d.id]||b.push(d):delete this.cache[g]}e=0;for(f=a.length;e<f;++e){d=a[e];this.cache[d.id]=d;g=this.triggerEvent("featureover",{feature:d});if(g===false)break}e=0;for(f=b.length;e<f;++e){d=b[e];delete this.cache[d.id];g=this.triggerEvent("featureout",{feature:d});
if(g===false)break}},triggerEvent:function(a,b){var c=b.feature?b.feature.layer:b.layer,d=this.target.object;if(d instanceof OpenLayers.Map||d===c)return this.target.triggerEvent(a,b)},getFeatures:function(a){var b=a.clientX,c=a.clientY,d=[],e=[],f=[],g,h,j,l;for(l=this.map.layers.length-1;l>=0;--l){g=this.map.layers[l];if(g.div.style.display!=="none")if(g.renderer instanceof OpenLayers.Renderer.Elements){if(g instanceof OpenLayers.Layer.Vector)for(h=document.elementFromPoint(b,c);h&&h._featureId;)if(j=
g.getFeatureById(h._featureId)){d.push(j);h.style.display="none";e.push(h);h=document.elementFromPoint(b,c)}else h=false;f.push(g);g.div.style.display="none"}else if(g.renderer instanceof OpenLayers.Renderer.Canvas)if(j=g.renderer.getFeatureIdFromEvent(a)){d.push(j);f.push(g)}}l=0;for(a=e.length;l<a;++l)e[l].style.display="";for(l=f.length-1;l>=0;--l)f[l].div.style.display="block";return d},destroy:function(){for(var a=this.provides.length-1;a>=0;--a)delete this.target.extensions[this.provides[a]];
...
[a])},read:function(a){typeof a=="string"&&(a=OpenLayers.Format.XML.prototype.read.apply(this,[a]));var b=[];if(this.extractTracks)for(var c=a.getElementsByTagName("trk"),d=0,e=c.length;d<e;d++){var f={};this.extractAttributes&&(f=this.parseAttributes(c[d]));for(var g=this.getElementsByTagNameNS(c[d],c[d].namespaceURI,"trkseg"),h=0,j=g.length;h<j;h++){var l=this.extractSegment(g[h],"trkpt");b.push(new OpenLayers.Feature.Vector(l,f))}}if(this.extractRoutes){e=a.getElementsByTagName("rte");c=0;for(d=
...
"name");c.appendChild(this.createTextNode(b.attributes.name||b.id));a.appendChild(c);c=this.createElementNS(this.namespaces.gpx,"desc");c.appendChild(this.createTextNode(b.attributes.description||this.defaultDesc));a.appendChild(c)},CLASS_NAME:"OpenLayers.Format.GPX"});OpenLayers.Format.WMSDescribeLayer=OpenLayers.Class(OpenLayers.Format.XML.VersionedOGC,{defaultVersion:"1.1.1",CLASS_NAME:"OpenLayers.Format.WMSDescribeLayer"});
OpenLayers.Format.WMSDescribeLayer.v1_1_1=OpenLayers.Class(OpenLayers.Format.WMSDescribeLayer,{initialize:function(a){OpenLayers.Format.WMSDescribeLayer.prototype.initialize.apply(this,[a])},read:function(a){typeof a=="string"&&(a=OpenLayers.Format.XML.prototype.read.apply(this,[a]));for(var b=a.documentElement.childNodes,c={layerDescriptions:[]},d,e,f=0;f<b.length;++f){d=b[f];e=d.nodeName;if(e=="LayerDescription"){e=d.getAttribute("name");var g="",h="",j="";if(d.getAttribute("owsType")){g=d.getAttribute("owsType");
h=d.getAttribute("owsURL")}else if(d.getAttribute("wfs")!=""){g="WFS";h=d.getAttribute("wfs")}else if(d.getAttribute("wcs")!=""){g="WCS";h=d.getAttribute("wcs")}d=d.getElementsByTagName("Query");if(d.length>0)(j=d[0].getAttribute("typeName"))||(j=d[0].getAttribute("typename"));d={layerName:e,owsType:g,owsURL:h,typeName:j};c.layerDescriptions.push(d);c.length=c.layerDescriptions.length;c[c.length-1]=d}else if(e=="ServiceException")return{error:(new OpenLayers.Format.OGCExceptionReport).read(a)}}return c},
CLASS_NAME:"OpenLayers.Format.WMSDescribeLayer.v1_1_1"});OpenLayers.Format.WMSDescribeLayer.v1_1_0=OpenLayers.Format.WMSDescribeLayer.v1_1_1;
...
OpenLayers.Util.extend({crossOriginKeyword:"anonymous"},this.options&&this.options.tileOptions)},clone:function(a){a==null&&(a=new OpenLayers.Layer.OSM(this.name,this.url,this.getOptions()));return a=OpenLayers.Layer.XYZ.prototype.clone.apply(this,[a])},CLASS_NAME:"OpenLayers.Layer.OSM"});
...
b,c){var d=new Image,e=b.title||b.graphicTitle;if(e)d.title=e;var f=b.graphicWidth||b.graphicHeight,g=b.graphicHeight||b.graphicWidth,f=f?f:b.pointRadius*2,g=g?g:b.pointRadius*2,h=b.graphicXOffset!=void 0?b.graphicXOffset:-(0.5*f),j=b.graphicYOffset!=void 0?b.graphicYOffset:-(0.5*g),l=b.graphicOpacity||b.fillOpacity;d.onload=OpenLayers.Function.bind(function(){if(this.features[c]){var b=this.getLocalXY(a),e=b[0],b=b[1];if(!isNaN(e)&&!isNaN(b)){var e=e+h|0,b=b+j|0,o=this.canvas;o.globalAlpha=l;var p=
OpenLayers.Renderer.Canvas.drawImageScaleFactor||(OpenLayers.Renderer.Canvas.drawImageScaleFactor=/android 2.1/.test(navigator.userAgent.toLowerCase())?320/window.screen.width:1);o.drawImage(d,e*p,b*p,f*p,g*p);if(this.hitDetection){this.setHitContextStyle("fill",c);this.hitContext.fillRect(e,b,f,g)}}}},this);d.src=b.externalGraphic},drawNamedSymbol:function(a,b,c){var d,e,f,g;f=Math.PI/180;var h=OpenLayers.Renderer.symbol[b.graphicName];if(!h)throw Error(b.graphicName+" is not a valid symbol name");
...
"center";this.canvas.textBaseline=OpenLayers.Renderer.Canvas.LABEL_ALIGN[b.labelAlign[1]]||"middle";var g=OpenLayers.Renderer.Canvas.LABEL_FACTOR[b.labelAlign[1]];g==null&&(g=-0.5);d=this.canvas.measureText("Mg").height||this.canvas.measureText("xx").width;c[1]=c[1]+d*g*(f-1);for(g=0;g<f;g++){if(b.labelOutlineWidth){this.canvas.save();this.canvas.globalAlpha=b.labelOutlineOpacity||b.fontOpacity||1;this.canvas.strokeStyle=b.labelOutlineColor;this.canvas.lineWidth=b.labelOutlineWidth;this.canvas.strokeText(e[g],
c[0],c[1]+d*g+1);this.canvas.restore()}this.canvas.fillText(e[g],c[0],c[1]+d*g)}}else if(this.canvas.mozDrawText){this.canvas.mozTextStyle=d;var h=OpenLayers.Renderer.Canvas.LABEL_FACTOR[b.labelAlign[0]];h==null&&(h=-0.5);g=OpenLayers.Renderer.Canvas.LABEL_FACTOR[b.labelAlign[1]];g==null&&(g=-0.5);d=this.canvas.mozMeasureText("xx");c[1]=c[1]+d*(1+g*f);for(g=0;g<f;g++){var j=c[0]+h*this.canvas.mozMeasureText(e[g]),l=c[1]+g*d;this.canvas.translate(j,l);this.canvas.mozDrawText(e[g]);this.canvas.translate(-j,
-l)}}this.setCanvasStyle("reset")},getLocalXY:function(a){var b=this.getResolution(),c=this.extent;return[(a.x-this.featureDx)/b+-c.left/b,c.top/b-a.y/b]},clear:function(){var a=this.root.height,b=this.root.width;this.canvas.clearRect(0,0,b,a);this.features={};this.hitDetection&&this.hitContext.clearRect(0,0,b,a)},getFeatureIdFromEvent:function(a){var b;if(this.hitDetection&&this.root.style.display!=="none"&&!this.map.dragging){a=a.xy;a=this.hitContext.getImageData(a.x|0,a.y|0,1,1).data;if(a[3]===
255)if(a=a[2]+256*(a[1]+256*a[0])){a="OpenLayers_Feature_Vector_"+(a-1+this.hitOverflow);try{b=this.features[a][0]}catch(c){}}}return b},eraseFeatures:function(a){OpenLayers.Util.isArray(a)||(a=[a]);for(var b=0;b<a.length;++b)delete this.features[a[b].id];this.redraw()},redraw:function(){if(!this.locked){var a=this.root.height,b=this.root.width;this.canvas.clearRect(0,0,b,a);this.hitDetection&&this.hitContext.clearRect(0,0,b,a);var a=[],c,d,e=this.map.baseLayer&&this.map.baseLayer.wrapDateLine&&this.map.getMaxExtent(),
f;for(f in this.features)if(this.features.hasOwnProperty(f)){b=this.features[f][0];c=b.geometry;this.calculateFeatureDx(c.getBounds(),e);d=this.features[f][1];this.drawGeometry(c,d,b.id);d.label&&a.push([b,d])}b=0;for(c=a.length;b<c;++b){f=a[b];this.drawText(f[0].geometry.getCentroid(),f[1])}}},CLASS_NAME:"OpenLayers.Renderer.Canvas"});OpenLayers.Renderer.Canvas.LABEL_ALIGN={l:"left",r:"right",t:"top",b:"bottom"};OpenLayers.Renderer.Canvas.LABEL_FACTOR={l:0,r:-1,t:0,b:-1};
OpenLayers.Renderer.Canvas.drawImageScaleFactor=null;
OpenLayers.Format.OSM=OpenLayers.Class(OpenLayers.Format.XML,{checkTags:!1,interestingTagsExclude:null,areaTags:null,initialize:function(a){for(var b={interestingTagsExclude:["source","source_ref","source:ref","history","attribution","created_by"],areaTags:["area","building","leisure","tourism","ruins","historic","landuse","military","natural","sport"]},b=OpenLayers.Util.extend(b,a),c={},a=0;a<b.interestingTagsExclude.length;a++)c[b.interestingTagsExclude[a]]=true;b.interestingTagsExclude=c;c={};
for(a=0;a<b.areaTags.length;a++)c[b.areaTags[a]]=true;b.areaTags=c;this.externalProjection=new OpenLayers.Projection("EPSG:4326");OpenLayers.Format.XML.prototype.initialize.apply(this,[b])},read:function(a){typeof a=="string"&&(a=OpenLayers.Format.XML.prototype.read.apply(this,[a]));for(var b=this.getNodes(a),c=this.getWays(a),a=Array(c.length),d=0;d<c.length;d++){for(var e=Array(c[d].nodes.length),f=this.isWayArea(c[d])?1:0,g=0;g<c[d].nodes.length;g++){var h=b[c[d].nodes[g]],j=new OpenLayers.Geometry.Point(h.lon,
h.lat);j.osm_id=parseInt(c[d].nodes[g]);e[g]=j;h.used=true}h=null;h=f?new OpenLayers.Geometry.Polygon(new OpenLayers.Geometry.LinearRing(e)):new OpenLayers.Geometry.LineString(e);this.internalProjection&&this.externalProjection&&h.transform(this.externalProjection,this.internalProjection);e=new OpenLayers.Feature.Vector(h,c[d].tags);e.osm_id=parseInt(c[d].id);e.fid="way."+e.osm_id;a[d]=e}for(var l in b){h=b[l];if(!h.used||this.checkTags){c=null;if(this.checkTags){c=this.getTags(h.node,true);if(h.used&&
!c[1])continue;c=c[0]}else c=this.getTags(h.node);e=new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Point(h.lon,h.lat),c);this.internalProjection&&this.externalProjection&&e.geometry.transform(this.externalProjection,this.internalProjection);e.osm_id=parseInt(l);e.fid="node."+e.osm_id;a.push(e)}h.node=null}return a},getNodes:function(a){for(var a=a.getElementsByTagName("node"),b={},c=0;c<a.length;c++){var d=a[c],e=d.getAttribute("id");b[e]={lat:d.getAttribute("lat"),lon:d.getAttribute("lon"),
...
deactivate:function(){var a=false;if(OpenLayers.Control.prototype.deactivate.apply(this,arguments)){this.moveLayerBack();this.map.events.un({removelayer:this.handleMapEvents,changelayer:this.handleMapEvents,scope:this});this.layer.removeFeatures(this.vertices,{silent:true});this.layer.removeFeatures(this.virtualVertices,{silent:true});this.vertices=[];this.handlers.drag.deactivate();this.handlers.keyboard.deactivate();(a=this.feature)&&(a.geometry&&a.layer)&&this.unselectFeature(a);a=true}return a},
beforeSelectFeature:function(a){return this.layer.events.triggerEvent("beforefeaturemodified",{feature:a})},selectFeature:function(a){if(!(this.feature===a||this.geometryTypes&&OpenLayers.Util.indexOf(this.geometryTypes,a.geometry.CLASS_NAME)==-1)){if(this.beforeSelectFeature(a)!==false){this.feature&&this.unselectFeature(this.feature);this.feature=a;this.layer.selectedFeatures.push(a);this.layer.drawFeature(a,"select");this.modified=false;this.resetVertices();this.onModificationStart(this.feature)}var b=
a.modified;if(a.geometry&&(!b||!b.geometry))this._originalGeometry=a.geometry.clone()}},unselectFeature:function(a){this.layer.removeFeatures(this.vertices,{silent:true});this.vertices=[];this.layer.destroyFeatures(this.virtualVertices,{silent:true});this.virtualVertices=[];if(this.dragHandle){this.layer.destroyFeatures([this.dragHandle],{silent:true});delete this.dragHandle}if(this.radiusHandle){this.layer.destroyFeatures([this.radiusHandle],{silent:true});delete this.radiusHandle}this.layer.drawFeature(this.feature,
"default");this.feature=null;OpenLayers.Util.removeItem(this.layer.selectedFeatures,a);this.onModificationEnd(a);this.layer.events.triggerEvent("afterfeaturemodified",{feature:a,modified:this.modified});this.modified=false},dragStart:function(a){var b=a.geometry.CLASS_NAME=="OpenLayers.Geometry.Point";if(!this.standalone&&(!a._sketch&&b||!a._sketch)){if(this.toggle&&this.feature===a)this._unselect=a;this.selectFeature(a)}if(a._sketch||b){this.vertex=a;this.handlers.drag.stopDown=true}},dragVertex:function(a,
b){var c=this.map.getLonLatFromViewPortPx(b),d=a.geometry;d.move(c.lon-d.x,c.lat-d.y);this.modified=true;if(this.feature.geometry.CLASS_NAME=="OpenLayers.Geometry.Point")this.layer.events.triggerEvent("vertexmodified",{vertex:a.geometry,feature:this.feature,pixel:b});else{if(a._index){a.geometry.parent.addComponent(a.geometry,a._index);delete a._index;OpenLayers.Util.removeItem(this.virtualVertices,a);this.vertices.push(a)}else if(a==this.dragHandle){this.layer.removeFeatures(this.vertices,{silent:true});
this.vertices=[];if(this.radiusHandle){this.layer.destroyFeatures([this.radiusHandle],{silent:true});this.radiusHandle=null}}else a!==this.radiusHandle&&this.layer.events.triggerEvent("vertexmodified",{vertex:a.geometry,feature:this.feature,pixel:b});if(this.virtualVertices.length>0){this.layer.destroyFeatures(this.virtualVertices,{silent:true});this.virtualVertices=[]}this.layer.drawFeature(this.feature,this.standalone?void 0:"select")}this.layer.drawFeature(a)},dragComplete:function(){this.resetVertices();
...
0){this.layer.removeFeatures(this.vertices,{silent:true});this.vertices=[]}if(this.virtualVertices.length>0){this.layer.removeFeatures(this.virtualVertices,{silent:true});this.virtualVertices=[]}if(this.dragHandle){this.layer.destroyFeatures([this.dragHandle],{silent:true});this.dragHandle=null}if(this.radiusHandle){this.layer.destroyFeatures([this.radiusHandle],{silent:true});this.radiusHandle=null}if(this.feature&&this.feature.geometry.CLASS_NAME!="OpenLayers.Geometry.Point"){this.mode&OpenLayers.Control.ModifyFeature.DRAG&&
this.collectDragHandle();this.mode&(OpenLayers.Control.ModifyFeature.ROTATE|OpenLayers.Control.ModifyFeature.RESIZE)&&this.collectRadiusHandle();this.mode&OpenLayers.Control.ModifyFeature.RESHAPE&&(this.mode&OpenLayers.Control.ModifyFeature.RESIZE||this.collectVertices())}},handleKeypress:function(a){var b=a.keyCode;if(this.feature&&OpenLayers.Util.indexOf(this.deleteCodes,b)!=-1)if((b=this.layer.getFeatureFromEvent(this.handlers.drag.evt))&&OpenLayers.Util.indexOf(this.vertices,b)!=-1&&!this.handlers.drag.dragging&&
b.geometry.parent){b.geometry.parent.removeComponent(b.geometry);this.layer.events.triggerEvent("vertexremoved",{vertex:b.geometry,feature:this.feature,pixel:a.xy});this.layer.drawFeature(this.feature,this.standalone?void 0:"select");this.modified=true;this.resetVertices();this.setFeatureState();this.onModification(this.feature);this.layer.events.triggerEvent("featuremodified",{feature:this.feature})}},collectVertices:function(){function a(c){var d,e,f;if(c.CLASS_NAME=="OpenLayers.Geometry.Point"){e=
new OpenLayers.Feature.Vector(c);e._sketch=true;e.renderIntent=b.vertexRenderIntent;b.vertices.push(e)}else{f=c.components.length;c.CLASS_NAME=="OpenLayers.Geometry.LinearRing"&&(f=f-1);for(d=0;d<f;++d){e=c.components[d];if(e.CLASS_NAME=="OpenLayers.Geometry.Point"){e=new OpenLayers.Feature.Vector(e);e._sketch=true;e.renderIntent=b.vertexRenderIntent;b.vertices.push(e)}else a(e)}if(b.createVertices&&c.CLASS_NAME!="OpenLayers.Geometry.MultiPoint"){d=0;for(f=c.components.length;d<f-1;++d){e=c.components[d];
var g=c.components[d+1];if(e.CLASS_NAME=="OpenLayers.Geometry.Point"&&g.CLASS_NAME=="OpenLayers.Geometry.Point"){e=new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Point((e.x+g.x)/2,(e.y+g.y)/2),null,b.virtualStyle);e.geometry.parent=c;e._index=d+1;e._sketch=true;b.virtualVertices.push(e)}}}}}this.vertices=[];this.virtualVertices=[];var b=this;a.call(this,this.feature.geometry);this.layer.addFeatures(this.virtualVertices,{silent:true});this.layer.addFeatures(this.vertices,{silent:true})},collectDragHandle:function(){var a=
this.feature.geometry,b=a.getBounds().getCenterLonLat(),b=new OpenLayers.Geometry.Point(b.lon,b.lat),c=new OpenLayers.Feature.Vector(b);b.move=function(b,c){OpenLayers.Geometry.Point.prototype.move.call(this,b,c);a.move(b,c)};c._sketch=true;this.dragHandle=c;this.dragHandle.renderIntent=this.vertexRenderIntent;this.layer.addFeatures([this.dragHandle],{silent:true})},collectRadiusHandle:function(){var a=this.feature.geometry,b=a.getBounds(),c=b.getCenterLonLat(),d=new OpenLayers.Geometry.Point(c.lon,
c.lat),b=new OpenLayers.Geometry.Point(b.right,b.bottom),c=new OpenLayers.Feature.Vector(b),e=this.mode&OpenLayers.Control.ModifyFeature.RESIZE,f=this.mode&OpenLayers.Control.ModifyFeature.RESHAPE,g=this.mode&OpenLayers.Control.ModifyFeature.ROTATE;b.move=function(b,c){OpenLayers.Geometry.Point.prototype.move.call(this,b,c);var l=this.x-d.x,m=this.y-d.y,n=l-b,o=m-c;if(g){var p=Math.atan2(o,n),p=Math.atan2(m,l)-p,p=p*(180/Math.PI);a.rotate(p,d)}if(e){var q;if(f){m=m/o;q=l/n/m}else{n=Math.sqrt(n*n+
o*o);m=Math.sqrt(l*l+m*m)/n}a.resize(m,d,q)}};c._sketch=true;this.radiusHandle=c;this.radiusHandle.renderIntent=this.vertexRenderIntent;this.layer.addFeatures([this.radiusHandle],{silent:true})},setMap:function(a){this.handlers.drag.setMap(a);OpenLayers.Control.prototype.setMap.apply(this,arguments)},handleMapEvents:function(a){(a.type=="removelayer"||a.property=="order")&&this.moveLayerToTop()},moveLayerToTop:function(){var a=Math.max(this.map.Z_INDEX_BASE.Feature-1,this.layer.getZIndex())+1;this.layer.setZIndex(a)},
...
true);this.isBaseLayer||this.redraw();this.updateAttribution()},getURL:function(a){if(this.url){for(var b=this.getXYZ(a),a=b.x,c=b.y,b=b.z,d=[],e=b;e>0;--e){var f="0",g=1<<e-1;(a&g)!=0&&f++;if((c&g)!=0){f++;f++}d.push(f)}d=d.join("");a=this.selectUrl(""+a+c+b,this.url);return OpenLayers.String.format(a,{quadkey:d})}},updateAttribution:function(){var a=this.metadata;if(a.resourceSets&&this.map&&this.map.center){var b=a.resourceSets[0].resources[0],c=this.map.getExtent().transform(this.map.getProjectionObject(),
new OpenLayers.Projection("EPSG:4326")),d=b.imageryProviders||[],e=OpenLayers.Util.indexOf(this.serverResolutions,this.getServerResolution()),b="",f,g,h,j,l,m,n;g=0;for(h=d.length;g<h;++g){f=d[g];j=0;for(l=f.coverageAreas.length;j<l;++j){n=f.coverageAreas[j];m=OpenLayers.Bounds.fromArray(n.bbox,true);c.intersectsBounds(m)&&(e<=n.zoomMax&&e>=n.zoomMin)&&(b=b+(f.attribution+" "))}}a=a.brandLogoUri.replace(this.protocolRegex,this.protocol);this.attribution=OpenLayers.String.format(this.attributionTemplate,
...
d=this.renderer.setExtent(e,b);this.renderer.root.style.visibility="visible";if(OpenLayers.IS_GECKO===true)this.div.scrollLeft=this.div.scrollLeft;if(!b&&d)for(var f in this.unrenderedFeatures){e=this.unrenderedFeatures[f];this.drawFeature(e)}}if(!this.drawn||b||!d){this.drawn=true;f=0;for(d=this.features.length;f<d;f++){this.renderer.locked=f!==d-1;e=this.features[f];this.drawFeature(e)}}},display:function(a){OpenLayers.Layer.prototype.display.apply(this,arguments);var b=this.div.style.display;if(b!=
this.renderer.root.style.display)this.renderer.root.style.display=b},addFeatures:function(a,b){OpenLayers.Util.isArray(a)||(a=[a]);var c=!b||!b.silent;if(c){var d={features:a};if(this.events.triggerEvent("beforefeaturesadded",d)===false)return;a=d.features}for(var d=[],e=0,f=a.length;e<f;e++){this.renderer.locked=e!=a.length-1?true:false;var g=a[e];if(this.geometryType&&!(g.geometry instanceof this.geometryType))throw new TypeError("addFeatures: component should be an "+this.geometryType.prototype.CLASS_NAME);
g.layer=this;if(!g.style&&this.style)g.style=OpenLayers.Util.extend({},this.style);if(c){if(this.events.triggerEvent("beforefeatureadded",{feature:g})===false)continue;this.preFeatureInsert(g)}d.push(g);this.features.push(g);this.drawFeature(g);if(c){this.events.triggerEvent("featureadded",{feature:g});this.onFeatureInsert(g)}}c&&this.events.triggerEvent("featuresadded",{features:d})},removeFeatures:function(a,b){if(a&&a.length!==0){if(a===this.features)return this.removeAllFeatures(b);OpenLayers.Util.isArray(a)||
...
OpenLayers.Layer.Heatmap=OpenLayers.Class(OpenLayers.Layer,{isBaseLayer:!1,heatmap:null,mapLayer:null,tmpData:{},initialize:function(a,b,c,d,e){var f=document.createElement("div");OpenLayers.Layer.prototype.initialize.apply(this,[a,e]);f.style.cssText="position:absolute;width:"+b.getSize().w+"px;height:"+b.getSize().h+"px;";this.div.appendChild(f);d.element=f;this.mapLayer=c;this.map=b;this.heatmap=h337.create(d);a=function(){this.tmpData.max&&this.updateLayer()};b.eventsRegister("zoomend",this,a);
b.eventsRegister("moveend",this,a)},updateLayer:function(){var a=this.getPixelOffset(),b=this.heatmap.get("element");b.style.top=(a.y>0?"-"+a.y:Math.abs(a.y))+"px";b.style.left=(a.x>0?"-"+a.x:Math.abs(a.x))+"px";this.setDataSet(this.tmpData)},getPixelOffset:function(){var a=this.mapLayer.map.layerContainerOrigin,a=new OpenLayers.LonLat(a.lon,a.lat),a=this.mapLayer.getViewPortPxFromLonLat(a),b=this.mapLayer.map.center,b=new OpenLayers.LonLat(b.lon,b.lat),b=this.mapLayer.getViewPortPxFromLonLat(b);
return{x:a.x-b.x,y:a.y-b.y}},setDataSet:function(a){var b={},c=a.data,d=c.length,e,f;b.max=a.max;for(b.data=[];d--;){e=c[d];f=e.lonlat.clone().transform(this.projection,this.mapLayer.map.getProjectionObject());(f=this.roundPixels(this.mapLayer.map.getViewPortPxFromLonLat(f)))&&b.data.push({x:f.x,y:f.y,count:e.count})}this.tmpData=a;this.heatmap.store.setDataSet(b)},roundPixels:function(a){if(a.x<0||a.y<0)return false;a.x=a.x>>0;a.y=a.y>>0;return a},addDataPoint:function(a){var b=this.roundPixels(this.mapLayer.getViewPortPxFromLonLat(a)),
c={lonlat:a};if(arguments.length==2)c.count=arguments[1];this.tmpData.data.push(c);if(b){b=[b.x,b.y];arguments.length==2&&b.push(arguments[1]);this.heatmap.store.addDataPoint.apply(this.heatmap.store,b)}},toggle:function(){this.heatmap.toggleDisplay()},destroy:function(){OpenLayers.Layer.Grid.prototype.destroy.apply(this,arguments)},CLASS_NAME:"OpenLayers.Layer.Heatmap"});
...
d/2,b.lat-e/2,b.lon+d/2,b.lat+e/2);for(var b=Math.floor(e/this.dy),d=Math.floor(d/this.dx),e=c.lon+this.dx*Math.ceil((this.gridBounds.left-c.lon)/this.dx),c=c.lat+this.dy*Math.ceil((this.gridBounds.bottom-c.lat)/this.dy),g=Array(b*d),h,j=0;j<d;++j)for(var f=e+j*this.dx,l=0;l<b;++l){h=c+l*this.dy;h=new OpenLayers.Geometry.Point(f,h);this.rotation&&h.rotate(this.rotation,a);g[j*b+l]=new OpenLayers.Feature.Vector(h)}this.destroyFeatures(this.features,{silent:true});this.addFeatures(g,{silent:true})}},
...
false,c=false,d=false,e=OpenLayers.Event.element(a);e!=null&&!d&&!b;){if(!b)try{var f,b=(f=e.currentStyle?e.currentStyle.overflow:document.defaultView.getComputedStyle(e,null).getPropertyValue("overflow"))&&f=="auto"||f=="scroll"}catch(g){}if(!c){c=OpenLayers.Element.hasClass(e,"olScrollable");if(!c)for(var d=0,h=this.map.layers.length;d<h;d++){var j=this.map.layers[d];if(e==j.div||e==j.pane){c=true;break}}}d=e==this.map.div;e=e.parentNode}if(!b&&d){if(c){b=0;if(a.wheelDelta){b=a.wheelDelta;b%160===
0&&(b=b*0.75);b=b/120}else a.detail&&(b=-(a.detail/Math.abs(a.detail)));this.delta=this.delta+b;window.clearTimeout(this._timeoutId);if(this.interval&&Math.abs(this.delta)<this.maxDelta){var l=OpenLayers.Util.extend({},a);this._timeoutId=window.setTimeout(OpenLayers.Function.bind(function(){this.wheelZoom(l)},this),this.interval)}else this.wheelZoom(a)}OpenLayers.Event.stop(a)}}},wheelZoom:function(a){var b=this.delta;this.delta=0;if(b){a.xy=this.map.events.getMousePosition(a);b<0?this.callback("down",
[a,this.cumulative?Math.max(-this.maxDelta,b):-1]):this.callback("up",[a,this.cumulative?Math.min(this.maxDelta,b):1])}},activate:function(a){if(OpenLayers.Handler.prototype.activate.apply(this,arguments)){var b=this.wheelListener;OpenLayers.Event.observe(window,"DOMMouseScroll",b);OpenLayers.Event.observe(window,"mousewheel",b);OpenLayers.Event.observe(document,"mousewheel",b);return true}return false},deactivate:function(a){if(OpenLayers.Handler.prototype.deactivate.apply(this,arguments)){var b=
this.wheelListener;OpenLayers.Event.stopObserving(window,"DOMMouseScroll",b);OpenLayers.Event.stopObserving(window,"mousewheel",b);OpenLayers.Event.stopObserving(document,"mousewheel",b);return true}return false},CLASS_NAME:"OpenLayers.Handler.MouseWheel"});OpenLayers.Symbolizer=OpenLayers.Class({zIndex:0,initialize:function(a){OpenLayers.Util.extend(this,a)},clone:function(){return new (eval(this.CLASS_NAME))(OpenLayers.Util.extend({},this))},CLASS_NAME:"OpenLayers.Symbolizer"});
...
this.base=b||document.location.href}},destroy:function(){if(this.element&&this.element.parentNode==this.div){this.div.removeChild(this.element);this.element=null}this.map&&this.map.events.unregister("moveend",this,this.updateLink);OpenLayers.Control.prototype.destroy.apply(this,arguments)},setMap:function(a){OpenLayers.Control.prototype.setMap.apply(this,arguments);for(var b=0,c=this.map.controls.length;b<c;b++){var d=this.map.controls[b];if(d.CLASS_NAME==this.argParserClass.CLASS_NAME){if(d.displayProjection!=
this.displayProjection)this.displayProjection=d.displayProjection;break}}b==this.map.controls.length&&this.map.addControl(new this.argParserClass({displayProjection:this.displayProjection}))},draw:function(){OpenLayers.Control.prototype.draw.apply(this,arguments);if(!this.element&&!this.anchor){this.element=document.createElement("a");this.element.innerHTML=OpenLayers.i18n("Permalink");this.element.href="";this.div.appendChild(this.element)}this.map.events.on({moveend:this.updateLink,changelayer:this.updateLink,
changebaselayer:this.updateLink,scope:this});this.updateLink();return this.div},updateLink:function(){var a=this.anchor?"#":"?",b=this.base,c=null;b.indexOf("#")!=-1&&this.anchor==false&&(c=b.substring(b.indexOf("#"),b.length));b.indexOf(a)!=-1&&(b=b.substring(0,b.indexOf(a)));b=b.split("#")[0]+a+OpenLayers.Util.getParameterString(this.createParams());c&&(b=b+c);this.anchor&&!this.element?window.location.href=b:this.element.href=b},createParams:function(a,b,c){var a=a||this.map.getCenter(),d=OpenLayers.Util.getParameters(this.base);
...
OpenLayers.Format.WCSCapabilities=OpenLayers.Class(OpenLayers.Format.XML.VersionedOGC,{defaultVersion:"1.1.0",CLASS_NAME:"OpenLayers.Format.WCSCapabilities"});OpenLayers.Format.WCSCapabilities.v1=OpenLayers.Class(OpenLayers.Format.XML,{regExes:{trimSpace:/^\s*|\s*$/g,splitSpace:/\s+/},defaultPrefix:"wcs",read:function(a){typeof a=="string"&&(a=OpenLayers.Format.XML.prototype.read.apply(this,[a]));if(a&&a.nodeType==9)a=a.documentElement;var b={};this.readNode(a,b);return b},CLASS_NAME:"OpenLayers.Format.WCSCapabilities.v1"});
OpenLayers.Format.WCSCapabilities.v1_0_0=OpenLayers.Class(OpenLayers.Format.WCSCapabilities.v1,{namespaces:{wcs:"http://www.opengis.net/wcs",xlink:"http://www.w3.org/1999/xlink",xsi:"http://www.w3.org/2001/XMLSchema-instance",ows:"http://www.opengis.net/ows"},errorProperty:"service",readers:{wcs:{WCS_Capabilities:function(a,b){this.readChildNodes(a,b)},Service:function(a,b){b.service={};this.readChildNodes(a,b.service)},name:function(a,b){b.name=this.getChildValue(a)},label:function(a,b){b.label=
...
"http://www.opengis.net/gml","pos");if(c.length==2){var d={},e={};OpenLayers.Format.GML.v3.prototype.readers.gml.pos.apply(this,[c[0],d]);OpenLayers.Format.GML.v3.prototype.readers.gml.pos.apply(this,[c[1],e]);b.lonLatEnvelope={};b.lonLatEnvelope.srsName=a.getAttribute("srsName");b.lonLatEnvelope.min=d.points[0];b.lonLatEnvelope.max=e.points[0]}}}},CLASS_NAME:"OpenLayers.Format.WCSCapabilities.v1_0_0"});
OpenLayers.Strategy.Fixed=OpenLayers.Class(OpenLayers.Strategy,{preload:!1,activate:function(){var a=OpenLayers.Strategy.prototype.activate.apply(this,arguments);if(a){this.layer.events.on({refresh:this.load,scope:this});if(this.layer.visibility==true||this.preload)this.load();else this.layer.events.on({visibilitychanged:this.load,scope:this})}return a},deactivate:function(){var a=OpenLayers.Strategy.prototype.deactivate.call(this);a&&this.layer.events.un({refresh:this.load,visibilitychanged:this.load,
...
drawMarker:function(a){var b=this.map.getLayerPxFromLonLat(a.lonlat);if(b==null)a.display(false);else if(a.isDrawn())a.icon&&a.icon.moveTo(b);else{a=a.draw(b);this.div.appendChild(a)}},getDataExtent:function(){var a=null;if(this.markers&&this.markers.length>0)for(var a=new OpenLayers.Bounds,b=0,c=this.markers.length;b<c;b++)a.extend(this.markers[b].lonlat);return a},CLASS_NAME:"OpenLayers.Layer.Markers"});
OpenLayers.Control.Pan=OpenLayers.Class(OpenLayers.Control.Button,{slideFactor:50,slideRatio:null,direction:null,initialize:function(a,b){this.direction=a;this.CLASS_NAME=this.CLASS_NAME+this.direction;OpenLayers.Control.prototype.initialize.apply(this,[b])},trigger:function(){if(this.map){var a=OpenLayers.Function.bind(function(a){return this.slideRatio?this.map.getSize()[a]*this.slideRatio:this.slideFactor},this);switch(this.direction){case OpenLayers.Control.Pan.NORTH:this.map.pan(0,-a("h"));break;
...
a.feature;var b=this.layer.map.getLonLatFromViewPortPx(a.pixel);this.considerSnapping(a.vertex,new OpenLayers.Geometry.Point(b.lon,b.lat))},considerSnapping:function(a,b){for(var c={rank:Number.POSITIVE_INFINITY,dist:Number.POSITIVE_INFINITY,x:null,y:null},d=false,e,f,g=0,h=this.targets.length;g<h;++g){f=this.targets[g];if(e=this.testTarget(f,b))if(this.greedy){c=e;c.target=f;d=true;break}else if(e.rank<c.rank||e.rank===c.rank&&e.dist<c.dist){c=e;c.target=f;d=true}}if(d)if(this.events.triggerEvent("beforesnap",
...
for(var c={node:this.getGeoTolerance(a.nodeTolerance,c),vertex:this.getGeoTolerance(a.vertexTolerance,c),edge:this.getGeoTolerance(a.edgeTolerance,c)},d=Math.max(c.node,c.vertex,c.edge),e={rank:Number.POSITIVE_INFINITY,dist:Number.POSITIVE_INFINITY},f=false,g=a.layer.features,h,j,l,m,n,o,p=this.precedence.length,q=new OpenLayers.LonLat(b.x,b.y),r=0,s=g.length;r<s;++r){h=g[r];if(h!==this.feature&&(!h._sketch&&h.state!==OpenLayers.State.DELETE&&(!a.filter||a.filter.evaluate(h)))&&h.atPoint(q,d,d))for(var t=
0,u=Math.min(e.rank+1,p);t<u;++t){j=this.precedence[t];if(a[j])if(j==="edge"){l=h.geometry.distanceTo(b,{details:true});n=l.distance;if(n<=c[j]&&n<e.dist){e={rank:t,dist:n,x:l.x0,y:l.y0};f=true;break}}else{l=h.geometry.getVertices(j==="node");o=false;for(var v=0,w=l.length;v<w;++v){m=l[v];n=m.distanceTo(b);if(n<=c[j]&&(t<e.rank||t===e.rank&&n<e.dist)){e={rank:t,dist:n,x:m.x,y:m.y};o=f=true}}if(o)break}}}return f?e:null},getGeoTolerance:function(a,b){if(b!==this.resolution){this.resolution=b;this.geoToleranceCache=
{}}var c=this.geoToleranceCache[a];if(c===void 0){c=a*b;this.geoToleranceCache[a]=c}return c},destroy:function(){this.active&&this.deactivate();delete this.layer;delete this.targets;OpenLayers.Control.prototype.destroy.call(this)},CLASS_NAME:"OpenLayers.Control.Snapping"});
...
d);break;case "polystyle":d=this.parseProperty(e,"*","color");if(d=this.parseKmlColor(d)){b.fillOpacity=d.opacity;b.fillColor=d.color}this.parseProperty(e,"*","fill")=="0"&&(b.fillColor="none");this.parseProperty(e,"*","outline")=="0"&&(b.strokeWidth="0");break;case "iconstyle":var h=parseFloat(this.parseProperty(e,"*","scale")||1);d=32*h;var j=32*h,l=this.getElementsByTagNameNS(e,"*","Icon")[0];if(l){var m=this.parseProperty(l,"*","href");if(m){var n=this.parseProperty(l,"*","w"),o=this.parseProperty(l,
"*","h");if(OpenLayers.String.startsWith(m,"http://maps.google.com/mapfiles/kml")&&!n&&!o){o=n=64;h=h/2}n=n||o;o=o||n;n&&(d=parseInt(n)*h);o&&(j=parseInt(o)*h);if(o=m.match(this.regExes.kmlIconPalette)){n=o[1];o=o[2];m=this.parseProperty(l,"*","x");l=this.parseProperty(l,"*","y");m="http://maps.google.com/mapfiles/kml/pal"+n+"/icon"+((l?7-l/32:7)*8+(m?m/32:0))+o}b.graphicOpacity=1;b.externalGraphic=m}}if(e=this.getElementsByTagNameNS(e,"*","hotSpot")[0]){m=parseFloat(e.getAttribute("x"));l=parseFloat(e.getAttribute("y"));
...
parseFloat(d[0]);h.attributes.tilt=parseFloat(d[1]);h.attributes.roll=parseFloat(d[2])}b.features.push(h)}},coord:function(a,b){var c=this.getChildValue(a).replace(this.regExes.trimSpace,"").split(/\s+/),d=new OpenLayers.Geometry.Point(c[0],c[1]);if(c.length>2)d.z=parseFloat(c[2]);b.points.push(d)},angles:function(a,b){var c=this.getChildValue(a).replace(this.regExes.trimSpace,"").split(/\s+/);b.angles.push(c)}}},parseFeature:function(a){for(var b=["MultiGeometry","Polygon","LineString","Point"],
...
d;c++){e=g[c];f=e.getAttribute("name");var h={},j=e.getElementsByTagName("value");j.length&&(h.value=this.getChildValue(j[0]));if(this.kvpAttributes)b[f]=h.value;else{e=e.getElementsByTagName("displayName");e.length&&(h.displayName=this.getChildValue(e[0]));b[f]=h}}a=a.getElementsByTagName("SimpleData");c=0;for(d=a.length;c<d;c++){h={};e=a[c];f=e.getAttribute("name");h.value=this.getChildValue(e);if(this.kvpAttributes)b[f]=h.value;else{h.displayName=f;b[f]=h}}return b},parseProperty:function(a,b,
...
d.appendChild(e);b.appendChild(d)}return this.isSimpleContent(b)?null:b},CLASS_NAME:"OpenLayers.Format.KML"});OpenLayers.Format.WMSCapabilities=OpenLayers.Class(OpenLayers.Format.XML.VersionedOGC,{defaultVersion:"1.1.1",profile:null,CLASS_NAME:"OpenLayers.Format.WMSCapabilities"});
OpenLayers.Format.WMSCapabilities.v1=OpenLayers.Class(OpenLayers.Format.XML,{namespaces:{wms:"http://www.opengis.net/wms",xlink:"http://www.w3.org/1999/xlink",xsi:"http://www.w3.org/2001/XMLSchema-instance"},defaultPrefix:"wms",read:function(a){typeof a=="string"&&(a=OpenLayers.Format.XML.prototype.read.apply(this,[a]));var b=a;if(a&&a.nodeType==9)a=a.documentElement;var c={};this.readNode(a,c);if(c.service===void 0){a=new OpenLayers.Format.OGCExceptionReport;c.error=a.read(b)}return c},readers:{wms:{Service:function(a,
...
this.readChildNodes(a,b.getmap)},GetFeatureInfo:function(a,b){b.getfeatureinfo={formats:[]};this.readChildNodes(a,b.getfeatureinfo)},Exception:function(a,b){b.exception={formats:[]};this.readChildNodes(a,b.exception)},Layer:function(a,b){var c,d;if(b.capability){d=b.capability;c=b}else d=b;var e=a.getAttributeNode("queryable"),f=e&&e.specified?a.getAttribute("queryable"):null,g=(e=a.getAttributeNode("cascaded"))&&e.specified?a.getAttribute("cascaded"):null,e=(e=a.getAttributeNode("opaque"))&&e.specified?
a.getAttribute("opaque"):null,h=a.getAttribute("noSubsets"),j=a.getAttribute("fixedWidth"),l=a.getAttribute("fixedHeight"),m=c||{},n=OpenLayers.Util.extend;c={nestedLayers:[],styles:c?[].concat(c.styles):[],srs:c?n({},m.srs):{},metadataURLs:[],bbox:c?n({},m.bbox):{},llbbox:m.llbbox,dimensions:c?n({},m.dimensions):{},authorityURLs:c?n({},m.authorityURLs):{},identifiers:{},keywords:[],queryable:f&&f!==""?f==="1"||f==="true":m.queryable||false,cascaded:g!==null?parseInt(g):m.cascaded||0,opaque:e?e===
"1"||e==="true":m.opaque||false,noSubsets:h!==null?h==="1"||h==="true":m.noSubsets||false,fixedWidth:j!=null?parseInt(j):m.fixedWidth||0,fixedHeight:l!=null?parseInt(l):m.fixedHeight||0,minScale:m.minScale,maxScale:m.maxScale,attribution:m.attribution};b.nestedLayers.push(c);c.capability=d;this.readChildNodes(a,c);delete c.capability;if(c.name){f=c.name.split(":");g=d.request;e=g.getfeatureinfo;if(f.length>0)c.prefix=f[0];d.layers.push(c);if(c.formats===void 0)c.formats=g.getmap.formats;if(c.infoFormats===
void 0&&e)c.infoFormats=e.formats}},Attribution:function(a,b){b.attribution={};this.readChildNodes(a,b.attribution)},LogoURL:function(a,b){b.logo={width:a.getAttribute("width"),height:a.getAttribute("height")};this.readChildNodes(a,b.logo)},Style:function(a,b){var c={};b.styles.push(c);this.readChildNodes(a,c)},LegendURL:function(a,b){var c={width:a.getAttribute("width"),height:a.getAttribute("height")};b.legend=c;this.readChildNodes(a,c)},MetadataURL:function(a,b){var c={type:a.getAttribute("type")};
...
parseFloat(a.getAttribute("maxx")),parseFloat(a.getAttribute("maxy"))]},BoundingBox:function(a,b){var c=OpenLayers.Format.WMSCapabilities.v1.prototype.readers.wms.BoundingBox.apply(this,[a,b]);c.srs=a.getAttribute("SRS");b.bbox[c.srs]=c},ScaleHint:function(a,b){var c=a.getAttribute("min"),d=a.getAttribute("max"),e=Math.pow(2,0.5),f=OpenLayers.INCHES_PER_UNIT.m;if(c!=0)b.maxScale=parseFloat((c/e*f*OpenLayers.DOTS_PER_INCH).toPrecision(13));if(d!=Number.POSITIVE_INFINITY)b.minScale=parseFloat((d/e*
f*OpenLayers.DOTS_PER_INCH).toPrecision(13))},Dimension:function(a,b){var c={name:a.getAttribute("name").toLowerCase(),units:a.getAttribute("units"),unitsymbol:a.getAttribute("unitSymbol")};b.dimensions[c.name]=c},Extent:function(a,b){var c=a.getAttribute("name").toLowerCase();if(c in b.dimensions){c=b.dimensions[c];c.nearestVal=a.getAttribute("nearestValue")==="1";c.multipleVal=a.getAttribute("multipleValues")==="1";c.current=a.getAttribute("current")==="1";c["default"]=a.getAttribute("default")||
...
b},touchstart:function(a){this.startTouch();return OpenLayers.Event.isMultiTouch(a)?true:this.mousedown(a)},touchmove:function(a){OpenLayers.Event.preventDefault(a)},mousedown:function(a){if(OpenLayers.Event.isLeftClick(a)||OpenLayers.Event.isSingleTouch(a))this.down=a.xy;return this.handle(a)?!this.stopDown:true},mouseup:function(a){this.up=a.xy;return this.handle(a)?!this.stopUp:true},click:function(a){return this.handle(a)?!this.stopClick:true},mousemove:function(a){if(!this.callbacks.over&&!this.callbacks.out)return true;
this.handle(a);return true},dblclick:function(a){return!this.handle(a)},geometryTypeMatches:function(a){return this.geometryTypes==null||OpenLayers.Util.indexOf(this.geometryTypes,a.geometry.CLASS_NAME)>-1},handle:function(a){if(this.feature&&!this.feature.layer)this.feature=null;var b=a.type,c=false,d=!!this.feature,e=b=="click"||b=="dblclick"||b=="touchstart";if((this.feature=this.layer.getFeatureFromEvent(a))&&!this.feature.layer)this.feature=null;if(this.lastFeature&&!this.lastFeature.layer)this.lastFeature=
null;if(this.feature){b==="touchstart"&&OpenLayers.Event.preventDefault(a);a=this.feature!=this.lastFeature;if(this.geometryTypeMatches(this.feature)){if(d&&a){this.lastFeature&&this.triggerCallback(b,"out",[this.lastFeature]);this.triggerCallback(b,"in",[this.feature])}else(!d||e)&&this.triggerCallback(b,"in",[this.feature]);this.lastFeature=this.feature;c=true}else{this.lastFeature&&(d&&a||e)&&this.triggerCallback(b,"out",[this.lastFeature]);this.feature=null}}else this.lastFeature&&(d||e)&&this.triggerCallback(b,
"out",[this.lastFeature]);return c},triggerCallback:function(a,b,c){if(b=this.EVENTMAP[a][b])if(a=="click"&&this.up&&this.down){Math.sqrt(Math.pow(this.up.x-this.down.x,2)+Math.pow(this.up.y-this.down.y,2))<=this.clickTolerance&&this.callback(b,c);this.up=this.down=null}else this.callback(b,c)},activate:function(){var a=false;if(OpenLayers.Handler.prototype.activate.apply(this,arguments)){this.moveLayerToTop();this.map.events.on({removelayer:this.handleMapEvents,changelayer:this.handleMapEvents,scope:this});
a=true}return a},deactivate:function(){var a=false;if(OpenLayers.Handler.prototype.deactivate.apply(this,arguments)){this.moveLayerBack();this.up=this.down=this.lastFeature=this.feature=null;this.map.events.un({removelayer:this.handleMapEvents,changelayer:this.handleMapEvents,scope:this});a=true}return a},handleMapEvents:function(a){(a.type=="removelayer"||a.property=="order")&&this.moveLayerToTop()},moveLayerToTop:function(){var a=Math.max(this.map.Z_INDEX_BASE.Feature-1,this.layer.getZIndex())+
1;this.layer.setZIndex(a)},moveLayerBack:function(){var a=this.layer.getZIndex()-1;a>=this.map.Z_INDEX_BASE.Feature?this.layer.setZIndex(a):this.map.setLayerZIndex(this.layer,this.map.getLayerIndex(this.layer))},CLASS_NAME:"OpenLayers.Handler.Feature"});
...
deactivate:function(){if(this.active){this.handlers.feature.deactivate();this.handlers.box&&this.handlers.box.deactivate();this.layers&&this.map.removeLayer(this.layer)}return OpenLayers.Control.prototype.deactivate.apply(this,arguments)},unselectAll:function(a){var b=this.layers||[this.layer],c,d,e,f;for(e=0;e<b.length;++e){c=b[e];f=0;if(c.selectedFeatures!=null)for(;c.selectedFeatures.length>f;){d=c.selectedFeatures[f];!a||a.except!=d?this.unselect(d):++f}}},clickFeature:function(a){if(!this.hover)if(OpenLayers.Util.indexOf(a.layer.selectedFeatures,
...
false;this.lastTouchPx=this.lastUp=this.lastDown=null;this.callback(a?"cancel":"done",[this.geometryClone()]);this.destroyFeature(a)},cancel:function(){this.finalize(true)},click:function(a){OpenLayers.Event.stop(a);return false},dblclick:function(a){OpenLayers.Event.stop(a);return false},modifyFeature:function(a){this.point||this.createFeature(a);a=this.layer.getLonLatFromViewPortPx(a);this.point.geometry.x=a.lon;this.point.geometry.y=a.lat;this.callback("modify",[this.point.geometry,this.point,
false]);this.point.geometry.clearBounds();this.drawFeature()},drawFeature:function(){this.layer.drawFeature(this.point,this.style)},getGeometry:function(){var a=this.point&&this.point.geometry;a&&this.multi&&(a=new OpenLayers.Geometry.MultiPoint([a]));return a},geometryClone:function(){var a=this.getGeometry();return a&&a.clone()},mousedown:function(a){return this.down(a)},touchstart:function(a){this.startTouch();this.lastTouchPx=a.xy;return this.down(a)},mousemove:function(a){return this.move(a)},
touchmove:function(a){this.lastTouchPx=a.xy;return this.move(a)},mouseup:function(a){return this.up(a)},touchend:function(a){a.xy=this.lastTouchPx;return this.up(a)},down:function(a){this.mouseDown=true;this.lastDown=a.xy;this.touch||this.modifyFeature(a.xy);this.stoppedDown=this.stopDown;return!this.stopDown},move:function(a){!this.touch&&(!this.mouseDown||this.stoppedDown)&&this.modifyFeature(a.xy);return true},up:function(a){this.mouseDown=false;this.stoppedDown=this.stopDown;if(this.checkModifiers(a)&&
(!this.lastUp||!this.lastUp.equals(a.xy))&&this.lastDown&&this.passesTolerance(this.lastDown,a.xy,this.pixelTolerance)){this.touch&&this.modifyFeature(a.xy);this.persist&&this.destroyPersistedFeature();this.lastUp=a.xy;this.finalize();return!this.stopUp}return true},mouseout:function(a){if(OpenLayers.Util.mouseLeft(a,this.map.viewPortDiv)){this.stoppedDown=this.stopDown;this.mouseDown=false}},passesTolerance:function(a,b,c){var d=true;c!=null&&a&&b&&a.distanceTo(b)>c&&(d=false);return d},CLASS_NAME:"OpenLayers.Handler.Point"});
...
a)},down:function(a){var b=this.stopDown;if(this.freehandMode(a)){b=true;if(this.touch){this.modifyFeature(a.xy,!!this.lastUp);OpenLayers.Event.stop(a)}}!this.touch&&(!this.lastDown||!this.passesTolerance(this.lastDown,a.xy,this.pixelTolerance))&&this.modifyFeature(a.xy,!!this.lastUp);this.mouseDown=true;this.lastDown=a.xy;this.stoppedDown=b;return!b},move:function(a){if(this.stoppedDown&&this.freehandMode(a)){this.persist&&this.destroyPersistedFeature();if(this.maxVertices&&this.line&&this.line.geometry.components.length===
this.maxVertices){this.removePoint();this.finalize()}else this.addPoint(a.xy);return false}!this.touch&&(!this.mouseDown||this.stoppedDown)&&this.modifyFeature(a.xy,!!this.lastUp);return true},up:function(a){if(this.mouseDown&&(!this.lastUp||!this.lastUp.equals(a.xy)))if(this.stoppedDown&&this.freehandMode(a)){this.persist&&this.destroyPersistedFeature();this.removePoint();this.finalize()}else if(this.passesTolerance(this.lastDown,a.xy,this.pixelTolerance)){this.touch&&this.modifyFeature(a.xy);this.lastUp==
...
tileloaded:this.onTileLoaded,scope:this})},makeSameOrigin:function(a){if(this.active){a=a.tile;if(a instanceof OpenLayers.Tile.Image&&!a.crossOriginKeyword&&a.url.substr(0,5)!=="data:"){var b=OpenLayers.Request.makeSameOrigin(a.url,OpenLayers.ProxyHost);OpenLayers.Control.CacheWrite.urlMap[b]=a.url;a.url=b}}},onTileLoaded:function(a){if(this.active&&!a.aborted&&a.tile instanceof OpenLayers.Tile.Image&&a.tile.url.substr(0,5)!=="data:"){this.cache({tile:a.tile});delete OpenLayers.Control.CacheWrite.urlMap[a.tile.url]}},
...
metadataURL:a.metadataURL};this.layerOptions&&OpenLayers.Util.applyDefaults(d,this.layerOptions);var e={layers:a.name,transparent:a.transparent,version:a.version};if(a.formats&&a.formats.length>0){e.format=a.formats[0].value;b=0;for(c=a.formats.length;b<c;b++){var f=a.formats[b];if(f.current==true){e.format=f.value;break}}}if(a.styles&&a.styles.length>0){b=0;for(c=a.styles.length;b<c;b++){f=a.styles[b];if(f.current==true){f.href?e.sld=f.href:f.body?e.sld_body=f.body:e.styles=f.name;break}}}this.layerParams&&
OpenLayers.Util.applyDefaults(e,this.layerParams);b=null;c=a.service;if(c==OpenLayers.Format.Context.serviceTypes.WFS){d.strategies=[new OpenLayers.Strategy.BBOX];d.protocol=new OpenLayers.Protocol.WFS({url:a.url,featurePrefix:a.name.split(":")[0],featureType:a.name.split(":").pop()});b=new OpenLayers.Layer.Vector(a.title||a.name,d)}else if(c==OpenLayers.Format.Context.serviceTypes.KML){d.strategies=[new OpenLayers.Strategy.Fixed];d.protocol=new OpenLayers.Protocol.HTTP({url:a.url,format:new OpenLayers.Format.KML});
b=new OpenLayers.Layer.Vector(a.title||a.name,d)}else if(c==OpenLayers.Format.Context.serviceTypes.GML){d.strategies=[new OpenLayers.Strategy.Fixed];d.protocol=new OpenLayers.Protocol.HTTP({url:a.url,format:new OpenLayers.Format.GML});b=new OpenLayers.Layer.Vector(a.title||a.name,d)}else if(a.features){b=new OpenLayers.Layer.Vector(a.title||a.name,d);b.addFeatures(a.features)}else a.categoryLayer!==true&&(b=new OpenLayers.Layer.WMS(a.title||a.name,a.url,e,d));return b},getLayersFromContext:function(a){for(var b=
...
f.tick>this.delay)break;b=f}if(b){d=(new Date).getTime()-b.tick;c=Math.sqrt(Math.pow(a.x-b.xy.x,2)+Math.pow(a.y-b.xy.y,2));d=c/d;if(!(d==0||d<this.threshold)){c=Math.asin((a.y-b.xy.y)/c);b.xy.x<=a.x&&(c=Math.PI-c);return{speed:d,theta:c}}}},move:function(a,b){var c=a.speed,d=Math.cos(a.theta),e=-Math.sin(a.theta),f=(new Date).getTime(),g=0,h=0;this.timerId=OpenLayers.Animation.start(OpenLayers.Function.bind(function(){if(this.timerId!=null){var a=(new Date).getTime()-f,l=-this.deceleration*Math.pow(a,
2)/2+c*a,m=l*d,l=l*e,n,o;n=false;if(-this.deceleration*a+c<=0){OpenLayers.Animation.stop(this.timerId);this.timerId=null;n=true}a=m-g;o=l-h;g=m;h=l;b(a,o,n)}},this))},CLASS_NAME:"OpenLayers.Kinetic"});
...
schemaLocation:"http://www.opengis.net/wps/1.0.0 http://schemas.opengis.net/wps/1.0.0/wpsAll.xsd",schemaLocationAttr:function(){},write:function(a){var b;if(window.ActiveXObject)this.xmldom=b=new ActiveXObject("Microsoft.XMLDOM");else b=document.implementation.createDocument("","",null);a=this.writeNode("wps:Execute",a,b);this.setAttributeNS(a,this.namespaces.xsi,"xsi:schemaLocation",this.schemaLocation);return OpenLayers.Format.XML.prototype.write.apply(this,[a])},read:function(a){typeof a=="string"&&
(a=OpenLayers.Format.XML.prototype.read.apply(this,[a]));if(a&&a.nodeType==9)a=a.documentElement;var b={};this.readNode(a,b);return b},writers:{wps:{Execute:function(a){var b=this.createElementNSPlus("wps:Execute",{attributes:{version:this.VERSION,service:"WPS"}});this.writeNode("ows:Identifier",a.identifier,b);this.writeNode("wps:DataInputs",a.dataInputs,b);this.writeNode("wps:ResponseForm",a.responseForm,b);return b},ResponseForm:function(a){var b=this.createElementNSPlus("wps:ResponseForm",{});
...
b.appendChild(c);return b},Reference:function(a){var b=this.createElementNSPlus("wps:Reference",{attributes:{mimeType:a.mimeType,"xlink:href":a.href,method:a.method,encoding:a.encoding,schema:a.schema}});a.body&&this.writeNode("wps:Body",a.body,b);return b},BoundingBoxData:function(a,b){this.writers.ows.BoundingBox.apply(this,[a,b,"wps:BoundingBoxData"])},Body:function(a){var b=this.createElementNSPlus("wps:Body",{});if(a.wcs)this.writeNode("wcs:GetCoverage",a.wcs,b);else if(a.wfs){this.featureType=
a.wfs.featureType;this.version=a.wfs.version;this.writeNode("wfs:GetFeature",a.wfs,b)}else this.writeNode("wps:Execute",a,b);return b}},wcs:OpenLayers.Format.WCSGetCoverage.prototype.writers.wcs,wfs:OpenLayers.Format.WFST.v1_1_0.prototype.writers.wfs,ogc:OpenLayers.Format.Filter.v1_1_0.prototype.writers.ogc,ows:OpenLayers.Format.OWSCommon.v1_1_0.prototype.writers.ows},readers:{wps:{ExecuteResponse:function(a,b){b.executeResponse={lang:a.getAttribute("lang"),statusLocation:a.getAttribute("statusLocation"),
serviceInstance:a.getAttribute("serviceInstance"),service:a.getAttribute("service")};this.readChildNodes(a,b.executeResponse)},Process:function(a,b){b.process={};this.readChildNodes(a,b.process)},Status:function(a,b){b.status={creationTime:a.getAttribute("creationTime")};this.readChildNodes(a,b.status)},ProcessSucceeded:function(a,b){b.processSucceeded=true},ProcessOutputs:function(a,b){b.processOutputs=[];this.readChildNodes(a,b.processOutputs)},Output:function(a,b){var c={};this.readChildNodes(a,
c);b.push(c)},Reference:function(a,b){b.reference={href:a.getAttribute("href"),mimeType:a.getAttribute("mimeType"),encoding:a.getAttribute("encoding"),schema:a.getAttribute("schema")}},Data:function(a,b){b.data={};this.readChildNodes(a,b)},LiteralData:function(a,b){b.literalData={dataType:a.getAttribute("dataType"),uom:a.getAttribute("uom"),value:this.getChildValue(a)}},ComplexData:function(a,b){b.complexData={mimeType:a.getAttribute("mimeType"),schema:a.getAttribute("schema"),encoding:a.getAttribute("encoding"),
value:""};if(this.isSimpleContent(a)){var c;for(c=a.firstChild;c;c=c.nextSibling)switch(c.nodeType){case 3:case 4:b.complexData.value=b.complexData.value+c.nodeValue}}else for(c=a.firstChild;c;c=c.nextSibling)if(c.nodeType==1)b.complexData.value=c},BoundingBox:function(a,b){b.boundingBoxData={dimensions:a.getAttribute("dimensions"),crs:a.getAttribute("crs")};this.readChildNodes(a,b.boundingBoxData)}},ows:OpenLayers.Format.OWSCommon.v1_1_0.prototype.readers.ows},CLASS_NAME:"OpenLayers.Format.WPSExecute"});
...
success:this.parseData,scope:this});this.loaded=true}},moveTo:function(a,b,c){OpenLayers.Layer.Markers.prototype.moveTo.apply(this,arguments);this.visibility&&!this.loaded&&this.loadRSS()},parseData:function(a){var b=a.responseXML;if(!b||!b.documentElement)b=OpenLayers.Format.XML.prototype.read(a.responseText);if(this.useFeedTitle){a=null;try{a=b.getElementsByTagNameNS("*","title")[0].firstChild.nodeValue}catch(c){a=b.getElementsByTagName("title")[0].firstChild.nodeValue}a&&this.setName(a)}a={};OpenLayers.Util.extend(a,
...
this.icon==null?OpenLayers.Marker.defaultIcon():this.icon.clone();e.popupSize=this.popupSize?this.popupSize.clone():new OpenLayers.Size(250,120);if(g||h){e.title=g;e.description=h;var l='<div class="olLayerGeoRSSClose">[x]</div>',l=l+'<div class="olLayerGeoRSSTitle">';j&&(l=l+('<a class="link" href="'+j+'" target="_blank">'));l=l+g;j&&(l=l+"</a>");l=l+"</div>";l=l+'<div style="" class="olLayerGeoRSSDescription">';l=l+h;l=l+"</div>";e.popupContentHTML=l}f=new OpenLayers.Feature(this,f,e);this.features.push(f);
...
this));this.layer.map.addPopup(b)}OpenLayers.Event.stop(a)},clearFeatures:function(){if(this.features!=null)for(;this.features.length>0;){var a=this.features[0];OpenLayers.Util.removeItem(this.features,a);a.destroy()}},CLASS_NAME:"OpenLayers.Layer.GeoRSS"});OpenLayers.Symbolizer.Point=OpenLayers.Class(OpenLayers.Symbolizer,{initialize:function(a){OpenLayers.Symbolizer.prototype.initialize.apply(this,arguments)},CLASS_NAME:"OpenLayers.Symbolizer.Point"});
...
graphicName:"square"},read:function(a,b){var b=OpenLayers.Util.applyDefaults(b,this.options),c={namedLayers:b.namedLayersAsArray===true?[]:{}};this.readChildNodes(a,c);return c},readers:OpenLayers.Util.applyDefaults({sld:{StyledLayerDescriptor:function(a,b){b.version=a.getAttribute("version");this.readChildNodes(a,b)},Name:function(a,b){b.name=this.getChildValue(a)},Title:function(a,b){b.title=this.getChildValue(a)},Abstract:function(a,b){b.description=this.getChildValue(a)},NamedLayer:function(a,
b){var c={userStyles:[],namedStyles:[]};this.readChildNodes(a,c);for(var d=0,e=c.userStyles.length;d<e;++d)c.userStyles[d].layerName=c.name;OpenLayers.Util.isArray(b.namedLayers)?b.namedLayers.push(c):b.namedLayers[c.name]=c},NamedStyle:function(a,b){b.namedStyles.push(this.getChildName(a.firstChild))},UserStyle:function(a,b){var c={defaultsPerSymbolizer:true,rules:[]};this.featureTypeCounter=-1;this.readChildNodes(a,c);if(this.multipleSymbolizers){delete c.defaultsPerSymbolizer;c=new OpenLayers.Style2(c)}else c=
new OpenLayers.Style(this.defaultSymbolizer,c);b.userStyles.push(c)},IsDefault:function(a,b){if(this.getChildValue(a)=="1")b.isDefault=true},FeatureTypeStyle:function(a,b){++this.featureTypeCounter;var c={rules:this.multipleSymbolizers?b.rules:[]};this.readChildNodes(a,c);if(!this.multipleSymbolizers)b.rules=c.rules},Rule:function(a,b){var c;this.multipleSymbolizers&&(c={symbolizers:[]});c=new OpenLayers.Rule(c);this.readChildNodes(a,c);b.rules.push(c)},ElseFilter:function(a,b){b.elseFilter=true},
MinScaleDenominator:function(a,b){b.minScaleDenominator=parseFloat(this.getChildValue(a))},MaxScaleDenominator:function(a,b){b.maxScaleDenominator=parseFloat(this.getChildValue(a))},TextSymbolizer:function(a,b){var c={};this.readChildNodes(a,c);if(this.multipleSymbolizers){c.zIndex=this.featureTypeCounter;b.symbolizers.push(new OpenLayers.Symbolizer.Text(c))}else b.symbolizer.Text=OpenLayers.Util.applyDefaults(c,b.symbolizer.Text)},LabelPlacement:function(a,b){this.readChildNodes(a,b)},PointPlacement:function(a,
b){var c={};this.readChildNodes(a,c);c.labelRotation=c.rotation;delete c.rotation;var d,e=b.labelAnchorPointX,f=b.labelAnchorPointY;e<=1/3?d="l":e>1/3&&e<2/3?d="c":e>=2/3&&(d="r");f<=1/3?d=d+"b":f>1/3&&f<2/3?d=d+"m":f>=2/3&&(d=d+"t");c.labelAlign=d;OpenLayers.Util.applyDefaults(b,c)},AnchorPoint:function(a,b){this.readChildNodes(a,b)},AnchorPointX:function(a,b){var c=this.readers.ogc._expression.call(this,a);if(c)b.labelAnchorPointX=c},AnchorPointY:function(a,b){var c=this.readers.ogc._expression.call(this,
...
a);if(c)b.label=c},Font:function(a,b){this.readChildNodes(a,b)},Halo:function(a,b){var c={};this.readChildNodes(a,c);b.haloRadius=c.haloRadius;b.haloColor=c.fillColor;b.haloOpacity=c.fillOpacity},Radius:function(a,b){var c=this.readers.ogc._expression.call(this,a);if(c!=null)b.haloRadius=c},RasterSymbolizer:function(a,b){var c={};this.readChildNodes(a,c);if(this.multipleSymbolizers){c.zIndex=this.featureTypeCounter;b.symbolizers.push(new OpenLayers.Symbolizer.Raster(c))}else b.symbolizer.Raster=OpenLayers.Util.applyDefaults(c,
b.symbolizer.Raster)},Geometry:function(a,b){b.geometry={};this.readChildNodes(a,b.geometry)},ColorMap:function(a,b){b.colorMap=[];this.readChildNodes(a,b.colorMap)},ColorMapEntry:function(a,b){var c=a.getAttribute("quantity"),d=a.getAttribute("opacity");b.push({color:a.getAttribute("color"),quantity:c!==null?parseFloat(c):void 0,label:a.getAttribute("label")||void 0,opacity:d!==null?parseFloat(d):void 0})},LineSymbolizer:function(a,b){var c={};this.readChildNodes(a,c);if(this.multipleSymbolizers){c.zIndex=
this.featureTypeCounter;b.symbolizers.push(new OpenLayers.Symbolizer.Line(c))}else b.symbolizer.Line=OpenLayers.Util.applyDefaults(c,b.symbolizer.Line)},PolygonSymbolizer:function(a,b){var c={fill:false,stroke:false};this.multipleSymbolizers||(c=b.symbolizer.Polygon||c);this.readChildNodes(a,c);if(this.multipleSymbolizers){c.zIndex=this.featureTypeCounter;b.symbolizers.push(new OpenLayers.Symbolizer.Polygon(c))}else b.symbolizer.Polygon=c},PointSymbolizer:function(a,b){var c={fill:false,stroke:false,
graphic:false};this.multipleSymbolizers||(c=b.symbolizer.Point||c);this.readChildNodes(a,c);if(this.multipleSymbolizers){c.zIndex=this.featureTypeCounter;b.symbolizers.push(new OpenLayers.Symbolizer.Point(c))}else b.symbolizer.Point=c},Stroke:function(a,b){b.stroke=true;this.readChildNodes(a,b)},Fill:function(a,b){b.fill=true;this.readChildNodes(a,b)},CssParameter:function(a,b){var c=a.getAttribute("name"),d=this.cssMap[c];b.label&&(c==="fill"?d="fontColor":c==="fill-opacity"&&(d="fontOpacity"));
if(d)(c=this.readers.ogc._expression.call(this,a))&&(b[d]=c)},Graphic:function(a,b){b.graphic=true;var c={};this.readChildNodes(a,c);for(var d=["stroke","strokeColor","strokeWidth","strokeOpacity","strokeLinecap","fill","fillColor","fillOpacity","graphicName","rotation","graphicFormat"],e,f,g=0,h=d.length;g<h;++g){e=d[g];f=c[e];f!=void 0&&(b[e]=f)}if(c.opacity!=void 0)b.graphicOpacity=c.opacity;if(c.size!=void 0)isNaN(c.size/2)?b.graphicWidth=c.size:b.pointRadius=c.size/2;if(c.href!=void 0)b.externalGraphic=
c.href;if(c.rotation!=void 0)b.rotation=c.rotation},ExternalGraphic:function(a,b){this.readChildNodes(a,b)},Mark:function(a,b){this.readChildNodes(a,b)},WellKnownName:function(a,b){b.graphicName=this.getChildValue(a)},Opacity:function(a,b){var c=this.readers.ogc._expression.call(this,a);if(c)b.opacity=c},Size:function(a,b){var c=this.readers.ogc._expression.call(this,a);if(c)b.size=c},Rotation:function(a,b){var c=this.readers.ogc._expression.call(this,a);if(c)b.rotation=c},OnlineResource:function(a,
b){b.href=this.getAttributeNS(a,this.namespaces.xlink,"href")},Format:function(a,b){b.graphicFormat=this.getChildValue(a)}}},OpenLayers.Format.Filter.v1_0_0.prototype.readers),cssMap:{stroke:"strokeColor","stroke-opacity":"strokeOpacity","stroke-width":"strokeWidth","stroke-linecap":"strokeLinecap","stroke-dasharray":"strokeDashstyle",fill:"fillColor","fill-opacity":"fillOpacity","font-family":"fontFamily","font-size":"fontSize","font-weight":"fontWeight","font-style":"fontStyle"},getCssProperty:function(a){var b=
...
d=typeof b=="string"?b.split("${"):[b];c.appendChild(this.createTextNode(d[0]));for(var e,f,g=1,h=d.length;g<h;g++){e=d[g];f=e.indexOf("}");if(f>0){this.writeNode("ogc:PropertyName",{property:e.substring(0,f)},c);c.appendChild(this.createTextNode(e.substring(++f)))}else c.appendChild(this.createTextNode("${"+e))}return c},StyledLayerDescriptor:function(a){var b=this.createElementNSPlus("sld:StyledLayerDescriptor",{attributes:{version:this.VERSION,"xsi:schemaLocation":this.schemaLocation}});b.setAttribute("xmlns:ogc",
this.namespaces.ogc);b.setAttribute("xmlns:gml",this.namespaces.gml);a.name&&this.writeNode("Name",a.name,b);a.title&&this.writeNode("Title",a.title,b);a.description&&this.writeNode("Abstract",a.description,b);if(OpenLayers.Util.isArray(a.namedLayers))for(var c=0,d=a.namedLayers.length;c<d;++c)this.writeNode("NamedLayer",a.namedLayers[c],b);else for(c in a.namedLayers)this.writeNode("NamedLayer",a.namedLayers[c],b);return b},Name:function(a){return this.createElementNSPlus("sld:Name",{value:a})},
...
this.createElementNSPlus("sld:NamedStyle");this.writeNode("Name",a,b);return b},UserStyle:function(a){var b=this.createElementNSPlus("sld:UserStyle");a.name&&this.writeNode("Name",a.name,b);a.title&&this.writeNode("Title",a.title,b);a.description&&this.writeNode("Abstract",a.description,b);a.isDefault&&this.writeNode("IsDefault",a.isDefault,b);if(this.multipleSymbolizers&&a.rules){for(var c={"0":[]},d=[0],e,f,g,h,j,l=0,m=a.rules.length;l<m;++l){e=a.rules[l];if(e.symbolizers){f={};for(var n=0,o=e.symbolizers.length;n<
o;++n){g=e.symbolizers[n];h=g.zIndex;if(!(h in f)){j=e.clone();j.symbolizers=[];f[h]=j}f[h].symbolizers.push(g.clone())}for(h in f){if(!(h in c)){d.push(h);c[h]=[]}c[h].push(f[h])}}else c[0].push(e.clone())}d.sort();l=0;for(m=d.length;l<m;++l){e=c[d[l]];if(e.length>0){j=a.clone();j.rules=c[d[l]];this.writeNode("FeatureTypeStyle",j,b)}}}else this.writeNode("FeatureTypeStyle",a,b);return b},IsDefault:function(a){return this.createElementNSPlus("sld:IsDefault",{value:a?"1":"0"})},FeatureTypeStyle:function(a){for(var b=
...
a.label!=null&&this.writeNode("Label",a.label,b);(a.fontFamily!=null||a.fontSize!=null||a.fontWeight!=null||a.fontStyle!=null)&&this.writeNode("Font",a,b);(a.labelAnchorPointX!=null||a.labelAnchorPointY!=null||a.labelAlign!=null||a.labelXOffset!=null||a.labelYOffset!=null||a.labelRotation!=null||a.labelPerpendicularOffset!=null)&&this.writeNode("LabelPlacement",a,b);(a.haloRadius!=null||a.haloColor!=null||a.haloOpacity!=null)&&this.writeNode("Halo",a,b);(a.fontColor!=null||a.fontOpacity!=null)&&this.writeNode("Fill",
{fillColor:a.fontColor,fillOpacity:a.fontOpacity},b);return b},LabelPlacement:function(a){var b=this.createElementNSPlus("sld:LabelPlacement");(a.labelAnchorPointX!=null||a.labelAnchorPointY!=null||a.labelAlign!=null||a.labelXOffset!=null||a.labelYOffset!=null||a.labelRotation!=null)&&a.labelPerpendicularOffset==null&&this.writeNode("PointPlacement",a,b);a.labelPerpendicularOffset!=null&&this.writeNode("LinePlacement",a,b);return b},LinePlacement:function(a){var b=this.createElementNSPlus("sld:LinePlacement");
this.writeNode("PerpendicularOffset",a.labelPerpendicularOffset,b);return b},PerpendicularOffset:function(a){return this.createElementNSPlus("sld:PerpendicularOffset",{value:a})},PointPlacement:function(a){var b=this.createElementNSPlus("sld:PointPlacement");(a.labelAnchorPointX!=null||a.labelAnchorPointY!=null||a.labelAlign!=null)&&this.writeNode("AnchorPoint",a,b);(a.labelXOffset!=null||a.labelYOffset!=null)&&this.writeNode("Displacement",a,b);a.labelRotation!=null&&this.writeNode("Rotation",a.labelRotation,
b);return b},AnchorPoint:function(a){var b=this.createElementNSPlus("sld:AnchorPoint"),c=a.labelAnchorPointX,d=a.labelAnchorPointY;c!=null&&this.writeNode("AnchorPointX",c,b);d!=null&&this.writeNode("AnchorPointY",d,b);if(c==null&&d==null){var e=a.labelAlign.substr(0,1),a=a.labelAlign.substr(1,1);e==="l"?c=0:e==="c"?c=0.5:e==="r"&&(c=1);a==="b"?d=0:a==="m"?d=0.5:a==="t"&&(d=1);this.writeNode("AnchorPointX",c,b);this.writeNode("AnchorPointY",d,b)}return b},AnchorPointX:function(a){return this.createElementNSPlus("sld:AnchorPointX",
{value:a})},AnchorPointY:function(a){return this.createElementNSPlus("sld:AnchorPointY",{value:a})},Displacement:function(a){var b=this.createElementNSPlus("sld:Displacement");a.labelXOffset!=null&&this.writeNode("DisplacementX",a.labelXOffset,b);a.labelYOffset!=null&&this.writeNode("DisplacementY",a.labelYOffset,b);return b},DisplacementX:function(a){return this.createElementNSPlus("sld:DisplacementX",{value:a})},DisplacementY:function(a){return this.createElementNSPlus("sld:DisplacementY",{value:a})},
Font:function(a){var b=this.createElementNSPlus("sld:Font");a.fontFamily&&this.writeNode("CssParameter",{symbolizer:a,key:"fontFamily"},b);a.fontSize&&this.writeNode("CssParameter",{symbolizer:a,key:"fontSize"},b);a.fontWeight&&this.writeNode("CssParameter",{symbolizer:a,key:"fontWeight"},b);a.fontStyle&&this.writeNode("CssParameter",{symbolizer:a,key:"fontStyle"},b);return b},Label:function(a){return this.writers.sld._OGCExpression.call(this,"sld:Label",a)},Halo:function(a){var b=this.createElementNSPlus("sld:Halo");
a.haloRadius&&this.writeNode("Radius",a.haloRadius,b);(a.haloColor||a.haloOpacity)&&this.writeNode("Fill",{fillColor:a.haloColor,fillOpacity:a.haloOpacity},b);return b},Radius:function(a){return this.createElementNSPlus("sld:Radius",{value:a})},RasterSymbolizer:function(a){var b=this.createElementNSPlus("sld:RasterSymbolizer");a.geometry&&this.writeNode("Geometry",a.geometry,b);a.opacity&&this.writeNode("Opacity",a.opacity,b);a.colorMap&&this.writeNode("ColorMap",a.colorMap,b);return b},Geometry:function(a){var b=
this.createElementNSPlus("sld:Geometry");a.property&&this.writeNode("ogc:PropertyName",a,b);return b},ColorMap:function(a){for(var b=this.createElementNSPlus("sld:ColorMap"),c=0,d=a.length;c<d;++c)this.writeNode("ColorMapEntry",a[c],b);return b},ColorMapEntry:function(a){var b=this.createElementNSPlus("sld:ColorMapEntry");b.setAttribute("color",a.color);a.opacity!==void 0&&b.setAttribute("opacity",parseFloat(a.opacity));a.quantity!==void 0&&b.setAttribute("quantity",parseFloat(a.quantity));a.label!==
void 0&&b.setAttribute("label",a.label);return b},PolygonSymbolizer:function(a){var b=this.createElementNSPlus("sld:PolygonSymbolizer");a.fill!==false&&this.writeNode("Fill",a,b);a.stroke!==false&&this.writeNode("Stroke",a,b);return b},Fill:function(a){var b=this.createElementNSPlus("sld:Fill");a.fillColor&&this.writeNode("CssParameter",{symbolizer:a,key:"fillColor"},b);a.fillOpacity!=null&&this.writeNode("CssParameter",{symbolizer:a,key:"fillOpacity"},b);return b},PointSymbolizer:function(a){var b=
this.createElementNSPlus("sld:PointSymbolizer");this.writeNode("Graphic",a,b);return b},Graphic:function(a){var b=this.createElementNSPlus("sld:Graphic");a.externalGraphic!=void 0?this.writeNode("ExternalGraphic",a,b):this.writeNode("Mark",a,b);a.graphicOpacity!=void 0&&this.writeNode("Opacity",a.graphicOpacity,b);a.pointRadius!=void 0?this.writeNode("Size",a.pointRadius*2,b):a.graphicWidth!=void 0&&this.writeNode("Size",a.graphicWidth,b);a.rotation!=void 0&&this.writeNode("Rotation",a.rotation,b);
return b},ExternalGraphic:function(a){var b=this.createElementNSPlus("sld:ExternalGraphic");this.writeNode("OnlineResource",a.externalGraphic,b);a=a.graphicFormat||this.getGraphicFormat(a.externalGraphic);this.writeNode("Format",a,b);return b},Mark:function(a){var b=this.createElementNSPlus("sld:Mark");a.graphicName&&this.writeNode("WellKnownName",a.graphicName,b);a.fill!==false&&this.writeNode("Fill",a,b);a.stroke!==false&&this.writeNode("Stroke",a,b);return b},WellKnownName:function(a){return this.createElementNSPlus("sld:WellKnownName",
...
a[c],b);return b},Address:function(a){var b=this.createElementNSPlus("xls:Address",{attributes:{countryCode:a.countryCode}});if(a.freeFormAddress)this.writeNode("freeFormAddress",a.freeFormAddress,b);else{a.street&&this.writeNode("StreetAddress",a,b);a.municipality&&this.writeNode("Municipality",a.municipality,b);a.countrySubdivision&&this.writeNode("CountrySubdivision",a.countrySubdivision,b);a.postalCode&&this.writeNode("PostalCode",a.postalCode,b)}return b},freeFormAddress:function(a){return this.createElementNSPlus("freeFormAddress",
...
setStyle:function(a,b,c){var b=b||a._style,c=c||a._options,d=b.title||b.graphicTitle;if(d){a.setAttributeNS(null,"title",d);var e=a.getElementsByTagName("title");if(e.length>0)e[0].firstChild.textContent=d;else{e=this.nodeFactory(null,"title");e.textContent=d;a.appendChild(e)}}var e=parseFloat(a.getAttributeNS(null,"r")),d=1,f;if(a._geometryClass=="OpenLayers.Geometry.Point"&&e){a.style.visibility="";if(b.graphic===false)a.style.visibility="hidden";else if(b.externalGraphic){f=this.getPosition(a);
b.graphicWidth&&b.graphicHeight&&a.setAttributeNS(null,"preserveAspectRatio","none");var e=b.graphicWidth||b.graphicHeight,g=b.graphicHeight||b.graphicWidth,e=e?e:b.pointRadius*2,g=g?g:b.pointRadius*2,h=b.graphicYOffset!=void 0?b.graphicYOffset:-(0.5*g),j=b.graphicOpacity||b.fillOpacity;a.setAttributeNS(null,"x",(f.x+(b.graphicXOffset!=void 0?b.graphicXOffset:-(0.5*e))).toFixed());a.setAttributeNS(null,"y",(f.y+h).toFixed());a.setAttributeNS(null,"width",e);a.setAttributeNS(null,"height",g);a.setAttributeNS(this.xlinkns,
"xlink:href",b.externalGraphic);a.setAttributeNS(null,"style","opacity: "+j);a.onclick=OpenLayers.Event.preventDefault}else if(this.isComplexSymbol(b.graphicName)){var e=b.pointRadius*3,g=e*2,l=this.importSymbol(b.graphicName);f=this.getPosition(a);d=this.symbolMetrics[l.id][0]*3/g;h=a.parentNode;j=a.nextSibling;h&&h.removeChild(a);a.firstChild&&a.removeChild(a.firstChild);a.appendChild(l.firstChild.cloneNode(true));a.setAttributeNS(null,"viewBox",l.getAttributeNS(null,"viewBox"));a.setAttributeNS(null,
"width",g);a.setAttributeNS(null,"height",g);a.setAttributeNS(null,"x",f.x-e);a.setAttributeNS(null,"y",f.y-e);j?h.insertBefore(a,j):h&&h.appendChild(a)}else a.setAttributeNS(null,"r",b.pointRadius);e=b.rotation;if((e!==void 0||a._rotation!==void 0)&&f){a._rotation=e;e=e|0;if(a.nodeName!=="svg")a.setAttributeNS(null,"transform","rotate("+e+" "+f.x+" "+f.y+")");else{f=this.symbolMetrics[l.id];a.firstChild.setAttributeNS(null,"transform","rotate("+e+" "+f[1]+" "+f[2]+")")}}}if(c.isFilled){a.setAttributeNS(null,
"fill",b.fillColor);a.setAttributeNS(null,"fill-opacity",b.fillOpacity)}else a.setAttributeNS(null,"fill","none");if(c.isStroked){a.setAttributeNS(null,"stroke",b.strokeColor);a.setAttributeNS(null,"stroke-opacity",b.strokeOpacity);a.setAttributeNS(null,"stroke-width",b.strokeWidth*d);a.setAttributeNS(null,"stroke-linecap",b.strokeLinecap||"round");a.setAttributeNS(null,"stroke-linejoin","round");b.strokeDashstyle&&a.setAttributeNS(null,"stroke-dasharray",this.dashStyle(b,d))}else a.setAttributeNS(null,
...
if(c.path){a.setAttributeNS(null,"points",c.path);return c.complete?a:null}return false},drawPolygon:function(a,b){for(var c="",d=true,e=true,f,g,h=0,j=b.components.length;h<j;h++){c=c+" M";f=this.getComponentsString(b.components[h].components," ");if(g=f.path){c=c+(" "+g);e=f.complete&&e}else d=false}if(d){a.setAttributeNS(null,"d",c+" z");a.setAttributeNS(null,"fill-rule","evenodd");return e?a:null}return false},drawRectangle:function(a,b){var c=this.getResolution(),d=(b.x-this.featureDx)/c+this.left,
e=this.top-b.y/c;if(this.inValidRange(d,e)){a.setAttributeNS(null,"x",d);a.setAttributeNS(null,"y",e);a.setAttributeNS(null,"width",b.width/c);a.setAttributeNS(null,"height",b.height/c);return a}return false},drawText:function(a,b,c){var d=!!b.labelOutlineWidth;if(d){var e=OpenLayers.Util.extend({},b);e.fontColor=e.labelOutlineColor;e.fontStrokeColor=e.labelOutlineColor;e.fontStrokeWidth=b.labelOutlineWidth;if(b.labelOutlineOpacity)e.fontOpacity=b.labelOutlineOpacity;delete e.labelOutlineWidth;this.drawText(a,
e,c)}var f=this.getResolution(),e=(c.x-this.featureDx)/f+this.left,g=c.y/f-this.top,d=d?this.LABEL_OUTLINE_SUFFIX:this.LABEL_ID_SUFFIX,f=this.nodeFactory(a+d,"text");f.setAttributeNS(null,"x",e);f.setAttributeNS(null,"y",-g);b.fontColor&&f.setAttributeNS(null,"fill",b.fontColor);b.fontStrokeColor&&f.setAttributeNS(null,"stroke",b.fontStrokeColor);b.fontStrokeWidth&&f.setAttributeNS(null,"stroke-width",b.fontStrokeWidth);b.fontOpacity&&f.setAttributeNS(null,"opacity",b.fontOpacity);b.fontFamily&&f.setAttributeNS(null,
"font-family",b.fontFamily);b.fontSize&&f.setAttributeNS(null,"font-size",b.fontSize);b.fontWeight&&f.setAttributeNS(null,"font-weight",b.fontWeight);b.fontStyle&&f.setAttributeNS(null,"font-style",b.fontStyle);if(b.labelSelect===true){f.setAttributeNS(null,"pointer-events","visible");f._featureId=a}else f.setAttributeNS(null,"pointer-events","none");g=b.labelAlign||OpenLayers.Renderer.defaultSymbolizer.labelAlign;f.setAttributeNS(null,"text-anchor",OpenLayers.Renderer.SVG.LABEL_ALIGN[g[0]]||"middle");
OpenLayers.IS_GECKO===true&&f.setAttributeNS(null,"dominant-baseline",OpenLayers.Renderer.SVG.LABEL_ALIGN[g[1]]||"central");for(var h=b.label.split("\n"),j=h.length;f.childNodes.length>j;)f.removeChild(f.lastChild);for(var l=0;l<j;l++){var m=this.nodeFactory(a+d+"_tspan_"+l,"tspan");if(b.labelSelect===true){m._featureId=a;m._geometry=c;m._geometryClass=c.CLASS_NAME}OpenLayers.IS_GECKO===false&&m.setAttributeNS(null,"baseline-shift",OpenLayers.Renderer.SVG.LABEL_VSHIFT[g[1]]||"-35%");m.setAttribute("x",
e);if(l==0){var n=OpenLayers.Renderer.SVG.LABEL_VFACTOR[g[1]];n==null&&(n=-0.5);m.setAttribute("dy",n*(j-1)+"em")}else m.setAttribute("dy","1em");m.textContent=h[l]===""?" ":h[l];m.parentNode||f.appendChild(m)}f.parentNode||this.textRoot.appendChild(f)},getComponentsString:function(a,b){for(var c=[],d=true,e=a.length,f=[],g,h=0;h<e;h++){g=a[h];c.push(g);if(g=this.getShortString(g))f.push(g);else{h>0&&this.getShortString(a[h-1])&&f.push(this.clipLine(a[h],a[h-1]));h<e-1&&this.getShortString(a[h+1])&&
f.push(this.clipLine(a[h],a[h+1]));d=false}}return{path:f.join(b||","),complete:d}},clipLine:function(a,b){if(b.equals(a))return"";var c=this.getResolution(),d=this.MAX_PIXEL-this.translationParameters.x,e=this.MAX_PIXEL-this.translationParameters.y,f=(b.x-this.featureDx)/c+this.left,g=this.top-b.y/c,h=(a.x-this.featureDx)/c+this.left,c=this.top-a.y/c,j;if(h<-d||h>d){j=(c-g)/(h-f);h=h<0?-d:d;c=g+(h-f)*j}if(c<-e||c>e){j=(h-f)/(c-g);c=c<0?-e:e;h=f+(c-g)*j}return h+","+c},getShortString:function(a){var b=
...
e=this.nodeFactory(null,"polygon");a.appendChild(e);for(var c=new OpenLayers.Bounds(Number.MAX_VALUE,Number.MAX_VALUE,0,0),f=[],g,h,j=0;j<d.length;j=j+2){g=d[j];h=d[j+1];c.left=Math.min(c.left,g);c.bottom=Math.min(c.bottom,h);c.right=Math.max(c.right,g);c.top=Math.max(c.top,h);f.push(g,",",h)}e.setAttributeNS(null,"points",f.join(" "));d=c.getWidth();e=c.getHeight();a.setAttributeNS(null,"viewBox",[c.left-d,c.bottom-e,d*3,e*3].join(" "));this.symbolMetrics[b]=[Math.max(d,e),c.getCenterLonLat().lon,
...
OpenLayers.Renderer.SVG.preventDefault=function(a){OpenLayers.Event.preventDefault(a)};OpenLayers.Format.SLD.v1_0_0=OpenLayers.Class(OpenLayers.Format.SLD.v1,{VERSION:"1.0.0",schemaLocation:"http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd",CLASS_NAME:"OpenLayers.Format.SLD.v1_0_0"});
...
this.contentDisplayClass+"'>"+this.contentDiv.innerHTML+"</div>",b=this.map?this.map.div:document.body,c=OpenLayers.Util.getRenderedDimensions(a,null,{displayClass:this.displayClass,containerElement:b}),d=this.getSafeContentSize(c),e=null;if(d.equals(c))e=c;else{c={w:d.w<c.w?d.w:null,h:d.h<c.h?d.h:null};if(c.w&&c.h)e=d;else{a=OpenLayers.Util.getRenderedDimensions(a,c,{displayClass:this.contentDisplayClass,containerElement:b});if(OpenLayers.Element.getStyle(this.contentDiv,"overflow")!="hidden"&&a.equals(d)){d=
OpenLayers.Util.getScrollbarWidth();c.w?a.h=a.h+d:a.w=a.w+d}e=this.getSafeContentSize(a)}}this.setSize(e)},setBackgroundColor:function(a){if(a!=void 0)this.backgroundColor=a;if(this.div!=null)this.div.style.backgroundColor=this.backgroundColor},setOpacity:function(a){if(a!=void 0)this.opacity=a;if(this.div!=null){this.div.style.opacity=this.opacity;this.div.style.filter="alpha(opacity="+this.opacity*100+")"}},setBorder:function(a){if(a!=void 0)this.border=a;if(this.div!=null)this.div.style.border=
...
a*c[b],e=1;if(this.geodesic===true){e=(this.map.getGeodesicPixelSize().w||1E-6)*this.maxWidth/(d/c.km);d=d*e}var f,g;if(d>1E5){f=this.topOutUnits;g=this.bottomOutUnits}else{f=this.topInUnits;g=this.bottomInUnits}var h=d/c[f],j=d/c[g],d=this.getBarLen(h),l=this.getBarLen(j),h=d/c[b]*c[f],j=l/c[b]*c[g],b=h/a/e,a=j/a/e;if(this.eBottom.style.visibility=="visible"){this.eBottom.style.width=Math.round(a)+"px";this.eBottom.innerHTML=l+" "+g}if(this.eTop.style.visibility=="visible"){this.eTop.style.width=
...
this.size,this.offset,this.calculateOffset)},setSize:function(a){if(a!=null)this.size=a;this.draw()},setUrl:function(a){if(a!=null)this.url=a;this.draw()},draw:function(a){OpenLayers.Util.modifyAlphaImageDiv(this.imageDiv,null,null,this.size,this.url,"absolute");this.moveTo(a);return this.imageDiv},erase:function(){this.imageDiv!=null&&this.imageDiv.parentNode!=null&&OpenLayers.Element.remove(this.imageDiv)},setOpacity:function(a){OpenLayers.Util.modifyAlphaImageDiv(this.imageDiv,null,null,null,null,
null,null,null,a)},moveTo:function(a){if(a!=null)this.px=a;if(this.imageDiv!=null)if(this.px==null)this.display(false);else{if(this.calculateOffset)this.offset=this.calculateOffset(this.size);OpenLayers.Util.modifyAlphaImageDiv(this.imageDiv,null,{x:this.px.x+this.offset.x,y:this.px.y+this.offset.y})}},display:function(a){this.imageDiv.style.display=a?"":"none"},isDrawn:function(){return this.imageDiv&&this.imageDiv.parentNode&&this.imageDiv.parentNode.nodeType!=11},CLASS_NAME:"OpenLayers.Icon"});
OpenLayers.Marker=OpenLayers.Class({icon:null,lonlat:null,events:null,map:null,initialize:function(a,b){this.lonlat=a;var c=b?b:OpenLayers.Marker.defaultIcon();if(this.icon==null)this.icon=c;else{this.icon.url=c.url;this.icon.size=c.size;this.icon.offset=c.offset;this.icon.calculateOffset=c.calculateOffset}this.events=new OpenLayers.Events(this,this.icon.imageDiv)},destroy:function(){this.erase();this.map=null;this.events.destroy();this.events=null;if(this.icon!=null){this.icon.destroy();this.icon=
...
1),new OpenLayers.Geometry.Point(0,1),new OpenLayers.Geometry.Point(-1,1),new OpenLayers.Geometry.Point(-1,0),new OpenLayers.Geometry.Point(-1,-1)]),null,typeof this.renderIntent=="string"?null:this.renderIntent);this.box.geometry.move=function(b,c){a._moving=true;OpenLayers.Geometry.LineString.prototype.move.apply(this,arguments);a.center.move(b,c);delete a._moving};for(var b=function(a,b){OpenLayers.Geometry.Point.prototype.move.apply(this,arguments);this._rotationHandle&&this._rotationHandle.geometry.move(a,
b);this._handle.geometry.move(a,b)},c=function(a,b,c){OpenLayers.Geometry.Point.prototype.resize.apply(this,arguments);this._rotationHandle&&this._rotationHandle.geometry.resize(a,b,c);this._handle.geometry.resize(a,b,c)},d=function(a,b){OpenLayers.Geometry.Point.prototype.rotate.apply(this,arguments);this._rotationHandle&&this._rotationHandle.geometry.rotate(a,b);this._handle.geometry.rotate(a,b)},e=function(b,c){var d=this.x,e=this.y;OpenLayers.Geometry.Point.prototype.move.call(this,b,c);if(!a._moving){var f=
a.dragControl.handlers.drag.evt,g=!(!a._setfeature&&a.preserveAspectRatio)&&!(f&&f.shiftKey),h=new OpenLayers.Geometry.Point(d,e),f=a.center;this.rotate(-a.rotation,f);h.rotate(-a.rotation,f);var j=this.x-f.x,l=this.y-f.y,m=j-(this.x-h.x),n=l-(this.y-h.y);if(a.irregular&&!a._setfeature){j=j-(this.x-h.x)/2;l=l-(this.y-h.y)/2}this.x=d;this.y=e;h=1;if(g){l=Math.abs(n)<1E-5?1:l/n;h=(Math.abs(m)<1E-5?1:j/m)/l}else{m=Math.sqrt(m*m+n*n);l=Math.sqrt(j*j+l*l)/m}a._moving=true;a.box.geometry.rotate(-a.rotation,
f);delete a._moving;a.box.geometry.resize(l,f,h);a.box.geometry.rotate(a.rotation,f);a.transformFeature({scale:l,ratio:h});if(a.irregular&&!a._setfeature){j=f.clone();j.x=j.x+(Math.abs(d-f.x)<1E-5?0:this.x-d);j.y=j.y+(Math.abs(e-f.y)<1E-5?0:this.y-e);a.box.geometry.move(this.x-d,this.y-e);a.transformFeature({center:j})}}},f=function(b,c){var d=this.x,e=this.y;OpenLayers.Geometry.Point.prototype.move.call(this,b,c);if(!a._moving){var f=a.dragControl.handlers.drag.evt,f=f&&f.shiftKey?45:1,g=a.center,
h=this.x-g.x,j=this.y-g.y;this.x=d;this.y=e;d=Math.atan2(j-c,h-b);d=Math.atan2(j,h)-d;d=d*(180/Math.PI);a._angle=(a._angle+d)%360;d=a.rotation%f;if(Math.abs(a._angle)>=f||d!==0){d=Math.round(a._angle/f)*f-d;a._angle=0;a.box.geometry.rotate(d,g);a.transformFeature({rotation:d})}}},g=Array(8),h=Array(4),j,l,m,n=["sw","s","se","e","ne","n","nw","w"],o=0;o<8;++o){j=this.box.geometry.components[o];l=new OpenLayers.Feature.Vector(j.clone(),{role:n[o]+"-resize"},typeof this.renderIntent=="string"?null:this.renderIntent);
if(o%2==0){m=new OpenLayers.Feature.Vector(j.clone(),{role:n[o]+"-rotate"},typeof this.rotationHandleSymbolizer=="string"?null:this.rotationHandleSymbolizer);m.geometry.move=f;j._rotationHandle=m;h[o/2]=m}j.move=b;j.resize=c;j.rotate=d;l.geometry.move=e;j._handle=l;g[o]=l}this.rotationHandles=h;this.handles=g},createControl:function(){var a=this;this.dragControl=new OpenLayers.Control.DragFeature(this.layer,{documentDrag:true,moveFeature:function(b){if(this.feature===a.feature)this.feature=a.box;
OpenLayers.Control.DragFeature.prototype.moveFeature.apply(this,arguments)},onDrag:function(b){b===a.box&&a.transformFeature({center:a.center})},onStart:function(b){var c=!a.geometryTypes||OpenLayers.Util.indexOf(a.geometryTypes,b.geometry.CLASS_NAME)!==-1,d=OpenLayers.Util.indexOf(a.handles,b),d=d+OpenLayers.Util.indexOf(a.rotationHandles,b);b!==a.feature&&(b!==a.box&&d==-2&&c)&&a.setFeature(b)},onComplete:function(){a.events.triggerEvent("transformcomplete",{feature:a.feature})}})},drawHandles:function(){for(var a=
this.layer,b=0;b<8;++b){this.rotate&&b%2===0&&a.drawFeature(this.rotationHandles[b/2],this.rotationHandleSymbolizer);a.drawFeature(this.handles[b],this.renderIntent)}},transformFeature:function(a){if(!this._setfeature){this.scale=this.scale*(a.scale||1);this.ratio=this.ratio*(a.ratio||1);var b=this.rotation;this.rotation=(this.rotation+(a.rotation||0))%360;if(this.events.triggerEvent("beforetransform",a)!==false){var c=this.feature,d=c.geometry,e=this.center;d.rotate(-b,e);a.scale||a.ratio?d.resize(a.scale,
e,a.ratio):a.center&&c.move(a.center.getBounds().getCenterLonLat());d.rotate(this.rotation,e);this.layer.drawFeature(c);c.toState(OpenLayers.State.UPDATE);this.events.triggerEvent("transform",a)}}this.layer.drawFeature(this.box,this.renderIntent);this.drawHandles()},destroy:function(){for(var a,b=0;b<8;++b){a=this.box.geometry.components[b];a._handle.destroy();a._handle=null;a._rotationHandle&&a._rotationHandle.destroy();a._rotationHandle=null}this.rotationHandles=this.rotationHandleSymbolizer=this.handles=
...
arguments)){this.dragHandler.deactivate()&&this.zoomBox&&this.removeBox();return true}return false},getBoxOffsets:function(){if(!this.boxOffsets){var a=document.createElement("div");a.style.position="absolute";a.style.border="1px solid black";a.style.width="3px";document.body.appendChild(a);var b=a.clientWidth==3;document.body.removeChild(a);var a=parseInt(OpenLayers.Element.getStyle(this.zoomBox,"border-left-width")),c=parseInt(OpenLayers.Element.getStyle(this.zoomBox,"border-right-width")),d=parseInt(OpenLayers.Element.getStyle(this.zoomBox,
...
c.x-e*a)/(d-e),y:(d*c.y-e*g)/(d-e)});f==this.map.getZoom()&&this.alwaysZoom==true&&this.map.zoomTo(f+(this.out?-1:1))}else this.zoomOnClick&&(this.out?this.map.zoomTo(this.map.getZoom()-1,a):this.map.zoomTo(this.map.getZoom()+1,a))},CLASS_NAME:"OpenLayers.Control.ZoomBox"});
...
documentDrag:this.documentDrag},this.dragPanOptions));this.zoomBox=new OpenLayers.Control.ZoomBox({map:this.map,keyMask:this.zoomBoxKeyMask});this.dragPan.draw();this.zoomBox.draw();this.handlers.wheel=new OpenLayers.Handler.MouseWheel(this,{up:this.wheelUp,down:this.wheelDown},OpenLayers.Util.extend(this.map.fractionalZoom?{}:{cumulative:false,interval:50,maxDelta:6},this.mouseWheelOptions));if(OpenLayers.Control.PinchZoom)this.pinchZoom=new OpenLayers.Control.PinchZoom(OpenLayers.Util.extend({map:this.map},
...
new OpenLayers.Control.DrawFeature(a,OpenLayers.Handler.Polygon,{displayClass:"olControlDrawFeaturePolygon",handlerOptions:{citeCompliant:this.citeCompliant}})];this.addControls(c)},draw:function(){var a=OpenLayers.Control.Panel.prototype.draw.apply(this,arguments);if(this.defaultControl===null)this.defaultControl=this.controls[0];return a},CLASS_NAME:"OpenLayers.Control.EditingToolbar"});
...
filters:[this.layer.filter,a]}));return a},merge:function(a){this.layer.destroyFeatures();if(a.success()){var b=a.features;if(b&&b.length>0){var c=this.layer.projection,d=this.layer.map.getProjectionObject();if(!d.equals(c))for(var e,f=0,g=b.length;f<g;++f)(e=b[f].geometry)&&e.transform(c,d);this.layer.addFeatures(b)}}else this.bounds=null;this.response=null;this.layer.events.triggerEvent("loadend",{response:a})},CLASS_NAME:"OpenLayers.Strategy.BBOX"});
...
d.tileMatrixSetLinks.length>=1&&(h=c.tileMatrixSets[d.tileMatrixSetLinks[0].tileMatrixSet]);if(!h)throw Error("matrixSet not found");for(var j,e=0,f=d.styles.length;e<f;++e){j=d.styles[e];if(j.isDefault)break}c=b.requestEncoding;if(!c){c="KVP";if(a.operationsMetadata.GetTile.dcp.http){var l=a.operationsMetadata.GetTile.dcp.http;if(l.get[0].constraints){l=l.get[0].constraints.GetEncoding.allowedValues;if(!l.KVP&&(l.REST||l.RESTful))c="REST"}}}var l=[],m=b.params||{};delete b.params;for(var n=0,o=d.dimensions.length;n<
o;n++){var p=d.dimensions[n];l.push(p.identifier);m.hasOwnProperty(p.identifier)||(m[p.identifier]=p["default"])}var n=b.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),o=b.units||(n==="EPSG:4326"?"degrees":"m"),p=[],q;for(q in h.matrixIds)h.matrixIds.hasOwnProperty(q)&&p.push(h.matrixIds[q].scaleDenominator*2.8E-4/OpenLayers.METERS_PER_INCH/OpenLayers.INCHES_PER_UNIT[o]);if(c==="REST"&&d.resourceUrls){q=[];for(var f=0,r=d.resourceUrls.length;f<r;++f){e=d.resourceUrls[f];
e.format===g&&e.resourceType==="tile"&&q.push(e.template)}}else{r=a.operationsMetadata.GetTile.dcp.http.get;q=[];for(var s,e=0,f=r.length;e<f;e++){s=r[e].constraints;(!s||s&&s.GetEncoding.allowedValues[c])&&q.push(r[e].url)}}return new OpenLayers.Layer.WMTS(OpenLayers.Util.applyDefaults(b,{url:q,requestEncoding:c,name:d.title,style:j.identifier,format:g,matrixIds:h.matrixIds,matrixSet:h.identifier,projection:n,units:o,resolutions:b.isBaseLayer===false?void 0:p,serverResolutions:p,tileFullExtent:h.bounds,
dimensions:l,params:m}))},CLASS_NAME:"OpenLayers.Format.WMTSCapabilities"});
OpenLayers.Layer.Google.v3={DEFAULTS:{sphericalMercator:!0,projection:"EPSG:900913"},animationEnabled:!0,loadMapObject:function(){if(!this.type)this.type=google.maps.MapTypeId.ROADMAP;var a,b=OpenLayers.Layer.Google.cache[this.map.id];if(b){a=b.mapObject;++b.count}else{a=this.map.getCenter();b=document.createElement("div");b.className="olForeignContainer";b.style.width="100%";b.style.height="100%";a=new google.maps.Map(b,{center:a?new google.maps.LatLng(a.lat,a.lon):new google.maps.LatLng(0,0),zoom:this.map.getZoom()||
0,mapTypeId:this.type,disableDefaultUI:true,keyboardShortcuts:false,draggable:false,disableDoubleClickZoom:true,scrollwheel:false,streetViewControl:false});b=document.createElement("div");b.style.width="100%";b.style.height="100%";a.controls[google.maps.ControlPosition.TOP_LEFT].push(b);b={googleControl:b,mapObject:a,count:1};OpenLayers.Layer.Google.cache[this.map.id]=b}this.mapObject=a;this.setGMapVisibility(this.visibility)},onMapResize:function(){this.visibility&&google.maps.event.trigger(this.mapObject,
"resize")},setGMapVisibility:function(a){var b=OpenLayers.Layer.Google.cache[this.map.id],c=this.map;if(b){for(var d=this.type,e=c.layers,f,g=e.length-1;g>=0;--g){f=e[g];if(f instanceof OpenLayers.Layer.Google&&f.visibility===true&&f.inRange===true){d=f.type;a=true;break}}e=this.mapObject.getDiv();if(a===true){if(e.parentNode!==c.div)if(b.rendered){c.div.appendChild(e);b.googleControl.appendChild(c.viewPortDiv);google.maps.event.trigger(this.mapObject,"resize")}else{var h=this;google.maps.event.addListenerOnce(this.mapObject,
"tilesloaded",function(){b.rendered=true;h.setGMapVisibility(h.getVisibility());h.moveTo(h.map.getCenter())})}this.mapObject.setMapTypeId(d)}else if(b.googleControl.hasChildNodes()){c.div.appendChild(c.viewPortDiv);c.div.removeChild(e)}}},getMapContainer:function(){return this.mapObject.getDiv()},getMapObjectBoundsFromOLBounds:function(a){var b=null;if(a!=null){b=this.sphericalMercator?this.inverseMercator(a.bottom,a.left):new OpenLayers.LonLat(a.bottom,a.left);a=this.sphericalMercator?this.inverseMercator(a.top,
...
a.lat)},getMapObjectPixelFromMapObjectLonLat:function(a){var b=this.getLongitudeFromMapObjectLonLat(a),a=this.getLatitudeFromMapObjectLonLat(a),c=this.map.getResolution(),d=this.map.getExtent();return this.getMapObjectPixelFromXY(1/c*(b-d.left),1/c*(d.top-a))},setMapObjectCenter:function(a,b){if(this.animationEnabled===false&&b!=this.mapObject.zoom){var c=this.getMapContainer();google.maps.event.addListenerOnce(this.mapObject,"idle",function(){c.style.visibility=""});c.style.visibility="hidden"}this.mapObject.setOptions({center:a,
zoom:b})},getMapObjectZoomFromMapObjectBounds:function(a){return this.mapObject.getBoundsZoomLevel(a)},getMapObjectLonLatFromLonLat:function(a,b){var c;if(this.sphericalMercator){c=this.inverseMercator(a,b);c=new google.maps.LatLng(c.lat,c.lon)}else c=new google.maps.LatLng(b,a);return c},getMapObjectPixelFromXY:function(a,b){return new google.maps.Point(a,b)}};
...
this.readChildNodes(a,c);b.push(c)},BoundingBoxData:function(a,b){b.boundingBoxData={};this.readChildNodes(a,b.boundingBoxData)},CRS:function(a,b){if(!b.CRSs)b.CRSs={};b.CRSs[this.getChildValue(a)]=true},LiteralData:function(a,b){b.literalData={};this.readChildNodes(a,b.literalData)},ComplexData:function(a,b){b.complexData={};this.readChildNodes(a,b.complexData)},Default:function(a,b){b["default"]={};this.readChildNodes(a,b["default"])},Supported:function(a,b){b.supported={};this.readChildNodes(a,
b.supported)},Format:function(a,b){var c={};this.readChildNodes(a,c);if(!b.formats)b.formats={};b.formats[c.mimeType]=true},MimeType:function(a,b){b.mimeType=this.getChildValue(a)}},ows:OpenLayers.Format.OWSCommon.v1_1_0.prototype.readers.ows},CLASS_NAME:"OpenLayers.Format.WPSDescribeProcess"});
...
this,c=this.getOutputIndex(b.description.processOutputs,a.output);b.setResponseForm({outputIndex:c});(function e(){OpenLayers.Util.removeItem(b.executeCallbacks,e);b.chained!==0?b.executeCallbacks.push(e):OpenLayers.Request.POST({url:b.client.servers[b.server].url,data:(new OpenLayers.Format.WPSExecute).write(b.description),success:function(e){var g=b.findMimeType(b.description.processOutputs[c].complexOutput.supported.formats),e=b.formats[g].read(e.responseText);e instanceof OpenLayers.Feature.Vector&&
(e=[e]);if(a.success){g={};g[a.output||"result"]=e;a.success.call(a.scope,g)}},scope:b})})()},scope:this})},output:function(a){return new OpenLayers.WPSProcess.ChainLink({process:this,output:a})},parseDescription:function(){var a=this.client.servers[this.server];this.description=(new OpenLayers.Format.WPSDescribeProcess).read(a.processDescription[this.identifier]).processDescriptions[this.identifier]},setInputData:function(a,b){delete a.data;delete a.reference;if(b instanceof OpenLayers.WPSProcess.ChainLink){++this.chained;
a.reference={method:"POST",href:b.process.server===this.server?this.localWPS:this.client.servers[b.process.server].url};b.process.describe({callback:function(){--this.chained;this.chainProcess(a,b)},scope:this})}else{a.data={};var c=a.complexData;if(c){c=this.findMimeType(c.supported.formats);a.data.complexData={mimeType:c,value:this.formats[c].write(this.toFeatures(b))}}else a.data.literalData={value:b}}},setResponseForm:function(a){var a=a||{},b=this.description.processOutputs[a.outputIndex||0];
this.description.responseForm={rawDataOutput:{identifier:b.identifier,mimeType:this.findMimeType(b.complexOutput.supported.formats,a.supportedFormats)}}},getOutputIndex:function(a,b){var c;if(b)for(var d=a.length-1;d>=0;--d){if(a[d].identifier===b){c=d;break}}else c=0;return c},chainProcess:function(a,b){var c=this.getOutputIndex(b.process.description.processOutputs,b.output);a.reference.mimeType=this.findMimeType(a.complexData.supported.formats,b.process.description.processOutputs[c].complexOutput.supported.formats);
var d={};d[a.reference.mimeType]=true;b.process.setResponseForm({outputIndex:c,supportedFormats:d});for(a.reference.body=b.process.description;this.executeCallbacks.length>0;)this.executeCallbacks[0]()},toFeatures:function(a){var b=OpenLayers.Util.isArray(a);b||(a=[a]);for(var c=Array(a.length),d,e=0,f=a.length;e<f;++e){d=a[e];c[e]=d instanceof OpenLayers.Feature.Vector?d:new OpenLayers.Feature.Vector(d)}return b?c:c[0]},findMimeType:function(a,b){var b=b||this.formats,c;for(c in a)if(c in b)return c},
CLASS_NAME:"OpenLayers.WPSProcess"});OpenLayers.WPSProcess.ChainLink=OpenLayers.Class({process:null,output:null,initialize:function(a){OpenLayers.Util.extend(this,a)},CLASS_NAME:"OpenLayers.WPSProcess.ChainLink"});
OpenLayers.WPSClient=OpenLayers.Class({servers:null,version:"1.0.0",lazy:!1,events:null,initialize:function(a){OpenLayers.Util.extend(this,a);this.events=new OpenLayers.Events(this);this.servers={};for(var b in a.servers)this.servers[b]=typeof a.servers[b]=="string"?{url:a.servers[b],version:this.version,processDescription:{}}:a.servers[b]},execute:function(a){this.getProcess(a.server,a.process).execute({inputs:a.inputs,success:a.success,scope:a.scope})},getProcess:function(a,b){var c=new OpenLayers.WPSProcess({client:this,
server:a,identifier:b});this.lazy||c.describe();return c},describeProcess:function(a,b,c,d){var e=this.servers[a];if(e.processDescription[b])window.setTimeout(function(){c.call(d,e.processDescription[b])},0);else if(b in e.processDescription)this.events.register("describeprocess",this,function g(a){if(a.identifier===b){this.events.unregister("describeprocess",this,g);c.call(d,a.raw)}});else{e.processDescription[b]=null;OpenLayers.Request.GET({url:e.url,params:{SERVICE:"WPS",VERSION:e.version,REQUEST:"DescribeProcess",
IDENTIFIER:b},success:function(a){e.processDescription[b]=a.responseText;this.events.triggerEvent("describeprocess",{identifier:b,raw:a.responseText})},scope:this})}},destroy:function(){this.events.destroy();this.servers=this.events=null},CLASS_NAME:"OpenLayers.WPSClient"});
...
e.split("\t"),f=new OpenLayers.Geometry.Point(0,0),g={},h=this.defaultStyle?OpenLayers.Util.applyDefaults({},this.defaultStyle):null,j=false,l=0;l<e.length;l++)if(e[l])if(b[l]=="point"){j=e[l].split(",");f.y=parseFloat(j[0]);f.x=parseFloat(j[1]);j=true}else if(b[l]=="lat"){f.y=parseFloat(e[l]);j=true}else if(b[l]=="lon"){f.x=parseFloat(e[l]);j=true}else if(b[l]=="title")g.title=e[l];else if(b[l]=="image"||b[l]=="icon"&&h)h.externalGraphic=e[l];else if(b[l]=="iconSize"&&h){var m=e[l].split(",");h.graphicWidth=
parseFloat(m[0]);h.graphicHeight=parseFloat(m[1])}else if(b[l]=="iconOffset"&&h){m=e[l].split(",");h.graphicXOffset=parseFloat(m[0]);h.graphicYOffset=parseFloat(m[1])}else b[l]=="description"?g.description=e[l]:b[l]=="overflow"?g.overflow=e[l]:g[b[l]]=e[l];if(j){this.internalProjection&&this.externalProjection&&f.transform(this.externalProjection,this.internalProjection);e=new OpenLayers.Feature.Vector(f,g,h);c.push(e)}}else b=e.split("\t")}return c},CLASS_NAME:"OpenLayers.Format.Text"});
...
(new OpenLayers.Format.Text(b)).read(a),b=0,c=a.length;b<c;b++){var d={},e=a[b],f,g,h;f=new OpenLayers.LonLat(e.geometry.x,e.geometry.y);e.style.graphicWidth&&e.style.graphicHeight&&(g=new OpenLayers.Size(e.style.graphicWidth,e.style.graphicHeight));e.style.graphicXOffset!==void 0&&e.style.graphicYOffset!==void 0&&(h=new OpenLayers.Pixel(e.style.graphicXOffset,e.style.graphicYOffset));if(e.style.externalGraphic!=null)d.icon=new OpenLayers.Icon(e.style.externalGraphic,g,h);else{d.icon=OpenLayers.Marker.defaultIcon();
...
createSLD:function(a,b,c){for(var d={version:"1.0.0",namedLayers:{}},e=(""+a.params.LAYERS).split(","),f=0,g=e.length;f<g;f++){var h=e[f];d.namedLayers[h]={name:h,userStyles:[]};var j=this.selectionSymbolizer,l=c[f];l.type.indexOf("Polygon")>=0?j={Polygon:this.selectionSymbolizer.Polygon}:l.type.indexOf("LineString")>=0?j={Line:this.selectionSymbolizer.Line}:l.type.indexOf("Point")>=0&&(j={Point:this.selectionSymbolizer.Point});d.namedLayers[h].userStyles.push({name:"default",rules:[new OpenLayers.Rule({symbolizer:j,
filter:b[f],maxScaleDenominator:a.options.minScale})]})}return(new OpenLayers.Format.SLD({srsName:this.map.getProjection()})).write(d)},parseDescribeLayer:function(a){var b=new OpenLayers.Format.WMSDescribeLayer,c=a.responseXML;if(!c||!c.documentElement)c=a.responseText;for(var a=b.read(c),b=[],c=null,d=0,e=a.length;d<e;d++)if(a[d].owsType=="WFS"){b.push(a[d].typeName);c=a[d].owsURL}OpenLayers.Request.GET({url:c,params:{SERVICE:"WFS",TYPENAME:b.toString(),REQUEST:"DescribeFeatureType",VERSION:"1.0.0"},
callback:function(a){var b=new OpenLayers.Format.WFSDescribeFeatureType,c=a.responseXML;if(!c||!c.documentElement)c=a.responseText;a=b.read(c);this.control.wfsCache[this.layer.id]=a;this.control._queue&&this.control.applySelection()},scope:this})},getGeometryAttributes:function(a){for(var b=[],a=this.wfsCache[a.id],c=0,d=a.featureTypes.length;c<d;c++)for(var e=a.featureTypes[c].properties,f=0,g=e.length;f<g;f++){var h=e[f],j=h.type;(j.indexOf("LineString")>=0||j.indexOf("GeometryAssociationType")>=
...
OpenLayers.Control.prototype.deactivate.call(this);if(a)for(var b=0,c=this.layers.length;b<c;b++){var d=this.layers[b];if(d&&this.clearOnDeactivate===true){var e=this.layerCache,f=e[d.id];if(f){d.events.un({visibilitychanged:this.coupleLayerVisiblity,scope:f});f.destroy();delete e[d.id]}}}return a},setLayers:function(a){if(this.active){this.deactivate();this.layers=a;this.activate()}else this.layers=a},createFilter:function(a,b){var c=null;this.handler instanceof OpenLayers.Handler.RegularPolygon?
c=this.handler.irregular===true?new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.BBOX,property:a.name,value:b.getBounds()}):new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.INTERSECTS,property:a.name,value:b}):this.handler instanceof OpenLayers.Handler.Polygon?c=new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.INTERSECTS,property:a.name,value:b}):this.handler instanceof OpenLayers.Handler.Path?c=a.type.indexOf("Point")>=0?new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.DWITHIN,
...
0.01,distanceUnits:this.map.getUnits(),value:b}));return c},select:function(a){this._queue=function(){for(var b=0,c=this.layers.length;b<c;b++){for(var d=this.layers[b],e=this.getGeometryAttributes(d),f=[],g=0,h=e.length;g<h;g++){var j=e[g];if(j!==null){if(!(a instanceof OpenLayers.Geometry)){var l=this.map.getLonLatFromPixel(a.xy);a=new OpenLayers.Geometry.Point(l.lon,l.lat)}j=this.createFilter(j,a);j!==null&&f.push(j)}}g=this.createSelectionLayer(d);this.events.triggerEvent("selected",{layer:d,
filters:f});d=this.createSLD(d,f,e);g.mergeNewParams({SLD_BODY:d});delete this._queue}};this.applySelection()},applySelection:function(){for(var a=true,b=0,c=this.layers.length;b<c;b++)if(!this.wfsCache[this.layers[b].id]){a=false;break}a&&this._queue.call(this)},CLASS_NAME:"OpenLayers.Control.SLDSelect"});
...
f=OpenLayers.Util.upperCaseObject(OpenLayers.Util.getParameters(c)),g;for(g in e)g.toUpperCase()in f&&delete e[g];e=OpenLayers.Util.getParameterString(e);e=e.replace(/,/g,"+");if(e!=""){f=c.charAt(c.length-1);d=f=="&"||f=="?"?d+e:c.indexOf("?")==-1?d+("?"+e):d+("&"+e)}return d},getImageFilePath:function(a,b){var c=b==null?this.url:b;typeof c=="object"&&(c=c[Math.floor(Math.random()*c.length)]);var d="",e="";a.tilerow<0&&(d="-");d=a.tilerow==0?d+"0":d+Math.floor(Math.abs(a.tilerow/this.params.tileRowsPerFolder))*
this.params.tileRowsPerFolder;a.tilecol<0&&(e="-");e=a.tilecol==0?e+"0":e+Math.floor(Math.abs(a.tilecol/this.params.tileColumnsPerFolder))*this.params.tileColumnsPerFolder;d="/S"+Math.floor(a.scaleindex)+"/"+this.params.basemaplayergroupname+"/R"+d+"/C"+e+"/"+a.tilerow%this.params.tileRowsPerFolder+"_"+a.tilecol%this.params.tileColumnsPerFolder+"."+this.params.format;this.params.querystring&&(d=d+("?"+this.params.querystring));return c+d},CLASS_NAME:"OpenLayers.Layer.MapGuide"});
...
this.handler=new a(this,this.callbacks,b);c&&this.activate()},measureComplete:function(a){this.cancelDelay();this.measure(a,"measure")},measurePartial:function(a,b){this.cancelDelay();b=b.clone();this.handler.freehandMode(this.handler.evt)?this.measure(b,"measurepartial"):this.delayedTrigger=window.setTimeout(OpenLayers.Function.bind(function(){this.delayedTrigger=null;this.measure(b,"measurepartial")},this),this.partialDelay)},measureImmediate:function(a,b,c){if(c&&!this.handler.freehandMode(this.handler.evt)){this.cancelDelay();
this.measure(b.geometry,"measurepartial")}},cancelDelay:function(){if(this.delayedTrigger!==null){window.clearTimeout(this.delayedTrigger);this.delayedTrigger=null}},measure:function(a,b){var c,d;if(a.CLASS_NAME.indexOf("LineString")>-1){c=this.getBestLength(a);d=1}else{c=this.getBestArea(a);d=2}this.events.triggerEvent(b,{measure:c[0],units:c[1],order:d,geometry:a})},getBestArea:function(a){for(var b=this.displaySystemUnits[this.displaySystem],c,d,e=0,f=b.length;e<f;++e){c=b[e];d=this.getArea(a,
c);if(d>1)break}return[d,c]},getArea:function(a,b){var c,d;if(this.geodesic){c=a.getGeodesicArea(this.map.getProjectionObject());d="m"}else{c=a.getArea();d=this.map.getUnits()}var e=OpenLayers.INCHES_PER_UNIT[b];e&&(c=c*Math.pow(OpenLayers.INCHES_PER_UNIT[d]/e,2));return c},getBestLength:function(a){for(var b=this.displaySystemUnits[this.displaySystem],c,d,e=0,f=b.length;e<f;++e){c=b[e];d=this.getLength(a,c);if(d>1)break}return[d,c]},getLength:function(a,b){var c,d;if(this.geodesic){c=a.getGeodesicLength(this.map.getProjectionObject());
d="m"}else{c=a.getLength();d=this.map.getUnits()}var e=OpenLayers.INCHES_PER_UNIT[b];e&&(c=c*(OpenLayers.INCHES_PER_UNIT[d]/e));return c},CLASS_NAME:"OpenLayers.Control.Measure"});
...
OpenLayers.Popup.CSSFramedCloud=OpenLayers.Class(OpenLayers.Popup.Framed,{autoSize:!0,panMapIfOutOfView:!0,fixedRelativePosition:!1,positionBlocks:{tl:{offset:new OpenLayers.Pixel(44,-6),padding:new OpenLayers.Bounds(5,14,5,5),blocks:[{className:"olwidgetPopupStemTL",size:new OpenLayers.Size(20,20),anchor:new OpenLayers.Bounds(null,4,32,null),position:new OpenLayers.Pixel(0,-28)}]},tr:{offset:new OpenLayers.Pixel(-44,-6),padding:new OpenLayers.Bounds(5,14,5,5),blocks:[{className:"olwidgetPopupStemTR",
size:new OpenLayers.Size(20,20),anchor:new OpenLayers.Bounds(32,4,null,null),position:new OpenLayers.Pixel(0,-28)}]},bl:{offset:new OpenLayers.Pixel(44,6),padding:new OpenLayers.Bounds(5,5,5,14),blocks:[{className:"olwidgetPopupStemBL",size:new OpenLayers.Size(20,20),anchor:new OpenLayers.Bounds(null,null,32,4),position:new OpenLayers.Pixel(0,0)}]},br:{offset:new OpenLayers.Pixel(-44,6),padding:new OpenLayers.Bounds(5,5,5,14),blocks:[{className:"olwidgetPopupStemBR",size:new OpenLayers.Size(20,20),
anchor:new OpenLayers.Bounds(32,null,null,4),position:new OpenLayers.Pixel(0,0)}]}},initialize:function(a,b,c,d,e,f,g,h,j){if(h&&h!="auto"){this.fixedRelativePosition=true;this.relativePosition=h}this.separator=j===void 0?" of ":j;this.olwidgetCloseBox=f;this.olwidgetCloseBoxCallback=g;this.page=0;OpenLayers.Popup.Framed.prototype.initialize.apply(this,[a,b,c,d,e,false,null])},setContentHTML:function(a){if(a!==null&&a!==void 0)this.contentHTML=a;if(this.contentDiv!==null){var b=this;this.contentDiv.innerHTML=
"";a=document.createElement("div");a.innerHTML=this.contentHTML;a.className="olwidgetPopupContent";this.contentDiv.appendChild(a);if(this.olwidgetCloseBox){a=document.createElement("div");a.className="olwidgetPopupCloseBox";a.innerHTML="close";a.onclick=function(a){b.olwidgetCloseBoxCallback.apply(b,arguments)};this.contentDiv.appendChild(a)}if(this.autoSize){this.registerImageListeners();this.updateSize()}}},createBlocks:function(){this.blocks=[];var a=null,b;for(b in this.positionBlocks){a=b;break}a=
this.positionBlocks[a];for(b=0;b<a.blocks.length;b++){var c={};this.blocks.push(c);c.div=OpenLayers.Util.createDiv(this.id+"_FrameDecorationDiv_"+b,null,null,null,"absolute",null,"hidden",null);this.groupDiv.appendChild(c.div)}},updateBlocks:function(){this.blocks||this.createBlocks();if(this.size&&this.relativePosition){for(var a=this.positionBlocks[this.relativePosition],b=0;b<a.blocks.length;b++){var c=a.blocks[b],d=this.blocks[b],e=c.anchor.left,f=c.anchor.bottom,g=c.anchor.right,h=c.anchor.top,
j=isNaN(c.size.w)?this.size.w-(g+e):c.size.w,l=isNaN(c.size.h)?this.size.h-(f+h):c.size.h;d.div.style.width=(j<0?0:j)+"px";d.div.style.height=(l<0?0:l)+"px";d.div.style.left=e!==null?e+"px":"";d.div.style.bottom=f!==null?f+"px":"";d.div.style.right=g!==null?g+"px":"";d.div.style.top=h!==null?h+"px":"";d.div.className=c.className}this.contentDiv.style.left=this.padding.left+"px";this.contentDiv.style.top=this.padding.top+"px"}},updateSize:function(){return OpenLayers.Popup.prototype.updateSize.apply(this,
arguments)},CLASS_NAME:"OpenLayers.Popup.CSSFramedCloud"});
...
null;a&&this.frame.removeChild(this.frame.firstChild)}}return OpenLayers.Tile.Image.prototype.draw.apply(this,arguments)},getImage:function(){if(this.useIFrame===true){if(!this.frame.childNodes.length){var a=document.createElement("div"),b=a.style;b.position="absolute";b.width="100%";b.height="100%";b.zIndex=1;b.backgroundImage="url("+this.blankImageUrl+")";this.frame.appendChild(a)}a=this.id+"_iFrame";if(parseFloat(navigator.appVersion.split("MSIE")[1])<9){b=document.createElement('<iframe name="'+
...
OpenLayers.Handler.Pinch=OpenLayers.Class(OpenLayers.Handler,{started:!1,stopDown:!1,pinching:!1,last:null,start:null,touchstart:function(a){var b=true;this.pinching=false;if(OpenLayers.Event.isMultiTouch(a)){this.started=true;this.last=this.start={distance:this.getDistance(a.touches),delta:0,scale:1};this.callback("start",[a,this.start]);b=!this.stopDown}else{if(this.started)return false;this.started=false;this.last=this.start=null}OpenLayers.Event.preventDefault(a);return b},touchmove:function(a){if(this.started&&
OpenLayers.Event.isMultiTouch(a)){this.pinching=true;var b=this.getPinchData(a);this.callback("move",[a,b]);this.last=b;OpenLayers.Event.stop(a)}else if(this.started)return false;return true},touchend:function(a){if(this.started&&!OpenLayers.Event.isMultiTouch(a)){this.pinching=this.started=false;this.callback("done",[a,this.start,this.last]);this.last=this.start=null;return false}return true},activate:function(){var a=false;if(OpenLayers.Handler.prototype.activate.apply(this,arguments)){this.pinching=
false;a=true}return a},deactivate:function(){var a=false;if(OpenLayers.Handler.prototype.deactivate.apply(this,arguments)){this.pinching=this.started=false;this.last=this.start=null;a=true}return a},getDistance:function(a){var b=a[0],a=a[1];return Math.sqrt(Math.pow(b.olClientX-a.olClientX,2)+Math.pow(b.olClientY-a.olClientY,2))},getPinchData:function(a){a=this.getDistance(a.touches);return{distance:a,delta:this.last.distance-a,scale:a/this.start.distance}},CLASS_NAME:"OpenLayers.Handler.Pinch"});
...
OpenLayers.Strategy.Refresh=OpenLayers.Class(OpenLayers.Strategy,{force:!1,interval:0,timer:null,activate:function(){var a=OpenLayers.Strategy.prototype.activate.call(this);if(a){this.layer.visibility===true&&this.start();this.layer.events.on({visibilitychanged:this.reset,scope:this})}return a},deactivate:function(){var a=OpenLayers.Strategy.prototype.deactivate.call(this);if(a){this.stop();this.layer.events.un({visibilitychanged:this.reset,scope:this})}return a},reset:function(){this.layer.visibility===
...
OpenLayers.Control.GetFeature=OpenLayers.Class(OpenLayers.Control,{protocol:null,multipleKey:null,toggleKey:null,modifiers:null,multiple:!1,click:!0,single:!0,clickout:!0,toggle:!1,clickTolerance:5,hover:!1,box:!1,maxFeatures:10,features:null,hoverFeature:null,handlers:null,hoverResponse:null,filterType:OpenLayers.Filter.Spatial.BBOX,initialize:function(a){a.handlerOptions=a.handlerOptions||{};OpenLayers.Control.prototype.initialize.apply(this,[a]);this.features={};this.handlers={};if(this.click)this.handlers.click=
...
y:a.top});b=new OpenLayers.Bounds(b.lon,b.lat,a.lon,a.lat)}else{if(this.click)return;b=this.pixelToBounds(a)}this.setModifiers(this.handlers.box.dragHandler.evt);this.request(b)},selectHover:function(a){a=this.pixelToBounds(a.xy);this.request(a,{single:true,hover:true})},cancelHover:function(){if(this.hoverResponse){this.protocol.abort(this.hoverResponse);this.hoverResponse=null;OpenLayers.Element.removeClass(this.map.viewPortDiv,"olCursorWait")}},request:function(a,b){var b=b||{},c=new OpenLayers.Filter.Spatial({type:this.filterType,
value:a});OpenLayers.Element.addClass(this.map.viewPortDiv,"olCursorWait");c=this.protocol.read({maxFeatures:b.single==true?this.maxFeatures:void 0,filter:c,callback:function(c){if(c.success())if(c.features.length)b.single==true?this.selectBestFeature(c.features,a.getCenterLonLat(),b):this.select(c.features);else if(b.hover)this.hoverSelect();else{this.events.triggerEvent("clickout");this.clickout&&this.unselectAll()}OpenLayers.Element.removeClass(this.map.viewPortDiv,"olCursorWait")},scope:this});
if(b.hover==true)this.hoverResponse=c},selectBestFeature:function(a,b,c){c=c||{};if(a.length){for(var b=new OpenLayers.Geometry.Point(b.lon,b.lat),d,e,f,g=Number.MAX_VALUE,h=0;h<a.length;++h){d=a[h];if(d.geometry){f=b.distanceTo(d.geometry,{edge:false});if(f<g){g=f;e=d;if(g==0)break}}}c.hover==true?this.hoverSelect(e):this.select(e||a)}},setModifiers:function(a){this.modifiers={multiple:this.multiple||this.multipleKey&&a[this.multipleKey],toggle:this.toggle||this.toggleKey&&a[this.toggleKey]}},select:function(a){!this.modifiers.multiple&&
!this.modifiers.toggle&&this.unselectAll();OpenLayers.Util.isArray(a)||(a=[a]);var b=this.events.triggerEvent("beforefeaturesselected",{features:a});if(b!==false){for(var c=[],d,e=0,f=a.length;e<f;++e){d=a[e];if(this.features[d.fid||d.id])this.modifiers.toggle&&this.unselect(this.features[d.fid||d.id]);else{b=this.events.triggerEvent("beforefeatureselected",{feature:d});if(b!==false){this.features[d.fid||d.id]=d;c.push(d);this.events.triggerEvent("featureselected",{feature:d})}}}this.events.triggerEvent("featuresselected",
{features:c})}},hoverSelect:function(a){var b=a?a.fid||a.id:null,c=this.hoverFeature?this.hoverFeature.fid||this.hoverFeature.id:null;if(c&&c!=b){this.events.triggerEvent("outfeature",{feature:this.hoverFeature});this.hoverFeature=null}if(b&&b!=c){this.events.triggerEvent("hoverfeature",{feature:a});this.hoverFeature=a}},unselect:function(a){delete this.features[a.fid||a.id];this.events.triggerEvent("featureunselected",{feature:a})},unselectAll:function(){for(var a in this.features)this.unselect(this.features[a])},
setMap:function(a){for(var b in this.handlers)this.handlers[b].setMap(a);OpenLayers.Control.prototype.setMap.apply(this,arguments)},pixelToBounds:function(a){var b=a.add(-this.clickTolerance/2,this.clickTolerance/2),a=a.add(this.clickTolerance/2,-this.clickTolerance/2),b=this.map.getLonLatFromPixel(b),a=this.map.getLonLatFromPixel(a);return new OpenLayers.Bounds(b.lon,b.lat,a.lon,a.lat)},CLASS_NAME:"OpenLayers.Control.GetFeature"});
OpenLayers.Format.QueryStringFilter=function(){var a={};a[OpenLayers.Filter.Comparison.EQUAL_TO]="eq";a[OpenLayers.Filter.Comparison.NOT_EQUAL_TO]="ne";a[OpenLayers.Filter.Comparison.LESS_THAN]="lt";a[OpenLayers.Filter.Comparison.LESS_THAN_OR_EQUAL_TO]="lte";a[OpenLayers.Filter.Comparison.GREATER_THAN]="gt";a[OpenLayers.Filter.Comparison.GREATER_THAN_OR_EQUAL_TO]="gte";a[OpenLayers.Filter.Comparison.LIKE]="ilike";return OpenLayers.Class(OpenLayers.Format,{wildcarded:false,srsInBBOX:false,write:function(b,
c){var c=c||{},d=b.CLASS_NAME,d=d.substring(d.lastIndexOf(".")+1);switch(d){case "Spatial":switch(b.type){case OpenLayers.Filter.Spatial.BBOX:c.bbox=b.value.toArray();this.srsInBBOX&&b.projection&&c.bbox.push(b.projection.getCode());break;case OpenLayers.Filter.Spatial.DWITHIN:c.tolerance=b.distance;case OpenLayers.Filter.Spatial.WITHIN:c.lon=b.value.x;c.lat=b.value.y;break;default:OpenLayers.Console.warn("Unknown spatial filter type "+b.type)}break;case "Comparison":d=a[b.type];if(d!==void 0){var e=
b.value;if(b.type==OpenLayers.Filter.Comparison.LIKE){e=e.replace(/%/g,"\\%");e=e.replace(/\\\\\.(\*)?/g,function(a,b){return b?a:"\\\\_"});e=e.replace(/\\\\\.\*/g,"\\\\%");e=e.replace(/(\\)?\.(\*)?/g,function(a,b,c){return b||c?a:"_"});e=e.replace(/(\\)?\.\*/g,function(a,b){return b?a:"%"});e=e.replace(/\\\./g,".");e=e.replace(/(\\)?\\\*/g,function(a,b){return b?a:"*"});this.wildcarded&&(e="%"+e+"%")}c[b.property+"__"+d]=e;c.queryable=c.queryable||[];c.queryable.push(b.property)}else OpenLayers.Console.warn("Unknown comparison filter type "+
b.type);break;case "Logical":if(b.type===OpenLayers.Filter.Logical.AND){d=0;for(e=b.filters.length;d<e;d++)c=this.write(b.filters[d],c)}else OpenLayers.Console.warn("Unsupported logical filter type "+b.type);break;default:OpenLayers.Console.warn("Unknown filter type "+d)}return c},CLASS_NAME:"OpenLayers.Format.QueryStringFilter"})}();
...
OpenLayers.Control.Geolocate=OpenLayers.Class(OpenLayers.Control,{geolocation:null,available:"geolocation"in navigator,bind:!0,watch:!1,geolocationOptions:null,destroy:function(){this.deactivate();OpenLayers.Control.prototype.destroy.apply(this,arguments)},activate:function(){if(this.available&&!this.geolocation)this.geolocation=navigator.geolocation;if(!this.geolocation){this.events.triggerEvent("locationuncapable");return false}if(OpenLayers.Control.prototype.activate.apply(this,arguments)){this.watch?
this.watchId=this.geolocation.watchPosition(OpenLayers.Function.bind(this.geolocate,this),OpenLayers.Function.bind(this.failure,this),this.geolocationOptions):this.getCurrentLocation();return true}return false},deactivate:function(){this.active&&this.watchId!==null&&this.geolocation.clearWatch(this.watchId);return OpenLayers.Control.prototype.deactivate.apply(this,arguments)},geolocate:function(a){var b=(new OpenLayers.LonLat(a.coords.longitude,a.coords.latitude)).transform(new OpenLayers.Projection("EPSG:4326"),
...
OpenLayers.Tile.UTFGrid=OpenLayers.Class(OpenLayers.Tile,{url:null,utfgridResolution:2,json:null,format:null,destroy:function(){this.clear();OpenLayers.Tile.prototype.destroy.apply(this,arguments)},draw:function(){var a=OpenLayers.Tile.prototype.draw.apply(this,arguments);if(a){if(this.isLoading){this.abortLoading();this.events.triggerEvent("reload")}else{this.isLoading=true;this.events.triggerEvent("loadstart")}this.url=this.layer.getURL(this.bounds);if(this.layer.useJSONP){var b=new OpenLayers.Protocol.Script({url:this.url,
callback:function(a){this.isLoading=false;this.events.triggerEvent("loadend");this.json=a.data},scope:this});b.read();this.request=b}else this.request=OpenLayers.Request.GET({url:this.url,callback:function(a){this.isLoading=false;this.events.triggerEvent("loadend");a.status===200&&this.parseData(a.responseText)},scope:this})}else this.unload();return a},abortLoading:function(){if(this.request){this.request.abort();delete this.request}this.isLoading=false},getFeatureInfo:function(a,b){var c=null;if(this.json){var d=
this.getFeatureId(a,b);d!==null&&(c={id:d,data:this.json.data[d]})}return c},getFeatureId:function(a,b){var c=null;if(this.json){var d=this.utfgridResolution,d=this.json.grid[Math.floor(b/d)].charCodeAt(Math.floor(a/d)),d=this.indexFromCharCode(d),e=this.json.keys;!isNaN(d)&&d in e&&(c=e[d])}return c},indexFromCharCode:function(a){a>=93&&a--;a>=35&&a--;return a-32},parseData:function(a){if(!this.format)this.format=new OpenLayers.Format.JSON;this.json=this.format.read(a)},clear:function(){this.json=
null},CLASS_NAME:"OpenLayers.Tile.UTFGrid"});
...
a.features?a.features.length:0,c=Array(b),e=0;e<b;++e)c[e]=a.features[e].fid;q.insertIds=c;d.apply(this,[a])}function d(a){this.callUserCallback(a,b);p=p&&a.success();f++;if(f>=o&&b.callback){q.code=p?OpenLayers.Protocol.Response.SUCCESS:OpenLayers.Protocol.Response.FAILURE;b.callback.apply(b.scope,[q])}}var b=OpenLayers.Util.applyDefaults(b,this.options),e=[],f=0,g={};g[OpenLayers.State.INSERT]=[];g[OpenLayers.State.UPDATE]=[];g[OpenLayers.State.DELETE]=[];for(var h,j,l=[],m=0,n=a.length;m<n;++m){h=
a[m];if(j=g[h.state]){j.push(h);l.push(h)}}var o=(g[OpenLayers.State.INSERT].length>0?1:0)+g[OpenLayers.State.UPDATE].length+g[OpenLayers.State.DELETE].length,p=true,q=new OpenLayers.Protocol.Response({reqFeatures:l});h=g[OpenLayers.State.INSERT];h.length>0&&e.push(this.create(h,OpenLayers.Util.applyDefaults({callback:c,scope:this},b.create)));h=g[OpenLayers.State.UPDATE];for(m=h.length-1;m>=0;--m)e.push(this.update(h[m],OpenLayers.Util.applyDefaults({callback:d,scope:this},b.update)));h=g[OpenLayers.State.DELETE];
for(m=h.length-1;m>=0;--m)e.push(this["delete"](h[m],OpenLayers.Util.applyDefaults({callback:d,scope:this},b["delete"])));return e},abort:function(a){a&&a.priv.abort()},callUserCallback:function(a,b){var c=b[a.requestType];c&&c.callback&&c.callback.call(c.scope,a)},CLASS_NAME:"OpenLayers.Protocol.HTTP"});
OpenLayers.Strategy.Cluster=OpenLayers.Class(OpenLayers.Strategy,{distance:20,threshold:null,features:null,clusters:null,clustering:!1,resolution:null,activate:function(){var a=OpenLayers.Strategy.prototype.activate.call(this);if(a)this.layer.events.on({beforefeaturesadded:this.cacheFeatures,featuresremoved:this.clearCache,moveend:this.cluster,scope:this});return a},deactivate:function(){var a=OpenLayers.Strategy.prototype.deactivate.call(this);if(a){this.clearCache();this.layer.events.un({beforefeaturesadded:this.cacheFeatures,
featuresremoved:this.clearCache,moveend:this.cluster,scope:this})}return a},cacheFeatures:function(a){var b=true;if(!this.clustering){this.clearCache();this.features=a.features;this.cluster();b=false}return b},clearCache:function(){if(!this.clustering)this.features=null},cluster:function(a){if((!a||a.zoomChanged)&&this.features){a=this.layer.map.getResolution();if(a!=this.resolution||!this.clustersExist()){this.resolution=a;for(var a=[],b,c,d,e=0;e<this.features.length;++e){b=this.features[e];if(b.geometry){c=
false;for(var f=a.length-1;f>=0;--f){d=a[f];if(this.shouldCluster(d,b)){this.addToCluster(d,b);c=true;break}}c||a.push(this.createCluster(this.features[e]))}}this.clustering=true;this.layer.removeAllFeatures();this.clustering=false;if(a.length>0){if(this.threshold>1){b=a.slice();a=[];e=0;for(d=b.length;e<d;++e){c=b[e];c.attributes.count<this.threshold?Array.prototype.push.apply(a,c.cluster):a.push(c)}}this.clustering=true;this.layer.addFeatures(a);this.clustering=false}this.clusters=a}}},clustersExist:function(){var a=
false;if(this.clusters&&this.clusters.length>0&&this.clusters.length==this.layer.features.length)for(var a=true,b=0;b<this.clusters.length;++b)if(this.clusters[b]!=this.layer.features[b]){a=false;break}return a},shouldCluster:function(a,b){var c=a.geometry.getBounds().getCenterLonLat(),d=b.geometry.getBounds().getCenterLonLat();return Math.sqrt(Math.pow(c.lon-d.lon,2)+Math.pow(c.lat-d.lat,2))/this.resolution<=this.distance},addToCluster:function(a,b){a.cluster.push(b);a.attributes.count=a.attributes.count+
1},createCluster:function(a){var b=a.geometry.getBounds().getCenterLonLat(),b=new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Point(b.lon,b.lat),{count:1});b.cluster=[a];return b},CLASS_NAME:"OpenLayers.Strategy.Cluster"});
...
this.caching=false}if(a.length>0){a={features:a};this.handleAdd(a);if(a.features.length>0){this.caching=true;this.layer.addFeatures(a.features);this.caching=false}}},CLASS_NAME:"OpenLayers.Strategy.Filter"});OpenLayers.Protocol.SOS=function(a){var a=OpenLayers.Util.applyDefaults(a,OpenLayers.Protocol.SOS.DEFAULTS),b=OpenLayers.Protocol.SOS["v"+a.version.replace(/\./g,"_")];if(!b)throw"Unsupported SOS version: "+a.version;return new b(a)};OpenLayers.Protocol.SOS.DEFAULTS={version:"1.0.0"};
OpenLayers.Format.WFSDescribeFeatureType=OpenLayers.Class(OpenLayers.Format.XML,{regExes:{trimSpace:/^\s*|\s*$/g},namespaces:{xsd:"http://www.w3.org/2001/XMLSchema"},readers:{xsd:{schema:function(a,b){var c=[],d={},e,f;this.readChildNodes(a,{complexTypes:c,customTypes:d});var g=a.attributes,h,j;e=0;for(f=g.length;e<f;++e){h=g[e];j=h.name;j.indexOf("xmlns")===0?this.setNamespace(j.split(":")[1]||"",h.value):b[j]=h.value}b.featureTypes=c;b.targetPrefix=this.namespaceAlias[b.targetNamespace];e=0;for(f=
c.length;e<f;++e){g=c[e];h=d[g.typeName];if(d[g.typeName])g.typeName=h.name}},complexType:function(a,b){var c={typeName:a.getAttribute("name")};this.readChildNodes(a,c);b.complexTypes.push(c)},complexContent:function(a,b){this.readChildNodes(a,b)},extension:function(a,b){this.readChildNodes(a,b)},sequence:function(a,b){var c={elements:[]};this.readChildNodes(a,c);b.properties=c.elements},element:function(a,b){var c;if(b.elements){var d={};c=a.attributes;for(var e,f=0,g=c.length;f<g;++f){e=c[f];d[e.name]=
e.value}c=d.type;if(!c){c={};this.readChildNodes(a,c);d.restriction=c;d.type=c.base}d.localType=(c.base||c).split(":").pop();b.elements.push(d);this.readChildNodes(a,d)}if(b.complexTypes){c=a.getAttribute("type");d=c.split(":").pop();b.customTypes[d]={name:a.getAttribute("name"),type:c}}},annotation:function(a,b){b.annotation={};this.readChildNodes(a,b.annotation)},appinfo:function(a,b){if(!b.appinfo)b.appinfo=[];b.appinfo.push(this.getChildValue(a))},documentation:function(a,b){if(!b.documentation)b.documentation=
[];var c=this.getChildValue(a);b.documentation.push({lang:a.getAttribute("xml:lang"),textContent:c.replace(this.regExes.trimSpace,"")})},simpleType:function(a,b){this.readChildNodes(a,b)},restriction:function(a,b){b.base=a.getAttribute("base");this.readRestriction(a,b)}}},readRestriction:function(a,b){for(var c=a.childNodes,d,e,f=0,g=c.length;f<g;++f){d=c[f];if(d.nodeType==1){e=d.nodeName.split(":").pop();d=d.getAttribute("value");if(b[e]){typeof b[e]=="string"&&(b[e]=[b[e]]);b[e].push(d)}else b[e]=
d}}},read:function(a){typeof a=="string"&&(a=OpenLayers.Format.XML.prototype.read.apply(this,[a]));if(a&&a.nodeType==9)a=a.documentElement;var b={};if(a.nodeName.split(":").pop()==="ExceptionReport"){var c=new OpenLayers.Format.OGCExceptionReport;b.error=c.read(a)}else this.readNode(a,b);return b},CLASS_NAME:"OpenLayers.Format.WFSDescribeFeatureType"});
...
this.geons,"long"),e=this.getElementsByTagNameNS(a,this.georssns,"line"),f=this.getElementsByTagNameNS(a,this.georssns,"polygon"),g=this.getElementsByTagNameNS(a,this.georssns,"where"),a=this.getElementsByTagNameNS(a,this.georssns,"box");if(b.length>0||c.length>0&&d.length>0){if(b.length>0){c=OpenLayers.String.trim(b[0].firstChild.nodeValue).split(/\s+/);c.length!=2&&(c=OpenLayers.String.trim(b[0].firstChild.nodeValue).split(/\s*,\s*/))}else c=[parseFloat(c[0].firstChild.nodeValue),parseFloat(d[0].firstChild.nodeValue)];
var h=new OpenLayers.Geometry.Point(c[1],c[0])}else if(e.length>0){c=OpenLayers.String.trim(this.getChildValue(e[0])).split(/\s+/);d=[];e=0;for(f=c.length;e<f;e=e+2){b=new OpenLayers.Geometry.Point(c[e+1],c[e]);d.push(b)}h=new OpenLayers.Geometry.LineString(d)}else if(f.length>0){c=OpenLayers.String.trim(this.getChildValue(f[0])).split(/\s+/);d=[];e=0;for(f=c.length;e<f;e=e+2){b=new OpenLayers.Geometry.Point(c[e+1],c[e]);d.push(b)}h=new OpenLayers.Geometry.Polygon([new OpenLayers.Geometry.LinearRing(d)])}else if(g.length>
0){if(!this.gmlParser)this.gmlParser=new OpenLayers.Format.GML({xy:this.xy});h=this.gmlParser.parseFeature(g[0]).geometry}else if(a.length>0){c=OpenLayers.String.trim(a[0].firstChild.nodeValue).split(/\s+/);d=[];if(c.length>3){b=new OpenLayers.Geometry.Point(c[1],c[0]);d.push(b);b=new OpenLayers.Geometry.Point(c[1],c[2]);d.push(b);b=new OpenLayers.Geometry.Point(c[3],c[2]);d.push(b);b=new OpenLayers.Geometry.Point(c[3],c[0]);d.push(b);b=new OpenLayers.Geometry.Point(c[1],c[0]);d.push(b)}h=new OpenLayers.Geometry.Polygon([new OpenLayers.Geometry.LinearRing(d)])}h&&
...
OpenLayers.Rico.Color.HSBtoRGB=function(a,b,c){var d=0,e=0,f=0;if(b==0)f=e=d=parseInt(c*255+0.5);else{var a=(a-Math.floor(a))*6,g=a-Math.floor(a),h=c*(1-b),j=c*(1-b*g),b=c*(1-b*(1-g));switch(parseInt(a)){case 0:d=c*255+0.5;e=b*255+0.5;f=h*255+0.5;break;case 1:d=j*255+0.5;e=c*255+0.5;f=h*255+0.5;break;case 2:d=h*255+0.5;e=c*255+0.5;f=b*255+0.5;break;case 3:d=h*255+0.5;e=j*255+0.5;f=c*255+0.5;break;case 4:d=b*255+0.5;e=h*255+0.5;f=c*255+0.5;break;case 5:d=c*255+0.5;e=h*255+0.5;f=j*255+0.5}}return{r:parseInt(d),
...
b)},HTTP:function(a,b){this.readChildNodes(a,b.href)},Get:function(a,b){b.get=a.getAttribute("onlineResource")},Post:function(a,b){b.post=a.getAttribute("onlineResource")},SRS:function(a,b){var c=this.getChildValue(a);if(c)b.srs=c}},OpenLayers.Format.WFSCapabilities.v1.prototype.readers.wfs)},CLASS_NAME:"OpenLayers.Format.WFSCapabilities.v1_0_0"});
...
1].w*this.tierSizeInTiles[a-1].h+this.tileCountUpToTier[a-1])}if(!this.serverResolutions)this.serverResolutions=b},destroy:function(){OpenLayers.Layer.Grid.prototype.destroy.apply(this,arguments);this.tileCountUpToTier.length=0;this.tierSizeInTiles.length=0;this.tierImageSize.length=0},clone:function(a){a==null&&(a=new OpenLayers.Layer.Zoomify(this.name,this.url,this.size,this.options));return a=OpenLayers.Layer.Grid.prototype.clone.apply(this,[a])},getURL:function(a){var a=this.adjustBounds(a),b=
this.getServerResolution(),c=Math.round((a.left-this.tileOrigin.lon)/(b*this.tileSize.w)),a=Math.round((this.tileOrigin.lat-a.top)/(b*this.tileSize.h)),b=this.getZoomForResolution(b),c="TileGroup"+Math.floor((c+a*this.tierSizeInTiles[b].w+this.tileCountUpToTier[b])/256)+"/"+b+"-"+c+"-"+a+".jpg",b=this.url;OpenLayers.Util.isArray(b)&&(b=this.selectUrl(c,b));return b+c},getImageSize:function(){if(arguments.length>0){var a=this.adjustBounds(arguments[0]),b=this.getServerResolution(),c=Math.round((a.left-
this.tileOrigin.lon)/(b*this.tileSize.w)),a=Math.round((this.tileOrigin.lat-a.top)/(b*this.tileSize.h)),b=this.getZoomForResolution(b),d=this.standardTileSize,e=this.standardTileSize;c==this.tierSizeInTiles[b].w-1&&(d=this.tierImageSize[b].w%this.standardTileSize);a==this.tierSizeInTiles[b].h-1&&(e=this.tierImageSize[b].h%this.standardTileSize);return new OpenLayers.Size(d,e)}return this.tileSize},setMap:function(a){OpenLayers.Layer.Grid.prototype.setMap.apply(this,arguments);this.tileOrigin=new OpenLayers.LonLat(this.map.maxExtent.left,
this.map.maxExtent.top)},CLASS_NAME:"OpenLayers.Layer.Zoomify"});
...
var e=OpenLayers.Util.upperCaseObject(OpenLayers.Util.getParameters(c)),f;for(f in d)f.toUpperCase()in e&&delete d[f];e=OpenLayers.Util.getParameterString(d);d=c;e=e.replace(/,/g,"+");if(e!=""){f=c.charAt(c.length-1);d=f=="&"||f=="?"?d+e:c.indexOf("?")==-1?d+("?"+e):d+("&"+e)}return d},CLASS_NAME:"OpenLayers.Layer.MapServer"});
...
arguments)}},supported:function(){return!!document.namespaces},setExtent:function(a,b){var c=OpenLayers.Renderer.Elements.prototype.setExtent.apply(this,arguments),d=this.getResolution(),e=a.left/d|0,d=a.top/d-this.size.h|0;if(b||!this.offset){this.offset={x:e,y:d};d=e=0}else{e=e-this.offset.x;d=d-this.offset.y}this.root.coordorigin=e-this.xOffset+" "+d;for(var e=[this.root,this.vectorRoot,this.textRoot],f=0,g=e.length;f<g;++f){d=e[f];d.coordsize=this.size.w+" "+this.size.h}this.root.style.flip="y";
return c},setSize:function(a){OpenLayers.Renderer.prototype.setSize.apply(this,arguments);for(var b=[this.rendererRoot,this.root,this.vectorRoot,this.textRoot],c=this.size.w+"px",d=this.size.h+"px",e,f=0,g=b.length;f<g;++f){e=b[f];e.style.width=c;e.style.height=d}},getNodeType:function(a,b){var c=null;switch(a.CLASS_NAME){case "OpenLayers.Geometry.Point":c=b.externalGraphic?"olv:rect":this.isComplexSymbol(b.graphicName)?"olv:shape":"olv:oval";break;case "OpenLayers.Geometry.Rectangle":c="olv:rect";
break;case "OpenLayers.Geometry.LineString":case "OpenLayers.Geometry.LinearRing":case "OpenLayers.Geometry.Polygon":case "OpenLayers.Geometry.Curve":c="olv:shape"}return c},setStyle:function(a,b,c,d){var b=b||a._style,c=c||a._options,e=b.fillColor,f=b.title||b.graphicTitle;if(f)a.title=f;if(a._geometryClass==="OpenLayers.Geometry.Point")if(b.externalGraphic){c.isFilled=true;var e=b.graphicWidth||b.graphicHeight,f=b.graphicHeight||b.graphicWidth,e=e?e:b.pointRadius*2,f=f?f:b.pointRadius*2,g=this.getResolution(),
h=b.graphicXOffset!=void 0?b.graphicXOffset:-(0.5*e),j=b.graphicYOffset!=void 0?b.graphicYOffset:-(0.5*f);a.style.left=((d.x-this.featureDx)/g-this.offset.x+h|0)+"px";a.style.top=(d.y/g-this.offset.y-(j+f)|0)+"px";a.style.width=e+"px";a.style.height=f+"px";a.style.flip="y";e="none";c.isStroked=false}else if(this.isComplexSymbol(b.graphicName)){f=this.importSymbol(b.graphicName);a.path=f.path;a.coordorigin=f.left+","+f.bottom;f=f.size;a.coordsize=f+","+f;this.drawCircle(a,d,b.pointRadius);a.style.flip=
"y"}else this.drawCircle(a,d,b.pointRadius);c.isFilled?a.fillcolor=e:a.filled="false";d=a.getElementsByTagName("fill");d=d.length==0?null:d[0];if(c.isFilled){d||(d=this.createNode("olv:fill",a.id+"_fill"));d.opacity=b.fillOpacity;if(a._geometryClass==="OpenLayers.Geometry.Point"&&b.externalGraphic){if(b.graphicOpacity)d.opacity=b.graphicOpacity;d.src=b.externalGraphic;d.type="frame";if(!b.graphicWidth||!b.graphicHeight)d.aspect="atmost"}d.parentNode!=a&&a.appendChild(d)}else d&&a.removeChild(d);e=
b.rotation;if(e!==void 0||a._rotation!==void 0){a._rotation=e;if(b.externalGraphic){this.graphicRotate(a,h,j,b);d.opacity=0}else if(a._geometryClass==="OpenLayers.Geometry.Point")a.style.rotation=e||0}h=a.getElementsByTagName("stroke");h=h.length==0?null:h[0];if(c.isStroked){if(!h){h=this.createNode("olv:stroke",a.id+"_stroke");a.appendChild(h)}h.on=true;h.color=b.strokeColor;h.weight=b.strokeWidth+"px";h.opacity=b.strokeOpacity;h.endcap=b.strokeLinecap=="butt"?"flat":b.strokeLinecap||"round";if(b.strokeDashstyle)h.dashstyle=
this.dashStyle(b)}else{a.stroked=false;if(h)h.on=false}if(b.cursor!="inherit"&&b.cursor!=null)a.style.cursor=b.cursor;return a},graphicRotate:function(a,b,c,d){var d=d||a._style,e=d.rotation||0,f,g;if(!d.graphicWidth||!d.graphicHeight){var h=new Image;h.onreadystatechange=OpenLayers.Function.bind(function(){if(h.readyState=="complete"||h.readyState=="interactive"){f=h.width/h.height;g=Math.max(d.pointRadius*2,d.graphicWidth||0,d.graphicHeight||0);b=b*f;d.graphicWidth=g*f;d.graphicHeight=g;this.graphicRotate(a,
b,c,d)}},this);h.src=d.externalGraphic}else{g=Math.max(d.graphicWidth,d.graphicHeight);f=d.graphicWidth/d.graphicHeight;var j=Math.round(d.graphicWidth||g*f),l=Math.round(d.graphicHeight||g);a.style.width=j+"px";a.style.height=l+"px";var m=document.getElementById(a.id+"_image");if(!m){m=this.createNode("olv:imagedata",a.id+"_image");a.appendChild(m)}m.style.width=j+"px";m.style.height=l+"px";m.src=d.externalGraphic;m.style.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='', sizingMethod='scale')";
m=e*Math.PI/180;e=Math.sin(m);m=Math.cos(m);e="progid:DXImageTransform.Microsoft.Matrix(M11="+m+",M12="+-e+",M21="+e+",M22="+m+",SizingMethod='auto expand')\n";(m=d.graphicOpacity||d.fillOpacity)&&m!=1&&(e=e+("progid:DXImageTransform.Microsoft.BasicImage(opacity="+m+")\n"));a.style.filter=e;e=new OpenLayers.Geometry.Point(-b,-c);j=(new OpenLayers.Bounds(0,0,j,l)).toGeometry();j.rotate(d.rotation,e);j=j.getBounds();a.style.left=Math.round(parseInt(a.style.left)+j.left)+"px";a.style.top=Math.round(parseInt(a.style.top)-
j.bottom)+"px"}},postDraw:function(a){a.style.visibility="visible";var b=a._style.fillColor,c=a._style.strokeColor;if(b=="none"&&a.fillcolor!=b)a.fillcolor=b;if(c=="none"&&a.strokecolor!=c)a.strokecolor=c},setNodeDimension:function(a,b){var c=b.getBounds();if(c){var d=this.getResolution(),c=new OpenLayers.Bounds((c.left-this.featureDx)/d-this.offset.x|0,c.bottom/d-this.offset.y|0,(c.right-this.featureDx)/d-this.offset.x|0,c.top/d-this.offset.y|0);a.style.left=c.left+"px";a.style.top=c.top+"px";a.style.width=
c.getWidth()+"px";a.style.height=c.getHeight()+"px";a.coordorigin=c.left+" "+c.top;a.coordsize=c.getWidth()+" "+c.getHeight()}},dashStyle:function(a){a=a.strokeDashstyle;switch(a){case "solid":case "dot":case "dash":case "dashdot":case "longdash":case "longdashdot":return a;default:a=a.split(/[ ,]/);return a.length==2?1*a[0]>=2*a[1]?"longdash":a[0]==1||a[1]==1?"dot":"dash":a.length==4?1*a[0]>=2*a[1]?"longdashdot":"dashdot":"solid"}},createNode:function(a,b){var c=document.createElement(a);if(b)c.id=
b;c.unselectable="on";c.onselectstart=OpenLayers.Function.False;return c},nodeTypeCompare:function(a,b){var c=b,d=c.indexOf(":");d!=-1&&(c=c.substr(d+1));var e=a.nodeName,d=e.indexOf(":");d!=-1&&(e=e.substr(d+1));return c==e},createRenderRoot:function(){return this.nodeFactory(this.container.id+"_vmlRoot","div")},createRoot:function(a){return this.nodeFactory(this.container.id+a,"olv:group")},drawPoint:function(a,b){return this.drawCircle(a,b,1)},drawCircle:function(a,b,c){if(!isNaN(b.x)&&!isNaN(b.y)){var d=
this.getResolution();a.style.left=((b.x-this.featureDx)/d-this.offset.x|0)-c+"px";a.style.top=(b.y/d-this.offset.y|0)-c+"px";b=c*2;a.style.width=b+"px";a.style.height=b+"px";return a}return false},drawLineString:function(a,b){return this.drawLine(a,b,false)},drawLinearRing:function(a,b){return this.drawLine(a,b,true)},drawLine:function(a,b,c){this.setNodeDimension(a,b);for(var d=this.getResolution(),e=b.components.length,f=Array(e),g,h,j=0;j<e;j++){g=b.components[j];h=(g.x-this.featureDx)/d-this.offset.x|
0;g=g.y/d-this.offset.y|0;f[j]=" "+h+","+g+" l "}a.path="m"+f.join("")+(c?" x e":" e");return a},drawPolygon:function(a,b){this.setNodeDimension(a,b);var c=this.getResolution(),d=[],e,f,g,h,j,l,m,n,o,p;e=0;for(f=b.components.length;e<f;e++){d.push("m");g=b.components[e].components;h=e===0;l=j=null;m=0;for(n=g.length;m<n;m++){o=g[m];p=(o.x-this.featureDx)/c-this.offset.x|0;o=o.y/c-this.offset.y|0;p=" "+p+","+o;d.push(p);m==0&&d.push(" l");h||(j?j!=p&&(l?l!=p&&(h=true):l=p):j=p)}d.push(h?" x ":" ")}d.push("e");
a.path=d.join("");return a},drawRectangle:function(a,b){var c=this.getResolution();a.style.left=((b.x-this.featureDx)/c-this.offset.x|0)+"px";a.style.top=(b.y/c-this.offset.y|0)+"px";a.style.width=(b.width/c|0)+"px";a.style.height=(b.height/c|0)+"px";return a},drawText:function(a,b,c){var d=this.nodeFactory(a+this.LABEL_ID_SUFFIX,"olv:rect"),e=this.nodeFactory(a+this.LABEL_ID_SUFFIX+"_textbox","olv:textbox"),f=this.getResolution();d.style.left=((c.x-this.featureDx)/f-this.offset.x|0)+"px";d.style.top=
(c.y/f-this.offset.y|0)+"px";d.style.flip="y";e.innerText=b.label;if(b.cursor!="inherit"&&b.cursor!=null)e.style.cursor=b.cursor;if(b.fontColor)e.style.color=b.fontColor;if(b.fontOpacity)e.style.filter="alpha(opacity="+b.fontOpacity*100+")";if(b.fontFamily)e.style.fontFamily=b.fontFamily;if(b.fontSize)e.style.fontSize=b.fontSize;if(b.fontWeight)e.style.fontWeight=b.fontWeight;if(b.fontStyle)e.style.fontStyle=b.fontStyle;if(b.labelSelect===true){d._featureId=a;e._featureId=a;e._geometry=c;e._geometryClass=
c.CLASS_NAME}e.style.whiteSpace="nowrap";e.inset="1px,0px,0px,0px";if(!d.parentNode){d.appendChild(e);this.textRoot.appendChild(d)}b=b.labelAlign||"cm";b.length==1&&(b=b+"m");a=e.clientWidth*OpenLayers.Renderer.VML.LABEL_SHIFT[b.substr(0,1)];e=e.clientHeight*OpenLayers.Renderer.VML.LABEL_SHIFT[b.substr(1,1)];d.style.left=parseInt(d.style.left)-a-1+"px";d.style.top=parseInt(d.style.top)+e+"px"},moveRoot:function(a){var b=this.map.getLayer(a.container.id);b instanceof OpenLayers.Layer.Vector.RootContainer&&
...
this,this.fetch)},fetch:function(a){if(this.active&&window.localStorage&&a.tile instanceof OpenLayers.Tile.Image){var b=a.tile,c=b.url;!b.layer.crossOriginKeyword&&(OpenLayers.ProxyHost&&c.indexOf(OpenLayers.ProxyHost)===0)&&(c=OpenLayers.Control.CacheWrite.urlMap[c]);if(c=window.localStorage.getItem("olCache_"+c)){b.url=c;a.type==="tileerror"&&b.setImgSrc(c)}}},destroy:function(){if(this.layers||this.map){var a,b=this.layers||this.map.layers;for(a=b.length-1;a>=0;--a)this.removeLayer({layer:b[a]})}this.map&&
...
"*","FIELDS"),c=0,d=a.length;c<d;c++){var e=a[c],f={},g,h=e.attributes.length;if(h>0)for(g=0;g<h;g++){var j=e.attributes[g];f[j.nodeName]=j.nodeValue}else{e=e.childNodes;g=0;for(h=e.length;g<h;++g){j=e[g];j.nodeType!=3&&(f[j.getAttribute("name")]=j.getAttribute("value"))}}b.push(new OpenLayers.Feature.Vector(null,f,null))}return b},getSiblingNodesByTagCriteria:function(a,b){var c=[],d,e,f,g;if(a&&a.hasChildNodes()){d=a.childNodes;f=d.length;for(var h=0;h<f;h++){for(g=d[h];g&&g.nodeType!=1;){g=g.nextSibling;
h++}e=g?g.nodeName:"";if(e.length>0&&e.indexOf(b)>-1)c.push(g);else{e=this.getSiblingNodesByTagCriteria(g,b);e.length>0&&(c.length==0?c=e:c.push(e))}}}return c},parseAttributes:function(a){var b={};if(a.nodeType==1)for(var a=a.childNodes,c=a.length,d=0;d<c;++d){var e=a[d];if(e.nodeType==1){var f=e.childNodes,e=e.prefix?e.nodeName.split(":")[1]:e.nodeName;if(f.length==0)b[e]=null;else if(f.length==1){f=f[0];if(f.nodeType==3||f.nodeType==4){f=f.nodeValue.replace(this.regExes.trimSpace,"");b[e]=f}}}}return b},
parseGeometry:function(a){if(!this.gmlFormat)this.gmlFormat=new OpenLayers.Format.GML;var a=this.gmlFormat.parseFeature(a),b,c=null;if(a){b=a.geometry&&a.geometry.clone();c=a.bounds&&a.bounds.clone();a.destroy()}return{geometry:b,bounds:c}},CLASS_NAME:"OpenLayers.Format.WMSGetFeatureInfo"});
OpenLayers.Control.WMTSGetFeatureInfo=OpenLayers.Class(OpenLayers.Control,{hover:!1,requestEncoding:"KVP",drillDown:!1,maxFeatures:10,clickCallback:"click",layers:null,queryVisible:!0,infoFormat:"text/html",vendorParams:{},format:null,formatOptions:null,handler:null,hoverRequest:null,pending:0,initialize:function(a){a=a||{};a.handlerOptions=a.handlerOptions||{};OpenLayers.Control.prototype.initialize.apply(this,[a]);if(!this.format)this.format=new OpenLayers.Format.WMSGetFeatureInfo(a.formatOptions);
...
if(this.pending<=0){OpenLayers.Element.removeClass(this.map.viewPortDiv,"olCursorWait");this.pending=0}this.hoverRequest.abort();this.hoverRequest=null}},findLayers:function(){for(var a=this.layers||this.map.layers,b=[],c,d=a.length-1;d>=0;--d){c=a[d];if(c instanceof OpenLayers.Layer.WMTS&&c.requestEncoding===this.requestEncoding&&(!this.queryVisible||c.getVisibility())){b.push(c);if(!this.drillDown||this.hover)break}}return b},buildRequestOptions:function(a,b){var c=this.map.getLonLatFromPixel(b),
d=a.getURL(new OpenLayers.Bounds(c.lon,c.lat,c.lon,c.lat)),d=OpenLayers.Util.getParameters(d),c=a.getTileInfo(c);OpenLayers.Util.extend(d,{service:"WMTS",version:a.version,request:"GetFeatureInfo",infoFormat:this.infoFormat,i:c.i,j:c.j});OpenLayers.Util.applyDefaults(d,this.vendorParams);return{url:OpenLayers.Util.isArray(a.url)?a.url[0]:a.url,params:OpenLayers.Util.upperCaseObject(d),callback:function(c){this.handleResponse(b,c,a)},scope:this}},request:function(a,b){var b=b||{},c=this.findLayers();
if(c.length>0){for(var d,e,f=0,g=c.length;f<g;f++){e=c[f];d=this.events.triggerEvent("beforegetfeatureinfo",{xy:a,layer:e});if(d!==false){++this.pending;d=this.buildRequestOptions(e,a);d=OpenLayers.Request.GET(d);if(b.hover===true)this.hoverRequest=d}}this.pending>0&&OpenLayers.Element.addClass(this.map.viewPortDiv,"olCursorWait")}},handleResponse:function(a,b,c){--this.pending;if(this.pending<=0){OpenLayers.Element.removeClass(this.map.viewPortDiv,"olCursorWait");this.pending=0}if(b.status&&(b.status<
...
a.responseXML;if(!b||!b.documentElement)b=a.responseText;return!b||b.length<=0?null:this.format.read(b)},CLASS_NAME:"OpenLayers.Protocol.CSW.v2_0_2"});
...
b){var c={};this.readChildNodes(a,c);b.push(c)},Identifier:function(a,b){b.identifier=this.getChildValue(a)},Title:function(a,b){b.title=this.getChildValue(a)},Abstract:function(a,b){b["abstract"]=this.getChildValue(a)},SupportedCRS:function(a,b){var c=this.getChildValue(a);if(c){if(!b.supportedCRS)b.supportedCRS=[];b.supportedCRS.push(c)}},SupportedFormat:function(a,b){var c=this.getChildValue(a);if(c){if(!b.supportedFormat)b.supportedFormat=[];b.supportedFormat.push(c)}}},OpenLayers.Format.WCSCapabilities.v1.prototype.readers.wcs),
...
f=new OpenLayers.Pixel(e.lon,e.lat);OpenLayers.Projection.transform(f,c,b);for(var e=this.targetSize*d,e=e*e,g,d=0;d<this.intervals.length;++d){g=this.intervals[d];var h=g/2,j=f.offset({x:-h,y:-h}),h=f.offset({x:h,y:h});OpenLayers.Projection.transform(j,b,c);OpenLayers.Projection.transform(h,b,c);if((j.x-h.x)*(j.x-h.x)+(j.y-h.y)*(j.y-h.y)<=e)break}f.x=Math.floor(f.x/g)*g;f.y=Math.floor(f.y/g)*g;var d=0,e=[f.clone()],h=f.clone(),l;do{h=h.offset({x:0,y:g});l=OpenLayers.Projection.transform(h.clone(),
b,c);e.unshift(h)}while(a.containsPixel(l)&&++d<1E3);h=f.clone();do{h=h.offset({x:0,y:-g});l=OpenLayers.Projection.transform(h.clone(),b,c);e.push(h)}while(a.containsPixel(l)&&++d<1E3);d=0;j=[f.clone()];h=f.clone();do{h=h.offset({x:-g,y:0});l=OpenLayers.Projection.transform(h.clone(),b,c);j.unshift(h)}while(a.containsPixel(l)&&++d<1E3);h=f.clone();do{h=h.offset({x:g,y:0});l=OpenLayers.Projection.transform(h.clone(),b,c);j.push(h)}while(a.containsPixel(l)&&++d<1E3);g=[];for(d=0;d<j.length;++d){l=j[d].x;
for(var f=[],m=null,n=Math.min(e[0].y,90),h=Math.max(e[e.length-1].y,-90),o=(n-h)/this.numPoints,n=h,h=0;h<=this.numPoints;++h){var p=new OpenLayers.Geometry.Point(l,n);p.transform(b,c);f.push(p);n=n+o;p.y>=a.bottom&&!m&&(m=p)}if(this.labelled){m=new OpenLayers.Geometry.Point(m.x,a.bottom);l={value:l,label:this.labelled?OpenLayers.Util.getFormattedLonLat(l,"lon",this.labelFormat):"",labelAlign:"cb",xOffset:0,yOffset:2};this.gratLayer.addFeatures(new OpenLayers.Feature.Vector(m,l))}f=new OpenLayers.Geometry.LineString(f);
g.push(new OpenLayers.Feature.Vector(f))}for(h=0;h<e.length;++h){n=e[h].y;if(!(n<-90||n>90)){f=[];d=j[0].x;o=(j[j.length-1].x-d)/this.numPoints;l=d;m=null;for(d=0;d<=this.numPoints;++d){p=new OpenLayers.Geometry.Point(l,n);p.transform(b,c);f.push(p);l=l+o;p.x<a.right&&(m=p)}if(this.labelled){m=new OpenLayers.Geometry.Point(a.right,m.y);l={value:n,label:this.labelled?OpenLayers.Util.getFormattedLonLat(n,"lat",this.labelFormat):"",labelAlign:"rb",xOffset:-2,yOffset:2};this.gratLayer.addFeatures(new OpenLayers.Feature.Vector(m,
l))}f=new OpenLayers.Geometry.LineString(f);g.push(new OpenLayers.Feature.Vector(f))}}this.gratLayer.addFeatures(g)}},CLASS_NAME:"OpenLayers.Control.Graticule"});OpenLayers.Console.warn("OpenLayers.Rico is deprecated");OpenLayers.Rico=OpenLayers.Rico||{};
...
b=this.previousStack.shift();if(b!=void 0){this.nextStack.unshift(a);this.previousStack.unshift(b);this.restoring=true;this.restore(b);this.restoring=false;this.onNextChange(this.nextStack[0],this.nextStack.length);this.onPreviousChange(this.previousStack[1],this.previousStack.length-1)}else this.previousStack.unshift(a);return b},nextTrigger:function(){var a=this.nextStack.shift();if(a!=void 0){this.previousStack.unshift(a);this.restoring=true;this.restore(a);this.restoring=false;this.onNextChange(this.nextStack[0],
...
this.registry[a].apply(this,arguments);this.previousStack.unshift(b);if(this.previousStack.length>1)this.onPreviousChange(this.previousStack[1],this.previousStack.length-1);this.previousStack.length>this.limit+1&&this.previousStack.pop();if(this.nextStack.length>0){this.nextStack=[];this.onNextChange(null,0)}}return true},this)},activate:function(){var a=false;if(this.map&&OpenLayers.Control.prototype.activate.apply(this)){this.listeners==null&&this.setListeners();for(var b in this.listeners)this.map.events.register(b,
this,this.listeners[b]);a=true;this.previousStack.length==0&&this.initStack()}return a},initStack:function(){this.map.getCenter()&&this.listeners.moveend()},deactivate:function(){var a=false;if(this.map&&OpenLayers.Control.prototype.deactivate.apply(this)){for(var b in this.listeners)this.map.events.unregister(b,this,this.listeners[b]);this.clearOnDeactivate&&this.clear();a=true}return a},CLASS_NAME:"OpenLayers.Control.NavigationHistory"});
OpenLayers.Layer.UTFGrid=OpenLayers.Class(OpenLayers.Layer.XYZ,{isBaseLayer:!1,projection:new OpenLayers.Projection("EPSG:900913"),useJSONP:!1,tileClass:OpenLayers.Tile.UTFGrid,initialize:function(a){OpenLayers.Layer.Grid.prototype.initialize.apply(this,[a.name,a.url,{},a]);this.tileOptions=OpenLayers.Util.extend({utfgridResolution:this.utfgridResolution},this.tileOptions)},createBackBuffer:function(){},clone:function(a){a==null&&(a=new OpenLayers.Layer.UTFGrid(this.getOptions()));return a=OpenLayers.Layer.Grid.prototype.clone.apply(this,
...
delete this.tileQueue[a.id];delete this.tileQueueId[a.id];OpenLayers.Util.removeItem(this.maps,a)}},move:function(a){this.updateTimeout(a.object,this.moveDelay,true)},zoomEnd:function(a){this.updateTimeout(a.object,this.zoomDelay)},changeLayer:function(a){(a.property==="visibility"||a.property==="params")&&this.updateTimeout(a.object,0)},addLayer:function(a){a=a.layer;if(a instanceof OpenLayers.Layer.Grid){a.events.on({addtile:this.addTile,retile:this.clearTileQueue,scope:this});var b,c,d;for(b=a.grid.length-
1;b>=0;--b)for(c=a.grid[b].length-1;c>=0;--c){d=a.grid[b][c];this.addTile({tile:d});d.url&&this.manageTileCache({object:d})}}},removeLayer:function(a){a=a.layer;if(a instanceof OpenLayers.Layer.Grid){this.clearTileQueue({object:a});a.events&&a.events.un({addtile:this.addTile,retile:this.clearTileQueue,scope:this});if(a.grid){var b,c,d;for(b=a.grid.length-1;b>=0;--b)for(c=a.grid[b].length-1;c>=0;--c){d=a.grid[b][c];this.unloadTile({object:d});d.url&&this.manageTileCache({object:d})}}}},updateTimeout:function(a,
...
loadend:this.addToCache,unload:this.unloadTile,scope:this});OpenLayers.Util.removeItem(this.tileQueue[a.layer.map.id],a)},queueTileDraw:function(a){var a=a.object,b=false,c=a.layer,d=c.getURL(a.bounds),e=this.tileCache[d];if(e&&e.className!=="olTileImage"){delete this.tileCache[d];OpenLayers.Util.removeItem(this.tileCacheIndex,d);e=null}if(c.url&&(c.async||!e)){b=this.tileQueue[c.map.id];~OpenLayers.Util.indexOf(b,a)||b.push(a);b=true}return!b},drawTilesFromQueue:function(a){for(var b=this.tileQueue[a.id],
c=this.tilesPerFrame,a=a.zoomTween&&a.zoomTween.playing;!a&&b.length&&c;){b.shift().draw(true);--c}},manageTileCache:function(a){var a=a.object,b=this.tileCache[a.url];if(b&&(!b.parentNode||OpenLayers.Element.hasClass(b.parentNode,"olBackBuffer"))){if(a.layer.backBuffer){if(a.layer.backBuffer===b.parentNode)return;b.style.opacity=0;b.style.visibility="hidden"}b.id=null;a.setImage(b);OpenLayers.Util.removeItem(this.tileCacheIndex,a.url);this.tileCacheIndex.push(a.url)}},addToCache:function(a){a=a.object;
if(!this.tileCache[a.url]&&!OpenLayers.Element.hasClass(a.imgDiv,"olImageLoadError")){if(this.tileCacheIndex.length>=this.cacheSize){delete this.tileCache[this.tileCacheIndex[0]];this.tileCacheIndex.shift()}this.tileCache[a.url]=a.imgDiv;this.tileCacheIndex.push(a.url)}},clearTileQueue:function(a){for(var a=a.object,b=this.tileQueue[a.map.id],c=b.length-1;c>=0;--c)b[c].layer===a&&b.splice(c,1)},destroy:function(){for(var a=this.maps.length-1;a>=0;--a)this.removeMap(this.maps[a]);this.tileCacheIndex=
this.tileCache=this.tileQueueId=this.tileQueue=this.maps=null;this._destroyed=true}});
...
[]:this.resolutions=[];this.lods=[];for(var g in d.tileInfo.lods)if(d.tileInfo.lods.hasOwnProperty(g)){var h=d.tileInfo.lods[g];this.useScales?this.scales.push(h.scale):this.resolutions.push(h.resolution);var j=this.getContainingTileCoords(f,h.resolution);h.startTileCol=j.x;h.startTileRow=j.y;j=this.getContainingTileCoords(e,h.resolution);h.endTileCol=j.x;h.endTileRow=j.y;this.lods.push(h)}this.maxExtent=this.calculateMaxExtentWithLOD(this.lods[0]);this.serverResolutions=this.resolutions;if(this.overrideDPI&&
...
if(c<e.x||c>=b.x||d<e.y||d>=b.y)return null}b=this.url;e=""+c+d+a;OpenLayers.Util.isArray(b)&&(b=this.selectUrl(e,b));if(this.useArcGISServer)b=b+"/tile/${z}/${y}/${x}";else{c="C"+OpenLayers.Number.zeroPad(c,8,16);d="R"+OpenLayers.Number.zeroPad(d,8,16);a="L"+OpenLayers.Number.zeroPad(a,2,10);b=b+"/${z}/${y}/${x}."+this.type}b=OpenLayers.String.format(b,{x:c,y:d,z:a});return OpenLayers.Util.urlAppend(b,OpenLayers.Util.getParameterString(this.params))},CLASS_NAME:"OpenLayers.Layer.ArcGISCache"});
...
null)this.reset();else{var b=this.map.getLonLatFromPixel(a.xy);if(b){var c=this.findLayers();if(c.length>0){for(var d={},e,f,g=0,h=c.length;g<h;g++){e=c[g];f=OpenLayers.Util.indexOf(this.map.layers,e);d[f]=e.getFeatureInfo(b)}this.callback(d,b,a.xy)}}}},callback:function(){},reset:function(){this.callback(null)},findLayers:function(){for(var a=this.layers||this.map.layers,b=[],c,d=a.length-1;d>=0;--d){c=a[d];c instanceof OpenLayers.Layer.UTFGrid&&b.push(c)}return b},CLASS_NAME:"OpenLayers.Control.UTFGrid"});
OpenLayers.Format.CQL=function(){var a={PROPERTY:/^[_a-zA-Z]\w*/,COMPARISON:/^(=|<>|<=|<|>=|>|LIKE)/i,IS_NULL:/^IS NULL/i,COMMA:/^,/,LOGICAL:/^(AND|OR)/i,VALUE:/^('([^']|'')*'|\d+(\.\d*)?|\.\d+)/,LPAREN:/^\(/,RPAREN:/^\)/,SPATIAL:/^(BBOX|INTERSECTS|DWITHIN|WITHIN|CONTAINS)/i,NOT:/^NOT/i,BETWEEN:/^BETWEEN/i,GEOMETRY:function(a){var b=/^(POINT|LINESTRING|POLYGON|MULTIPOINT|MULTILINESTRING|MULTIPOLYGON|GEOMETRYCOLLECTION)/.exec(a);if(b){var c=a.length,b=a.indexOf("(",b[0].length);if(b>-1)for(var d=1;b<
c&&d>0;){b++;switch(a.charAt(b)){case "(":d++;break;case ")":d--}}return[a.substr(0,b+1)]}},END:/^$/},b={LPAREN:["GEOMETRY","SPATIAL","PROPERTY","VALUE","LPAREN"],RPAREN:["NOT","LOGICAL","END","RPAREN"],PROPERTY:["COMPARISON","BETWEEN","COMMA","IS_NULL"],BETWEEN:["VALUE"],IS_NULL:["END"],COMPARISON:["VALUE"],COMMA:["GEOMETRY","VALUE","PROPERTY"],VALUE:["LOGICAL","COMMA","RPAREN","END"],SPATIAL:["LPAREN"],LOGICAL:["NOT","VALUE","SPATIAL","PROPERTY","LPAREN"],NOT:["PROPERTY","LPAREN"],GEOMETRY:["COMMA",
...
f={},g={RPAREN:3,LOGICAL:2,COMPARISON:1},h;for(h in c)c.hasOwnProperty(h)&&(d[c[h]]=h);for(h in e)e.hasOwnProperty(h)&&(f[e[h]]=h);return OpenLayers.Class(OpenLayers.Format,{read:function(d){var f=d,d=[],h,n=["NOT","GEOMETRY","SPATIAL","PROPERTY","LPAREN"];do{a:{h=n;for(var o=void 0,n=void 0,p=h.length,o=0;o<p;o++){var n=h[o],q=a[n]instanceof RegExp?a[n].exec(f):(0,a[n])(f);if(q){h=q[0];f=f.substr(h.length).replace(/^\s*/,"");h={type:n,text:h,remainder:f};break a}}d="ERROR: In parsing: ["+f+"], expected one of: ";
for(o=0;o<p;o++){n=h[o];d=d+("\n    "+n+": "+a[n])}throw Error(d);}f=h.remainder;n=b[h.type];if(h.type!="END"&&!n)throw Error("No follows list for "+h.type);d.push(h)}while(h.type!="END");for(var r=function(){var a=s.pop();switch(a.type){case "LOGICAL":var b=r(),d=r();return new OpenLayers.Filter.Logical({filters:[d,b],type:e[a.text.toUpperCase()]});case "NOT":a=r();return new OpenLayers.Filter.Logical({filters:[a],type:OpenLayers.Filter.Logical.NOT});case "BETWEEN":s.pop();d=r();a=r();b=r();return new OpenLayers.Filter.Comparison({property:b,
lowerBoundary:a,upperBoundary:d,type:OpenLayers.Filter.Comparison.BETWEEN});case "COMPARISON":d=r();b=r();return new OpenLayers.Filter.Comparison({property:b,value:d,type:c[a.text.toUpperCase()]});case "IS_NULL":b=r();return new OpenLayers.Filter.Comparison({property:b,type:c[a.text.toUpperCase()]});case "VALUE":return(b=a.text.match(/^'(.*)'$/))?b[1].replace(/''/g,"'"):Number(a.text);case "SPATIAL":switch(a.text.toUpperCase()){case "BBOX":var a=r(),b=r(),d=r(),f=r(),g=r();return new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.BBOX,
property:g,value:OpenLayers.Bounds.fromArray([f,d,b,a])});case "INTERSECTS":d=r();b=r();return new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.INTERSECTS,property:b,value:d});case "WITHIN":d=r();b=r();return new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.WITHIN,property:b,value:d});case "CONTAINS":d=r();b=r();return new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.CONTAINS,property:b,value:d});case "DWITHIN":a=r();d=r();b=r();return new OpenLayers.Filter.Spatial({type:OpenLayers.Filter.Spatial.DWITHIN,
value:d,property:b,distance:Number(a)})}case "GEOMETRY":return OpenLayers.Geometry.fromWKT(a.text);default:return a.text}},n=[],s=[];d.length;){f=d.shift();switch(f.type){case "PROPERTY":case "GEOMETRY":case "VALUE":s.push(f);break;case "COMPARISON":case "BETWEEN":case "IS_NULL":case "LOGICAL":for(h=g[f.type];n.length>0&&g[n[n.length-1].type]<=h;)s.push(n.pop());n.push(f);break;case "SPATIAL":case "NOT":case "LPAREN":n.push(f);break;case "RPAREN":for(;n.length>0&&n[n.length-1].type!="LPAREN";)s.push(n.pop());
n.pop();n.length>0&&n[n.length-1].type=="SPATIAL"&&s.push(n.pop());case "COMMA":case "END":break;default:throw Error("Unknown token type "+f.type);}}for(;n.length>0;)s.push(n.pop());d=r();if(s.length>0){d="Remaining tokens after building AST: \n";for(n=s.length-1;n>=0;n--)d=d+(s[n].type+": "+s[n].text+"\n");throw Error(d);}if(this.keepData)this.data=d;return d},write:function(a){if(a instanceof OpenLayers.Geometry)return a.toString();switch(a.CLASS_NAME){case "OpenLayers.Filter.Spatial":switch(a.type){case OpenLayers.Filter.Spatial.BBOX:return"BBOX("+
...
}case "OpenLayers.Filter.Logical":if(a.type==OpenLayers.Filter.Logical.NOT)return"NOT ("+this.write(a.filters[0])+")";for(var b="(",c=true,e=0;e<a.filters.length;e++){c?c=false:b=b+(") "+f[a.type]+" (");b=b+this.write(a.filters[e])}return b+")";case "OpenLayers.Filter.Comparison":return a.type==OpenLayers.Filter.Comparison.BETWEEN?a.property+" BETWEEN "+this.write(a.lowerBoundary)+" AND "+this.write(a.upperBoundary):a.value!==null?a.property+" "+d[a.type]+" "+this.write(a.value):a.property+" "+d[a.type];
case void 0:if(typeof a==="string")return"'"+a.replace(/'/g,"''")+"'";if(typeof a==="number")return String(a);default:throw Error("Can't encode: "+a.CLASS_NAME+" "+a);}},CLASS_NAME:"OpenLayers.Format.CQL"})}();
OpenLayers.Control.Split=OpenLayers.Class(OpenLayers.Control,{layer:null,source:null,sourceOptions:null,tolerance:null,edge:!0,deferDelete:!1,mutual:!0,targetFilter:null,sourceFilter:null,handler:null,initialize:function(a){OpenLayers.Control.prototype.initialize.apply(this,[a]);this.options=a||{};this.options.source&&this.setSource(this.options.source)},setSource:function(a){if(this.active){this.deactivate();if(this.handler){this.handler.destroy();delete this.handler}this.source=a;this.activate()}else this.source=
...
a&&this.source&&this.source.events&&this.source.events.un({sketchcomplete:this.onSketchComplete,afterfeaturemodified:this.afterFeatureModified,scope:this});return a},onSketchComplete:function(a){this.feature=null;return!this.considerSplit(a.feature)},afterFeatureModified:function(a){if(a.modified&&typeof a.feature.geometry.split==="function"){this.feature=a.feature;this.considerSplit(a.feature)}},removeByGeometry:function(a,b){for(var c=0,d=a.length;c<d;++c)if(a[c].geometry===b){a.splice(c,1);break}},
isEligible:function(a){return a.geometry?a.state!==OpenLayers.State.DELETE&&typeof a.geometry.split==="function"&&this.feature!==a&&(!this.targetFilter||this.targetFilter.evaluate(a.attributes)):false},considerSplit:function(a){var b=false,c=false;if(!this.sourceFilter||this.sourceFilter.evaluate(a.attributes)){for(var d=this.layer&&this.layer.features||[],e,f,g=[],h=[],j=this.layer===this.source&&this.mutual,l={edge:this.edge,tolerance:this.tolerance,mutual:j},m=[a.geometry],n,o,p,q=0,r=d.length;q<
r;++q){n=d[q];if(this.isEligible(n)){o=[n.geometry];for(var s=0;s<m.length;++s){p=m[s];for(var t=0;t<o.length;++t){e=o[t];if(p.getBounds().intersectsBounds(e.getBounds()))if(e=p.split(e,l)){f=this.events.triggerEvent("beforesplit",{source:a,target:n});if(f!==false){if(j){f=e[0];if(f.length>1){f.unshift(s,1);Array.prototype.splice.apply(m,f);s=s+(f.length-3)}e=e[1]}if(e.length>1){e.unshift(t,1);Array.prototype.splice.apply(o,e);t=t+(e.length-3)}}}}}if(o&&o.length>1){this.geomsToFeatures(n,o);this.events.triggerEvent("split",
{original:n,features:o});Array.prototype.push.apply(g,o);h.push(n);c=true}}}if(m&&m.length>1){this.geomsToFeatures(a,m);this.events.triggerEvent("split",{original:a,features:m});Array.prototype.push.apply(g,m);h.push(a);b=true}if(b||c){if(this.deferDelete){d=[];q=0;for(r=h.length;q<r;++q){c=h[q];if(c.state===OpenLayers.State.INSERT)d.push(c);else{c.state=OpenLayers.State.DELETE;this.layer.drawFeature(c)}}this.layer.destroyFeatures(d,{silent:true});q=0;for(r=g.length;q<r;++q)g[q].state=OpenLayers.State.INSERT}else this.layer.destroyFeatures(h,
{silent:true});this.layer.addFeatures(g,{silent:true});this.events.triggerEvent("aftersplit",{source:a,features:g})}}return b},geomsToFeatures:function(a,b){var c=a.clone();delete c.geometry;for(var d,e=0,f=b.length;e<f;++e){d=c.clone();d.geometry=b[e];d.state=OpenLayers.State.INSERT;b[e]=d}},destroy:function(){this.active&&this.deactivate();OpenLayers.Control.prototype.destroy.call(this)},CLASS_NAME:"OpenLayers.Control.Split"});
...
this.maxExtent}},moveTo:function(a,b,c){(b||!this.matrix)&&this.updateMatrixProperties();return OpenLayers.Layer.Grid.prototype.moveTo.apply(this,arguments)},clone:function(a){a==null&&(a=new OpenLayers.Layer.WMTS(this.options));return a=OpenLayers.Layer.Grid.prototype.clone.apply(this,[a])},getIdentifier:function(){return this.getServerZoom()},getMatrix:function(){var a;if(!this.matrixIds||this.matrixIds.length===0)a={identifier:this.getIdentifier()};else if("scaleDenominator"in this.matrixIds[0])for(var b=
OpenLayers.METERS_PER_INCH*OpenLayers.INCHES_PER_UNIT[this.units]*this.getServerResolution()/2.8E-4,c=Number.POSITIVE_INFINITY,d,e=0,f=this.matrixIds.length;e<f;++e){d=Math.abs(1-this.matrixIds[e].scaleDenominator/b);if(d<c){c=d;a=this.matrixIds[e]}}else a=this.matrixIds[this.getIdentifier()];return a},getTileInfo:function(a){var b=this.getServerResolution(),c=(a.lon-this.tileOrigin.lon)/(b*this.tileSize.w),a=(this.tileOrigin.lat-a.lat)/(b*this.tileSize.h),b=Math.floor(c),d=Math.floor(a);return{col:b,
row:d,i:Math.floor((c-b)*this.tileSize.w),j:Math.floor((a-d)*this.tileSize.h)}},getURL:function(a){var a=this.adjustBounds(a),b="";if(!this.tileFullExtent||this.tileFullExtent.intersectsBounds(a)){var a=a.getCenterLonLat(),c=this.getTileInfo(a),a=this.dimensions,d,b=OpenLayers.Util.isArray(this.url)?this.selectUrl([this.version,this.style,this.matrixSet,this.matrix.identifier,c.row,c.col].join(),this.url):this.url;if(this.requestEncoding.toUpperCase()==="REST"){d=this.params;if(b.indexOf("{")!==-1){b=
b.replace(/\{/g,"${");c={style:this.style,Style:this.style,TileMatrixSet:this.matrixSet,TileMatrix:this.matrix.identifier,TileRow:c.row,TileCol:c.col};if(a){var e,f;for(f=a.length-1;f>=0;--f){e=a[f];c[e]=d[e.toUpperCase()]}}b=OpenLayers.String.format(b,c)}else{e=this.version+"/"+this.layer+"/"+this.style+"/";if(a)for(f=0;f<a.length;f++)d[a[f]]&&(e=e+d[a[f]]+"/");e=e+this.matrixSet+"/"+this.matrix.identifier+"/"+c.row+"/"+c.col+"."+this.formatSuffix;b.match(/\/$/)||(b=b+"/");b=b+e}}else if(this.requestEncoding.toUpperCase()===
"KVP"){d={SERVICE:"WMTS",REQUEST:"GetTile",VERSION:this.version,LAYER:this.layer,STYLE:this.style,TILEMATRIXSET:this.matrixSet,TILEMATRIX:this.matrix.identifier,TILEROW:c.row,TILECOL:c.col,FORMAT:this.format};b=OpenLayers.Layer.Grid.prototype.getFullRequestString.apply(this,[d])}}return b},mergeNewParams:function(a){if(this.requestEncoding.toUpperCase()==="KVP")return OpenLayers.Layer.Grid.prototype.mergeNewParams.apply(this,[OpenLayers.Util.upperCaseObject(a)])},CLASS_NAME:"OpenLayers.Layer.WMTS"});
...
removelayer:this.redraw,changebaselayer:this.redraw,scope:this});this.events.unregister("buttonclick",this,this.onButtonClick);OpenLayers.Control.prototype.destroy.apply(this,arguments)},setMap:function(a){OpenLayers.Control.prototype.setMap.apply(this,arguments);this.map.events.on({addlayer:this.redraw,changelayer:this.redraw,removelayer:this.redraw,changebaselayer:this.redraw,scope:this});if(this.outsideViewport){this.events.attachToElement(this.div);this.events.register("buttonclick",this,this.onButtonClick)}else this.map.events.register("buttonclick",
this,this.onButtonClick)},draw:function(){OpenLayers.Control.prototype.draw.apply(this);this.loadContents();this.outsideViewport||this.minimizeControl();this.redraw();return this.div},onButtonClick:function(a){a=a.buttonElement;if(a===this.minimizeDiv)this.minimizeControl();else if(a===this.maximizeDiv)this.maximizeControl();else if(a._layerSwitcher===this.id){a["for"]&&(a=document.getElementById(a["for"]));if(!a.disabled)if(a.type=="radio"){a.checked=true;this.map.setBaseLayer(this.map.getLayer(a._layer))}else{a.checked=
!a.checked;this.updateMap()}}},clearLayersArray:function(a){this[a+"LayersDiv"].innerHTML="";this[a+"Layers"]=[]},checkRedraw:function(){if(!this.layerStates.length||this.map.layers.length!=this.layerStates.length)return true;for(var a=0,b=this.layerStates.length;a<b;a++){var c=this.layerStates[a],d=this.map.layers[a];if(c.name!=d.name||c.inRange!=d.inRange||c.id!=d.id||c.visibility!=d.visibility)return true}return false},redraw:function(){if(!this.checkRedraw())return this.div;this.clearLayersArray("base");
this.clearLayersArray("data");var a=false,b=false,c=this.map.layers.length;this.layerStates=Array(c);for(var d=0;d<c;d++){var e=this.map.layers[d];this.layerStates[d]={name:e.name,visibility:e.visibility,inRange:e.inRange,id:e.id}}var f=this.map.layers.slice();this.ascending||f.reverse();d=0;for(c=f.length;d<c;d++){var e=f[d],g=e.isBaseLayer;if(e.displayInLayerSwitcher){g?b=true:a=true;var h=g?e==this.map.baseLayer:e.getVisibility(),j=document.createElement("input"),l=OpenLayers.Util.createUniqueID(this.id+
"_input_");j.id=l;j.name=g?this.id+"_baseLayers":e.name;j.type=g?"radio":"checkbox";j.value=e.name;j.checked=h;j.defaultChecked=h;j.className="olButton";j._layer=e.id;j._layerSwitcher=this.id;if(!g&&!e.inRange)j.disabled=true;h=document.createElement("label");h["for"]=j.id;OpenLayers.Element.addClass(h,"labelSpan olButton");h._layer=e.id;h._layerSwitcher=this.id;if(!g&&!e.inRange)h.style.color="gray";h.innerHTML=e.name;h.style.verticalAlign=g?"bottom":"baseline";l=document.createElement("br");(g?
this.baseLayers:this.dataLayers).push({layer:e,inputElem:j,labelSpan:h});e=g?this.baseLayersDiv:this.dataLayersDiv;e.appendChild(j);e.appendChild(h);e.appendChild(l)}}this.dataLbl.style.display=a?"":"none";this.baseLbl.style.display=b?"":"none";return this.div},updateMap:function(){for(var a=0,b=this.baseLayers.length;a<b;a++){var c=this.baseLayers[a];c.inputElem.checked&&this.map.setBaseLayer(c.layer,false)}a=0;for(b=this.dataLayers.length;a<b;a++){c=this.dataLayers[a];c.layer.setVisibility(c.inputElem.checked)}},
maximizeControl:function(a){this.div.style.width="";this.div.style.height="";this.showControls(false);a!=null&&OpenLayers.Event.stop(a)},minimizeControl:function(a){this.div.style.width="0px";this.div.style.height="0px";this.showControls(true);a!=null&&OpenLayers.Event.stop(a)},showControls:function(a){this.maximizeDiv.style.display=a?"":"none";this.minimizeDiv.style.display=a?"none":"";this.layersDiv.style.display=a?"none":""},loadContents:function(){this.layersDiv=document.createElement("div");
...
this.dataLayersDiv=document.createElement("div");OpenLayers.Element.addClass(this.dataLayersDiv,"dataLayersDiv");if(this.ascending){this.layersDiv.appendChild(this.baseLbl);this.layersDiv.appendChild(this.baseLayersDiv);this.layersDiv.appendChild(this.dataLbl);this.layersDiv.appendChild(this.dataLayersDiv)}else{this.layersDiv.appendChild(this.dataLbl);this.layersDiv.appendChild(this.dataLayersDiv);this.layersDiv.appendChild(this.baseLbl);this.layersDiv.appendChild(this.baseLayersDiv)}this.div.appendChild(this.layersDiv);
...
if(d.length>0){c={};if(e=d[0].getAttribute("type"))c.type=e;if(e=d[0].getAttribute("src"))c.src=e;else{c.value=c.type=="text"||c.type=="html"||c.type==null?this.getFirstChildValue(a,f,"content",null):c.type=="xhtml"||c.type.match(/(\+|\/)xml$/)?this.getChildEl(d[0]):this.getFirstChildValue(a,f,"content",null);b.content=c}}this.parsePersonConstructs(a,"contributor",b);b.id=this.getFirstChildValue(a,f,"id",null);d=this.getElementsByTagNameNS(a,f,"link");if(d.length>0)b.links=Array(d.length);for(var j=
["rel","type","hreflang","title","length"],g=0,h=d.length;g<h;g++){c={};c.href=d[g].getAttribute("href");for(var l=0,m=j.length;l<m;l++)(e=d[g].getAttribute(j[l]))&&(c[j[l]]=e);b.links[g]=c}if(c=this.getFirstChildValue(a,f,"published",null))b.published=c;if(c=this.getFirstChildValue(a,f,"rights",null))b.rights=c;if(c=this.getFirstChildValue(a,f,"summary",null))b.summary=c;b.title=this.getFirstChildValue(a,f,"title",null);b.updated=this.getFirstChildValue(a,f,"updated",null);c={title:b.title,description:b.summary,
...
c)}c=c.components;if((d=this.getElementsByTagNameNS(a,b,"point"))&&d.length>0){e=0;for(f=d.length;e<f;e++){var g=OpenLayers.String.trim(d[e].firstChild.nodeValue).split(/\s+/);g.length!=2&&(g=OpenLayers.String.trim(d[e].firstChild.nodeValue).split(/\s*,\s*/));c.push(new OpenLayers.Geometry.Point(g[1],g[0]))}}var h=this.getElementsByTagNameNS(a,b,"line");if(h&&h.length>0)for(var j,e=0,f=h.length;e<f;e++){d=OpenLayers.String.trim(h[e].firstChild.nodeValue).split(/\s+/);j=[];for(var l=0,m=d.length;l<
m;l=l+2){g=new OpenLayers.Geometry.Point(d[l+1],d[l]);j.push(g)}c.push(new OpenLayers.Geometry.LineString(j))}if((a=this.getElementsByTagNameNS(a,b,"polygon"))&&a.length>0){e=0;for(f=a.length;e<f;e++){d=OpenLayers.String.trim(a[e].firstChild.nodeValue).split(/\s+/);j=[];l=0;for(m=d.length;l<m;l=l+2){g=new OpenLayers.Geometry.Point(d[l+1],d[l]);j.push(g)}c.push(new OpenLayers.Geometry.Polygon([new OpenLayers.Geometry.LinearRing(j)]))}}if(this.internalProjection&&this.externalProjection){e=0;for(f=
c.length;e<f;e++)c[e]&&c[e].transform(this.externalProjection,this.internalProjection)}return c},parsePersonConstructs:function(a,b,c){for(var d=[],e=this.namespaces.atom,a=this.getElementsByTagNameNS(a,e,b),f=["uri","email"],g=0,h=a.length;g<h;g++){var j={};j.name=this.getFirstChildValue(a[g],e,"name",null);for(var l=0,m=f.length;l<m;l++){var n=this.getFirstChildValue(a[g],e,f[l],null);n&&(j[f[l]]=n)}d.push(j)}d.length>0&&(c[b+"s"]=d)},CLASS_NAME:"OpenLayers.Format.Atom"});
OpenLayers.Control.KeyboardDefaults=OpenLayers.Class(OpenLayers.Control,{autoActivate:!0,slideFactor:75,observeElement:null,draw:function(){this.handler=new OpenLayers.Handler.Keyboard(this,{keydown:this.defaultKeyPress},{observeElement:this.observeElement||document})},defaultKeyPress:function(a){var b,c=true;b=OpenLayers.Event.element(a);if(!b||!(b.tagName=="INPUT"||b.tagName=="TEXTAREA"||b.tagName=="SELECT")){switch(a.keyCode){case OpenLayers.Event.KEY_LEFT:this.map.pan(-this.slideFactor,0);break;
case OpenLayers.Event.KEY_RIGHT:this.map.pan(this.slideFactor,0);break;case OpenLayers.Event.KEY_UP:this.map.pan(0,-this.slideFactor);break;case OpenLayers.Event.KEY_DOWN:this.map.pan(0,this.slideFactor);break;case 33:b=this.map.getSize();this.map.pan(0,-0.75*b.h);break;case 34:b=this.map.getSize();this.map.pan(0,0.75*b.h);break;case 35:b=this.map.getSize();this.map.pan(0.75*b.w,0);break;case 36:b=this.map.getSize();this.map.pan(-0.75*b.w,0);break;case 43:case 61:case 187:case 107:this.map.zoomIn();
break;case 45:case 109:case 189:case 95:this.map.zoomOut();break;default:c=false}c&&OpenLayers.Event.stop(a)}},CLASS_NAME:"OpenLayers.Control.KeyboardDefaults"});
...
c);b.matrixIds.push(c)},ScaleDenominator:function(a,b){b.scaleDenominator=parseFloat(this.getChildValue(a))},TopLeftCorner:function(a,b){var c=this.getChildValue(a).split(" "),d;if(b.supportedCRS){d=b.supportedCRS.replace(/urn:ogc:def:crs:(\w+):.+:(\w+)$/,"urn:ogc:def:crs:$1::$2");d=!!this.yx[d]}b.topLeftCorner=d?new OpenLayers.LonLat(c[1],c[0]):new OpenLayers.LonLat(c[0],c[1])},TileWidth:function(a,b){b.tileWidth=parseInt(this.getChildValue(a))},TileHeight:function(a,b){b.tileHeight=parseInt(this.getChildValue(a))},
MatrixWidth:function(a,b){b.matrixWidth=parseInt(this.getChildValue(a))},MatrixHeight:function(a,b){b.matrixHeight=parseInt(this.getChildValue(a))},ResourceURL:function(a,b){b.resourceUrl=b.resourceUrl||{};var c=a.getAttribute("resourceType");if(!b.resourceUrls)b.resourceUrls=[];c=b.resourceUrl[c]={format:a.getAttribute("format"),template:a.getAttribute("template"),resourceType:c};b.resourceUrls.push(c)},WSDL:function(a,b){b.wsdl={};b.wsdl.href=a.getAttribute("xlink:href")},ServiceMetadataURL:function(a,
...
(function(a){var b=function(a){var b={data:[],heatmap:a};this.max=1;this.get=function(a){return b[a]};this.set=function(a,c){b[a]=c}};b.prototype={addDataPoint:function(a,b){if(!(a<0||b<0)){var c=this.get("heatmap"),d=this.get("data");d[a]||(d[a]=[]);d[a][b]||(d[a][b]=0);d[a][b]=d[a][b]+(arguments.length<3?1:arguments[2]);this.set("data",d);if(this.max<d[a][b]){c.get("actx").clearRect(0,0,c.get("width"),c.get("height"));this.setDataSet({max:d[a][b],data:d},true)}else c.drawAlpha(a,b,d[a][b],true)}},
setDataSet:function(a,b){var c=this.get("heatmap"),d=[],j=a.data,l=j.length;c.clear();this.max=a.max;c.get("legend")&&c.get("legend").update(a.max);if(b!=null&&b)for(var m in j){if(m!==void 0)for(var n in j[m])n!==void 0&&c.drawAlpha(m,n,j[m][n],false)}else for(;l--;){m=j[l];c.drawAlpha(m.x,m.y,m.count,false);d[m.x]||(d[m.x]=[]);d[m.x][m.y]||(d[m.x][m.y]=0);d[m.x][m.y]=m.count}c.colorize();this.set("data",j)},exportDataSet:function(){var a=this.get("data"),b=[],c;for(c in a)if(c!==void 0)for(var d in a[c])d!==
void 0&&b.push({x:parseInt(c,10),y:parseInt(d,10),count:a[c][d]});return{max:this.max,data:b}},generateRandomDataSet:function(a){var b=this.get("heatmap"),c=b.get("width"),b=b.get("height"),d={},j=Math.floor(Math.random()*1E3+1);d.max=j;for(var l=[];a--;)l.push({x:Math.floor(Math.random()*c+1),y:Math.floor(Math.random()*b+1),count:Math.floor(Math.random()*j+1)});d.data=l;this.setDataSet(d)}};var c=function(a){this.config=a;var b={element:null,labelsEl:null,gradientCfg:null,ctx:null};this.get=function(a){return b[a]};
this.set=function(a,c){b[a]=c};this.init()};c.prototype={init:function(){var a=this.config,b=a.title||"Legend",c=a.position,d=a.offset||10,a=document.createElement("ul"),j="";this.processGradientObject();j=c.indexOf("t")>-1?j+("top:"+d+"px;"):j+("bottom:"+d+"px;");j=c.indexOf("l")>-1?j+("left:"+d+"px;"):j+("right:"+d+"px;");c=document.createElement("div");c.style.cssText="border-radius:5px;position:absolute;"+j+"font-family:Helvetica; width:256px;z-index:10000000000; background:rgba(255,255,255,1);padding:10px;border:1px solid black;margin:0;";
...
processGradientObject:function(){var a=this.config.gradient,b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push({stop:c,value:a[c]});b.sort(function(a,b){return a.stop-b.stop});b.unshift({stop:0,value:"rgba(0,0,0,0)"});this.set("gradientArr",b)},createGradientImage:function(){var a=this.get("gradientArr"),b=a.length,c=document.createElement("canvas"),d=c.getContext("2d"),j;c.width="256";c.height="15";j=d.createLinearGradient(0,5,256,10);for(var l=0;l<b;l++)j.addColorStop(1/(b-1)*l,a[l].value);d.fillStyle=
j;d.fillRect(0,5,256,10);d.strokeStyle="black";d.beginPath();for(l=0;l<b;l++){d.moveTo((1/(b-1)*l*256>>0)+0.5,0);d.lineTo((1/(b-1)*l*256>>0)+0.5,l==0?15:5)}d.moveTo(255.5,0);d.lineTo(255.5,15);d.moveTo(255.5,4.5);d.lineTo(0,4.5);d.stroke();this.set("ctx",d);return c.toDataURL()},getElement:function(){return this.get("element")},update:function(a){for(var b=this.get("gradientArr"),c=this.get("ctx"),d=this.get("labelsEl"),j,l="",m,n=0;n<b.length;n++){j=a*b[n].stop>>0;m=c.measureText(j).width/2>>0;n==
0&&(m=0);n==b.length-1&&(m=m*2);l=l+('<li style="position:absolute;left:'+(((1/(b.length-1)*n*256||0)>>0)-m+0.5)+'px">'+j+"</li>")}d.innerHTML=l}};var d=function(a){var c={blur:15,radius:40,element:{},canvas:{},acanvas:{},ctx:{},actx:{},legend:null,visible:true,width:0,height:0,max:false,gradient:false,opacity:180,premultiplyAlpha:false,bounds:{l:1E3,r:0,t:1E3,b:0},debug:false};this.store=new b(this);this.get=function(a){return c[a]};this.set=function(a,b){c[a]=b};this.configure(a);this.init()};d.prototype=
{configure:function(a){this.set("blur",a.blur||15);this.set("radius",a.radius||40);this.set("element",a.element instanceof Object?a.element:document.getElementById(a.element));this.set("visible",a.visible!=null?a.visible:true);this.set("max",a.max||false);this.set("gradient",a.gradient||{"0.45":"rgb(0,0,255)","0.55":"rgb(0,255,255)","0.65":"rgb(0,255,0)","0.95":"yellow",1:"rgb(255,0,0)"});this.set("opacity",parseInt(255/(100/a.opacity),10)||180);this.set("width",a.width||0);this.set("height",a.height||
0);this.set("debug",a.debug);if(a.legend){a=a.legend;a.gradient=this.get("gradient");this.set("legend",new c(a))}},resize:function(){var a=this.get("element"),b=this.get("canvas"),c=this.get("acanvas");b.width=c.width=this.get("width")||a.style.width.replace(/px/,"")||this.getWidth(a);this.set("width",b.width);b.height=c.height=this.get("height")||a.style.height.replace(/px/,"")||this.getHeight(a);this.set("height",b.height)},init:function(){var a=document.createElement("canvas"),b=document.createElement("canvas"),
c=a.getContext("2d"),d=b.getContext("2d"),j=this.get("element");this.initColorPalette();this.set("canvas",a);this.set("ctx",c);this.set("acanvas",b);this.set("actx",d);this.resize();a.style.cssText=b.style.cssText="position:absolute;top:0;left:0;z-index:10000000;";if(!this.get("visible"))a.style.display="none";j.appendChild(a);this.get("legend")&&j.appendChild(this.get("legend").getElement());this.get("debug")&&document.body.appendChild(b);d.shadowOffsetX=15E3;d.shadowOffsetY=15E3;d.shadowBlur=this.get("blur")},
initColorPalette:function(){var a=document.createElement("canvas"),b=this.get("gradient"),c,d;a.width="1";a.height="256";a=a.getContext("2d");c=a.createLinearGradient(0,0,1,256);d=a.getImageData(0,0,1,1);d.data[0]=d.data[3]=64;d.data[1]=d.data[2]=0;a.putImageData(d,0,0);d=a.getImageData(0,0,1,1);this.set("premultiplyAlpha",d.data[0]<60||d.data[0]>70);for(var j in b)c.addColorStop(j,b[j]);a.fillStyle=c;a.fillRect(0,0,1,256);this.set("gradient",a.getImageData(0,0,1,256).data)},getWidth:function(a){var b=
a.offsetWidth;a.style.paddingLeft&&(b=b+a.style.paddingLeft);a.style.paddingRight&&(b=b+a.style.paddingRight);return b},getHeight:function(a){var b=a.offsetHeight;a.style.paddingTop&&(b=b+a.style.paddingTop);a.style.paddingBottom&&(b=b+a.style.paddingBottom);return b},colorize:function(a,b){var c=this.get("width"),d=this.get("radius"),j=this.get("height"),l=this.get("actx"),m=this.get("ctx"),n=d*3,d=this.get("premultiplyAlpha"),o=this.get("gradient"),p=this.get("opacity"),q=this.get("bounds"),r,s,
t;if(a!=null&&b!=null){a+n>c&&(a=c-n);a<0&&(a=0);b<0&&(b=0);b+n>j&&(b=j-n);r=a;c=b;s=a+n;j=b+n}else{r=q.l<0?0:q.l;s=q.r>c?c:q.r;c=q.t<0?0:q.t;j=q.b>j?j:q.b}l=l.getImageData(r,c,s-r,j-c);j=l.data;n=j.length;for(s=3;s<n;s=s+4){t=j[s];if(q=t*4){t=t<p?t:p;j[s-3]=o[q];j[s-2]=o[q+1];j[s-1]=o[q+2];if(d){j[s-3]=j[s-3]/(255/t);j[s-2]=j[s-2]/(255/t);j[s-1]=j[s-1]/(255/t)}j[s]=t}}l.data=j;m.putImageData(l,r,c)},drawAlpha:function(a,b,c,d){var j=this.get("radius"),l=this.get("actx");this.get("max");var m=this.get("bounds"),
n=a-1.5*j>>0,o=b-1.5*j>>0,p=a+1.5*j>>0,q=b+1.5*j>>0;l.shadowColor="rgba(0,0,0,"+(c?c/this.store.max:"0.1")+")";l.shadowOffsetX=15E3;l.shadowOffsetY=15E3;l.shadowBlur=this.get("blur");l.beginPath();l.arc(a-15E3,b-15E3,j,0,Math.PI*2,true);l.closePath();l.fill();if(d)this.colorize(n,o);else{n<m.l&&(m.l=n);o<m.t&&(m.t=o);p>m.r&&(m.r=p);q>m.b&&(m.b=q)}},toggleDisplay:function(){var a=this.get("visible");this.get("canvas").style.display=a?"none":"block";this.set("visible",!a)},getImageData:function(){return this.get("canvas").toDataURL()},
clear:function(){var a=this.get("width"),b=this.get("height");this.store.set("data",[]);this.get("ctx").clearRect(0,0,a,b);this.get("actx").clearRect(0,0,a,b)},cleanup:function(){this.get("element").removeChild(this.get("canvas"))}};a.h337=a.heatmapFactory={create:function(a){return new d(a)},util:{mousePosition:function(a){var b,c;if(a.layerX){b=a.layerX;c=a.layerY}else if(a.offsetX){b=a.offsetX;c=a.offsetY}if(typeof b!="undefined")return[b,c]}}}})(window);Lemon.Register("SPGIS");Lemon.Register("SPGIS.Base");Lemon.Register("SPGIS.Theme");Lemon.Register("SPGIS.Geometry");Lemon.Register("SPGIS.Data");Lemon.Register("SPGIS.Layer");Lemon.Register("SPGIS.Mapping");Lemon.Register("SPGIS.Feature");Lemon.Register("SPGIS.Style");Lemon.Register("SPGIS.Control");Lemon.Register("SPGIS.Verify");SPGIS.ServerIp="172.26.181.152";SPGIS.Port="6060";SPGIS.LemonDomain="default";SPGIS.userLayers=[];SPGIS.Resource=null;
SPGIS.MeasureStyleMap=new OpenLayers.StyleMap({"default":{strokeColor:"#00FF00",strokeOpacity:1,strokeWidth:3,fillColor:"#FF5500",fillOpacity:0.5,pointRadius:6,pointerEvents:"visiblePainted",fontColor:"${favColor}",fontSize:"12px",fontFamily:"Courier New, monospace",fontWeight:"bold",labelAlign:"${align}",labelXOffset:"${xOffset}",labelYOffset:"${yOffset}",labelOutlineColor:"white",labelOutlineWidth:3}});
SPGIS.MeasureStyle=new OpenLayers.Style({strokeColor:"#00FF00",strokeOpacity:1,strokeWidth:3,fillColor:"#FF5500",fillOpacity:0.5,pointRadius:6,pointerEvents:"visiblePainted",fontColor:"${favColor}",fontSize:"12px",fontFamily:"Courier New, monospace",fontWeight:"bold",labelAlign:"${align}",labelXOffset:"${xOffset}",labelYOffset:"${yOffset}",labelOutlineColor:"white",labelOutlineWidth:3});
...
function base64encode(a){var b,c,d,e,f,g;d=a.length;c=0;for(b="";c<d;){e=a.charCodeAt(c++)&255;if(c==d){b+=base64EncodeChars.charAt(e>>2);b+=base64EncodeChars.charAt((e&3)<<4);b+="==";break}f=a.charCodeAt(c++);if(c==d){b+=base64EncodeChars.charAt(e>>2);b+=base64EncodeChars.charAt((e&3)<<4|(f&240)>>4);b+=base64EncodeChars.charAt((f&15)<<2);b+="=";break}g=a.charCodeAt(c++);b+=base64EncodeChars.charAt(e>>2);b+=base64EncodeChars.charAt((e&3)<<4|(f&240)>>4);b+=base64EncodeChars.charAt((f&15)<<2|(g&192)>>
6);b+=base64EncodeChars.charAt(g&63)}return b}
function base64decode(a){var b,c,d,e,f;e=a.length;d=0;for(f="";d<e;){do b=base64DecodeChars[a.charCodeAt(d++)&255];while(d<e&&-1==b);if(-1==b)break;do c=base64DecodeChars[a.charCodeAt(d++)&255];while(d<e&&-1==c);if(-1==c)break;f+=String.fromCharCode(b<<2|(c&48)>>4);do{b=a.charCodeAt(d++)&255;if(61==b)return f;b=base64DecodeChars[b]}while(d<e&&-1==b);if(-1==b)break;f+=String.fromCharCode((c&15)<<4|(b&60)>>2);do{c=a.charCodeAt(d++)&255;if(61==c)return f;c=base64DecodeChars[c]}while(d<e&&-1==c);if(-1==
c)break;f+=String.fromCharCode((b&3)<<6|c)}return f}function utf16to8(a){var b,c,d,e;b="";d=a.length;for(c=0;c<d;c++)e=a.charCodeAt(c),1<=e&&127>=e?b+=a.charAt(c):(2047<e?(b+=String.fromCharCode(224|e>>12&15),b+=String.fromCharCode(128|e>>6&63)):b+=String.fromCharCode(192|e>>6&31),b+=String.fromCharCode(128|e>>0&63));return b}
function utf8to16(a){var b,c,d,e,f,g;b="";d=a.length;for(c=0;c<d;)switch(e=a.charCodeAt(c++),e>>4){case 0:case 1:case 2:case 3:case 4:case 5:case 6:case 7:b+=a.charAt(c-1);break;case 12:case 13:f=a.charCodeAt(c++);b+=String.fromCharCode((e&31)<<6|f&63);break;case 14:f=a.charCodeAt(c++),g=a.charCodeAt(c++),b+=String.fromCharCode((e&15)<<12|(f&63)<<6|(g&63)<<0)}return b}
function doit(){var a=document.f;a.output.value=base64encode(utf16to8(a.source.value));a.decode.value=utf8to16(base64decode(a.output.value))};SPGIS.System=SPGIS.System||function(){this.getKey=function(){return""};this.init=function(){SPGIS.ServerIp=SPGIS.ServerIp.replace("#$(&%[ip]&*#*@)%","localhost");SPGIS.Port=SPGIS.Port.replace("#$(&%[port]&*#*@)%","6060");SPGIS.LemonDomain=SPGIS.LemonDomain.replace("#$(&%[domain]&*#*@)%","default");SPGIS.SIC=new Lemon.LemonServer(SPGIS.ServerIp,SPGIS.Port,SPGIS.LemonDomain)}};var sys=new SPGIS.System;sys.init();SPGIS.Control=SPGIS.Control||{};SPGIS.Control.PanZoomBar=function(){return new OpenLayers.Control.PanZoomBar};
SPGIS.Control.PanPanel=function(){return new (OpenLayers.Class(OpenLayers.Control.PanZoom,{draw:function(a){OpenLayers.Control.prototype.draw.apply(this,arguments);a=this.position;this.buttons=[];var b={w:20,h:14},c={w:40,h:14},d=new OpenLayers.Pixel(a.x+b.w/2,a.y),e=new OpenLayers.Pixel(a.x,a.y);this._addButton("panup","../../lib/img/north-mini.png",e,c);a.y=d.y+b.h;this._addButton("panleft","../../lib/img/west-mini.png",a,b);this._addButton("panright","../../lib/img/east-mini.png",a.add(b.w,0),
b);this._addButton("pandown","../../lib/img/south-mini.png",e.add(0,2*b.h),c);return this.div}}))};SPGIS.Control.PanZoom=function(){return new OpenLayers.Control.PanZoom};SPGIS.Control.ScaleLine=function(){OpenLayers.INCHES_PER_UNIT["\u5343\u7c73"]=OpenLayers.INCHES_PER_UNIT.km;OpenLayers.INCHES_PER_UNIT["\u7c73"]=OpenLayers.INCHES_PER_UNIT.m;return new OpenLayers.Control.ScaleLine({topOutUnits:"\u5343\u7c73",topInUnits:"\u7c73",bottomOutUnits:"",bottomInUnits:""})};
SPGIS.Control.OverviewMap=function(){var a=new OpenLayers.Control.OverviewMap;a.size=new OpenLayers.Size(400,300);a.minRatio=10;a.mapOptions={resolutions:[0.703125,0.3515625,0.17578125,0.087890625,0.0439453125,0.02197265625,0.010986328125,0.0054931640625,0.00274658203125,0.001373291015625,6.866455078125E-4,3.4332275390625E-4,1.71661376953125E-4,8.58306884765625E-5,4.291534423828125E-5,2.1457672119140625E-5,1.0728836059570312E-5,5.364418029785156E-6,2.682209014892578E-6,1.341104507446289E-6],maxExtent:new OpenLayers.Bounds(-180,
-90,180,90)};return a};SPGIS.Control.MousePosition=function(){var a=new OpenLayers.Control.MousePosition;a.numDigits=2;return a};SPGIS.Control.ZoomIn=function(){return new OpenLayers.Control.ZoomIn};SPGIS.Control.ZoomOut=function(){return new OpenLayers.Control.ZoomOut};SPGIS.Control.Zoom=function(){return new OpenLayers.Control.Zoom};SPGIS.Control.Navigation=function(){return new OpenLayers.Control.Navigation};
SPGIS.Control.DragFeature=function(a,b){var c=new OpenLayers.Control.DragFeature(a.layer);c.onDrag=b;return c};SPGIS.Control.SelectFeature=function(a,b){var c=null;if(OpenLayers.Util.isArray(a)){for(var c=[],d=0;d<a.length;d++)c.push(a[d].layer);c=new OpenLayers.Control.SelectFeature(c)}else c=new OpenLayers.Control.SelectFeature(a.layer);c.callbacks.click=b;return c};SPGIS.Control.ModifyFeature=function(a){return new OpenLayers.Control.ModifyFeature(a,{vertexRenderIntent:"temporary",displayClass:"olControlModifyFeature"})};
SPGIS.Control.LayerSwitcher=function(){return new OpenLayers.Control.LayerSwitcher};
SPGIS.Control.ClickControl=function(a){return new (OpenLayers.Class(OpenLayers.Control,{defaultHandlerOptions:{single:!0,"double":!1,pixelTolerance:0,stopSingle:!1,stopDouble:!1},initialize:function(a){this.handlerOptions=OpenLayers.Util.extend({},this.defaultHandlerOptions);OpenLayers.Control.prototype.initialize.apply(this,arguments);this.handler=new OpenLayers.Handler.Click(this,{click:this.trigger},this.handlerOptions)},trigger:function(b){a.call(this,b)}}))};SPGIS.Control.WMSGetFeatureInfo=function(a){return new OpenLayers.Control.WMSGetFeatureInfo(a)};SPGIS.Data.AccessResult=function(){this.msg="";this.chains=[]};SPGIS.Data.DataOperate=function(a){this.datasource=a;this.submitback=null;this.setSubmitCallBack=function(a){this.submitback=a}};SPGIS.Data.DataOperate.prototype={constructor:SPGIS.Data.DataOperate,submit:function(){alert(123);throw Lemon.SE.S2001;}};SPGIS.Data.DataSource=function(a,b){var c=null;this.meta=null;var d=!1;this.connsucceedcallback=b;var e="";this.isSucceed=function(){return d};this.getName=function(){return""!=e?e:a};this.conn=function(){var a=this,b=new Lemon.LemonModule("connDataSource");b.addPar("dsname",this.getName());b.addPar("dsmapname",e);var h=new Lemon.CaiJSON(function(b){if(!(null==b||0==b.length)){if(d=b[0].data)a.meta=b[1].data,c=SPGIS.Data.DataSourceType.getValue(b[2].data);null!=a.connsucceedcallback&&a.connsucceedcallback(d)}},
function(){Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E001)});(new Lemon.SaiTier(SPGIS.SIC,h,b)).launch(Lemon.DoType.Post)};this.setMapName=function(a){e=a};this.getMetaData=function(){return null!=this.meta&&0<this.meta.length?JSON.parse(this.meta):{}};this.getType=function(){return c};this.setType=function(a){c=a}};SPGIS.Data.DataSource.prototype={constructor:SPGIS.Data.DataSource};SPGIS.Data.DataSourceType=SPGIS.Data.DataSourceType||{geoPoint:0,geoPolyLine:1,geoPolygon:2,attribute:3,unknown:4,getValue:function(a){if("geoPoint"==a)return this.geoPoint;if("geoPolygon"==a)return this.geoPolygon;if("geoPolyLine"==a)return this.geoPolyLine;if("attribute"==a)return this.attribute;if("unknown"==a)return this.unknown}};SPGIS.Data.LineString=function(){this.type="LineString";this.coordinates=[]};SPGIS.Data.MultiPolygon=function(){this.type="MultiPolygon";this.coordinates=[]};SPGIS.Data.Point=function(a,b){this.type="Point";this.coordinates=[a,b]};SPGIS.Data.TransitionSpation=function(){this.toPtPoint=function(a){return new SPGIS.Data.Point(a.x,a.y)};this.toPtMultiPolygonFromPolygon=function(a){if(0>a.getArea())return null;for(var b=[],c=0;c<a.components.length;c++){for(var d=a.components[c],e=[],f=0;f<d.components.length;f++){var g=[];g.push(d.components[f].x);g.push(d.components[f].y);e.push(g)}b.push(e)}a=new SPGIS.Data.MultiPolygon;a.coordinates.push(b);return a};this.toPtMultiPolygonFromBounds=function(a){var a=[[[a.left,a.bottom],[a.left,
a.top],[a.right,a.top],[a.right,a.bottom],[a.left,a.bottom]]],b=new SPGIS.Data.MultiPolygon;b.coordinates.push(a);return b}};SPGIS.Data.EditData=function(a,b){SPGIS.Data.DataOperate.call(this,a);this.param=b};Lemon.Inherit([SPGIS.Data.DataOperate,Lemon.Disposable],SPGIS.Data.EditData);
SPGIS.Data.EditData.prototype.submit=function(a){this.submitback=a;var b=this,a=this.param.getLemonModule();a.addPar("dsname",this.datasource.getName());a.addPar("dsmapname",this.datasource.getName());var c=new Lemon.CaiJSON(function(a){if(!(null==a||0==a.length)&&a[0].data!=SPGIS.Base.Chars.E002)if(null!=b.submitback){var c=new SPGIS.Data.AccessResult;c.chains=a[0].data;c.msg=SPGIS.Base.Chars.E003;b.submitback(c)}else Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E006)},function(){Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E001)});
(new Lemon.SaiTier(SPGIS.SIC,c,a)).launch(Lemon.DoType.Post)};SPGIS.Data.EditParameter=function(){this.lemonm=new Lemon.LemonModule("editDatasource")};SPGIS.Data.EditParameter.prototype={constructor:SPGIS.Data.EditParameter,getLemonModule:function(){return this.lemonm}};SPGIS.Data.EditType=SPGIS.Data.EditType||{inter:0,del:1,update:2,updateGeo:3,unknown:4,getValue:function(a){return"inter"==a?this.inter:"del"==a?this.del:"update"==a?this.update:"updateGeo"==a?this.updateGeo:this.unknown}};SPGIS.Data.DeleteParameter=function(a){SPGIS.Data.EditParameter.call(this);this.cmd=a};Lemon.Inherit([SPGIS.Data.EditParameter,Lemon.Disposable],SPGIS.Data.DeleteParameter);
SPGIS.Data.DeleteParameter.prototype={constructor:SPGIS.Data.DeleteParameter,getLemonModule:function(){this.lemonm.addPar("command",this.cmd);this.lemonm.addPar("edittype",SPGIS.Data.EditType.del);this.lemonm.addPar("uppropname",null);this.lemonm.addPar("uppropvalue",null);this.lemonm.addPar("geoPoint",null);this.lemonm.addPar("geoPolygon",null);this.lemonm.addPar("geoLine",null);return this.lemonm}};SPGIS.Data.GeoParameter=function(a){SPGIS.Data.EditParameter.call(this);this.cmd=a;this.setGeometry=function(){}};Lemon.Inherit([SPGIS.Data.EditParameter,Lemon.Disposable],SPGIS.Data.GeoParameter);
SPGIS.Data.GeoParameter.prototype={constructor:SPGIS.Data.GeoParameter,getLemonModule:function(){this.lemonm.addPar("command",this.cmd);this.lemonm.addPar("edittype",SPGIS.Data.EditType.updateGeo);this.lemonm.addPar("uppropname",null);this.lemonm.addPar("uppropvalue",null);this.lemonm.addPar("geoPoint",geopoint);this.lemonm.addPar("geoPolygon",geopolygon);this.lemonm.addPar("geoLine",geoline);return this.lemonm}};SPGIS.Data.InsertParameter=function(){SPGIS.Data.EditParameter.call(this);var a=SPGIS.Data.DataSourceType.unknown,b=[],c=[];this.getInsertType=function(){return a};this.getGeos=function(){return b};this.getPropts=function(){return c};this.clear=function(){b.length=0;c.length=0};getswitchtype=function(a){var b=null;return b="OpenLayers.Geometry.Polygon"==a?SPGIS.Data.DataSourceType.geoPolygon:"OpenLayers.Geometry.Point"==a?SPGIS.Data.DataSourceType.geoPoint:"OpenLayers.Geometry.LineString"==a?SPGIS.Data.DataSourceType.geoPolyLine:
SPGIS.Data.DataSourceType.attribute};this.add=function(d,e){if(a!=SPGIS.Data.DataSourceType.unknown){if(a!=getswitchtype(d.CLASS_NAME))return Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E007),SPGIS.Base.Chars.E007}else a=getswitchtype(d.CLASS_NAME);b.push(d);c.push(e)}};Lemon.Inherit([SPGIS.Data.EditParameter,Lemon.Disposable],SPGIS.Data.InsertParameter);
SPGIS.Data.InsertParameter.prototype={constructor:SPGIS.Data.InsertParameter,getLemonModule:function(){if(0<this.getGeos().length&&0<this.getPropts().length&&this.getGeos().length==this.getPropts().length){var a=this.strusdata();this.getInsertType()==SPGIS.Data.DataSourceType.geoPoint?(this.lemonm.addPar("geoPoint",a),this.lemonm.addPar("geoPolygon",null),this.lemonm.addPar("geoLine",null)):this.getInsertType()==SPGIS.Data.DataSourceType.geoPolygon?(this.lemonm.addPar("geoPoint",null),this.lemonm.addPar("geoPolygon",
a),this.lemonm.addPar("geoLine",null)):this.getInsertType()==SPGIS.Data.DataSourceType.geoPolyLine&&(this.lemonm.addPar("geoPoint",null),this.lemonm.addPar("geoPolygon",null),this.lemonm.addPar("geoLine",a));this.lemonm.addPar("edittype",SPGIS.Data.EditType.inter);this.lemonm.addPar("property",this.getPropts());this.lemonm.addPar("uppropname",null);this.lemonm.addPar("uppropvalue",null);return this.lemonm}},strusdata:function(){for(var a=[],b=new SPGIS.Data.TransitionSpation,c=0;c<this.getGeos().length;c++){var d=
this.getGeos()[c];if("OpenLayers.Geometry.Polygon"==d.CLASS_NAME)a.push(b.toPtMultiPolygonFromPolygon(d));else if("OpenLayers.Geometry.Point"==d.CLASS_NAME)a.push(b.toPtPoint(d));else if("OpenLayers.Geometry.LineString"==d.CLASS_NAME)throw"\u6ca1\u5b9e\u73b0";}return a}};SPGIS.Data.UpdateParameter=function(a){SPGIS.Data.EditParameter.call(this);this.cmd=a;var b="",c=null;this.setField=function(a,e){c=e;b=a};this.getFn=function(){return b};this.getVa=function(){return c}};Lemon.Inherit([SPGIS.Data.EditParameter,Lemon.Disposable],SPGIS.Data.UpdateParameter);
SPGIS.Data.UpdateParameter.prototype={constructor:SPGIS.Data.UpdateParameter,getLemonModule:function(){this.lemonm.addPar("command",this.cmd);this.lemonm.addPar("edittype",SPGIS.Data.EditType.update);this.lemonm.addPar("uppropname",this.getFn());this.lemonm.addPar("uppropvalue",this.getVa());this.lemonm.addPar("geoPoint",null);this.lemonm.addPar("geoPolygon",null);this.lemonm.addPar("geoLine",null);return this.lemonm}};SPGIS.Data.AnalysisType=SPGIS.Data.AnalysisType||{spContain:0,spIntersect:1,spPointBuffer:2,attribute:3,getValue:function(a){if("spContain"==a)return this.spContain;if("spIntersect"==a)return this.spIntersect;if("spPointBuffer"==a)return this.spPointBuffer;if("attribute"==a)return this.attribute}};SPGIS.Data.AttributeParameter=function(a){var b=a;this.lemonm=new Lemon.LemonModule("queryingDatasource");this.setAttribute=function(a){b=a};this.getAttribute=function(){return b};this.getAtrLemonPar=function(){this.lemonm.addPar("anstype",SPGIS.Data.AnalysisType.attribute);this.lemonm.addPar("command",this.getAttribute());this.lemonm.addPar("geoPolygon",null);this.lemonm.addPar("geoPoint",null);this.lemonm.addPar("geoLine",null);this.lemonm.addPar("region",null);return this.lemonm}};
SPGIS.Data.AttributeParameter.prototype={constructor:SPGIS.Data.AttributeParameter,getLemonModule:function(){return this.getAtrLemonPar()}};SPGIS.Data.QueryData=function(a,b){SPGIS.Data.DataOperate.call(this,a);this.param=b};Lemon.Inherit([SPGIS.Data.DataOperate,Lemon.Disposable],SPGIS.Data.QueryData);
SPGIS.Data.QueryData.prototype.submit=function(a){this.submitback=a;var b=this,a=this.param.getLemonModule();a.addPar("dsname",this.datasource.getName());a.addPar("dsmapname",this.datasource.getName());var c=new Lemon.CaiJSON(function(a){if(null==a||0==a.length)if(null!=b.submitback){var c=new SPGIS.Data.AccessResult;c.chains=null;c.msg=SPGIS.Base.Chars.E005;b.submitback(c)}else Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E006);else a[0].data!=SPGIS.Base.Chars.E002?null!=b.submitback?(c=new SPGIS.Data.AccessResult,
c.chains=a[0].data,c.msg=SPGIS.Base.Chars.E003,b.submitback(c)):Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E006):Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E002)},function(){Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E001)});(new Lemon.SaiTier(SPGIS.SIC,c,a)).launch(Lemon.DoType.Post)};SPGIS.Data.BoundsParameter=function(a){SPGIS.Data.AttributeParameter.call(this);this.bounds=a};Lemon.Inherit([SPGIS.Data.AttributeParameter,Lemon.Disposable],SPGIS.Data.BoundsParameter);
SPGIS.Data.BoundsParameter.prototype={constructor:SPGIS.Data.BoundsParameter,getLemonModule:function(){if(null==this.bounds)return null;var a=(new SPGIS.Data.TransitionSpation).toPtMultiPolygonFromBounds(this.bounds);this.lemonm.addPar("anstype",SPGIS.Data.AnalysisType.spIntersect);this.lemonm.addPar("geoPolygon",a);this.lemonm.addPar("command",this.getAttribute());this.lemonm.addPar("geoPoint",null);this.lemonm.addPar("geoLine",null);this.lemonm.addPar("region",null);return this.lemonm},setBounds:function(a,
b,c,d){this.bounds=new SPGIS.Geometry.Bounds(a,b,c,d)}};SPGIS.Data.PolygonParameter=function(a){SPGIS.Data.AttributeParameter.call(this);this.plg=null;null!=a&&"OpenLayers.Geometry.Polygon"==a.CLASS_NAME&&(this.plg=a)};Lemon.Inherit([SPGIS.Data.AttributeParameter,Lemon.Disposable],SPGIS.Data.PolygonParameter);
SPGIS.Data.PolygonParameter.prototype={constructor:SPGIS.Data.PolygonParameter,getLemonModule:function(){if(null==this.plg||"OpenLayers.Geometry.Polygon"!=this.plg.CLASS_NAME)return null;var a=(new SPGIS.Data.TransitionSpation).toPtMultiPolygonFromPolygon(this.plg);this.lemonm.addPar("anstype",SPGIS.Data.AnalysisType.spIntersect);this.lemonm.addPar("geoPolygon",a);this.lemonm.addPar("command",this.getAttribute());this.lemonm.addPar("geoPoint",null);this.lemonm.addPar("geoLine",null);this.lemonm.addPar("region",
null);return this.lemonm},setBounds:function(a){if("OpenLayers.Geometry.Polygon"!=this.plg.CLASS_NAME)return null;this.plg=a}};SPGIS.Feature=function(a){return new OpenLayers.Feature.Vector(a)};SPGIS.Feature=function(a,b,c){return new OpenLayers.Feature.Vector(a,null,c)};SPGIS.FeatureOrdinary=function(a,b){return new OpenLayers.Feature(a,b)};SPGIS.Control.Measure=function(a,b,c){var d=b.layer,e=[],f=null,g=[],h=[],b=new OpenLayers.Style;b.addRules([new OpenLayers.Rule({symbolizer:{Point:{pointRadius:4,graphicName:"square",fillColor:"white",fillOpacity:1,strokeWidth:1,strokeOpacity:1,strokeColor:"#333333"},Line:{strokeWidth:3,strokeOpacity:1,strokeColor:"#666666",strokeDashstyle:"dash"},Polygon:{strokeWidth:2,strokeOpacity:1,strokeColor:"#666666",fillColor:"white",fillOpacity:0.3}}})]);var j=new OpenLayers.StyleMap({"default":b}),b=new OpenLayers.Control.SelectFeature(d);
a.addControl(b);b.activate();b.onSelect=function(a){"undefined"!=typeof a.index&&d.removeFeatures(g[a.index])};var l=function(a,b){return Math.round(a*Math.pow(10,b))/Math.pow(10,b)},m=function(a){var b=l(a.measure,2)+""+a.units;1<a.order&&(b+="2");var e=new OpenLayers.Feature.Vector(a.geometry.components[a.geometry.components.length-1]);e.attributes={total:b};var j=p(SPGIS.MeasureStyle.defaultStyle);j.label="\u603b\u957f:"+b;j.labelXOffset=15;j.labelYOffset=15;e.style=j;d.addFeatures([e]);b=new OpenLayers.Feature.Vector(a.geometry);
b.style=SPGIS.MeasureStyle.defaultStyle;d.addFeatures([b]);a=new OpenLayers.Feature.Vector(a.geometry.components[0]);a.style={pointRadius:6,stroke:!1};a.style.externalGraphic=c?c||c:"http://"+SPGIS.ServerIp+":8080/spgiswebsite/img/textures/delete.png";a.index=g.length;d.addFeatures([a]);f.deactivate();h.push(e,b,a);e=h;h=[];g.push(e)},n=function(a){if(2!=a.geometry.components.length){var b=l(a.measure,2)+""+a.units;1<a.order&&(b+="2");var c=new OpenLayers.Feature.Vector(a.geometry.components[a.geometry.components.length-
1]);c.attributes={total:b};var e=p(SPGIS.MeasureStyle.defaultStyle);e.label=b;e.labelXOffset=15;e.labelYOffset=15;c.style=e;a=new OpenLayers.Feature.Vector(a.geometry);a.style=SPGIS.MeasureStyle.defaultStyle;d.addFeatures([a]);d.addFeatures([c]);h.push(c,a)}},o=function(a){var b=l(a.measure,2)+""+a.units;1<a.order&&(b+="\u00b2");var e=new OpenLayers.Feature.Vector(a.geometry.components[a.geometry.components.length-1]);e.attributes={total:b};var j=p(SPGIS.MeasureStyle.defaultStyle);j.label="\u603b\u9762\u79ef:"+
b;e.style=j;d.addFeatures([e]);f.deactivate();a=new OpenLayers.Feature.Vector(a.geometry.components[0].components[a.geometry.components[0].components.length-1]);a.style={pointRadius:6,stroke:!1};a.style.externalGraphic=c?c||c:"http://"+SPGIS.ServerIp+":8080/spgiswebsite/img/textures/delete.png";a.index=g.length;d.addFeatures([a]);f.deactivate();h.push(e,a);e=h;h=[];g.push(e)};this.measurePath=function(){f&&f.deactivate();var b=new OpenLayers.Control.Measure(OpenLayers.Handler.Path,{persist:!0,eventListeners:{measure:m,
measurepartial:n},handlerOptions:{layerOptions:{styleMap:j}}});a.addControl(b);f=b;e.push(b);b.activate()};this.measurePolygon=function(){f&&f.deactivate();var b=new OpenLayers.Control.Measure(OpenLayers.Handler.Polygon,{persist:!0,eventListeners:{measure:o},handlerOptions:{layerOptions:{styleMap:j}}});a.addControl(b);f=b;e.push(b);b.activate()};this.measureRegularPolygon=function(){f&&f.deactivate();var b=new OpenLayers.Control.Measure(OpenLayers.Handler.RegularPolygon,{persist:!0,eventListeners:{measure:o},
handlerOptions:{layerOptions:{styleMap:j}}});a.addControl(b);f=b;e.push(b);b.activate()};this.cancel=function(){for(var a=0;a<e.length;a++)e[a].deactivate();d.removeAllFeatures()};var p=function(a){if("object"!=typeof a||null==a)return a;var b={},c;for(c in a)b[c]=p(a[c]);return b}};SPGIS.Search=SPGIS.Search||{};
SPGIS.Search.search=function(a,b,c){for(var d='<wfs:GetFeature service="WFS" version="1.0.0"\noutputFormat="GML2"\ncount="200"\nxmlns:opengis="http://www.cetusOpengis.com"\nxmlns:wfs="http://www.opengis.net/wfs"\nxmlns:ogc="http://www.opengis.net/ogc"\nxmlns:gml="http://www.opengis.net/gml"\nxmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"\nxsi:schemaLocation="http://www.opengis.net/wfs   http://schemas.opengis.net/wfs/1.0.0/WFS-basic.xsd">\n',e=0;e<a.length;e++)d+='<wfs:Query typeName="'+a[e]+
'">\n<ogc:Filter>\n<ogc:PropertyIsLike wildCard="*" singleChar="#" escapeChar="!">\n<ogc:PropertyName>CODE</ogc:PropertyName>\n<ogc:Literal>*'+b+"*</ogc:Literal>\n</ogc:PropertyIsLike>\n</ogc:Filter>\n</wfs:Query>\n";OpenLayers.Request.POST({url:SPGIS.WFSServer,data:d+"</wfs:GetFeature>",callback:c})};SPGIS.Spatial=SPGIS.Spatial||{};
SPGIS.Spatial.createCon=function(a,b,c,d,e){a.createBox(b,function(a){OpenLayers.Request.POST({url:d,params:{REQUEST:"GetFeature",SERVICE:"WFS",TYPENAME:c,version:"1.0.0",BBOX:a,outputFormat:"application/xml"},callback:e});var b=new SPGIS.Layer.Vector("vectorlayer"),h=[],j=new SPGIS.Geometry.Point(a.left,a.top);h.push(j);j=new SPGIS.Geometry.Point(a.right,a.top);h.push(j);j=new SPGIS.Geometry.Point(a.right,a.bottom);h.push(j);j=new SPGIS.Geometry.Point(a.left,a.bottom);h.push(j);a=new SPGIS.Geometry.LinearRing(h);
a=new SPGIS.Feature(new SPGIS.Geometry.Polygon(a));b.addFeatures(a,SPGIS.MeasureStyle);map.addLayer(b)})};SPGIS.Theme=SPGIS.Theme||{};SPGIS.Theme.Style=function(a){return new OpenLayers.Style(a)};SPGIS.Geometry.Bounds=function(a,b,c,d){return new OpenLayers.Bounds(a,b,c,d)};SPGIS.Geometry.Curve=function(a,b,c){this.sisClosed=!1;this.snumOfSegments=c;this.stension=b;if(!(null==a||3>a.length||3<a.length)){this.sptsa=[];for(b=0;b<a.length;b++)this.sptsa.push(a[b].x),this.sptsa.push(a[b].y);var d=this.sptsa,a=this.stension,b=this.sisClosed,c=this.snumOfSegments;if(2>=d.length)a=d;else{var a="number"===typeof a?a:0.5,b="boolean"===typeof b?b:!1,c="number"===typeof c?c:16,e=d.slice(0);b&&e.push(d[0],d[1],d[2],d[3]);var f=[],g,h,j,l,m,n,o,p,q,r,s,t,u,v,w,x=e.length,d=e.concat();
d.unshift(e[1]);d.unshift(e[0]);d.push(e[x-2],e[x-1]);for(r=2;r<x;r+=2){t=d[r];u=d[r+1];v=d[r+2];w=d[r+3];e=(v-d[r-2])*a;j=(d[r+4]-t)*a;l=(w-d[r-1])*a;m=(d[r+5]-u)*a;for(q=0;q<=c;q++)o=q/c,p=Math.pow(o,2),g=p*o,s=3*p,n=2*g,h=n-s+1,n=s-n,o=g-2*p+o,p=g-p,g=h*t+n*v+o*e+p*j,h=h*u+n*w+o*l+p*m,f.push(g,h)}b&&(f=f.slice(0,f.length-2*c));a=f}c=[];for(b=0;b<a.length;)c.push(new OpenLayers.Geometry.Point(a[b],a[b+1])),b++,b++;return this.curveLine=new OpenLayers.Geometry.LineString(c)}};SPGIS.Geometry.LinearRing=function(a){return new OpenLayers.Geometry.LinearRing(a)};SPGIS.Geometry.LineString=function(a){return new OpenLayers.Geometry.LineString(a)};SPGIS.Geometry.Point=function(a,b){return new OpenLayers.Geometry.Point(a,b)};SPGIS.Geometry.Polygon=function(a){return new OpenLayers.Geometry.Polygon(a)};SPGIS.Geometry.PolygonCreateRegularPolygonCurve=function(a,b,c,d){return new OpenLayers.Geometry.Polygon.createRegularPolygonCurve(a,b,c,d)};SPGIS.Geometry.Polygon.RegularPolygon=function(a,b,c,d){return new OpenLayers.Geometry.Polygon.createRegularPolygon(a,b,c,d)};SPGIS.Geometry.Polygon.Circle=function(a,b){return new OpenLayers.Geometry.Polygon.createRegularPolygon(a,b,100)};SPGIS.Layer.BaseLayer=function(a){if(""!=SPGIS.BaseLayerServer){var b={tileSize:new OpenLayers.Size(256,256),tileOrigin:new OpenLayers.LonLat(-400,400)};this.layer=new OpenLayers.Layer.WMS(a,SPGIS.BaseLayerServer,{layers:"pingtanmap",format:"image/png"},b)}};SPGIS.Layer.HeatLayer=function(a,b,c,d,e){this.layer=new OpenLayers.Layer.Heatmap(a,b,c,d,e);this.setDataSet=function(a){for(var b=a.length,c=-1;b--;)c<a[b].count&&(c=a[b].count);this.layer.setDataSet({data:a,max:c})}};SPGIS.Layer.HeatPoint=function(a,b,c){return{lonlat:new SPGIS.Mapping.LonLat(a,b),count:c}};SPGIS.Layer.ImageLayer=function(a){if(""!=SPGIS.ImageLayerServer){var b={tileSize:new OpenLayers.Size(256,256),tileOrigin:new OpenLayers.LonLat(-400,400)};this.layer=new OpenLayers.Layer.WMS(a,SPGIS.BaseLayerServer,{layers:"tifflinkimg",format:"image/png"},b)}};SPGIS.Layer.LayerInfo=function(){this.sicCharacter=this.sicFormat=this.sicName="";this.type=null;this.layerName="";this.sicResolutions=[];this.sicMaxExtent=new OpenLayers.Bounds(-400,25.470248828739557,119.84667086428351,400);this.sicCentre=new OpenLayers.LonLat(119.78491774496,25.477482630653);this.sicTileSize=new OpenLayers.Size(256,256);this.sicTileOrigin=new OpenLayers.LonLat(-400,400)};SPGIS.Layer.LayerType=SPGIS.Layer.LayerType||{Base:0,Image:1,Custom:2,Markers:3,unknown:4,getValue:function(a){if("BaseMap"==a)return this.BaseMap;if("Images"==a)return this.Images;if("Custom"==a)return this.Custom;if("Markers"==a)return this.Markers}};SPGIS.Layer.Markers=function(a,b){this.layer=new OpenLayers.Layer.Markers(a,b);this.addMarker=function(a){this.layer.addMarker(a)};this.removeMarker=function(a){this.layer.removeMarker(a)};this.clearMarkers=function(){this.layer.clearMarkers()}};SPGIS.Layer.Vector=function(a,b){this.layer=new OpenLayers.Layer.Vector(a,b);this.addFeatures=function(a,b){null==b?this.layer.addFeatures(a):this.layer.addFeatures(a,b)};this.removeFeatures=function(a,b){this.layer.removeFeatures(a,b)};this.removeAllFeatures=function(a){this.layer.removeAllFeatures(a)}};SPGIS.Layer.WMS=function(a,b,c,d){this.layer=new OpenLayers.Layer.WMS(a,b,c,d)};SPGIS.Layer.WMTS=function(a){this.layer=new OpenLayers.Layer.WMS(a)};SPGIS.Layer.LayerSet=function(a,b){this.name=a;this.map=b;this.settable=new Lemon.Hashtable;this.currentname="";this.createwms=function(a){if(null!=a){var b={layers:a.sicName,format:a.sicFormat};OpenLayers.DOTS_PER_INCH=96;OpenLayers.Util.onImageLoadErrorColor="transparent";var e={isBaseLayer:a.isBaseLayer,tileSize:new OpenLayers.Size(a.sicTileSize[0],a.sicTileSize[1]),tileOrigin:new OpenLayers.LonLat(a.sicTileOrigin.longitude,a.sicTileOrigin.latitude),transparent:a.isBaseLayer?!1:!0};return new OpenLayers.Layer.WMS(a.layerName,
a.sicUrl,b,e)}};this.initSet=function(){if(null==SPGIS.Resource.layersets||0==SPGIS.Resource.layersets.length)Lemon.Debug("\u521d\u59cb\u5316\u8d44\u6e90\u5931\u8d25");else{for(var a=0;a<SPGIS.Resource.layersets.length;a++){var b=SPGIS.Resource.layersets[a];b.layers=[];for(var e=0;e<b.sicInfos.length;e++){var f=this.createwms(b.sicInfos[e]);b.layers.push(f)}this.settable.add(b.setName,b);0==b.setIndex&&(this.currentname=b.setName)}this.showSet(this.currentname)}};this.showSet=function(a){if(null!=
a){var b=this.settable.items(this.currentname).layers;if(0<this.map.layers.length)for(var e=0;e<b.length;e++)this.map.removeLayer(b[e]);this.currentname="";b=this.settable.items(a);null!=b&&(e={resolutions:b.option.resolutions,projection:new OpenLayers.Projection("EPSG:4326"),maxExtent:new OpenLayers.Bounds(b.option.maxExtent.minx,b.option.maxExtent.miny,b.option.maxExtent.maxx,b.option.maxExtent.maxy),controls:[new OpenLayers.Control.Navigation]},this.map.setOptions(e),this.currentname=a,this.map.addLayers(b.layers))}};
this.getSetNames=function(){return this.settable.keyArry()};this.getCurtName=function(){return this.currentname}};SPGIS.Layer.LayerSicInfo=function(){this.sicCharacter=this.sicFormat=this.sicName="";this.type=null;this.layerName="";this.sicResolutions=[];this.sicMaxExtent=new OpenLayers.Bounds(-400,25.470248828739557,119.84667086428351,400);this.sicCentre=new OpenLayers.LonLat(119.78491774496,25.477482630653);this.sicTileSize=new OpenLayers.Size(256,256);this.sicTileOrigin=new OpenLayers.LonLat(-400,400)};SPGIS.Mapping.Action=function(a){var b=null,c=null;this.createPoint=function(a,b){c=b;d("makePoint",a.layer,OpenLayers.Handler.Point)};this.createPath=function(a,b){c=b;d("makePath",a.layer,OpenLayers.Handler.Path)};this.createPolygon=function(a,b){c=b;d("makePolygon",a.layer,OpenLayers.Handler.Polygon)};this.createBox=function(a,b){d("makeBox",a.layer,OpenLayers.Handler.Box,b)};this.createCircle=function(a,b){d("makCircle",a.layer,OpenLayers.Handler.RegularPolygon,b)};this.selectFeature=function(c,
d){b=new OpenLayers.Control.SelectFeature(c.layer,{onSelect:function(a){b.deactivate();d.call(this,a)}});a.addControl(b);b.activate()};this.close=function(){b.deactivate();a.removeControl(b)};var d=function(c,d,h,j){actionname=c;null!=b&&(b.deactivate(),a.removeControl(b));h==OpenLayers.Handler.Box?(currentActionLayer=d,b=new OpenLayers.Control,OpenLayers.Util.extend(b,{draw:function(){this.box=new OpenLayers.Handler.Box(b,{done:this.notice});this.box.activate()},notice:function(b){this.box.deactivate();
var c=a.getLonLatFromPixel(new SPGIS.Mapping.Pixel(b.left,b.bottom)),b=a.getLonLatFromPixel(new SPGIS.Mapping.Pixel(b.right,b.top));queryBounds=new SPGIS.Geometry.Bounds(c.lon,c.lat,b.lon,b.lat);j(queryBounds)}}),a.addControl(b)):h==OpenLayers.Handler.RegularPolygon?(currentActionLayer=d,b=new OpenLayers.Control,OpenLayers.Util.extend(b,{draw:function(){this.circle=new OpenLayers.Handler.RegularPolygon(b,{done:this.notice},{sides:150});this.circle.activate()},notice:function(a){this.circle.deactivate();
j(a)}}),b.events.on({featureadded:e}),a.addControl(b)):(b=new OpenLayers.Control.DrawFeature(d,h),currentActionLayer=d,b.events.on({featureadded:e}),a.addControl(b),b.activate())},e=function(d){b.deactivate();a.removeControl(b);c.call(this,d)}};SPGIS.Theme=SPGIS.Theme||{};SPGIS.Theme.Icon=function(a,b,c){var d=null;return d=new OpenLayers.Icon(a,b,c)};SPGIS.Theme.Icon.IconType={red:"\u7ea2\u8272",blue:"\u84dd\u8272"};SPGIS.Mapping.LonLat=function(a,b){return new OpenLayers.LonLat(a,b)};SPGIS.Map=function(a){OpenLayers.DOTS_PER_INCH=96;OpenLayers.Util.onImageLoadErrorColor="transparent";var b={projection:new OpenLayers.Projection("EPSG:4326"),controls:[new OpenLayers.Control.Navigation,new OpenLayers.Control.TouchNavigation({dragPanOptions:{enableKinetic:!0}})]},c=new OpenLayers.Map(a,b),a=c.viewPortDiv.offsetTop+c.viewPortDiv.offsetHeight-15;$("#map_sth").css("top",a);this.layerset=new SPGIS.Layer.LayerSet("m",c);this.layerset.initSet();this.showSicMapOfName=function(a){this.layerset.showSet(a)};
this.getCurrentSicMapName=function(){this.layerset.getCurtName()};this.getSicMapNames=function(){return this.layerset.getSetNames()};this.addLayer=function(a){c.addLayers([a.layer])};this.getLayers=function(){return c.layers};this.removeLayer=function(a){a=c.getLayersByName(a);null!=a&&0<a.length&&c.removeLayer(a[0])};this.getLayer=function(a){return c.getLayersByName(a)};this.addControl=function(a,b){c.addControl(a,b)};this.removeControl=function(a){c.removeControl(a)};this.zoomToExtent=function(a){c.zoomToExtent(a,
!0)};this.zoomToScale=function(a){c.zoomToScale(a)};this.createAction=function(){return new SPGIS.Mapping.Action(c)};this.show=function(){c.setCenter(new OpenLayers.LonLat(119.78491774496,25.477482630653),2)};this.showOfBounds=function(a){null!=a&&c.zoomToExtent(a)};this.getBounds=function(){return c.calculateBounds(c.getCenter(),c.getResolution())};this.setCenter=function(a,b){c.setCenter(a,b)};this.zoomTo=function(a){c.zoomTo(a)};this.getCenter=function(){return c.getCenter()};this.zoomOut=function(){c.zoomOut()};
this.zoomIn=function(){c.zoomIn()};this.getLonLatFromPixel=function(a){return c.getLonLatFromPixel(a)};this.getPixelFromLonLat=function(a){return c.getPixelFromLonLat(a)};this.addEventListener=function(a,b){c.events.register(a,null,b)};this.removeEventListener=function(a,b){c.events.unregister(a,null,b)};this.getResolution=function(){return c.getResolution()};this.updateSize=function(){return c.updateSize()};this.getSize=function(){return c.getSize()};this.eventsRegister=function(a,b,f,g){c.events.register(a,
b,f,g)};this.calculateBounds=function(){return c.calculateBounds()};this.getProjectionObject=function(){return c.getProjectionObject()}};SPGIS.Mapping.Marker=function(a,b,c,d,e,f,g,h){a=new OpenLayers.Feature(a,b);a.closeBox=d;a.popupClass=c;a.data.popupContentHTML=f;a.data.overflow=e?"auto":"hidden";a.data.icon=g;c=a.createMarker();c.events.register("mousedown",a,function(a){$("#markerId").val(h);null==this.popup?(this.popup=this.createPopup(this.closeBox),a.object.map.addPopup(this.popup),this.popup.show()):this.popup.toggle();currentPopup=this.popup;OpenLayers.Event.stop(a)});return c};SPGIS.Mapping.Pixel=function(a,b){return new OpenLayers.Pixel(a,b)};SPGIS.Mapping.Popup=function(a,b,c,d,e,f,g){this.popup=new OpenLayers.Popup(a,b,c,e,f,g);this.popup.offset=d;this.destroy=function(){this.popup.destroy()};this.cTag=function(){this.destroy()}};SPGIS.Mapping.Popup.FramedCloud=function(a,b,c,d,e,f,g){a=new OpenLayers.Popup.FramedCloud(a,b,c,d,e,f,g);a.autoSize=!1;return a};SPGIS.Mapping.Popup.Class=function(a){return a?OpenLayers.Class(OpenLayers.Popup.FramedCloud,{autoSize:!0}):OpenLayers.Class(OpenLayers.Popup.Anchored,{autoSize:!0})};SPGIS.Mapping.Projection=function(){return new OpenLayers.Projection("EPSG:4326")};SPGIS.Mapping.ScreenShot=function(){this.getURL=function(){str="<div>";$("img.olTileImage").each(function(a,b){str+=b.outerHTML});str+="</div>";OpenWindow=window.open("","ScreenShot");OpenWindow.document.write(str);OpenWindow.document.close()}};SPGIS.Mapping.Size=function(a,b){return new OpenLayers.Size(a,b)};SPGIS.Mapping.StyleMap=function(a){return new OpenLayers.StyleMap(a)};SPGIS.Base.Chars=SPGIS.Base.Chars||{};SPGIS.Base.Chars.E001="\u8bbf\u95ee\u670d\u52a1\u53d1\u751f\u5f02\u5e38";SPGIS.Base.Chars.E002="\u6570\u636e\u6e90\u8fde\u63a5\u5931\u8d25";SPGIS.Base.Chars.E003="\u67e5\u8be2\u6210\u529f";SPGIS.Base.Chars.E004="\u64cd\u4f5c\u6210\u529f";SPGIS.Base.Chars.E005="\u67e5\u8be2\u6210\u529f,\u4f46\u662f\u6ca1\u6709\u83b7\u53d6\u8fd4\u56de\u6570\u636e";SPGIS.Base.Chars.E006="\u6ca1\u6709\u5b9a\u4e49\u56de\u8c03\u51fd\u6570";SPGIS.Base.Chars.E007="\u9519\u8bef\u7684\u7c7b\u578b";SPGIS.Resource=SPGIS.Resource||{layersets:null,approveFigure:"",mapoption:null,imgResSicRoot:"",getdata:function(a){var b=new Lemon.LemonModule("getResource"),c=new Lemon.CaiJSON(function(b){0<b.length&&(SPGIS.Resource.layersets=b[0].data,SPGIS.Resource.imgResSicRoot=b[1].data);null!=a&&a({state:0})},function(){Lemon.MSG.error(SPGIS.Base.Chars.E001)});(new Lemon.SaiTier(SPGIS.SIC,c,b)).launch(Lemon.DoType.Get)}};SPGIS.Verify.PortalAdmin=function(){this.state="";this.exists=function(){var a=this,b=new Lemon.LemonModule("existsPortalAdmin"),c=new Lemon.CaiJSON(function(b){null==b||0==b.length||(a.state=b[0].data,alert(a.state))},function(){Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E001)});(new Lemon.SaiTier(SPGIS.SIC,c,b)).launch(Lemon.DoType.Post)}};SPGIS.VerifyKey=function(a,b){var c=window.location.host;window.location.href.split("/");var d=new Lemon.LemonModule("checkoutPortal");d.addPar("urldomain",c);d.addPar("userkey",a);c=new Lemon.CaiJSON(function(a){null==a?null!=b&&b({state:-1}):0==a.length?SPGIS.Resource.getdata(b):"\u8bbf\u95ee\u6388\u6743\u5931\u8d25"==a[0].data?null!=b&&b({state:1}):2<a.length?(SPGIS.Resource.layersets=a[1].data,SPGIS.Resource.imgResSicRoot=a[2].data,null!=b&&b({state:0})):null!=b&&b({state:1})},function(){Lemon.MSG.error(SPGIS.Base.Chars.E001)});
(new Lemon.SaiTier(SPGIS.SIC,c,d)).launch(Lemon.DoType.Get)};SPGIS.Theme.HeatChart=function(a,b){this.lname=b;this.pmap=a;this.hour=this.date=this.cityName=this.cityCode="";this.colorInterval={"0.1":"rgb(0,0,255)","0.2":"rgb(0,255,255)","0.4":"rgb(0,255,0)","0.5":"yellow",1:"rgb(255,0,0)"};this.blur=15;this.max=!1;this.radius=20;this.region=null;this.filter=SPGIS.Theme.ViewFilter.property;this.bearlayer=null;this.opacity=0.3;this.maxpeople=0;this.show=function(a){if(""==this.date||""==this.hour)return"\u65e5\u671f\u548c\u5c0f\u65f6\u4e0d\u80fd\u4e3a\u7a7a";
if(this.filter!=SPGIS.Theme.ViewFilter.geometry&&""==this.cityCode&&""==this.cityName)return"\u57ce\u5e02\u7f16\u7801\u548c\u57ce\u5e02\u540d\u79f0\u81f3\u5c11\u6307\u5b9a\u4e00\u4e2a";if(0==this.pmap.getLayers().length&&null==this.bearlayer)return"\u8bf7\u52a0\u8f7d\u57fa\u7840\u56fe\u5c42\u6216\u6307\u5b9a\u627f\u8f7d\u70ed\u529b\u56fe\u7684\u57fa\u7840\u56fe\u5c42\u5bf9\u8c61";var b=this,e=new Lemon.LemonModule("getPoptOfDateName");e.addPar("sdate",this.date);e.addPar("shour",this.hour);e.addPar("saddressname",
this.cityName);e.addPar("saddresscode",this.cityCode);if(null!=this.region){for(var f=[],g=0;g<this.region.length;g++){var h=new SPGIS.Data.TransitionSpation;this.region[g]instanceof OpenLayers.Bounds?(h=h.toPtMultiPolygonFromBounds(this.region[g]),f.push(h)):this.region[g]instanceof OpenLayers.Geometry.Polygon&&(h=h.toPtMultiPolygonFromPolygon(this.region[g]),f.push(h))}e.addPar("region",f)}else e.addPar("region",null);e.addPar("filter",this.filter);f=new Lemon.CaiJSON(function(e){if(!(null==e||
0==e.length)){for(var f=[],g=e[0].data[0].number,h=0;h<e[0].data.length;h++){0<h&&(g=g>e[0].data[h].number?g:e[0].data[h].number);var o=new SPGIS.Layer.HeatPoint(e[0].data[h].geometry.coordinates[0],e[0].data[h].geometry.coordinates[1],e[0].data[h].number);f.push(o)}b.maxpeople=7*g;e=new SPGIS.Layer.HeatLayer(b.lname,b.pmap,null==b.bearlayer?b.pmap.layerset.map.layers[0]:b.bearlayer,{visible:!0,radius:b.radius,blur:b.blur,max:b.max,gradient:b.colorInterval},{isBaseLayer:!1,opacity:b.opacity,projection:new SPGIS.Mapping.Projection});
b.pmap.addLayer(e);e.setDataSet(f);a&&a(b.maxpeople)}},function(){Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E001)});(new Lemon.SaiTier(SPGIS.SIC,f,e)).launch(Lemon.DoType.Post)};this.hide=function(){this.pmap.removeLayer(this.lname)};this.setMaxPeople=function(a){this.maxPeople=a}};SPGIS.Theme.MigrateChart=function(a,b){this.lname=b;this.pmap=a;this.hour=this.date=this.outflowcode=this.districtcode=this.inflowcode="";this.range=null;this.contrast=0;this.bearlayer=null;this.show=function(){if(""==this.date)return"\u65f6\u95f4\u4e0d\u80fd\u4e3a\u7a7a!";if(""==this.inflowcode&&""==this.outflowcode)return"\u8fc1\u5165 \uff0c\u8fc1\u51fa\u57ce\u5e02\u81f3\u5c11\u6709\u4e00\u4e2a\u4e0d\u80fd\u4e3a\u7a7a";var b=this,d=new Lemon.LemonModule("getMigrateDate");d.addPar("sdate",this.date);
d.addPar("shour",this.hour);d.addPar("sinflowcode",this.inflowcode);d.addPar("soutflowcode",this.outflowcode);d.addPar("sdistrictcode",this.districtcode);var e=new Lemon.CaiJSON(function(d){if(!(null==d||0==d[0].data.length)){a.removeLayer("layer");var d=d[0].data,e,h,j=new SPGIS.Layer.Vector("layer");new SPGIS.Layer.Vector("point_layer");var l=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);l.fillOpacity=0.2;l.graphicOpacity=1;var m=!0,n,o,p;p=OpenLayers.Util.extend({},l);n=
OpenLayers.Util.extend({},l);n.strokeColor="gold";n.fillColor="gold";n.strokeOpacity=0.8;n.fillOpacity=0.6;n.pointRadius=10;n.strokeWidth=5*this.contrast;""!=b.inflowcode?(h=d[0].inflow.location.longitude,o=d[0].inflow.location.latitude,e=new SPGIS.Geometry.Point(h,o),m=!0):(h=d[0].outflow.location.longitude,o=d[0].outflow.location.latitude,e=new SPGIS.Geometry.Point(h,o),m=!1);o=new SPGIS.Feature(e,null,n);j.addFeatures(o);for(var q=0;q<d.length;q++){if(m){if(!d[q].outflow||!d[q].outflow.location||
""==d[q].outflow.location)continue;h=d[q].outflow.location.longitude;o=d[q].outflow.location.latitude}else{if(!d[q].inflow||!d[q].inflow.location||""==d[q].inflow.location)continue;h=d[q].inflow.location.longitude;o=d[q].inflow.location.latitude}h=new SPGIS.Geometry.Point(h,o);2E3>d[q].number?(this.contrast=0.4,n=OpenLayers.Util.extend({},l),n.strokeColor="gold",n.fillColor="gold",n.strokeOpacity=this.contrast,n.fillOpacity=this.contrast,n.pointRadius=2,n.strokeWidth=5*this.contrast):5E3>d[q].number?
(this.contrast=0.8,n=OpenLayers.Util.extend({},l),n.strokeColor="gold",n.fillColor="gold",n.strokeOpacity=this.contrast,n.fillOpacity=this.contrast,n.pointRadius=2,n.strokeWidth=5*this.contrast):5E3<=d[q].number&&(this.contrast=1,n=OpenLayers.Util.extend({},l),n.strokeColor="gold",n.fillColor="gold",n.strokeOpacity=this.contrast,n.fillOpacity=this.contrast,n.pointRadius=2,n.strokeWidth=5*this.contrast);m?(o=new SPGIS.Geometry.LineString([h,e]),o=SPGIS.Feature(o,null,n),j.addFeatures(o),o=getLineAngle(o),
n.pointRadius=10,n.externalGraphic=SPGIS.Resource.imgResSicRoot+"DirectionBlueFill.png",n.graphicOpacity=1,n.rotation=o,o=SPGIS.Feature(e,null,n),j.addFeatures(o),p.pointRadius=10,p.externalGraphic=null,p.fillOpacity=0.2,p.strokeOpacity=0.1,h=new SPGIS.Geometry.Point(h.x+1E-8,h.y+1E-6),h=SPGIS.Feature(h,null,p),j.addFeatures(h),p.pointRadius=10,p.externalGraphic=null,p.fillOpacity=0.2,p.strokeOpacity=0.1,h=new SPGIS.Geometry.Point(e.x+1E-8,e.y+1E-6)):(o=new SPGIS.Geometry.LineString([e,h]),o=SPGIS.Feature(o,
null,n),j.addFeatures(o),o=getLineAngle(o),n.pointRadius=10,n.externalGraphic=SPGIS.Resource.imgResSicRoot+"DirectionBlueFill.png",n.graphicOpacity=1,n.rotation=o,o=SPGIS.Feature(h,null,n),j.addFeatures(o),p.pointRadius=10,p.externalGraphic=null,p.fillOpacity=0.2,p.strokeOpacity=0.1,h=new SPGIS.Geometry.Point(h.x+1E-8,h.y));h=SPGIS.Feature(h,null,p);j.addFeatures(h)}a.addLayer(j)}},function(){Lemon.MSG.MsgPanel.Debug(SPGIS.Base.Chars.E001)});(new Lemon.SaiTier(SPGIS.SIC,e,d)).launch(Lemon.DoType.Post)}};
function getQuadrantAngle(a,b,c){var d=0;0<=b&&0<=c?d=1:0<=b&&0>c?d=4:0>=b&&0<=c?d=2:0>=b&&0>c&&(d=3);return-a+[-1,90,-90,270,90][d]}
function getLineAngle(a){for(var b=[],c=[],d=[],e,f=0;f<a.geometry.components.length;f++){var g={x:a.geometry.components[f].x,y:a.geometry.components[f].y};if(0!=f){var h=(g.x+n.x)/2,j=(g.y+n.y)/2,l=g.x-n.x,m=g.y-n.y;e=180*Math.atan(m/l)/Math.PI;e=getQuadrantAngle(e,l,m);b.push(new OpenLayers.Geometry.LineString([new OpenLayers.Geometry.Point(g.x,g.y),new OpenLayers.Geometry.Point(n.x,n.y)]));c.push(new OpenLayers.Geometry.Point(h,j));d.push(e)}var n=g}return e};SPGIS.Theme.MigrateChartByName=function(a,b,c){this.contrast={flw:0.5,slw:17,fc:"#FFFF00",sc:"#FFFF00"};this.map=null;if(c||null!=c)if(null!=c.flw&&(this.contrast.flw=c.flw),null!=c.slw&&(this.contrast.slw=c.slw),null!=c.fc&&(this.contrast.fc=c.fc),null!=c.sc)this.contrast.sc=c.sc;if(!a||!b||""==a||""==b)return"\u8fc1\u5165\u8fc1\u51fa\u57ce\u5e02\u4e0d\u80fd\u4e3a\u7a7a\uff01";this.feature=null;this.flagcode=!1;this.getFeature=function(c){var f=this,g=new Lemon.LemonModule("getMigrateByName");g.addPar("sout_cityName",
$.trim(a));g.addPar("sin_cityName",$.trim(b));var h=new Lemon.CaiJSON(function(a){var b=a[0].data,a=[],g,h;h=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);h.fillOpacity=1;h.graphicOpacity=1;h=OpenLayers.Util.extend({},h);h.strokeColor=f.contrast.fc;h.strokeOpacity=1;h.fillColor=f.contrast.fc;h.fillOpacity=1;h.pointRadius=2;h.strokeWidth=4*f.contrast.flw;for(var o=0;o<b.length;o++)b[o].lon&&b[o].lat?(g=SPGIS.Geometry.Point(b[o].lon,b[o].lat),a.push(g)):alert("\u7f3a\u5931\u5730\u7406\u5750\u6807\u4fe1\u606f\uff01");
g=SPGIS.Geometry.LineString(a);b=g.getApproachCompoent(g.getLength()/2);o=0.05*g.getLength();g=null;g=0<(a[1].x-a[0].x)/(a[1].y-a[0].y)?new OpenLayers.Geometry.Point(b.x+o,b.y-o):new OpenLayers.Geometry.Point(b.x+o,b.y+o);b=[];b.push(a[0]);b.push(g);b.push(a[1]);a=new SPGIS.Geometry.Curve(b,0.6,2E3);new SPGIS.Geometry.Point(a.components[0].x,a.components[0].y);f.feature=SPGIS.Feature(a,null,h);c&&(c(f),(null!=f.map||f.map)&&d(a,f.map,1,f))},function(){alert("\u670d\u52a1\u5668\u5f02\u5e38!")});(new Lemon.SaiTier(SPGIS.SIC,
h,g)).launch(Lemon.DoType.Get)};this.setAnimation=function(a){this.map=a};this.clearAnimation=function(){this.flagcode=!0};var d=function(a,b,c,h){var j={strokeOpacity:0.1,strokeColor:h.contrast.sc,strokeWidth:h.contrast.slw,strokeLinecap:"round",pointRadius:4,pointerEvents:"visiblePainted",fillOpacity:1,fillColor:h.contrast.sc,graphicOpacity:0.1},l=new SPGIS.Layer.Vector("mtactionlayer",{style:j});b.addLayer(l);var m=0,n=[],o=setInterval(function(){if(h.flagcode)clearInterval(o);else if(m==a.components.length-
1)clearInterval(o),l.removeFeatures(l.lasttmpft),d(a,b,3,h);else{null!=l.lasttmpft&&l.removeFeatures(l.lasttmpft);null!=l.lasttmpftline&&l.removeFeatures(l.lasttmpftline);var p=a.components[m],q=new SPGIS.Feature(p,{style:j});l.addFeatures([q]);n.push(p);if(!c||3!=c){var p=new SPGIS.Geometry.LineString(n),r=new SPGIS.Feature(p,{style:j});l.addFeatures([r])}l.lasttmpft=q;l.lasttmpftline=r;m++}},1)}};SPGIS.Theme.ViewFilter=SPGIS.Theme.ViewFilter||{defaultway:0,property:1,geometry:2,getValue:function(a){return"defaultway"==a?this.defaultway:"property"==a?this.property:"geometry"==a?this.geometry:"mix"==a?this.mix:this.defaultway}};
