    ...
    var zp = {
        ...
        addhtml: function(obj, pageinit) {
            return (function() {
                ...
                obj.append('<span    style="margin-left: 10px;">' + '到第' + '<input type="number" class="zxfinput" value="'+(pageinit.okNum?pageinit.okNum:'')+'"/>' + '页' + '</span>');
        ...
        bindEvent: function(obj, pageinit) {
            return (function() {
                ...
                function() {
                    var cur = parseInt(obj.find(".zxfinput").val());
					if(isNaN(cur) || cur<1){
						cur = 1;
					}
