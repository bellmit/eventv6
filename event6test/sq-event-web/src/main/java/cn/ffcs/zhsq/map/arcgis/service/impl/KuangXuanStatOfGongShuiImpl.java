...
@Service(value = "kuangXuanStatOfGongShui")
public class KuangXuanStatOfGongShuiImpl implements IKuangXuanStatService {

	@Autowired
	protected IGisInfoService gisInfoService;

	/**
	 * 根据params的参数获取供水的统计信息
	 * 
	 * @param params
	 * @return
	 */
	...
	public int statOfKuangXuan(Map<String, Object> params) {
		params.put("resTypeId", 9L);
		params.put("markerType", "020201");
