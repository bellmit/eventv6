...
/**
 * 2015-03-20 周边资源校园周边实现类
 * @author sulch
 *
 */
@Service(value="zhouBianStatOfCampusService")
public class ZhouBianStatOfCampusServiceImpl implements IZhouBianStatService {
	@Autowired 
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		...
		int resultCount = this.zhouBianStatMapper.statOfCampusZhouBianCount(params);
		return resultCount;
	}
	...
	public EUDGPagination statOfZhouBianList(int pageNo, int pageSize,
		...
		if (pageNo == 1) {
			pagination.setTotal(this.zhouBianStatMapper.statOfCampusZhouBianCount(params));
		}
		RowBounds rowBounds = new RowBounds((pageNo - 1) * pageSize, pageSize);
		List<Map<String, Object>> list = this.zhouBianStatMapper.statOfCampusZhouBianListPage(params, rowBounds);
	...
	public String getZhouBianPagePath(String zhoubianType) {
		return "/map/arcgis/standardmappage/zhoubian/zhoubian_campus.ftl";
	}
