 ...
 * 
 */
@Service(value = "zhouBianStatOfCorrectionalService")
public class ZhouBianStatOfCorrectionalServiceImpl implements IZhouBianStatService {
	@Autowired
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("peopleTypeTableName", "T_ZZ_CORRECTIONAL_RECORD");
