...
/**
 * 2015-03-20 周边资源新消防栓、自来水公司、天然水源实现类
 * @author sulch
 *
 */
@Service(value="zhouBianStatOfFireHydrantService")
public class ZhouBianStatOfFireHydrantServiceImpl implements IZhouBianStatService {
	@Autowired 
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("markerType", "'0601','0602'");
		int resultCount = this.zhouBianStatMapper.statOfNewResourceZhouBianCount(params);
		return resultCount;
	}
	...
	public EUDGPagination statOfZhouBianList(int pageNo, int pageSize,
		...
		if (pageNo == 1) {
			pagination.setTotal(this.zhouBianStatMapper.statOfNewResourceZhouBianCount(params));
		}
		RowBounds rowBounds = new RowBounds((pageNo - 1) * pageSize, pageSize);
		List<Map<String, Object>> list = this.zhouBianStatMapper.statOfNewResourceZhouBianListPage(params, rowBounds);
