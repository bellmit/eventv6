 ...
 * 
 */
@Service(value = "zhouBianStatOfMentalService")
public class ZhouBianStatOfMentalServiceImpl implements IZhouBianStatService {
	@Autowired
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("peopleTypeTableName", "T_ZZ_MENTAL_ILLNESS_RECORD");
