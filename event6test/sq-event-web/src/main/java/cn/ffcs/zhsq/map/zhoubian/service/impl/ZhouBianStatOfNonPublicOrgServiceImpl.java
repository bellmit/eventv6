 ...
 */
@Service(value="zhouBianStatOfNonPublicOrgService")
public class ZhouBianStatOfNonPublicOrgServiceImpl implements IZhouBianStatService {
	@Autowired 
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("markerType", ConstantValue.NON_PUBLIC_ORG_MARKER_TYPE);
		int resultCount = this.zhouBianStatMapper.statOfNonPublicOrgsZhouBianCount(params);
		return resultCount;
	}
	...
	public EUDGPagination statOfZhouBianList(int pageNo, int pageSize,
		...
		if (pageNo == 1) {
			pagination.setTotal(this.zhouBianStatMapper.statOfNonPublicOrgsZhouBianCount(params));
		}
		RowBounds rowBounds = new RowBounds((pageNo - 1) * pageSize, pageSize);
		List<Map<String, Object>> list = this.zhouBianStatMapper.statOfNonPublicOrgsZhouBianListPage(params, rowBounds);
	...
	public String getZhouBianPagePath(String zhoubianType) {
		return "/map/arcgis/standardmappage/zhoubian/zhoubian_nonPublicOrg.ftl";
	}
