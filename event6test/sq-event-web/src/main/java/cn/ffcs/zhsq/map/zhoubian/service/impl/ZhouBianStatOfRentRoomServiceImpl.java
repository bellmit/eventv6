 ...
 * 周边资源出租屋实现类
 * @author sulch
 * 2015年12月3日 下午2:53:23
 */
@Service(value="zhouBianStatOfRentRoomService")
public class ZhouBianStatOfRentRoomServiceImpl implements IZhouBianStatService {
	@Autowired 
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("markerType", "'0801'");
		int resultCount = this.zhouBianStatMapper.statOfRentRoomsZhouBianCount(params);
		return resultCount;
	}
	...
	public EUDGPagination statOfZhouBianList(int pageNo, int pageSize,
		...
		if (pageNo == 1) {
			pagination.setTotal(this.zhouBianStatMapper.statOfRentRoomsZhouBianCount(params));
		}
		RowBounds rowBounds = new RowBounds((pageNo - 1) * pageSize, pageSize);
		List<Map<String, Object>> list = this.zhouBianStatMapper.statOfRentRoomsZhouBianListPage(params, rowBounds);
	...
	public String getZhouBianPagePath(String zhoubianType) {
		return "/map/arcgis/standardmappage/zhoubian/zhoubian_rentRoom.ftl";
	}
