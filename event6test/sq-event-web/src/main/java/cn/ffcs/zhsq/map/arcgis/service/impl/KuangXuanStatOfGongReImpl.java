...
@Service(value = "kuangXuanStatOfGongRe")
public class KuangXuanStatOfGongReImpl implements IKuangXuanStatService {

	@Autowired
	protected IGisInfoService gisInfoService;

	/**
	 * 根据params的参数获取供热的统计信息
	 * 
	 * @param params
	 * @return
	 */
	...
	public int statOfKuangXuan(Map<String, Object> params) {
		params.put("resTypeId", 10L);
		params.put("markerType", "020202");
