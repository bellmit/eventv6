 ...
 * 
 */
@Service(value = "zhouBianStatOfDrugService")
public class ZhouBianStatOfDrugServiceImpl implements IZhouBianStatService {
	@Autowired
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("peopleTypeTableName", "T_ZZ_DRUG_RECORD");
