 ...
 * @author YangCQ
 */
@Service(value="zhouBianStatOfCorBaseService")
public class ZhouBianStatOfCorBaseServiceImpl implements IZhouBianStatService {
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		int resultCount = this.zhouBianStatMapper.statOfCorBaseZhouBianCount(params);
		return resultCount;
	}
	...
	public EUDGPagination statOfZhouBianList(int pageNo, int pageSize, Map<String, Object> params) {
		...
		if (pageNo == 1) {
			pagination.setTotal(this.zhouBianStatMapper.statOfCorBaseZhouBianCount(params));
		}
		RowBounds rowBounds = new RowBounds((pageNo - 1) * pageSize, pageSize);
		List<Map<String, Object>> list = this.zhouBianStatMapper.statOfCorBaseZhouBianListPage(params, rowBounds);
	...
	public String getZhouBianPagePath(String zhoubianType) {
		return "/map/arcgis/standardmappage/zhoubian/zhoubian_corbase.ftl";
	}
