 ...
 *
 */
@Service(value="zhouBianDbrysService")
public class ZhouBianStatOfDbrysServiceImpl implements IZhouBianStatService {
	@Autowired 
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("peopleTypeTableName", "T_DC_CI_RS_POOR");
