...
@Service(value = "kuangXuanStatOfWellLid")
public class KuangXuanStatOfWellLidImpl implements IKuangXuanStatService {

	@Autowired
	protected IGisInfoService gisInfoService;

	/**
	 * 根据params的参数获取井盖的统计信息
	 * 
	 * @param params
	 * @return
	 */
