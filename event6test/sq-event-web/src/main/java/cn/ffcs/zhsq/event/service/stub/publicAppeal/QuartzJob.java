package cn.ffcs.zhsq.event.service.stub.publicAppeal;
    ...
    private void save(String jsonStr) {
        ...
        for (Object tempJsonObj : rows) {
            ...
            if (jsonRows.get("createTime") != null) {//发生时间
                ...
                Date date = cn.ffcs.shequ.utils.date.DateUtils.formatDate(happenTimeRow, "yyyyMMddHHmmss");
