...
@Service(value="zhouBianStatOfPrvetionTeamService")
public class ZhouBianStatOfPrvetionTeamServiceImpl implements IZhouBianStatService {
	@Autowired 
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("markerType", "'1101'");
		int resultCount = this.zhouBianStatMapper.statOfPrvetionTeamZhouBianCount(params);
		return resultCount;
	}
	...
	public EUDGPagination statOfZhouBianList(int pageNo, int pageSize,
		...
		if (pageNo == 1) {
			pagination.setTotal(this.zhouBianStatMapper.statOfPrvetionTeamZhouBianCount(params));
		}
		RowBounds rowBounds = new RowBounds((pageNo - 1) * pageSize, pageSize);
		List<Map<String, Object>> list = this.zhouBianStatMapper.statOfPrvetionTeamZhouBianListPage(params, rowBounds);
	...
	public String getZhouBianPagePath(String zhoubianType) {
		return "/map/arcgis/standardmappage/zhoubian/zhoubian_prvetionTeam.ftl";
	}
