...
@Service(value="zhouBianStatOfYouthService")
public class ZhouBianStatOfYouthServiceImpl implements IZhouBianStatService {
	@Autowired 
	...
	public int statOfZhouBianCount(Map<String, Object> params) {
		params.put("peopleTypeTableName", "T_ZZ_YOUTH");
